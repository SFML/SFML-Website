<?php
    ...
    (
        ...
        'SFML 2.4.2' => 'download/sfml/2.4.2'
    );
    include('../../../header.php');
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('Clang', '64-bit (OS X 10.7+, compatible with C++11 and libc++)', '5.34', '../../../files/SFML-2.4.2-osx-clang.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Source code</span><a href="../../../files/SFML-2.4.2-sources.zip">Download<span class="size">23.8 MB</span></a></td>
        </tr>
        <tr>
            <td><span class="description">HTML Documentation</span><a href="../../../files/SFML-2.4.2-doc.zip">Download<span class="size">1.48 MB</span></a></td>
        </tr>
    </tbody>
</table>
