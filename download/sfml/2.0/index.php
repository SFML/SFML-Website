...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('GCC', 'universal 32+64 bits (OS X 10.5+)', '5.90', 'SFML-2.0-osx-gcc-universal.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Clang', 'universal 32+64 bits (OS X 10.8+, compatible with C++11 and libc++)', '6.05', 'SFML-2.0-osx-clang-universal.zip') ?></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
