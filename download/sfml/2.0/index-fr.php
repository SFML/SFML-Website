...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('GCC', 'universel 32+64-bit (OS X 10.5+)', '5.90', '../../../files/SFML-2.0-osx-gcc-universal.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Clang', 'universel 32+64-bit (OS X 10.8+, compatible C++11 et libc++)', '6.05', '../../../files/SFML-2.0-osx-clang-universal.zip') ?></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.0-sources.zip">Télécharger<span class="size">12.5 Mo</span></a></td>
        </tr>
    </tbody>
</table>
