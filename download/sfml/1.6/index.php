<?php
    ...
    function download_link($compiler, $arch, $size, $link)
    {
        ...
        echo '<span class="description">' . $compiler . ' - ' . $arch . '</span><a href="http://downloads.sourceforge.net/sfml/' . $link . '" onclick="' . $counter_script . '">Download<span class="size">' . $size . ' MB</span></a>';
    }
?>
