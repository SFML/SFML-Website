<?php
    ...
    (
        ...
        'SFML 2.4.1' => 'download/sfml/2.4.1/index-fr.php'
    );
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('Clang', '64-bit (OS X 10.7+, compatible C++11 et libc++)', '5.34', '../../../files/SFML-2.4.1-osx-clang.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.4.1-sources.zip">Télécharger<span class="size">23.8 Mo</span></a></td>
        </tr>
        <tr>
            <td><span class="description">Documentation HTML</span><a href="../../../files/SFML-2.4.1-doc.zip">Télécharger<span class="size">1.42 Mo</span></a></td>
        </tr>
    </tbody>
</table>
