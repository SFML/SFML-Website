...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td><?php download_link('Visual C++ 17 (2022)', '32-bit', '20.3', '../../../files/SFML-2.6.0-windows-vc17-32-bit.zip') ?></td>
            <td><?php download_link('Visual C++ 17 (2022)', '64-bit', '21.9', '../../../files/SFML-2.6.0-windows-vc17-64-bit.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Visual C++ 16 (2019)', '32-bit', '19.3', '../../../files/SFML-2.6.0-windows-vc16-32-bit.zip') ?></td>
            <td><?php download_link('Visual C++ 16 (2019)', '64-bit', '20.8', '../../../files/SFML-2.6.0-windows-vc16-64-bit.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Visual C++ 15 (2017)', '32-bit', '17.7', '../../../files/SFML-2.6.0-windows-vc15-32-bit.zip') ?></td>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            ...
            <td><?php download_link('GCC', '64-bit', '8.43', '../../../files/SFML-2.6.0-linux-gcc-64-bit.tar.gz') ?></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.6.0-sources.zip">Télécharger<span class="size">24.7 Mo</span></a></td>
        </tr>
        <tr>
            <td><span class="description">Documentation HTML</span><a href="../../../files/SFML-2.6.0-doc.zip">Télécharger<span class="size">2.03 Mo</span></a></td>
        </tr>
    </tbody>
</table>
