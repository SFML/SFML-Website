<?php
    ...
    (
        ...
        'SFML 2.3.1' => 'download/sfml/2.3.1'
    );
    include('../../../header.php');
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Source code</span><a href="../../../files/SFML-2.3.1-sources.zip">Download<span class="size">21.5 MB</span></a></td>
        </tr>
        <tr>
            <td><span class="description">HTML Documentation</span><a href="../../../files/SFML-2.3.1-doc.zip">Download<span class="size">1.43 MB</span></a></td>
        </tr>
    </tbody>
</table>
