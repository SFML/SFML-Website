...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('GCC', 'universal 32+64 bits (OS X 10.5+)', '5.63', 'SFML-2.1-osx-gcc-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Clang', 'universal 32+64 bits (OS X 10.8+, compatible with C++11 and libc++)', '5.93', 'SFML-2.1-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
