...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('GCC', 'universel 32+64-bit (OS X 10.5+)', '5.63', 'SFML-2.1-osx-gcc-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Clang', 'universel 32+64-bit (OS X 10.8+, compatible C++11 et libc++)', '5.93', 'SFML-2.1-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
