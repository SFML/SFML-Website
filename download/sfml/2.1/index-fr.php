...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('GCC', 'universel 32+64-bit (OS X 10.5+)', '5.63', '../../../files/SFML-2.1-osx-gcc-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Clang', 'universel 32+64-bit (OS X 10.8+, compatible C++11 et libc++)', '5.93', '../../../files/SFML-2.1-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td><span class="description">Templates pour Xcode 5</span><a href="../../../files/SFML-2.1-osx-xcode5-template.zip">Télécharger<span class="size">1.16 Mo</span></a></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.1-sources.zip">Télécharger<span class="size">9.27 Mo</span></a></td>
        </tr>
    </tbody>
</table>
