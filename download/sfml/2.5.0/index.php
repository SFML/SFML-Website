<?php
    ...
    (
        ...
        'SFML 2.5.0' => 'download/sfml/2.5.0'
    );
    include('../../../header.php');
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Source code</span><a href="../../../files/SFML-2.5.0-sources.zip">Download<span class="size">23.8 MB</span></a></td>
        </tr>
        <tr>
            <td><span class="description">HTML Documentation</span><a href="../../../files/SFML-2.5.0-doc.zip">Download<span class="size">1.48 MB</span></a></td>
        </tr>
    </tbody>
</table>
