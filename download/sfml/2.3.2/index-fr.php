<?php
    ...
    (
        ...
        'SFML 2.3.2' => 'download/sfml/2.3.2/index-fr.php'
    );
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('Clang', 'universel 32+64-bit (OS X 10.7+, compatible C++11 et libc++)', '6.05', '../../../files/SFML-2.3.2-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="notice" colspan="3">
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.3.2-sources.zip">Télécharger<span class="size">21.5 Mo</span></a></td>
        </tr>
        <tr>
            <td><span class="description">Documentation HTML</span><a href="../../../files/SFML-2.3.2-doc.zip">Télécharger<span class="size">1.38 Mo</span></a></td>
        </tr>
    </tbody>
</table>
