<?php
    ...
    (
        ...
        'SFML 2.6.2' => 'download/sfml/2.6.2/index-fr.php'
    );
    include('../../../header-fr.php');

    function download_link($compiler, $arch, $size, $link)
    {
        $counter_script = "_gaq.push(['_trackEvent', 'Download', 'SFML 2.6.2']);";
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td><?php download_link('Visual C++ 17 (2022)', '32-bit', '20.9', '../../../files/SFML-2.6.2-windows-vc17-32-bit.zip') ?></td>
            <td><?php download_link('Visual C++ 17 (2022)', '64-bit', '22.3', '../../../files/SFML-2.6.2-windows-vc17-64-bit.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Visual C++ 16 (2019)', '32-bit', '19.7', '../../../files/SFML-2.6.2-windows-vc16-32-bit.zip') ?></td>
            <td><?php download_link('Visual C++ 16 (2019)', '64-bit', '21.2', '../../../files/SFML-2.6.2-windows-vc16-64-bit.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('Visual C++ 15 (2017)', '32-bit', '18.1', '../../../files/SFML-2.6.2-windows-vc15-32-bit.zip') ?></td>
            <td><?php download_link('Visual C++ 15 (2017)', '64-bit', '19.8', '../../../files/SFML-2.6.2-windows-vc15-64-bit.zip') ?></td>
        </tr>
        <tr>
            <td><?php download_link('GCC 13.1.0 MinGW (DW2)', '32-bit', '18.3', '../../../files/SFML-2.6.2-windows-gcc-13.1.0-mingw-32-bit.zip') ?></td>
            <td><?php download_link('GCC 13.1.0 MinGW (SEH)', '64-bit', '19.4', '../../../files/SFML-2.6.2-windows-gcc-13.1.0-mingw-64-bit.zip') ?></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            ...
            <td><?php download_link('GCC', '64-bit', '8.27', '../../../files/SFML-2.6.2-linux-gcc-64-bit.tar.gz') ?></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Clang - 64-bit (macOS 10.15+, compatible C++11 et libc++)</span> <a href="#">TBD</a></td>
        </tr>
        <tr>
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Code source</span><a href="../../../files/SFML-2.6.2-sources.zip">Télécharger<span class="size">27.7 Mo</span></a></td>
        </tr>
        <tr>
            <td><span class="description">Documentation HTML</span><a href="../../../files/SFML-2.6.2-doc.zip">Télécharger<span class="size">2.49 Mo</span></a></td>
        </tr>
    </tbody>
</table>
