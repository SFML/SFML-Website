<?php
    ...
    (
        ...
        'SFML 2.6.2' => 'download/sfml/2.6.2'
    );
    include('../../../header.php');
...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><span class="description">Source code</span><a href="../../../files/SFML-2.6.2-sources.zip">Download<span class="size">27.7 MB</span></a></td>
        </tr>
        <tr>
            <td><span class="description">HTML Documentation</span><a href="../../../files/SFML-2.6.2-doc.zip">Download<span class="size">2.49 MB</span></a></td>
        </tr>
    </tbody>
</table>
