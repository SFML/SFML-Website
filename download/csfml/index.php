...
<table class="styled download">
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2"><?php download_link('2.1', 'GCC', 'universal 32+64-bit (OS X 10.5+)', '0.62', 'CSFML-2.1-osx-gcc-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td colspan="2"><?php download_link('2.1', 'Clang', 'universal 32+64-bit (OS X 10.8+, compatible with C++11 and libc++)', '0.64', 'CSFML-2.1-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="os">All</td>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os" rowspan="2">Mac OS X</td>
            <td colspan="2"><?php download_link('2.0', 'GCC', 'universal 32+64-bit (OS X 10.5+)', '0.99', 'CSFML-2.0-osx-gcc-universal.zip') ?></td>
        </tr>
        <tr>
            <td colspan="2"><?php download_link('2.0', 'Clang', 'universal 32+64-bit (OS X 10.8+, compatible with C++11 and libc++)', '0.99', 'CSFML-2.0-osx-clang-universal.zip') ?></td>
        </tr>
        <tr>
            <td class="os">All</td>
