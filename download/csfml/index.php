...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">All</td>
            <td colspan="2"><span class="description">Code source</span><a href="../../files/CSFML-2.6.1-sources.zip">Download<span class="size">0.47 MB</span></a></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">All</td>
            <td colspan="2"><span class="description">Source code</span><a href="../../files/CSFML-2.6.0-sources.zip">Download<span class="size">0.47 MB</span></a></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">All</td>
            <td colspan="2"><span class="description">Source code</span><a href="../../files/CSFML-2.5.2-sources.zip">Download<span class="size">0.31 MB</span></a></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">All</td>
            <td colspan="2"><span class="description">Source code</span><a href="../../files/CSFML-2.5.1-sources.zip">Download<span class="size">0.31 MB</span></a></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">macOS</td>
            <td colspan="2"><?php download_link('2.3', 'Clang', 'universal 32+64-bit (OS X 10.7+, compatible with C++11 and libc++)', '0.21', '../../files/CSFML-2.3-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="os">All</td>
            <td colspan="2"><span class="description">Source code</span><a href="../../files/CSFML-2.3-sources.zip">Download<span class="size">0.25 MB</span></a></td>
        </tr>
    </tbody>
</table>
...
<table class="styled download">
    <tbody>
        ...
        <tr>
            <td class="os">macOS</td>
            <td colspan="2"><?php download_link('2.2', 'Clang', 'universal 32+64-bit (OS X 10.7+, compatible with C++11 and libc++)', '1.74', '../../files/CSFML-2.2-osx-clang-universal.tar.gz') ?></td>
        </tr>
        <tr>
            <td class="os">All</td>
