...
<p>
    ...
    une compatibilité maximale entre les plateformes. L'API de SFML.Net est proche de l'API C++, mais dans le style .Net : les conventions
...
<table class="styled download">
    <tbody>
        <tr>
            <td class="os" rowspan="2">All</td>
            <td><span class="description">Package officiel de NuGet</span><a href="https://www.nuget.org/packages/SFML.Net/2.5.0" target="_blank">SFML.Net</a></td>
        </tr>
        <tr>
