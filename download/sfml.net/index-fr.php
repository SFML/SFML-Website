...
<table class="styled download">
    <tbody>
        <tr>
            ...
            <td><?php download_link('2.1', 'Tous compilateurs', '32-bit', '2.63', 'SFML.Net-2.1-32bits.zip') ?></td>
            <td><?php download_link('2.1', 'Tous compilateurs', '64-bit', '2.66', 'SFML.Net-2.1-64bits.zip') ?></td>
        </tr>
        <tr>
...
<table class="styled download">
    <tbody>
        <tr>
            <td class="os" rowspan="2">Tous les OS</td>
            <td><?php download_link('2.0', 'Tous compilateurs', '32-bit', '2.43', 'SFML.Net-2.0-32bits.zip') ?></td>
            <td><?php download_link('2.0', 'Tous compilateurs', '64-bit', '2.62', 'SFML.Net-2.0-64bits.zip') ?></td>
        </tr>
        <tr>
