...
| 32-bit                                                                                                                                 | 64-bit                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Visual C++ 17 (2022) - [Download &#124; 61.7 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-vc17-32-bit.zip)                      | Visual C++ 17 (2022) - [Download &#124; 68.3 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-vc17-64-bit.zip)                      |
| GCC 14.2.0 MinGW (DW2) (UCRT) - [Download &#124; 70.4 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-gcc-14.2.0-mingw-32-bit.zip) | GCC 14.2.0 MinGW (SEH) (UCRT) - [Download &#124; 74.3 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-gcc-14.2.0-mingw-64-bit.zip) |
...
If you require a 32-bit build of SFML you'll have to [build it yourself](../../tutorials/3.1/getting-started/cmake.md).
...
GCC - 64-bit - [Download &#124; 18.4 MB](https://www.sfml-dev.org/files/SFML-3.1.0-linux-gcc-64-bit.tar.gz)

## macOS

!!! info

    You can also use [Homebrew](https://brew.sh/) to install SFML 3.1.0: `brew install sfml@3.1.0`

Clang - 64-bit (macOS 14.2+) - [Download &#124; 34.6 MB](https://www.sfml-dev.org/files/SFML-3.1.0-macOS-clang-64-bit.tar.gz)

Clang - ARM64 (macOS 15.5+) - [Download &#124; 33.4 MB](https://www.sfml-dev.org/files/SFML-3.1.0-macOS-clang-arm64.tar.gz)


## All OS

Source code - [Download &#124; 4.53 MB](https://www.sfml-dev.org/files/SFML-3.1.0-sources.zip)

HTML Documentation - [Download &#124; 2.6 MB](https://www.sfml-dev.org/files/SFML-3.1.0-doc.zip)