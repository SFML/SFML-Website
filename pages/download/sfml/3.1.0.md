...
| 32-bit                                                                                                                                 | 64-bit                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| Visual C++ 17 (2022) - [Download &#124; 33.7 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-vc17-32-bit.zip)                      | Visual C++ 17 (2022) - [Download &#124; 36.9 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-vc17-64-bit.zip)                      |
| GCC 14.2.0 MinGW (DW2) (UCRT) - [Download &#124; 34.1 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-gcc-14.2.0-mingw-32-bit.zip) | GCC 14.2.0 MinGW (SEH) (UCRT) - [Download &#124; 36.3 MB](https://www.sfml-dev.org/files/SFML-3.1.0-windows-gcc-14.2.0-mingw-64-bit.zip) |
...
GCC - 64-bit - [Download &#124; MB 11.2](https://www.sfml-dev.org/files/SFML-3.1.0-linux-gcc-64-bit.tar.gz)
...
Clang - 64-bit (macOS 14.2+) - [Download &#124; MB 17.3](https://www.sfml-dev.org/files/SFML-3.1.0-macOS-clang-64-bit.tar.gz)

Clang - ARM64 (macOS 15.5+) - [Download &#124; MB 16.6](https://www.sfml-dev.org/files/SFML-3.1.0-macOS-clang-arm64.tar.gz)


## All OS

Source code - [Download &#124; 4.7 MB](https://www.sfml-dev.org/files/SFML-3.1.0-sources.zip)

HTML Documentation - [Download &#124; 2.3 MB](https://www.sfml-dev.org/files/SFML-3.1.0-doc.zip)