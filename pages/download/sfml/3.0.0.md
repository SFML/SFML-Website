...
GCC - 64-bit - [Download &#124; 15.9 MB](https://www.sfml-dev.org/files/SFML-3.0.0-linux-gcc-64-bit.tar.gz)
...
Clang - 64-bit (macOS 10.15+) - [Download &#124; 7.81 MB](https://www.sfml-dev.org/files/SFML-3.0.0-macOS-clang-64-bit.tar.gz)

Clang - ARM64 (macOS 11.3+) - [Download &#124; 7.37 MB](https://www.sfml-dev.org/files/SFML-3.0.0-macOS-clang-arm64.tar.gz)
