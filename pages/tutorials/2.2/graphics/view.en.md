...
## [Coordinates conversions](https://www.sfml-dev.org/tutorials/2.6/graphics-view.php#coordinates-conversions)[](https://www.sfml-dev.org/tutorials/2.6/graphics-view.php#top "Top of the page")
