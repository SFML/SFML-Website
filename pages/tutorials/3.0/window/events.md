...
You can either put this data directly in a [`sf::String`](../../../documentation/3.0.1/classsf_1_1String.html "sf::String documentation"), or cast it to a `char` after making sure that it is in the ASCII range (0 - 127).
...
The other (easier) solution to produce smooth movement is to use real-time keyboard input with [`sf::Keyboard`](../../../documentation/3.0.1/namespacesf_1_1Keyboard.html "sf::Keyboard documentation") (see the [dedicated tutorial](inputs.md "Real-time inputs tutorial")).
