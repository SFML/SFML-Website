...
Fonts are encapsulated in the [`sf::Font`](../../../documentation/3.0.2/classsf_1_1Font.html "sf::Font documentation") class, which provides three main features: loading a font, getting glyphs (i.e. visual characters) from it, and reading its attributes.
...
To draw text, you will be using the [`sf::Text`](../../../documentation/3.0.2/classsf_1_1Text.html "sf::Text documentation") class.
...
The functions involved are the same as for the [`sf::Sprite`](../../../documentation/3.0.2/classsf_1_1Sprite.html "sf::Sprite documentation") class and other SFML entities.
...
If [`sf::Text`](../../../documentation/3.0.2/classsf_1_1Text.html "sf::Text documentation") is too limited, or if you want to do something else with pre-rendered glyphs, [`sf::Font`](../../../documentation/3.0.2/classsf_1_1Font.html "sf::Font documentation") provides everything that you need.
...
The [`sf::Glyph`](../../../documentation/3.0.2/structsf_1_1Glyph.html "sf::Glyph documentation") structure contains three data members of interest.
