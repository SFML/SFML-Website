...
Circles are represented by the [`sf::CircleShape`](https://www.sfml-dev.org/documentation/3.0.0/classsf_1_1CircleShape.php "sf::CircleShape documentation") class.
