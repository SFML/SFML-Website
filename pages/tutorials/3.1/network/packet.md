...
The two other problems (endianness and message boundaries) are solved by using a specific class to pack your data: [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation").
...
Sending and receiving packets is as easy as sending/receiving an array of bytes: sockets have an overload of `send` and `receive` that directly accept a [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation").
...
However, it has a slight drawback: To preserve message boundaries, [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation") has to send some extra bytes along with your data, which implies that you can only receive them with a [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation") if you want them to be properly decoded.
...
As with standard streams, you can make a type "compatible" with [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation") by providing an overload of the `<<` and `>>` operators.
...
This can easily be done by deriving from [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation") and overriding the following functions:
...
Such a packet class can be used exactly like [`sf::Packet`](../../../documentation/3.1.0/classsf_1_1Packet.html "sf::Packet documentation").
