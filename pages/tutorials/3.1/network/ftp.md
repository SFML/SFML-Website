...
The class provided by SFML is [`sf::Ftp`](../../../documentation/3.1.0/classsf_1_1Ftp.html "sf::Ftp documentation") (surprising, isn't it?).
It's a client, which means that it can connect to an FTP server, send commands to it and upload or download files.

Every function of the [`sf::Ftp`](../../../documentation/3.1.0/classsf_1_1Ftp.html "sf::Ftp documentation") class wraps an FTP command, and returns a standard FTP response.
...
FTP responses are encapsulated in the [`sf::Ftp::Response`](../../../documentation/3.1.0/classsf_1_1Ftp_1_1Response.html "sf::Ftp::Response documentation") class.
...
The server address can be any valid [`sf::IpAddress`](../../../documentation/3.1.0/classsf_1_1IpAddress.html "sf::IpAddress documentation"): A URL, an IP address, a network name, ...
...
Here is a short description of all the commands available in the [`sf::Ftp`](../../../documentation/3.1.0/classsf_1_1Ftp.html "sf::Ftp documentation") class.
...
[`sf::Ftp::DirectoryResponse`](../../../documentation/3.1.0/classsf_1_1Ftp_1_1DirectoryResponse.html "sf::Ftp::DirectoryResponse documentation") is a specialized [`sf::Ftp::Response`](../../../documentation/3.1.0/classsf_1_1Ftp_1_1Response.html "sf::Ftp::Response documentation") that also contains the requested directory.
...
[`sf::Ftp::ListingResponse`](../../../documentation/3.1.0/classsf_1_1Ftp_1_1ListingResponse.html "sf::Ftp::ListingResponse documentation") is a specialized [`sf::Ftp::Response`](../../../documentation/3.1.0/classsf_1_1Ftp_1_1Response.html "sf::Ftp::Response documentation") that also contains the requested directory/file names.
