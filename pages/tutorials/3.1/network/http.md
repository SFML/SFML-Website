...
To communicate with an HTTP server you must use the [`sf::Http`](../../../documentation/3.1.0/classsf_1_1Http.html "sf::Http documentation") class.
...
The only other function in [`sf::Http`](../../../documentation/3.1.0/classsf_1_1Http.html "sf::Http documentation"), sends requests.
...
An HTTP request, represented by the [`sf::Http::Request`](../../../documentation/3.1.0/classsf_1_1Http_1_1Request.html "sf::Http::Request documentation") class, contains the following information:
...
If the [`sf::Http`](../../../documentation/3.1.0/classsf_1_1Http.html "sf::Http documentation") class could successfully connect to the host and send the request, a response is sent back and returned to the user, encapsulated in an instance of the [`sf::Http::Response`](../../../documentation/3.1.0/classsf_1_1Http_1_1Response.html "sf::Http::Response documentation") class.
