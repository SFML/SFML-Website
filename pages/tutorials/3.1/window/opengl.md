...
In case you think it is *too* automatic, [`sf::Window`](../../../documentation/3.1.0/classsf_1_1Window.html "sf::Window documentation")'s constructor has an extra argument that allows you to change the settings of the underlying OpenGL context.
This argument is an instance of the [`sf::ContextSettings`](../../../documentation/3.1.0/structsf_1_1ContextSettings.html "sf::ContextSettings documentation") structure, it provides access to the following settings:
...
SFML allows you to create window-less contexts with the [`sf::Context`](../../../documentation/3.1.0/classsf_1_1Context.html "sf::Context documentation") class.
...
If you don't know the graphics module yet, all you have to know is that the [`sf::Window`](../../../documentation/3.1.0/classsf_1_1Window.html "sf::Window documentation") class is replaced with [`sf::RenderWindow`](../../../documentation/3.1.0/classsf_1_1RenderWindow.html "sf::RenderWindow documentation"), which inherits all its functions and adds features to draw SFML specific entities.
