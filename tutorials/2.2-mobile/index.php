...
<ul>
    ...
    <li><a href="start-ios.php" title="SFML and iOS">SFML and iOS</a></li>
    <li><a href="start-android.php" title="SFML and Android">SFML and Android</a></li>
    <li><a href="compile-with-cmake.php" title="Compiling SFML with CMake">Compiling SFML with CMake</a></li>
</ul>

<?php h2('Mobile OSes') ?>
<ul>
    <li><a href="mobile-considerations.php" title="SFML on mobile OSes">SFML on mobile OSes</a></li>
    <li><a href="mobile-ios.php" title="SFML on iOS">SFML on iOS</a></li>
    <li><a href="mobile-android.php" title="SFML on Android">SFML on Android</a></li>
</ul>
