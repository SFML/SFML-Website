...
<p>
    ...
    and <strong>origin</strong>; they all have their getter and setter. These transformation components are all independent from each other: if you want to change the
...
<p>
    ...
    and to provide your own functions on top of it. It is not abstract so there's no problem to instantiate it instead of using it as a base class.
</p>
