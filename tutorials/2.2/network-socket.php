...
<p class="important">
    ...
    You can change this behavior and make all functions non-blocking with the <code>setBlocking</code> function of the socket. See the next chapters for more details.
</p>
<p>
