...
<p>
    ...
    to HTTP status codes -- but not the sames), and a message that informs the user of what happened. FTP responses are encapsulated in the <?php class_link("Ftp::Response") ?>
    class.
</p>
<p>
