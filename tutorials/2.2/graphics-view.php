...
<p>
    This default behavior is suitable in most situations, but it sometimes needs to be changed. For example, to split the screen in a multiplayer game, you may want to
...
<p>
    If, instead of this default behavior, you'd like to show more/less stuff according to the new size of the window, all you have to do is to synchronize the size of the
