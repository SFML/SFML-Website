...
<p>
    ...
    only contains static functions and is not meant to be instanciated.
</p>
<p>
...
<p>
    Note that the "up" vector of the listener is always set to (0, 1, 0), in other words, the top of the listener's head is pointing towards +Y.
</p>
<p>
