...
<ul>
    ...
    <li><a href="http://developer.apple.com/xcode/" title="Download Xcode">Xcode</a> (preferably version 4 of the IDE which is available on the <em>App Store</em>)</li>
</ul>
<p class="important">
...
<p>
    SFML is provided with two templates for Xcode 4 which allow you to create new application projects very quickly and easily. These templates can create custom projects:
    you can select which modules your application requires, whether you want to use SFML as dylib or as frameworks, which compiler you want to use and whether to
...
<h3>C++ 11</h3>
<p>
    Apple ships a custom version of <tt>clang</tt> and <tt>libc++</tt> with Xcode 4 that partially supports C++11 (i.e. some new features are not yet implemented).
    If you plan to use C++11's new features, you need to configure your project to use <tt>clang</tt> and <tt>libc++</tt>. Also, make sure to download the right
