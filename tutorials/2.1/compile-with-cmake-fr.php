...
<p>
    ...
    CMake est lancé. Ce n'est pas un problème pour les utilisateurs Linux ou Mac OS X, étant donné que les compilateurs sont installés dans des
...
<table class="styled">
    ...
    <tbody>
        ...
        <tr class="one">
            ...
            <td>
                Ce paramètre définit pour quelles architectures SFML doit être compilée. La valeur recommandée est "i386;x86_64" afin de générer des binaires universels
                pour des systèmes 32 et 64 bits.
            </td>
        </tr>
        <tr class="two">
            <td><code>SFML_INSTALL_XCODE4_TEMPLATES<br/>(Mac OS X uniquement)</code></td>
            <td>
                Cette option booléenne détermine si CMake va installer les templates pour Xcode 4 sur votre système ou non.
