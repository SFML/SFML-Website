...
<p class="important">
    Parfois, les gens utilisent l'évènement <code>KeyPressed</code> pour gérer des mouvements continus. Or, cela ne produira pas des mouvements
    ...
    de répétition). Les mouvements fluides peuvent être obtenus en utilisant les entrées temps réel avec <?php class_link("Keyboard") ?> (voir le
...
<p>
    L'évènement <code>sf::Event::MouseWheelMoved</code> est déclenché lorsque la molette souris défile vers le haut ou le bas.
</p>
<p>
    Le membre associé à cet évènement est <code>event.mouseWheel</code>, il contient le nombre de "ticks" duquel la molette a bougé, ainsi que la
