...
<p>
    You can also get some of the font's other metrics, such as the kerning between two characters or the line height (always for a certain character size):
</p>
<pre><code class="cpp">int lineHeight = font.getLineHeight(characterSize);
