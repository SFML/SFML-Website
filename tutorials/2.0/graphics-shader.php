...
<?php h2('Introduction') ?>
<p>
    A shader is a small program that executes directly on the graphics card, and which allows the programer to describe its drawing process in a more
...
<p>
    ...
    with pixels. Depending on what kind of effect you want to achieve, you can define only the vertex shader, the fragment shader, or define boths.
</p>
<p>
