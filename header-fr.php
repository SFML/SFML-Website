        ...
        <div id="page">
            <div id="banner-container">
                <div id="banner">
                    ...
                    <ul id="menu">
                        <li><a href="<?php echo page('resources-fr.php') ?>">Ressources</a></li>
                        <li><a href="<?php echo page('license-fr.php') ?>">Licence</a></li>
                        <li><a href="<?php echo page('download-fr.php') ?>">Télécharger</a></li>
                        <li><a href="//fr.sfml-dev.org/forums/">Forum</a></li>
            ...
            <div id="navigation-container">
                <div id="navigation">
                    ...
                    <ul id="buttons">
                        ...
                        <li><a id="donate" href="https://www.paypal.com/cgi-bin/webscr/?cmd=_s-xclick&hosted_button_id=TYJ2XQPG3SXPG" title="Faire un don">Faire un don</a></li>
                        <li><a id="flattr" href="//flattr.com/thing/38063/SFML-multimedia-library" title="Flattrer SFML">Flattr</a></li>
                    </ul>
                </div>
            </div>
