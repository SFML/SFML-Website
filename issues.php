...
<div class="issues">
 ...
 <ol>
  <li>Create a <a href="//en.sfml-dev.org/forums/index.php?topic=5559.msg36368#msg36368">minimal and complete code example</a> which reproduces the issue.</li>
  <li>If while reducing your codebase the issue hasn't revealed itself to you:
   <ul>
    ...
    <li><a href="//en.sfml-dev.org/forums/index.php?action=search">Search the forum</a> for similar issues.</li>
    <li>If and only if none of the above has helped you resolve your issue: Create a new thread on the forum and make sure to follow the <a href="//en.sfml-dev.org/forums/index.php?topic=5559.0">forum rules</a>.</li>
   </ul>
  </li>
 </ol>
 ...
 <div style="text-align:center">
  <a class="box" href="//en.sfml-dev.org/forums/index.php#c3"><div class="title" title="Go to the forum.">Bug Report</div></a>
