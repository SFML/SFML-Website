...
<div class="home-section">
    <div class="column">
        ...
        <ul>
            ...
            <li><a href="https://kiwiirc.com/client/irc.sfml-dev.org/sfml" target="_blank" title="Discutez dans votre naviguateur maintenant">Discutez dans votre naviguateur maintenant</a></li>
        </ul>
    </div>
    <div class="column">
