...
<div class="home-section">
    <div class="column">
        <div class="title">&raquo; <a href="//fr.sfml-dev.org/forums/" title="Aller au forum">Forum</a></div>
        <p>
        ...
        <p>
            Dans le sous-forum <a href="//fr.sfml-dev.org/forums/index.php?board=24.0" title="Aller au sous-forum 'Projets SFML'">Projets SFML</a> vous trouvez de nombreux projets existant.
        </p>
    </div>
    <div class="column">
        <a href="//fr.sfml-dev.org/forums/" title="Aller au forum"><img src="<?php echo image('community/forum.png') ?>" alt="Forum" /></a>
    </div>
</div>
...
<div class="home-section">
    <div class="column">
        <div class="title">&raquo; <a href="//chat.sfml-dev.org" title="Chat in the browser now">IRC</a></div>
        <p>
        ...
        <ul>
            ...
            <li><a href="//chat.sfml-dev.org" title="Discutez dans votre naviguateur maintenant">Discutez dans votre naviguateur maintenant</a></li>
        </ul>
    </div>
    <div class="column">
