...
<div class="issues">
 ...
 <ol>
  <li>Créez un <a href="//en.sfml-dev.org/forums/index.php?topic=5559.msg36368#msg36368">code minimal et complet <img src="../images/icons/flag-en.png" alt="EN"></a> qui reproduise le problème.</li>
  <li>Si en réduisant votre code le problème n'est toujours pas identifié :
   <ul>
    ...
    <li><a href="//fr.sfml-dev.org/forums/index.php?action=search">Cherchez sur le forum</a> des problèmes similaires.</li>
 ...
 <ol>
  <li>Vérifiez que le bug ne soit pas déjà connu en consultant <a href="https://github.com/SFML/SFML/issues?q=">GitHub</a>, <a href="//fr.sfml-dev.org/forums/index.php?action=search">le forum</a> et si possible <a href="//en.sfml-dev.org/forums/index.php?action=search">sa version anglophone</a> aussi.</li>
  ...
  <li>Ouvrez un nouveau fil de discussion sur le <a href="//fr.sfml-dev.org/forums/">forum</a> dans la rubrique d'aide appropriée, et donnez les informations suivantes :
   <ul>
    <li><a href="//en.sfml-dev.org/forums/index.php?topic=5559.msg36368#msg36368">Un code minimal et complet</a> qui fait apparaître le bug.</li>
 ...
 <div style="text-align:center">
  <a class="box" href="//fr.sfml-dev.org/forums/index.php#c7"><div class="title" title="Aller au forum.">Rapport de bug</div></a>
