...
<div class="issues">
 ...
 <ol>
  ...
  <li>Si en réduisant votre code le problème n'est toujours pas identifié :
   <ul>
    ...
    <li>Vérifiez les <a href="tutorials/2.2/index-fr.php" target="_blank">official tutoriels</a>, tout spécialement les encadrés rouges.</li>
    <li><a href="http://fr.sfml-dev.org/forums/index.php?action=search" target="_blank">Cherchez le forum</a> pour des problèmes similaires.</li>
    <li>Si et seulement si les étapes ci-dessus ne vous a permis de corriger votre problème : Créez un nouveau fil de discussion sur le forum en suivant les règles de ce dernier.</li>
   </ul>
  </li>
 </ol>
 ...
 <ol>
  ...
  <li>Ouvrez un nouveau fil de discussion sur le <a href="http://fr.sfml-dev.org/forums/" target="_blank">forum</a> dans la rubrique d'aide appropriée et donnez les informations suivantes :
   <ul>
    <li><a href="http://en.sfml-dev.org/forums/index.php?topic=5559.msg36368#msg36368" target="_blank">Code minimal et complet</a> qui fait apparaître le bug.</li>
    ...
    <li>Captures d'écran ou vidéos, si pertinent, pour montrer certains comportements.</li>
    <li>Toute autre information susceptible d'aider à identifier le problème..</li>
   </ul>
  </li>
 </ol>
 <a class="box" href="http://fr.sfml-dev.org/forums/index.php#c7"><div class="title" title="Aller au formu.">Rapport de Bug</div></a>
 <a class="box" href="https://github.com/LaurentGomila/SFML/issues?q="><div class="title" title="Aller à la liste de tâches / bugs.">Liste de Tâches / Bug <img src="../images/icons/flag-en.png" alt="EN"></div></a>
</div>
