...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>MySoundFileReader : <span class="keyword">public</span> <a class="code" href="classsf_1_1SoundFileReader.php">sf::SoundFileReader</a></div>
<div class="line">{</div>
<div class="line"><span class="keyword">public</span>:</div>
<div class="line"></div>
<div class="line">    <span class="keyword">static</span> <span class="keywordtype">bool</span> check(<a class="code" href="classsf_1_1InputStream.php">sf::InputStream</a>&amp; stream)</div>
<div class="line">    {</div>
...
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code" href="classsf_1_1SoundFileReader.php#aa1d2fee2ba8f359c833ab74590d55935">open</a>(<a class="code" href="classsf_1_1InputStream.php">sf::InputStream</a>&amp; stream, Info&amp; info)</div>
<div class="line">    {</div>
...
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1SoundFileReader.php#a1e18ade5ffe882bdfa20a2ebe7e2b015">seek</a>(sf::Uint64 sampleOffset)</div>
<div class="line">    {</div>
<div class="line">        <span class="comment">// advance to the sampleOffset-th sample from the beginning of the sound</span></div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="keyword">virtual</span> sf::Uint64 <a class="code" href="classsf_1_1SoundFileReader.php#a3b7d86769ea07e24e7b0f0486bed7591">read</a>(sf::Int16* samples, sf::Uint64 maxCount)</div>
<div class="line">    {</div>
