...
<div class="line"><a name="l00045"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php">   45</a></span>&#160;<span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a> : <a class="code" href="classsf_1_1NonCopyable.php" title="Utility class that makes any derived class non-copyable.">NonCopyable</a></div>
<div class="line"><a name="l00046"></a><span class="lineno">   46</span>&#160;{</div>
<div class="line"><a name="l00047"></a><span class="lineno">   47</span>&#160;<span class="keyword">public</span> :</div>
<div class="line"><a name="l00048"></a><span class="lineno">   48</span>&#160;</div>
<div class="line"><a name="l00053"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">   53</a></span>&#160;    <span class="keyword">enum</span> <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc" title="Status codes that may be returned by socket functions.">Status</a></div>
<div class="line"><a name="l00054"></a><span class="lineno">   54</span>&#160;    {</div>
<div class="line"><a name="l00055"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1de3a85bc56d3ae85b3d0f3cfd04ae90">   55</a></span>&#160;        <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1de3a85bc56d3ae85b3d0f3cfd04ae90" title="The socket has sent / received the data.">Done</a>,         </div>
<div class="line"><a name="l00056"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca8554848daae98f996e131bdeed076c09">   56</a></span>&#160;        <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca8554848daae98f996e131bdeed076c09" title="The socket is not ready to send / receive data yet.">NotReady</a>,     </div>
<div class="line"><a name="l00057"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dcab215141f756acdc23c67fad149710eb1">   57</a></span>&#160;        <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dcab215141f756acdc23c67fad149710eb1" title="The TCP socket has been disconnected.">Disconnected</a>, </div>
<div class="line"><a name="l00058"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1dc9854433a28c22e192721179a2df5d">   58</a></span>&#160;        Error         </div>
...
<div class="line"><a name="l00067"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a5deb2c955fd347259c3a20d27b2481aaa5a3c30fd128895403afc11076f461b19">   67</a></span>&#160;        AnyPort = 0 </div>
...
<div class="line"><a name="l00076"></a><span class="lineno">   76</span>&#160;    <span class="keyword">virtual</span> ~<a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a>();</div>
...
<div class="line"><a name="l00113"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8">  113</a></span>&#160;    <span class="keyword">enum</span> <a class="code" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8" title="Types of protocols that the socket can use.">Type</a></div>
<div class="line"><a name="l00114"></a><span class="lineno">  114</span>&#160;    {</div>
<div class="line"><a name="l00115"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8acc02e97e90234b957eaad4dff7f22214">  115</a></span>&#160;        <a class="code" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8acc02e97e90234b957eaad4dff7f22214" title="TCP protocol.">Tcp</a>, </div>
<div class="line"><a name="l00116"></a><span class="lineno"><a class="code" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8a6ebf3094830db4820191a327f3cc6ce2">  116</a></span>&#160;        Udp  </div>
<div class="line"><a name="l00117"></a><span class="lineno">  117</span>&#160;    };</div>
<div class="line"><a name="l00118"></a><span class="lineno">  118</span>&#160;</div>
<div class="line"><a name="l00127"></a><span class="lineno">  127</span>&#160;    <a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a>(Type type);</div>
...
<div class="line"><a name="l00170"></a><span class="lineno">  170</span>&#160;    <span class="keyword">friend</span> <span class="keyword">class </span><a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a>;</div>
