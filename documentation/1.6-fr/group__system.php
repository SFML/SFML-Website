...
<tr class="separator:"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:"><td class="memItemLeft" align="right" valign="top">class &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Utf.php">sf::Utf</a></td></tr>
...
Functions</h2></td></tr>
<tr class="memitem:ga2f2620831533dee0ed432ed982342e09"><td class="memItemLeft" align="right" valign="top">void SFML_SYSTEM_API&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__system.php#ga2f2620831533dee0ed432ed982342e09">sf::sleep</a> (Time duration)</td></tr>
<tr class="memdesc:ga2f2620831533dee0ed432ed982342e09"><td class="mdescLeft">&#160;</td><td class="mdescRight">Make the current thread sleep for a given duration.  <a href="#ga2f2620831533dee0ed432ed982342e09"></a><br/></td></tr>
<tr class="separator:ga2f2620831533dee0ed432ed982342e09"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga7fe7f475639e26334606b5142c29551f"><td class="memItemLeft" align="right" valign="top">SFML_SYSTEM_API std::ostream &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__system.php#ga7fe7f475639e26334606b5142c29551f">sf::err</a> ()</td></tr>
...
<p><a class="el" href="group__system.php#ga7fe7f475639e26334606b5142c29551f" title="Standard stream used by SFML to output warnings and errors.">sf::err()</a> can be redirected to write to another output, independantly of std::cerr, by using the rdbuf() function provided by the std::ostream class.</p>
<p>Example: </p>
...
<div class="line">std::streambuf* previous = <a class="code" href="group__system.php#ga7fe7f475639e26334606b5142c29551f" title="Standard stream used by SFML to output warnings and errors.">sf::err</a>().rdbuf(file.rdbuf());</div>
<div class="line"></div>
<div class="line"><span class="comment">// Redirect to nothing</span></div>
<div class="line"><a class="code" href="group__system.php#ga7fe7f475639e26334606b5142c29551f" title="Standard stream used by SFML to output warnings and errors.">sf::err</a>().rdbuf(NULL);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Restore the original output</span></div>
<div class="line"><a class="code" href="group__system.php#ga7fe7f475639e26334606b5142c29551f" title="Standard stream used by SFML to output warnings and errors.">sf::err</a>().rdbuf(previous);</div>
</div><!-- fragment --> 
</div>
</div>
<a class="anchor" id="ga2f2620831533dee0ed432ed982342e09"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
