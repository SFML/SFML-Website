...
&#160;&#160;<a class="el" href="classsf_1_1Joystick.php#a951a7c775921304a5f3443c6e2bb4d65a6e0a2a95bc1da277610c04d80f52715e">Count</a> = 8, 
<br/>
...
<tr class="memdesc:ac7d4e1923e9f9420174f26703ea63d6c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Check if a joystick is connected.  <a href="#ac7d4e1923e9f9420174f26703ea63d6c"></a><br/></td></tr>
...
<tr class="memdesc:a4de9f445c6582bfe9f0873f695682885"><td class="mdescLeft">&#160;</td><td class="mdescRight">Return the number of buttons supported by a joystick.  <a href="#a4de9f445c6582bfe9f0873f695682885"></a><br/></td></tr>
...
<tr class="memdesc:a268e8f2a11ae6af4a47c727cb4ab4d95"><td class="mdescLeft">&#160;</td><td class="mdescRight">Check if a joystick supports a given axis.  <a href="#a268e8f2a11ae6af4a47c727cb4ab4d95"></a><br/></td></tr>
...
<tr class="memdesc:ae0d97a4b84268cbe6a7078e1b2717835"><td class="mdescLeft">&#160;</td><td class="mdescRight">Check if a joystick button is pressed.  <a href="#ae0d97a4b84268cbe6a7078e1b2717835"></a><br/></td></tr>
...
<tr class="memdesc:aea4930193331df1851b709f3060ba58b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the current position of a joystick axis.  <a href="#aea4930193331df1851b709f3060ba58b"></a><br/></td></tr>
...
<tr class="memdesc:ab85fa9175b4edd3e5a07ee3cde0b0f48"><td class="mdescLeft">&#160;</td><td class="mdescRight">Update the states of all joysticks.  <a href="#ab85fa9175b4edd3e5a07ee3cde0b0f48"></a><br/></td></tr>
...
<p>Unlike the keyboard or mouse, the state of joysticks is sometimes not directly available (depending on the OS), therefore an <a class="el" href="classsf_1_1Joystick.php#ab85fa9175b4edd3e5a07ee3cde0b0f48" title="Update the states of all joysticks.">update()</a> function must be called in order to update the current state of joysticks. When you have a window with event handling, this is done automatically, you don't need to call anything. But if you have no window, or if you want to check joysticks state before creating one, you must call <a class="el" href="classsf_1_1Joystick.php#ab85fa9175b4edd3e5a07ee3cde0b0f48" title="Update the states of all joysticks.">sf::Joystick::update</a> explicitely.</p>
<p>Usage example: </p>
<div class="fragment"><div class="line"><span class="comment">// Is joystick #0 connected?</span></div>
<div class="line"><span class="keywordtype">bool</span> connected = <a class="code" href="classsf_1_1Joystick.php#ac7d4e1923e9f9420174f26703ea63d6c" title="Check if a joystick is connected.">sf::Joystick::isConnected</a>(0);</div>
<div class="line"></div>
<div class="line"><span class="comment">// How many buttons does joystick #0 support?</span></div>
<div class="line"><span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> buttons = <a class="code" href="classsf_1_1Joystick.php#a4de9f445c6582bfe9f0873f695682885" title="Return the number of buttons supported by a joystick.">sf::Joystick::getButtonCount</a>(0);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Does joystick #0 define a X axis?</span></div>
<div class="line"><span class="keywordtype">bool</span> hasX = <a class="code" href="classsf_1_1Joystick.php#a268e8f2a11ae6af4a47c727cb4ab4d95" title="Check if a joystick supports a given axis.">sf::Joystick::hasAxis</a>(0, <a class="code" href="classsf_1_1Joystick.php#a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e" title="The X axis.">sf::Joystick::X</a>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Is button #2 pressed on joystick #0?</span></div>
<div class="line"><span class="keywordtype">bool</span> pressed = <a class="code" href="classsf_1_1Joystick.php#ae0d97a4b84268cbe6a7078e1b2717835" title="Check if a joystick button is pressed.">sf::Joystick::isButtonPressed</a>(0, 2);</div>
<div class="line"></div>
<div class="line"><span class="comment">// What&#39;s the current position of the Y axis on joystick #0?</span></div>
<div class="line"><span class="keywordtype">float</span> position = <a class="code" href="classsf_1_1Joystick.php#aea4930193331df1851b709f3060ba58b" title="Get the current position of a joystick axis.">sf::Joystick::getAxisPosition</a>(0, <a class="code" href="classsf_1_1Joystick.php#a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce" title="The Y axis.">sf::Joystick::Y</a>);</div>
...
<p>Definition at line <a class="el" href="Joystick_8hpp_source.php#l00040">40</a> of file <a class="el" href="Joystick_8hpp_source.php">Joystick.hpp</a>.</p>
...
<tr><td valign="top"><em><a class="anchor" id="a951a7c775921304a5f3443c6e2bb4d65a6e0a2a95bc1da277610c04d80f52715e"></a>Count</em>&nbsp;</td><td>
<p>Maximum number of supported joysticks. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a951a7c775921304a5f3443c6e2bb4d65a2f1b8a0a59f2c12a4775c0e1e69e1816"></a>ButtonCount</em>&nbsp;</td><td>
<p>Maximum number of supported buttons. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a951a7c775921304a5f3443c6e2bb4d65accf3e487c9f6ee2f384351323626a42c"></a>AxisCount</em>&nbsp;</td><td>
...
<p>Definition at line <a class="el" href="Joystick_8hpp_source.php#l00048">48</a> of file <a class="el" href="Joystick_8hpp_source.php">Joystick.hpp</a>.</p>
...
<dl><dt><b>Enumerator: </b></dt><dd><table border="0" cellspacing="2" cellpadding="0">
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e"></a>X</em>&nbsp;</td><td>
<p>The X axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce"></a>Y</em>&nbsp;</td><td>
<p>The Y axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a7c37a1240b2dafbbfc5c1a0e23911315"></a>Z</em>&nbsp;</td><td>
<p>The Z axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7aeebbcdb0828850f4d69e6a084801fab8"></a>R</em>&nbsp;</td><td>
<p>The R axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a0a901f61e75292dd2f642b6e4f33a214"></a>U</em>&nbsp;</td><td>
<p>The U axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7aa2e2c8ffa1837e7911ee0c7d045bf8f4"></a>V</em>&nbsp;</td><td>
<p>The V axis. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a06420f7714e4dfd8b841885a0b5f3954"></a>PovX</em>&nbsp;</td><td>
<p>The X axis of the point-of-view hat. </p>
</td></tr>
<tr><td valign="top"><em><a class="anchor" id="a48db337092c2e263774f94de6d50baa7a0f8ffb2dcddf91b98ab910a4f8327ad9"></a>PovY</em>&nbsp;</td><td>
...
<p>Definition at line <a class="el" href="Joystick_8hpp_source.php#l00059">59</a> of file <a class="el" href="Joystick_8hpp_source.php">Joystick.hpp</a>.</p>
