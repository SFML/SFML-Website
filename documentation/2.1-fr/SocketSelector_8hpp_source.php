...
<div class="line"><a name="l00043"></a><span class="lineno"><a class="code" href="classsf_1_1SocketSelector.php">   43</a></span>&#160;<span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a></div>
<div class="line"><a name="l00044"></a><span class="lineno">   44</span>&#160;{</div>
<div class="line"><a name="l00045"></a><span class="lineno">   45</span>&#160;<span class="keyword">public</span> :</div>
<div class="line"><a name="l00046"></a><span class="lineno">   46</span>&#160;</div>
<div class="line"><a name="l00051"></a><span class="lineno">   51</span>&#160;    <a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a>();</div>
<div class="line"><a name="l00052"></a><span class="lineno">   52</span>&#160;</div>
<div class="line"><a name="l00059"></a><span class="lineno">   59</span>&#160;    <a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a>(<span class="keyword">const</span> <a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a>&amp; copy);</div>
<div class="line"><a name="l00060"></a><span class="lineno">   60</span>&#160;</div>
<div class="line"><a name="l00065"></a><span class="lineno">   65</span>&#160;    ~<a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">SocketSelector</a>();</div>
<div class="line"><a name="l00066"></a><span class="lineno">   66</span>&#160;</div>
<div class="line"><a name="l00080"></a><span class="lineno">   80</span>&#160;    <span class="keywordtype">void</span> add(<a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a>&amp; socket);</div>
<div class="line"><a name="l00081"></a><span class="lineno">   81</span>&#160;</div>
<div class="line"><a name="l00093"></a><span class="lineno">   93</span>&#160;    <span class="keywordtype">void</span> <span class="keyword">remove</span>(<a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a>&amp; socket);</div>
...
<div class="line"><a name="l00123"></a><span class="lineno">  123</span>&#160;    <span class="keywordtype">bool</span> wait(<a class="code" href="classsf_1_1Time.php" title="Represents a time value.">Time</a> timeout = <a class="code" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0" title="Predefined &quot;zero&quot; time value.">Time::Zero</a>);</div>
<div class="line"><a name="l00124"></a><span class="lineno">  124</span>&#160;</div>
<div class="line"><a name="l00142"></a><span class="lineno">  142</span>&#160;    <span class="keywordtype">bool</span> isReady(<a class="code" href="classsf_1_1Socket.php" title="Base class for all the socket types.">Socket</a>&amp; socket) <span class="keyword">const</span>;</div>
