...
<tr class="memdesc:a7dd6e429b87520008326c4d71f1cf011"><td class="mdescLeft">&#160;</td><td class="mdescRight">Append data to the end of the packet.  <a href="#a7dd6e429b87520008326c4d71f1cf011"></a><br/></td></tr>
...
<tr class="memdesc:a133ea8b8fe6e93c230f0d79f19a3bf0d"><td class="mdescLeft">&#160;</td><td class="mdescRight">Clear the packet.  <a href="#a133ea8b8fe6e93c230f0d79f19a3bf0d"></a><br/></td></tr>
...
<tr class="memdesc:a304ba9ec94c992710f4dfff879c6340e"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get a pointer to the data contained in the packet.  <a href="#a304ba9ec94c992710f4dfff879c6340e"></a><br/></td></tr>
...
<tr class="memdesc:a004b62aa5bafa69df8917171a3fe1fa0"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the size of the data contained in the packet.  <a href="#a004b62aa5bafa69df8917171a3fe1fa0"></a><br/></td></tr>
...
<tr class="memdesc:aee3adfca6303f1e6bde3c62be392b945"><td class="mdescLeft">&#160;</td><td class="mdescRight">Tell if the reading position has reached the end of the packet.  <a href="#aee3adfca6303f1e6bde3c62be392b945"></a><br/></td></tr>
...
<tr class="memdesc:addcb990cde37859c748273d9de55e628"><td class="mdescLeft">&#160;</td><td class="mdescRight">Test the validity of the packet, for reading.  <a href="#addcb990cde37859c748273d9de55e628"></a><br/></td></tr>
...
<tr class="memdesc:af8e26c63ba9bdccd262565ff0d3eeba2"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overloads of operator &gt;&gt; to read data from the packet.  <a href="#af8e26c63ba9bdccd262565ff0d3eeba2"></a><br/></td></tr>
...
<tr class="memdesc:aa5a465ed02ba29d83ecdafb0ac3fff21"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overloads of operator &lt;&lt; to write data into the packet.  <a href="#aa5a465ed02ba29d83ecdafb0ac3fff21"></a><br/></td></tr>
...
<tr class="memdesc:a052e955906c9bfd671622cb625380edc"><td class="mdescLeft">&#160;</td><td class="mdescRight">Called before the packet is sent over the network.  <a href="#a052e955906c9bfd671622cb625380edc"></a><br/></td></tr>
...
<tr class="memdesc:ab71a31ef0f1d5d856de6f9fc75434128"><td class="mdescLeft">&#160;</td><td class="mdescRight">Called after the packet is received over the network.  <a href="#ab71a31ef0f1d5d856de6f9fc75434128"></a><br/></td></tr>
...
<p>The <a class="el" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a> class provides both input and output modes. It is designed to follow the behaviour of standard C++ streams, using operators &gt;&gt; and &lt;&lt; to extract and insert data.</p>
...
<div class="line"><a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a> packet;</div>
...
<div class="line">};</div>
<div class="line"></div>
<div class="line"><a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#aa5a465ed02ba29d83ecdafb0ac3fff21" title="Overloads of operator &lt;&lt; to write data into the packet.">operator &lt;&lt;</a>(<a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a>&amp; packet, <span class="keyword">const</span> MyStruct&amp; m)</div>
<div class="line">{</div>
<div class="line">    <span class="keywordflow">return</span> packet &lt;&lt; m.number &lt;&lt; m.integer &lt;&lt; m.str;</div>
<div class="line">}</div>
<div class="line"></div>
<div class="line"><a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#af8e26c63ba9bdccd262565ff0d3eeba2" title="Overloads of operator &gt;&gt; to read data from the packet.">operator &gt;&gt;</a>(<a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a>&amp; packet, MyStruct&amp; m)</div>
<div class="line">{</div>
<div class="line">    <span class="keywordflow">return</span> packet &gt;&gt; m.number &gt;&gt; m.integer &gt;&gt; m.str;</div>
<div class="line">}</div>
...
<div class="fragment"><div class="line"><span class="keyword">class </span>ZipPacket : <span class="keyword">public</span> <a class="code" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network.">sf::Packet</a></div>
<div class="line">{</div>
<div class="line">    <span class="keyword">virtual</span> <span class="keyword">const</span> <span class="keywordtype">void</span>* <a class="code" href="classsf_1_1Packet.php#a052e955906c9bfd671622cb625380edc" title="Called before the packet is sent over the network.">onSend</a>(std::size_t&amp; size)</div>
<div class="line">    {</div>
<div class="line">        <span class="keyword">const</span> <span class="keywordtype">void</span>* srcData = <a class="code" href="classsf_1_1Packet.php#a304ba9ec94c992710f4dfff879c6340e" title="Get a pointer to the data contained in the packet.">getData</a>();</div>
<div class="line">        std::size_t srcSize = <a class="code" href="classsf_1_1Packet.php#a004b62aa5bafa69df8917171a3fe1fa0" title="Get the size of the data contained in the packet.">getDataSize</a>();</div>
<div class="line"></div>
...
<div class="line"></div>
<div class="line">        <a class="code" href="classsf_1_1Packet.php#a7dd6e429b87520008326c4d71f1cf011" title="Append data to the end of the packet.">append</a>(dstData, dstSize);</div>
<div class="line">    }</div>
<div class="line">};</div>
<div class="line"></div>
