...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1String.php" title="Utility string class that automatically handles conversions between types and encodings.">sf::String</a> s;</div>
<div class="line"></div>
...
<div class="line"><a class="code" href="classsf_1_1String.php" title="Utility string class that automatically handles conversions between types and encodings.">sf::String</a> s;</div>
<div class="line">...</div>
<div class="line">std::string s1 = s.<a class="code" href="classsf_1_1String.php#a71d111ccfaf295b8b8be8ca4a3ceb5f4" title="Convert the unicode string to an ANSI string.">toAnsiString</a>(locale);</div>
<div class="line">s = <a class="code" href="classsf_1_1String.php" title="Utility string class that automatically handles conversions between types and encodings.">sf::String</a>(<span class="stringliteral">&quot;hello&quot;</span>, locale);</div>
...
<p>Definition at line <a class="el" href="String_8hpp_source.php#l00043">43</a> of file <a class="el" href="String_8hpp_source.php">String.hpp</a>.</p>
...
<p>Definition at line <a class="el" href="String_8hpp_source.php#l00050">50</a> of file <a class="el" href="String_8hpp_source.php">String.hpp</a>.</p>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1String.php#ac823012f39cb6f61100418876e99d53b" title="Return an iterator to the beginning of the string.">end</a> </dd></dl>
...
<p>Definition at line <a class="el" href="String_8hpp_source.php#l00056">56</a> of file <a class="el" href="String_8hpp_source.php">String.hpp</a>.</p>
