...
<tr class="memdesc:a741959c5158aeb1e4457cad47d90f76b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Default constructor.  <a href="#a741959c5158aeb1e4457cad47d90f76b"></a><br/></td></tr>
...
<tr class="memdesc:a50b1b955eb7ecb2e7c2764f3f4722fbf"><td class="mdescLeft">&#160;</td><td class="mdescRight">Copy constructor.  <a href="#a50b1b955eb7ecb2e7c2764f3f4722fbf"></a><br/></td></tr>
...
<tr class="memdesc:a9069cd61208260b8ed9cf233afa1f73d"><td class="mdescLeft">&#160;</td><td class="mdescRight">Destructor.  <a href="#a9069cd61208260b8ed9cf233afa1f73d"></a><br/></td></tr>
...
<tr class="memdesc:ade952013232802ff7b9b33668f8d2096"><td class="mdescLeft">&#160;</td><td class="mdescRight">Add a new socket to the selector.  <a href="#ade952013232802ff7b9b33668f8d2096"></a><br/></td></tr>
...
<tr class="memdesc:a98b6ab693a65b82caa375639232357c1"><td class="mdescLeft">&#160;</td><td class="mdescRight">Remove a socket from the selector.  <a href="#a98b6ab693a65b82caa375639232357c1"></a><br/></td></tr>
...
<tr class="memdesc:a76e650acb0199d4be91e90a493fbc91a"><td class="mdescLeft">&#160;</td><td class="mdescRight">Remove all the sockets stored in the selector.  <a href="#a76e650acb0199d4be91e90a493fbc91a"></a><br/></td></tr>
...
<tr class="memdesc:a9cfda5475f17925e65889394d70af702"><td class="mdescLeft">&#160;</td><td class="mdescRight">Wait until one or more sockets are ready to receive.  <a href="#a9cfda5475f17925e65889394d70af702"></a><br/></td></tr>
...
<tr class="memdesc:a8e67b463db05eadb4d356992c896833c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Test a socket to know if it is ready to receive data.  <a href="#a8e67b463db05eadb4d356992c896833c"></a><br/></td></tr>
...
<tr class="memdesc:ae6395c7a8d29a9ea14939cc5d1ba3a33"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overload of assignment operator.  <a href="#ae6395c7a8d29a9ea14939cc5d1ba3a33"></a><br/></td></tr>
...
<div class="line"><a class="code" href="classsf_1_1SocketSelector.php" title="Multiplexer that allows to read from multiple sockets.">sf::SocketSelector</a> selector;</div>
<div class="line"></div>
<div class="line"><span class="comment">// Add the listener to the selector</span></div>
<div class="line">selector.<a class="code" href="classsf_1_1SocketSelector.php#ade952013232802ff7b9b33668f8d2096" title="Add a new socket to the selector.">add</a>(listener);</div>
<div class="line"></div>
...
<div class="line">    <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a9cfda5475f17925e65889394d70af702" title="Wait until one or more sockets are ready to receive.">wait</a>())</div>
<div class="line">    {</div>
<div class="line">        <span class="comment">// Test the listener</span></div>
<div class="line">        <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a8e67b463db05eadb4d356992c896833c" title="Test a socket to know if it is ready to receive data.">isReady</a>(listener))</div>
<div class="line">        {</div>
<div class="line">            <span class="comment">// The listener is ready: there is a pending connection</span></div>
<div class="line">            <a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">sf::TcpSocket</a>* client = <span class="keyword">new</span> <a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">sf::TcpSocket</a>;</div>
<div class="line">            <span class="keywordflow">if</span> (listener.<a class="code" href="classsf_1_1TcpListener.php#ae2c83ce5a64d50b68180c46bef0a7346" title="Accept a new connection.">accept</a>(*client) == <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1de3a85bc56d3ae85b3d0f3cfd04ae90" title="The socket has sent / received the data.">sf::Socket::Done</a>)</div>
<div class="line">            {</div>
...
<div class="line">                selector.<a class="code" href="classsf_1_1SocketSelector.php#ade952013232802ff7b9b33668f8d2096" title="Add a new socket to the selector.">add</a>(*client);</div>
<div class="line">            }</div>
...
<div class="line">            {</div>
<div class="line">                <a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">sf::TcpSocket</a>&amp; client = **it;</div>
<div class="line">                <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a8e67b463db05eadb4d356992c896833c" title="Test a socket to know if it is ready to receive data.">isReady</a>(client))</div>
<div class="line">                {</div>
...
<div class="line">                    <span class="keywordflow">if</span> (client.<a class="code" href="classsf_1_1TcpSocket.php#a90ce50811ea61d4f00efc62bb99ae1af" title="Receive raw data from the remote peer.">receive</a>(packet) == <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1de3a85bc56d3ae85b3d0f3cfd04ae90" title="The socket has sent / received the data.">sf::Socket::Done</a>)</div>
<div class="line">                    {</div>
<div class="line">                        ...</div>
<div class="line">                    }</div>
<div class="line">                }</div>
