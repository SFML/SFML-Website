...
<p><code>#include &lt;<a class="el" href="UdpSocket_8hpp_source.php">UdpSocket.hpp</a>&gt;</code></p>
<div class="dynheader">
Inheritance diagram for sf::UdpSocket:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1UdpSocket__inherit__graph.png" border="0" usemap="#sf_1_1UdpSocket_inherit__map" alt="Inheritance graph"/></div>
<map name="sf_1_1UdpSocket_inherit__map" id="sf_1_1UdpSocket_inherit__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<div class="dynheader">
Collaboration diagram for sf::UdpSocket:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1UdpSocket__coll__graph.png" border="0" usemap="#sf_1_1UdpSocket_coll__map" alt="Collaboration graph"/></div>
<map name="sf_1_1UdpSocket_coll__map" id="sf_1_1UdpSocket_coll__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a name="pub-types"></a>
Public Types</h2></td></tr>
<tr class="memitem:a8ad087820b1ae07267858212f3d0fac5"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom">{ <a class="el" href="classsf_1_1UdpSocket.php#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb">MaxDatagramSize</a> = 65507
 }</td></tr>
...
<a id="a8ad087820b1ae07267858212f3d0fac5"></a>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a id="a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb"></a>MaxDatagramSize&#160;</td><td class="fielddoc"><p>The maximum number of bytes that can be sent in a single UDP datagram. </p>
</td></tr>
</table>
...
<p>Binding the socket to a port is necessary for being able to receive data on that port. You can use the special value <a class="el" href="classsf_1_1Socket.php#aa3e6c984bcb81a35234dcc9cc8369d75a5a3c30fd128895403afc11076f461b19" title="Special value that tells the system to pick any available port. ">Socket::AnyPort</a> to tell the system to automatically pick an available port, and then call getLocalPort to retrieve the chosen port.</p>
...
<h2 class="memtitle"><span class="permalink"><a href="#ade9ca0f7ed7919136917b0b997a9833a">&#9670;&nbsp;</a></span>receive() <span class="overload">[1/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#afdd5c655d00c96222d5b477fc057a22b">&#9670;&nbsp;</a></span>receive() <span class="overload">[2/2]</span></h2>
...
<p>Make sure that <em>size</em> is not greater than <a class="el" href="classsf_1_1UdpSocket.php#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb" title="The maximum number of bytes that can be sent in a single UDP datagram. ">UdpSocket::MaxDatagramSize</a>, otherwise this function will fail and no data will be sent.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<p>Make sure that the packet size is not greater than <a class="el" href="classsf_1_1UdpSocket.php#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb" title="The maximum number of bytes that can be sent in a single UDP datagram. ">UdpSocket::MaxDatagramSize</a>, otherwise this function will fail and no data will be sent.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
