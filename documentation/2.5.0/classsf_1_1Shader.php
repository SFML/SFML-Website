...
<p>To apply a shader to a drawable, you must pass it as an additional parameter to the Window::draw() draw() function: </p><div class="fragment"><div class="line">window.draw(sprite, &amp;shader);</div></div><!-- fragment --><p>... which is in fact just a shortcut for this: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1RenderStates.php">sf::RenderStates</a> states;</div><div class="line">states.<a class="code" href="classsf_1_1RenderStates.php#ad4f79ecdd0c60ed0d24fbe555b221bd8">shader</a> = &amp;shader;</div><div class="line">window.draw(sprite, states);</div></div><!-- fragment --><p>In the code above we pass a pointer to the shader, because it may be null (which means "no shader").</p>
