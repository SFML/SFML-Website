...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142ac3fe5df11d15b57317c053a2ae13d9a9">sf::Keyboard::Left</a>))</div><div class="line">{</div><div class="line">    <span class="comment">// move left...</span></div><div class="line">}</div><div class="line"><span class="keywordflow">else</span> <span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142a2aeb083dea103a8e36b6850b51ef3632">sf::Keyboard::Right</a>))</div><div class="line">{</div><div class="line">    <span class="comment">// move right...</span></div><div class="line">}</div><div class="line"><span class="keywordflow">else</span> <span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142a64b7ecb543c5d03bec8383dde123c95d">sf::Keyboard::Escape</a>))</div><div class="line">{</div><div class="line">    <span class="comment">// quit...</span></div><div class="line">}</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Joystick.php" title="Give access to the real-time state of the joysticks. ">sf::Joystick</a>, <a class="el" href="classsf_1_1Mouse.php" title="Give access to the real-time state of the mouse. ">sf::Mouse</a>, <a class="el" href="classsf_1_1Touch.php" title="Give access to the real-time state of the touches. ">sf::Touch</a> </dd></dl>

<p class="definition">Definition at line <a class="el" href="Keyboard_8hpp_source.php#l00040">40</a> of file <a class="el" href="Keyboard_8hpp_source.php">Keyboard.hpp</a>.</p>
...
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142a93e6ffa0320fe9b2f29aec14a58be36b"></a>KeyCount&#160;</td><td class="fielddoc"><p>Keep last &ndash; the total number of keyboard keys. </p>
</td></tr>
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142a401a183dcfde0a06cb60fe6c91fa1e39"></a>Dash&#160;</td><td class="fielddoc"><dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000019">Deprecated:</a></b></dt><dd>Use Hyphen instead </dd></dl>
</td></tr>
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142a33aeaab900abcd01eebf2fcc4f6d97e2"></a>BackSpace&#160;</td><td class="fielddoc"><dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000020">Deprecated:</a></b></dt><dd>Use Backspace instead </dd></dl>
</td></tr>
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142a536df84e73859aa44e11e192459470b6"></a>BackSlash&#160;</td><td class="fielddoc"><dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000021">Deprecated:</a></b></dt><dd>Use Backslash instead </dd></dl>
</td></tr>
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142a460ab09a36f9ed230504b89b9815de88"></a>SemiColon&#160;</td><td class="fielddoc"><dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000022">Deprecated:</a></b></dt><dd>Use Semicolon instead </dd></dl>
</td></tr>
<tr><td class="fieldname"><a id="acb4cacd7cc5802dec45724cf3314a142ac291de81bdee518d636bc359f2ca77de"></a>Return&#160;</td><td class="fielddoc"><dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000023">Deprecated:</a></b></dt><dd>Use Enter instead </dd></dl>
</td></tr>
</table>

<p class="definition">Definition at line <a class="el" href="Keyboard_8hpp_source.php#l00048">48</a> of file <a class="el" href="Keyboard_8hpp_source.php">Keyboard.hpp</a>.</p>
