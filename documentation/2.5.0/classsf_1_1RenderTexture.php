...
<p><code>#include &lt;<a class="el" href="RenderTexture_8hpp_source.php">RenderTexture.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<p>Usage example:</p>
<div class="fragment"><div class="line"><span class="comment">// Create a new render-window</span></div><div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Create a new render-texture</span></div><div class="line"><a class="code" href="classsf_1_1RenderTexture.php">sf::RenderTexture</a> texture;</div><div class="line"><span class="keywordflow">if</span> (!texture.<a class="code" href="classsf_1_1RenderTexture.php#a0e945c4ce7703591c7f240b169744603">create</a>(500, 500))</div><div class="line">    <span class="keywordflow">return</span> -1;</div><div class="line"></div><div class="line"><span class="comment">// The main loop</span></div><div class="line"><span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#ae873503db7d48157bb9cbf6129562bce">isOpen</a>())</div><div class="line">{</div><div class="line">   <span class="comment">// Event processing</span></div><div class="line">   <span class="comment">// ...</span></div><div class="line"></div><div class="line">   <span class="comment">// Clear the whole texture with red color</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a6bb6f0ba348f2b1e2f46114aeaf60f26">clear</a>(<a class="code" href="classsf_1_1Color.php#a127dbf55db9c07d0fa8f4bfcbb97594a">sf::Color::Red</a>);</div><div class="line"></div><div class="line">   <span class="comment">// Draw stuff to the texture</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(sprite);  <span class="comment">// sprite is a sf::Sprite</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(shape);   <span class="comment">// shape is a sf::Shape</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(text);    <span class="comment">// text is a sf::Text</span></div><div class="line"></div><div class="line">   <span class="comment">// We&#39;re done drawing to the texture</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTexture.php#af92886d5faef3916caff9fa9ab32c555">display</a>();</div><div class="line"></div><div class="line">   <span class="comment">// Now we start rendering to the window, clear it first</span></div><div class="line">   window.clear();</div><div class="line"></div><div class="line">   <span class="comment">// Draw the texture</span></div><div class="line">   <a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> sprite(texture.<a class="code" href="classsf_1_1RenderTexture.php#a07ecea85f05932fa02a8279416721bc9">getTexture</a>());</div><div class="line">   window.draw(sprite);</div><div class="line"></div><div class="line">   <span class="comment">// End the current frame and display its contents on screen</span></div><div class="line">   window.<a class="code" href="classsf_1_1Window.php#adabf839cb103ac96cfc82f781638772a">display</a>();</div><div class="line">}</div></div><!-- fragment --><p>Like <a class="el" href="classsf_1_1RenderWindow.php" title="Window that can serve as a target for 2D drawing. ">sf::RenderWindow</a>, <a class="el" href="classsf_1_1RenderTexture.php" title="Target for off-screen 2D rendering into a texture. ">sf::RenderTexture</a> is still able to render direct OpenGL stuff. It is even possible to mix together OpenGL calls and regular SFML drawing commands. If you need a depth buffer for 3D rendering, don't forget to request it when calling <a class="el" href="classsf_1_1RenderTexture.php#a0e945c4ce7703591c7f240b169744603" title="Create the render-texture. ">RenderTexture::create</a>.</p>
