...
<div class="center"><img src="classsf_1_1RenderWindow__inherit__graph.png" border="0" usemap="#sf_1_1RenderWindow_inherit__map" alt="Inheritance graph"/></div>
<map name="sf_1_1RenderWindow_inherit__map" id="sf_1_1RenderWindow_inherit__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<div class="dynheader">
Collaboration diagram for sf::RenderWindow:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1RenderWindow__coll__graph.png" border="0" usemap="#sf_1_1RenderWindow_coll__map" alt="Collaboration graph"/></div>
<map name="sf_1_1RenderWindow_coll__map" id="sf_1_1RenderWindow_coll__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
...
<tr class="memdesc:a5a784b8a09bf4a8bc97ef9e0a8957c35"><td class="mdescLeft">&#160;</td><td class="mdescRight">Copy the current contents of the window to an image.  <a href="#a5a784b8a09bf4a8bc97ef9e0a8957c35">More...</a><br /></td></tr>
...
<tr class="memitem:acf67483dc21f08d65c8835b3889b41b2"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#acf67483dc21f08d65c8835b3889b41b2">create</a> (<a class="el" href="group__window.php#gaed947028b0698a812cad2f97bfe9caa3">WindowHandle</a> handle, const <a class="el" href="structsf_1_1ContextSettings.php">ContextSettings</a> &amp;settings=<a class="el" href="structsf_1_1ContextSettings.php">ContextSettings</a>())</td></tr>
...
<tr class="memitem:aab7a05baece72b08ad120063b143d19b"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#aab7a05baece72b08ad120063b143d19b">setMouseCursor</a> (const <a class="el" href="classsf_1_1Cursor.php">Cursor</a> &amp;cursor)</td></tr>
...
<tr class="memitem:ad2fa6be5104ec0bfe79af7a5f524ea90"><td class="memItemLeft" align="right" valign="top"><a class="el" href="group__window.php#gaed947028b0698a812cad2f97bfe9caa3">WindowHandle</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#ad2fa6be5104ec0bfe79af7a5f524ea90">getSystemHandle</a> () const</td></tr>
...
<div class="fragment"><div class="line"><span class="comment">// Declare and create a new render-window</span></div><div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Limit the framerate to 60 frames per second (this step is optional)</span></div><div class="line">window.<a class="code" href="classsf_1_1Window.php#af4322d315baf93405bf0d5087ad5e784">setFramerateLimit</a>(60);</div><div class="line"></div><div class="line"><span class="comment">// The main loop - ends as soon as the window is closed</span></div><div class="line"><span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#ae873503db7d48157bb9cbf6129562bce">isOpen</a>())</div><div class="line">{</div><div class="line">   <span class="comment">// Event processing</span></div><div class="line">   <a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div><div class="line">   <span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#a338e996585faf82e93069858e3b531b7">pollEvent</a>(event))</div><div class="line">   {</div><div class="line">       <span class="comment">// Request for closing the window</span></div><div class="line">       <span class="keywordflow">if</span> (event.<a class="code" href="classsf_1_1Event.php#adf2f8044f713fd9d6019077b0d1ffe0a">type</a> == <a class="code" href="classsf_1_1Event.php#af41fa9ed45c02449030699f671331d4aa316e4212e083f1dce79efd8d9e9c0a95">sf::Event::Closed</a>)</div><div class="line">           window.<a class="code" href="classsf_1_1Window.php#a99d1e030387b0c26f5995670504fe7b5">close</a>();</div><div class="line">   }</div><div class="line"></div><div class="line">   <span class="comment">// Clear the whole window before rendering a new frame</span></div><div class="line">   window.clear();</div><div class="line"></div><div class="line">   <span class="comment">// Draw some graphical entities</span></div><div class="line">   window.draw(sprite);</div><div class="line">   window.draw(circle);</div><div class="line">   window.draw(text);</div><div class="line"></div><div class="line">   <span class="comment">// End the current frame and display its contents on screen</span></div><div class="line">   window.<a class="code" href="classsf_1_1Window.php#adabf839cb103ac96cfc82f781638772a">display</a>();</div><div class="line">}</div></div><!-- fragment --><p>Like <a class="el" href="classsf_1_1Window.php" title="Window that serves as a target for OpenGL rendering. ">sf::Window</a>, <a class="el" href="classsf_1_1RenderWindow.php" title="Window that can serve as a target for 2D drawing. ">sf::RenderWindow</a> is still able to render direct OpenGL stuff. It is even possible to mix together OpenGL calls and regular SFML drawing commands.</p>
<div class="fragment"><div class="line"><span class="comment">// Create the render window</span></div><div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML OpenGL&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Create a sprite and a text to display</span></div><div class="line"><a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> sprite;</div><div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text;</div><div class="line">...</div><div class="line"></div><div class="line"><span class="comment">// Perform OpenGL initializations</span></div><div class="line">glMatrixMode(GL_PROJECTION);</div><div class="line">...</div><div class="line"></div><div class="line"><span class="comment">// Start the rendering loop</span></div><div class="line">while (window.<a class="code" href="classsf_1_1Window.php#ae873503db7d48157bb9cbf6129562bce">isOpen</a>())</div><div class="line">{</div><div class="line">    <span class="comment">// Process events</span></div><div class="line">    ...</div><div class="line"></div><div class="line">    <span class="comment">// Draw a background sprite</span></div><div class="line">    window.pushGLStates();</div><div class="line">    window.draw(sprite);</div><div class="line">    window.popGLStates();</div><div class="line"></div><div class="line">    <span class="comment">// Draw a 3D object using OpenGL</span></div><div class="line">    glBegin(GL_QUADS);</div><div class="line">        glVertex3f(...);</div><div class="line">        ...</div><div class="line">    glEnd();</div><div class="line"></div><div class="line">    <span class="comment">// Draw text on top of the 3D object</span></div><div class="line">    window.pushGLStates();</div><div class="line">    window.draw(text);</div><div class="line">    window.popGLStates();</div><div class="line"></div><div class="line">    <span class="comment">// Finally, display the rendered frame on screen</span></div><div class="line">    window.<a class="code" href="classsf_1_1Window.php#adabf839cb103ac96cfc82f781638772a">display</a>();</div><div class="line">}</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Window.php" title="Window that serves as a target for OpenGL rendering. ">sf::Window</a>, <a class="el" href="classsf_1_1RenderTarget.php" title="Base class for all render targets (window, texture, ...) ">sf::RenderTarget</a>, <a class="el" href="classsf_1_1RenderTexture.php" title="Target for off-screen 2D rendering into a texture. ">sf::RenderTexture</a>, <a class="el" href="classsf_1_1View.php" title="2D camera that defines what region is shown on screen ">sf::View</a> </dd></dl>
...
<a id="a5a784b8a09bf4a8bc97ef9e0a8957c35"></a>
...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector2.php">sf::Vector2u</a> windowSize = window.<a class="code" href="classsf_1_1Window.php#a3969926741cbe83d7f9eeaf5333d4e71">getSize</a>();</div><div class="line"><a class="code" href="classsf_1_1Texture.php">sf::Texture</a> texture;</div><div class="line">texture.<a class="code" href="classsf_1_1Texture.php#a89b4c7d204acf1033c3a1b6e0a3ad0a3">create</a>(windowSize.<a class="code" href="classsf_1_1Vector2.php#a1e6ad77fa155f3753bfb92699bd28141">x</a>, windowSize.<a class="code" href="classsf_1_1Vector2.php#a420f2481b015f4eb929c75f2af564299">y</a>);</div><div class="line">texture.<a class="code" href="classsf_1_1Texture.php#ae4eab5c6781316840b0c50ad08370963">update</a>(window);</div><div class="line"><a class="code" href="classsf_1_1Image.php">sf::Image</a> screenshot = texture.<a class="code" href="classsf_1_1Texture.php#a77e18a70de2e525ac5e4a7cd95f614b9">copyToImage</a>();</div></div><!-- fragment --><p>This is a slow operation, whose main purpose is to make screenshots of the application. If you want to update an image with the contents of the window and then use it for drawing, you should rather use a <a class="el" href="classsf_1_1Texture.php" title="Image living on the graphics card that can be used for drawing. ">sf::Texture</a> and its update(Window&amp;) function. You can also draw things directly to a texture with the <a class="el" href="classsf_1_1RenderTexture.php" title="Target for off-screen 2D rendering into a texture. ">sf::RenderTexture</a> class.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname"><a class="el" href="group__window.php#gaed947028b0698a812cad2f97bfe9caa3">WindowHandle</a> sf::Window::getSystemHandle </td>
          <td>(</td>
          <td class="paramname"></td><td>)</td>
          <td> const</td>
        </tr>
...
<p>This function is not blocking: if there's no pending event then it will return false and leave <em>event</em> unmodified. Note that more than one event may be present in the event queue, thus you should always call this function in a loop to make sure that you process every pending event. </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div><div class="line"><span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#a338e996585faf82e93069858e3b531b7">pollEvent</a>(event))</div><div class="line">{</div><div class="line">   <span class="comment">// process event...</span></div><div class="line">}</div></div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<p>This function is blocking: if there's no pending event then it will wait until an event is received. After this function returns (and no error occurred), the <em>event</em> object is always valid and filled properly. This function is typically used when you have a thread that is dedicated to events handling: you want to make this thread sleep as long as no new event is received. </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div><div class="line"><span class="keywordflow">if</span> (window.<a class="code" href="classsf_1_1Window.php#aaf02ab64fbc1d374eef3696df54137bc">waitEvent</a>(event))</div><div class="line">{</div><div class="line">   <span class="comment">// process event...</span></div><div class="line">}</div></div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
    <tr><td class="paramname">event</td><td><a class="el" href="classsf_1_1Event.php" title="Defines a system event and its parameters. ">Event</a> to be returned</td></tr>
  </table>
  </dd>
