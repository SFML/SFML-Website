...
<div class="center"><img src="classsf_1_1ThreadLocal__inherit__graph.png" border="0" usemap="#sf_1_1ThreadLocal_inherit__map" alt="Inheritance graph"/></div>
<map name="sf_1_1ThreadLocal_inherit__map" id="sf_1_1ThreadLocal_inherit__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<div class="dynheader">
Collaboration diagram for sf::ThreadLocal:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1ThreadLocal__coll__graph.png" border="0" usemap="#sf_1_1ThreadLocal_coll__map" alt="Collaboration graph"/></div>
<map name="sf_1_1ThreadLocal_coll__map" id="sf_1_1ThreadLocal_coll__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
