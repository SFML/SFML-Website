...
<div class="center"><img src="classsf_1_1OutputSoundFile__inherit__graph.png" border="0" usemap="#sf_1_1OutputSoundFile_inherit__map" alt="Inheritance graph"/></div>
<map name="sf_1_1OutputSoundFile_inherit__map" id="sf_1_1OutputSoundFile_inherit__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<div class="dynheader">
Collaboration diagram for sf::OutputSoundFile:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1OutputSoundFile__coll__graph.png" border="0" usemap="#sf_1_1OutputSoundFile_coll__map" alt="Collaboration graph"/></div>
<map name="sf_1_1OutputSoundFile_coll__map" id="sf_1_1OutputSoundFile_coll__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
