...
<tr class="memitem:a9bd52a48320fd7b6db8a78037aad276e" id="r_a9bd52a48320fd7b6db8a78037aad276e"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Mutex.php#a9bd52a48320fd7b6db8a78037aad276e">Mutex</a> ()</td></tr>
...
<tr class="memitem:a9f76a67b7b6d3918131a692179b4e3f2" id="r_a9f76a67b7b6d3918131a692179b4e3f2"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Mutex.php#a9f76a67b7b6d3918131a692179b4e3f2">~Mutex</a> ()</td></tr>
...
<tr class="memitem:a1a16956a6bbea764480c1b80f2e45763" id="r_a1a16956a6bbea764480c1b80f2e45763"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">lock</a> ()</td></tr>
...
<tr class="memitem:ade71268ffc5e80756652058b01c23c33" id="r_ade71268ffc5e80756652058b01c23c33"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">unlock</a> ()</td></tr>
...
<div class="line">{</div>
<div class="line">    mutex.<a class="code hl_function" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread2</span></div>
<div class="line">    database.write(...);</div>
<div class="line">    mutex.<a class="code hl_function" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">unlock</a>(); <span class="comment">// if thread2 was waiting, it will now be unblocked</span></div>
<div class="line">}</div>
<div class="line"> </div>
<div class="line"><span class="keywordtype">void</span> thread2()</div>
<div class="line">{</div>
<div class="line">    mutex.<a class="code hl_function" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread1</span></div>
<div class="line">    database.write(...);</div>
<div class="line">    mutex.<a class="code hl_function" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">unlock</a>(); <span class="comment">// if thread1 was waiting, it will now be unblocked</span></div>
<div class="line">}</div>
...
<div class="ttc" id="aclasssf_1_1Mutex_php_a1a16956a6bbea764480c1b80f2e45763"><div class="ttname"><a href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">sf::Mutex::lock</a></div><div class="ttdeci">void lock()</div><div class="ttdoc">Lock the mutex.</div></div>
<div class="ttc" id="aclasssf_1_1Mutex_php_ade71268ffc5e80756652058b01c23c33"><div class="ttname"><a href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">sf::Mutex::unlock</a></div><div class="ttdeci">void unlock()</div><div class="ttdoc">Unlock the mutex.</div></div>
