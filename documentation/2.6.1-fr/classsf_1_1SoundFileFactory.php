...
<tr class="memitem:ae68185540db5e2a451d626be45036fe0" id="r_ae68185540db5e2a451d626be45036fe0"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1SoundFileReader.php">SoundFileReader</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundFileFactory.php#ae68185540db5e2a451d626be45036fe0">createReaderFromFilename</a> (const std::string &amp;filename)</td></tr>
...
<tr class="memitem:a2384ed647b08c5b2bbf43566d5d7b5fd" id="r_a2384ed647b08c5b2bbf43566d5d7b5fd"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1SoundFileReader.php">SoundFileReader</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundFileFactory.php#a2384ed647b08c5b2bbf43566d5d7b5fd">createReaderFromMemory</a> (const void *data, std::size_t sizeInBytes)</td></tr>
...
<tr class="memitem:af64ce454cde415ebd3ca5442801d87d8" id="r_af64ce454cde415ebd3ca5442801d87d8"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1SoundFileReader.php">SoundFileReader</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundFileFactory.php#af64ce454cde415ebd3ca5442801d87d8">createReaderFromStream</a> (<a class="el" href="classsf_1_1InputStream.php">InputStream</a> &amp;stream)</td></tr>
...
<tr class="memitem:a2bc9da55d78be2c41a273bbbea4c0978" id="r_a2bc9da55d78be2c41a273bbbea4c0978"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1SoundFileWriter.php">SoundFileWriter</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundFileFactory.php#a2bc9da55d78be2c41a273bbbea4c0978">createWriterFromFilename</a> (const std::string &amp;filename)</td></tr>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundFileFactory.php#a2384ed647b08c5b2bbf43566d5d7b5fd" title="Instantiate the right codec for the given file in memory.">createReaderFromMemory</a>, <a class="el" href="classsf_1_1SoundFileFactory.php#af64ce454cde415ebd3ca5442801d87d8" title="Instantiate the right codec for the given file in stream.">createReaderFromStream</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundFileFactory.php#ae68185540db5e2a451d626be45036fe0" title="Instantiate the right reader for the given file on disk.">createReaderFromFilename</a>, <a class="el" href="classsf_1_1SoundFileFactory.php#af64ce454cde415ebd3ca5442801d87d8" title="Instantiate the right codec for the given file in stream.">createReaderFromStream</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>A new sound file codec that can read the given file, or null if no codec can handle it</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundFileFactory.php#ae68185540db5e2a451d626be45036fe0" title="Instantiate the right reader for the given file on disk.">createReaderFromFilename</a>, <a class="el" href="classsf_1_1SoundFileFactory.php#a2384ed647b08c5b2bbf43566d5d7b5fd" title="Instantiate the right codec for the given file in memory.">createReaderFromMemory</a> </dd></dl>
