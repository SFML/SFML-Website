<?php
    ...
    $pagetitle = 'Class Members - Related Symbols'; // the $ title variable is automatically replaced by doxygen with the page title
...
/* @license-end */
  ...
  <div id="navrow3" class="tabs2">
    <ul class="tablist">
      ...
      <li class="current"><a href="functions_rela.php"><span>Related&#160;Symbols</span></a></li>
    </ul>
  </div>
</div><!-- top -->
