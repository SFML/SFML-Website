...
<tr class="memdesc:a72d7322b355ee2f1be4500f530e98081"><td class="mdescLeft">&#160;</td><td class="mdescRight">Copy constructor.  <a href="#a72d7322b355ee2f1be4500f530e98081"></a><br/></td></tr>
...
<tr class="memdesc:aa18a3c62e6e01e9a21c531b5cad4b7f2"><td class="mdescLeft">&#160;</td><td class="mdescRight">Destructor.  <a href="#aa18a3c62e6e01e9a21c531b5cad4b7f2"></a><br/></td></tr>
...
<tr class="memdesc:ab020052ef4e01f6c749a85571c0f3fd1"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the font from a file.  <a href="#ab020052ef4e01f6c749a85571c0f3fd1"></a><br/></td></tr>
...
<tr class="memdesc:abf2f8d6de31eb4e1db02e061c323e346"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the font from a file in memory.  <a href="#abf2f8d6de31eb4e1db02e061c323e346"></a><br/></td></tr>
...
<tr class="memdesc:abc3f37a354ce8b9a21f8eb93bd9fdafb"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the font from a custom stream.  <a href="#abc3f37a354ce8b9a21f8eb93bd9fdafb"></a><br/></td></tr>
...
<tr class="memdesc:a148eb92890113052f12f8a231ad619b9"><td class="mdescLeft">&#160;</td><td class="mdescRight">Retrieve a glyph of the font.  <a href="#a148eb92890113052f12f8a231ad619b9"></a><br/></td></tr>
<tr class="separator:a148eb92890113052f12f8a231ad619b9"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a4093f7d2d195c88ea90b34cf14e003c8"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a4093f7d2d195c88ea90b34cf14e003c8">getKerning</a> (Uint32 first, Uint32 second, unsigned int characterSize) const </td></tr>
<tr class="memdesc:a4093f7d2d195c88ea90b34cf14e003c8"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the kerning offset of two glyphs.  <a href="#a4093f7d2d195c88ea90b34cf14e003c8"></a><br/></td></tr>
<tr class="separator:a4093f7d2d195c88ea90b34cf14e003c8"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a05f23b88b13bd094083da5b7efc94371"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a05f23b88b13bd094083da5b7efc94371">getLineSpacing</a> (unsigned int characterSize) const </td></tr>
<tr class="memdesc:a05f23b88b13bd094083da5b7efc94371"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the line spacing.  <a href="#a05f23b88b13bd094083da5b7efc94371"></a><br/></td></tr>
...
<tr class="memdesc:a887368a4e6a3dfa32dea89d2af315951"><td class="mdescLeft">&#160;</td><td class="mdescRight">Retrieve the texture containing the loaded glyphs of a certain size.  <a href="#a887368a4e6a3dfa32dea89d2af315951"></a><br/></td></tr>
...
<tr class="memdesc:a232515549846e3172a514d0b47918399"><td class="mdescLeft">&#160;</td><td class="mdescRight">Overload of assignment operator.  <a href="#a232515549846e3172a514d0b47918399"></a><br/></td></tr>
...
<p>Once it is loaded, a <a class="el" href="classsf_1_1Font.php" title="Class for loading and manipulating character fonts.">sf::Font</a> instance provides three types of information about the font: </p>
<ul>
...
<div class="line"><a class="code" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target.">sf::Text</a> text1;</div>
<div class="line">text1.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81" title="Set the text&#39;s font.">setFont</a>(font);</div>
<div class="line">text1.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e" title="Set the character size.">setCharacterSize</a>(30);</div>
<div class="line">text1.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf" title="Set the text&#39;s style.">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82a2af9ae5e1cda126570f744448e0caa32" title="Regular characters, no style.">sf::Text::Regular</a>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create another text using the same font, but with different parameters</span></div>
<div class="line"><a class="code" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target.">sf::Text</a> text2;</div>
<div class="line">text2.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81" title="Set the text&#39;s font.">setFont</a>(font);</div>
<div class="line">text2.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e" title="Set the character size.">setCharacterSize</a>(50);</div>
<div class="line">text1.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf" title="Set the text&#39;s style.">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82aee249eb803848723c542c2062ebe69d8" title="Italic characters.">sf::Text::Italic</a>);</div>
