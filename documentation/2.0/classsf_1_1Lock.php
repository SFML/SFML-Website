...
<tr class="memdesc:a1a4c5d7a15da61103d85c9aa7f118920"><td class="mdescLeft">&#160;</td><td class="mdescRight">Construct the lock with a target mutex.  <a href="#a1a4c5d7a15da61103d85c9aa7f118920"></a><br/></td></tr>
...
<tr class="memdesc:a8168b36323a18ccf5b6bc531d964aec5"><td class="mdescLeft">&#160;</td><td class="mdescRight">Destructor.  <a href="#a8168b36323a18ccf5b6bc531d964aec5"></a><br/></td></tr>
...
<p>Usage example: </p>
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Mutex.php" title="Blocks concurrent access to shared resources from multiple threads.">sf::Mutex</a> mutex;</div>
<div class="line"></div>
<div class="line"><span class="keywordtype">void</span> <span class="keyword">function</span>()</div>
<div class="line">{</div>
<div class="line">    <a class="code" href="classsf_1_1Lock.php" title="Automatic wrapper for locking and unlocking mutexes.">sf::Lock</a> lock(mutex); <span class="comment">// mutex is now locked</span></div>
<div class="line"></div>
...
<div class="line">{</div>
<div class="line">    {</div>
<div class="line">      <a class="code" href="classsf_1_1Lock.php" title="Automatic wrapper for locking and unlocking mutexes.">sf::Lock</a> lock(mutex);</div>
...
<p>Definition at line <a class="el" href="Lock_8hpp_source.php#l00043">43</a> of file <a class="el" href="Lock_8hpp_source.php">Lock.hpp</a>.</p>
