...
<tr class="memdesc:a62a9bf81fd7f15fedb29fd1348483236"><td class="mdescLeft">&#160;</td><td class="mdescRight">Default constructor.  <a href="#a62a9bf81fd7f15fedb29fd1348483236"></a><br/></td></tr>
...
<tr class="memdesc:ab47eeb1cb71f2f251a83bc823773f1b3"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the port to which the socket is bound locally.  <a href="#ab47eeb1cb71f2f251a83bc823773f1b3"></a><br/></td></tr>
...
<tr class="memdesc:a7904ca6ab9e018021e305a3aeb7a1b9a"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the address of the connected peer.  <a href="#a7904ca6ab9e018021e305a3aeb7a1b9a"></a><br/></td></tr>
...
<tr class="memdesc:abc05220e06f1522144cecab822e79296"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the port of the connected peer to which the socket is connected.  <a href="#abc05220e06f1522144cecab822e79296"></a><br/></td></tr>
...
<tr class="memdesc:a68cd42d5ab70ab54b16787f555951c40"><td class="mdescLeft">&#160;</td><td class="mdescRight">Connect the socket to a remote peer.  <a href="#a68cd42d5ab70ab54b16787f555951c40"></a><br/></td></tr>
...
<tr class="memdesc:ac18f518a9be3d6be5e74b9404c253c1e"><td class="mdescLeft">&#160;</td><td class="mdescRight">Disconnect the socket from its remote peer.  <a href="#ac18f518a9be3d6be5e74b9404c253c1e"></a><br/></td></tr>
...
<tr class="memdesc:affce26ab3bcc4f5b9269dad79db544c0"><td class="mdescLeft">&#160;</td><td class="mdescRight">Send raw data to the remote peer.  <a href="#affce26ab3bcc4f5b9269dad79db544c0"></a><br/></td></tr>
...
<tr class="memdesc:a90ce50811ea61d4f00efc62bb99ae1af"><td class="mdescLeft">&#160;</td><td class="mdescRight">Receive raw data from the remote peer.  <a href="#a90ce50811ea61d4f00efc62bb99ae1af"></a><br/></td></tr>
...
<tr class="memdesc:a0f8276e2b1c75aac4a7b0a707b250f44"><td class="mdescLeft">&#160;</td><td class="mdescRight">Send a formatted packet of data to the remote peer.  <a href="#a0f8276e2b1c75aac4a7b0a707b250f44"></a><br/></td></tr>
...
<tr class="memdesc:aa655352609bc9804f2baa020df3e7331"><td class="mdescLeft">&#160;</td><td class="mdescRight">Receive a formatted packet of data from the remote peer.  <a href="#aa655352609bc9804f2baa020df3e7331"></a><br/></td></tr>
...
<tr class="memitem:a5d3ff44e56e68f02816bb0fabc34adf8"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8">Type</a> { <br/>
&#160;&#160;<a class="el" href="classsf_1_1Socket.php#a5d3ff44e56e68f02816bb0fabc34adf8acc02e97e90234b957eaad4dff7f22214">Tcp</a>, 
<br/>
...
<div class="line"><a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">sf::TcpSocket</a> socket;</div>
<div class="line">socket.<a class="code" href="classsf_1_1TcpSocket.php#a68cd42d5ab70ab54b16787f555951c40" title="Connect the socket to a remote peer.">connect</a>(<span class="stringliteral">&quot;192.168.1.50&quot;</span>, 55001);</div>
<div class="line"></div>
...
<div class="line">socket.<a class="code" href="classsf_1_1TcpSocket.php#affce26ab3bcc4f5b9269dad79db544c0" title="Send raw data to the remote peer.">send</a>(message.c_str(), message.size() + 1);</div>
<div class="line"></div>
...
<div class="line">socket.<a class="code" href="classsf_1_1TcpSocket.php#a90ce50811ea61d4f00efc62bb99ae1af" title="Receive raw data from the remote peer.">receive</a>(buffer, <span class="keyword">sizeof</span>(buffer), received);</div>
...
<div class="line"><a class="code" href="classsf_1_1TcpListener.php" title="Socket that listens to new TCP connections.">sf::TcpListener</a> listener;</div>
<div class="line">listener.<a class="code" href="classsf_1_1TcpListener.php#a409d9350d3abfea9636df8cf4a61004e" title="Start listening for connections.">listen</a>(55001);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Wait for a connection</span></div>
<div class="line"><a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">sf::TcpSocket</a> socket;</div>
<div class="line">listener.<a class="code" href="classsf_1_1TcpListener.php#ae2c83ce5a64d50b68180c46bef0a7346" title="Accept a new connection.">accept</a>(socket);</div>
<div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;New client connected: &quot;</span> &lt;&lt; socket.<a class="code" href="classsf_1_1TcpSocket.php#a7904ca6ab9e018021e305a3aeb7a1b9a" title="Get the address of the connected peer.">getRemoteAddress</a>() &lt;&lt; std::endl;</div>
<div class="line"></div>
