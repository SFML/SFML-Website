...
<p><a class="el" href="classsf_1_1Http_1_1Request.php" title="Define a HTTP request.">sf::Http::Request</a> builds the request that will be sent to the server. A request is made of: </p>
<ul>
...
<p><a class="el" href="classsf_1_1Http_1_1Response.php" title="Define a HTTP response.">sf::Http::Response</a> parse the response from the web server and provides getters to read them. The response contains: </p>
<ul>
<li>a status code </li>
...
<div class="line"><a class="code" href="classsf_1_1Http.php" title="A HTTP client.">sf::Http</a> http;</div>
<div class="line"></div>
<div class="line"><span class="comment">// We&#39;ll work on http://www.sfml-dev.org</span></div>
<div class="line">http.<a class="code" href="classsf_1_1Http.php#a55121d543b61c41cf20b885a97b04e65" title="Set the target host.">setHost</a>(<span class="stringliteral">&quot;http://www.sfml-dev.org&quot;</span>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Prepare a request to get the &#39;features.php&#39; page</span></div>
<div class="line"><a class="code" href="classsf_1_1Http_1_1Request.php" title="Define a HTTP request.">sf::Http::Request</a> request(<span class="stringliteral">&quot;features.php&quot;</span>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Send the request</span></div>
<div class="line"><a class="code" href="classsf_1_1Http_1_1Response.php" title="Define a HTTP response.">sf::Http::Response</a> response = http.<a class="code" href="classsf_1_1Http.php#aaf09ebfb5e00dcc82e0d494d5c6a9e2a" title="Send a HTTP request and return the server&#39;s response.">sendRequest</a>(request);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Check the status code and display the result</span></div>
<div class="line"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8" title="Enumerate all the valid status codes for a response.">sf::Http::Response::Status</a> status = response.<a class="code" href="classsf_1_1Http_1_1Response.php#a542e9856b1dd260a83940eb982b7f19a" title="Get the response status code.">getStatus</a>();</div>
<div class="line"><span class="keywordflow">if</span> (status == <a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0158f932254d3f09647dd1f64bd43832" title="Most common code returned when operation was successful.">sf::Http::Response::Ok</a>)</div>
<div class="line">{</div>
<div class="line">    std::cout &lt;&lt; response.<a class="code" href="classsf_1_1Http_1_1Response.php#a6b74ef73051a16ebb20041495c758e22" title="Get the body of the response.">getBody</a>() &lt;&lt; std::endl;</div>
<div class="line">}</div>
...
<p>You must have a valid host before sending a request (see setHost). Any missing mandatory header field in the request will be added with an appropriate value. Warning: this function waits for the server's response and may not return instantly; use a thread if you don't want to block your application, or use a timeout to limit the time to wait. A value of <a class="el" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0" title="Predefined &quot;zero&quot; time value.">Time::Zero</a> means that the client will use the system defaut timeout (which is usually pretty long).</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
