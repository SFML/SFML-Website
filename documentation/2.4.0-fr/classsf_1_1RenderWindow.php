...
<tr class="memitem:a2c7ff414be32621a453745cf2a0f8a3e"><td class="memItemLeft" align="right" valign="top">virtual <a class="el" href="classsf_1_1Vector2.php">Vector2u</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1RenderWindow.php#a2c7ff414be32621a453745cf2a0f8a3e">getSize</a> () const </td></tr>
...
<tr class="memitem:acd1967616b6ef482026b48f44fbf2624"><td class="memItemLeft" align="right" valign="top">SFML_DEPRECATED <a class="el" href="classsf_1_1Image.php">Image</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1RenderWindow.php#acd1967616b6ef482026b48f44fbf2624">capture</a> () const </td></tr>
<tr class="memdesc:acd1967616b6ef482026b48f44fbf2624"><td class="mdescLeft">&#160;</td><td class="mdescRight">Copy the current contents of the window to an image.  <a href="#acd1967616b6ef482026b48f44fbf2624">More...</a><br /></td></tr>
<tr class="separator:acd1967616b6ef482026b48f44fbf2624"><td class="memSeparator" colspan="2">&#160;</td></tr>
...
<tr class="memitem:a5aa9c2b2b0e51d3423c2b66c80253337"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#a5aa9c2b2b0e51d3423c2b66c80253337">isOpen</a> () const </td></tr>
...
<tr class="memitem:a2e6bc12612ea289afea8268fe37c8678"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Vector2.php">Vector2i</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#a2e6bc12612ea289afea8268fe37c8678">getPosition</a> () const </td></tr>
...
<tr class="memitem:a17ccf8ece0ce0bf2f1e6698bcfa29731"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#a17ccf8ece0ce0bf2f1e6698bcfa29731">setActive</a> (bool active=true) const </td></tr>
...
<tr class="memitem:ac4dce670f07c5039a732ba0903ce3a77"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#ac4dce670f07c5039a732ba0903ce3a77">hasFocus</a> () const </td></tr>
<tr class="memdesc:ac4dce670f07c5039a732ba0903ce3a77"><td class="mdescLeft">&#160;</td><td class="mdescRight">Check whether the window has the input focus.  <a href="#ac4dce670f07c5039a732ba0903ce3a77">More...</a><br /></td></tr>
<tr class="separator:ac4dce670f07c5039a732ba0903ce3a77"><td class="memSeparator" colspan="2">&#160;</td></tr>
...
<tr class="memitem:a26368e7162229f8637c34d80ab0f138e"><td class="memItemLeft" align="right" valign="top">WindowHandle&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#a26368e7162229f8637c34d80ab0f138e">getSystemHandle</a> () const </td></tr>
...
<div class="fragment"><div class="line"><span class="comment">// Declare and create a new render-window</span></div><div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Limit the framerate to 60 frames per second (this step is optional)</span></div><div class="line">window.setFramerateLimit(60);</div><div class="line"></div><div class="line"><span class="comment">// The main loop - ends as soon as the window is closed</span></div><div class="line"><span class="keywordflow">while</span> (window.isOpen())</div><div class="line">{</div><div class="line">   <span class="comment">// Event processing</span></div><div class="line">   <a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div><div class="line">   <span class="keywordflow">while</span> (window.pollEvent(event))</div><div class="line">   {</div><div class="line">       <span class="comment">// Request for closing the window</span></div><div class="line">       <span class="keywordflow">if</span> (event.<a class="code" href="classsf_1_1Event.php#adf2f8044f713fd9d6019077b0d1ffe0a">type</a> == <a class="code" href="classsf_1_1Event.php#af41fa9ed45c02449030699f671331d4aa316e4212e083f1dce79efd8d9e9c0a95">sf::Event::Closed</a>)</div><div class="line">           window.close();</div><div class="line">   }</div><div class="line"></div><div class="line">   <span class="comment">// Clear the whole window before rendering a new frame</span></div><div class="line">   window.clear();</div><div class="line"></div><div class="line">   <span class="comment">// Draw some graphical entities</span></div><div class="line">   window.draw(sprite);</div><div class="line">   window.draw(circle);</div><div class="line">   window.draw(text);</div><div class="line"></div><div class="line">   <span class="comment">// End the current frame and display its contents on screen</span></div><div class="line">   window.display();</div><div class="line">}</div></div><!-- fragment --><p>Like <a class="el" href="classsf_1_1Window.php" title="Window that serves as a target for OpenGL rendering. ">sf::Window</a>, <a class="el" href="classsf_1_1RenderWindow.php" title="Window that can serve as a target for 2D drawing. ">sf::RenderWindow</a> is still able to render direct OpenGL stuff. It is even possible to mix together OpenGL calls and regular SFML drawing commands.</p>
...
<p>Definition at line <a class="el" href="RenderWindow_8hpp_source.php#l00044">44</a> of file <a class="el" href="RenderWindow_8hpp_source.php">RenderWindow.hpp</a>.</p>
...
<a class="anchor" id="acd1967616b6ef482026b48f44fbf2624"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector2.php">sf::Vector2u</a> windowSize = window.getSize();</div><div class="line"><a class="code" href="classsf_1_1Texture.php">sf::Texture</a> texture;</div><div class="line">texture.<a class="code" href="classsf_1_1Texture.php#a89b4c7d204acf1033c3a1b6e0a3ad0a3">create</a>(windowSize.<a class="code" href="classsf_1_1Vector2.php#a1e6ad77fa155f3753bfb92699bd28141">x</a>, windowSize.<a class="code" href="classsf_1_1Vector2.php#a420f2481b015f4eb929c75f2af564299">y</a>);</div><div class="line">texture.<a class="code" href="classsf_1_1Texture.php#ae4eab5c6781316840b0c50ad08370963">update</a>(window);</div><div class="line"><a class="code" href="classsf_1_1Image.php">sf::Image</a> screenshot = texture.<a class="code" href="classsf_1_1Texture.php#aefc19bcd95565dd2348fd4cec0facddc">copyToImage</a>();</div></div><!-- fragment --><p>This is a slow operation, whose main purpose is to make screenshots of the application. If you want to update an image with the contents of the window and then use it for drawing, you should rather use a <a class="el" href="classsf_1_1Texture.php" title="Image living on the graphics card that can be used for drawing. ">sf::Texture</a> and its update(Window&amp;) function. You can also draw things directly to a texture with the <a class="el" href="classsf_1_1RenderTexture.php" title="Target for off-screen 2D rendering into a texture. ">sf::RenderTexture</a> class.</p>
...
<p>Implements <a class="el" href="classsf_1_1RenderTarget.php#a88031922215f4da7b06309b9214169aa">sf::RenderTarget</a>.</p>
...
<a class="anchor" id="ac4dce670f07c5039a732ba0903ce3a77"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<a class="anchor" id="a58cf7fa1775e8e7542032e3ecfa83b49"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<p>At any given time, only one window may have the input focus to receive input events such as keystrokes or mouse events. If a window requests focus, it only hints to the operating system, that it would like to be focused. The operating system is free to deny the request. This is not to be confused with <a class="el" href="classsf_1_1Window.php#a17ccf8ece0ce0bf2f1e6698bcfa29731" title="Activate or deactivate the window as the current target for OpenGL rendering. ">setActive()</a>.</p>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Window.php#ac4dce670f07c5039a732ba0903ce3a77" title="Check whether the window has the input focus. ">hasFocus</a> </dd></dl>
...
<a class="anchor" id="a5b4ef8ede77531e17b7a0287fa6ff9ce"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<p>If set, grabs the mouse cursor inside this window's client area so it may no longer be moved outside its bounds. Note that grabbing is only active while the window has focus and calling this function for fullscreen windows won't have any effect (fullscreen windows always grab the cursor).</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Window.php#a2e6bc12612ea289afea8268fe37c8678" title="Get the position of the window. ">getPosition</a> </dd></dl>

</div>
</div>
<a class="anchor" id="ab94ea32f22d15c0df11588e319de2546"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Window.php#ad2b55a731ba1680fe67292991ef1610e" title="Get the size of the rendering region of the window. ">getSize</a> </dd></dl>
