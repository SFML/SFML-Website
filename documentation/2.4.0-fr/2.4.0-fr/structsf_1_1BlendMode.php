...
<p>The blend factors and equations correspond to their OpenGL equivalents. In general, the color of the resulting pixel is calculated according to the following formula (<em>src</em> is the color of the source pixel, <em>dst</em> the color of the destination pixel, the other variables correspond to the public members, with the equations being + or - operators): </p><div class="fragment"><div class="line">dst.rgb = <a class="code" href="structsf_1_1BlendMode.php#a32d1a55dbfada86a06d9b881dc8ccf7b">colorSrcFactor</a> * src.rgb (<a class="code" href="structsf_1_1BlendMode.php#aed12f06eb7f50a1b95b892b0964857b1">colorEquation</a>) <a class="code" href="structsf_1_1BlendMode.php#adee68ee59e7f1bf71d12db03d251104d">colorDstFactor</a> * dst.rgb</div><div class="line">dst.a   = <a class="code" href="structsf_1_1BlendMode.php#aa94e44f8e1042a7357e8eff78c61a1be">alphaSrcFactor</a> * src.a   (<a class="code" href="structsf_1_1BlendMode.php#a68f5a305e0912946f39ba6c9265710c4">alphaEquation</a>) <a class="code" href="structsf_1_1BlendMode.php#aaf85b6b7943181cc81745569c4851e4e">alphaDstFactor</a> * dst.a</div></div><!-- fragment --><p> All factors and colors are represented as floating point numbers between 0 and 1. Where necessary, the result is clamped to fit in that range.</p>
<p>The most common blending modes are defined as constants in the sf namespace:</p>
<div class="fragment"><div class="line"><a class="code" href="structsf_1_1BlendMode.php">sf::BlendMode</a> alphaBlending          = sf::BlendAlpha;</div><div class="line"><a class="code" href="structsf_1_1BlendMode.php">sf::BlendMode</a> additiveBlending       = sf::BlendAdd;</div><div class="line"><a class="code" href="structsf_1_1BlendMode.php">sf::BlendMode</a> multiplicativeBlending = sf::BlendMultiply;</div><div class="line"><a class="code" href="structsf_1_1BlendMode.php">sf::BlendMode</a> noBlending             = sf::BlendNone;</div></div><!-- fragment --><p>In SFML, a blend mode can be specified every time you draw a <a class="el" href="classsf_1_1Drawable.php" title="Abstract base class for objects that can be drawn to a render target. ">sf::Drawable</a> object to a render target. It is part of the <a class="el" href="classsf_1_1RenderStates.php" title="Define the states used for drawing to a RenderTarget. ">sf::RenderStates</a> compound that is passed to the member function <a class="el" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39" title="Draw a drawable object to the render target. ">sf::RenderTarget::draw()</a>.</p>
...
<a id="a7bce470e2e384c4f9c8d9595faef7c32"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7bce470e2e384c4f9c8d9595faef7c32">&sect;&nbsp;</a></span>Equation <span class="overload">[1/2]</span></h2>
...
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32ada07390f79e829c0eeb83909d3b828dc"></a>Add&#160;</td><td class="fielddoc"><p>Pixel = Src * SrcFactor + Dst * DstFactor. </p>
</td></tr>
<tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32a1c1006d7453b982cb868d65ca439e75c"></a>Subtract&#160;</td><td class="fielddoc"><p>Pixel = Src * SrcFactor - Dst * DstFactor. </p>
</td></tr>
<tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32aae64991689dfb87f2b607706a1b11835"></a>ReverseSubtract&#160;</td><td class="fielddoc"><p>Pixel = Dst * DstFactor - Src * SrcFactor. </p>
</td></tr>
<tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32ada07390f79e829c0eeb83909d3b828dc"></a>Add&#160;</td><td class="fielddoc"><p>Pixel = Src * SrcFactor + Dst * DstFactor. </p>
</td></tr>
<tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32a1c1006d7453b982cb868d65ca439e75c"></a>Subtract&#160;</td><td class="fielddoc"><p>Pixel = Src * SrcFactor - Dst * DstFactor. </p>
</td></tr>
<tr><td class="fieldname"><a id="a7bce470e2e384c4f9c8d9595faef7c32aae64991689dfb87f2b607706a1b11835"></a>ReverseSubtract&#160;</td><td class="fielddoc"><p>Pixel = Dst * DstFactor - Src * SrcFactor. </p>
...
<a id="a7bce470e2e384c4f9c8d9595faef7c32"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7bce470e2e384c4f9c8d9595faef7c32">&sect;&nbsp;</a></span>Equation <span class="overload">[2/2]</span></h2>
...
<a id="afb9852caf356b53bb0de460c58a9ebbb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#afb9852caf356b53bb0de460c58a9ebbb">&sect;&nbsp;</a></span>Factor <span class="overload">[1/2]</span></h2>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba65485893f4abfbf2ae7702f371e003c1"></a>Zero&#160;</td><td class="fielddoc"><p>(0, 0, 0, 0) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba45992876072f707d1565f2d08d6b5ed6"></a>One&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbae3d90dc633cbb883554339e4303f0355"></a>SrcColor&#160;</td><td class="fielddoc"><p>(src.r, src.g, src.b, src.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbafc9454075ca0b0613f23c9d7d614dca4"></a>OneMinusSrcColor&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) - (src.r, src.g, src.b, src.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbabf55ba7b1fd4567def92e4fbfa40387a"></a>DstColor&#160;</td><td class="fielddoc"><p>(dst.r, dst.g, dst.b, dst.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbae000102101f7c9828e106c9162ddb69e"></a>OneMinusDstColor&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) - (dst.r, dst.g, dst.b, dst.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba8b0cabd5aa52557b385848b8055cb270"></a>SrcAlpha&#160;</td><td class="fielddoc"><p>(src.a, src.a, src.a, src.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbaf882a5496651c616d7f23cafc8eafe61"></a>OneMinusSrcAlpha&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) - (src.a, src.a, src.a, src.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba3344b2d94959aa49f66797bf8046b15b"></a>DstAlpha&#160;</td><td class="fielddoc"><p>(dst.a, dst.a, dst.a, dst.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba6f0663bcd2a998b0bb03110fb691ff48"></a>OneMinusDstAlpha&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) - (dst.a, dst.a, dst.a, dst.a) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba65485893f4abfbf2ae7702f371e003c1"></a>Zero&#160;</td><td class="fielddoc"><p>(0, 0, 0, 0) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbba45992876072f707d1565f2d08d6b5ed6"></a>One&#160;</td><td class="fielddoc"><p>(1, 1, 1, 1) </p>
</td></tr>
<tr><td class="fieldname"><a id="afb9852caf356b53bb0de460c58a9ebbbae3d90dc633cbb883554339e4303f0355"></a>SrcColor&#160;</td><td class="fielddoc"><p>(src.r, src.g, src.b, src.a) </p>
...
<a id="afb9852caf356b53bb0de460c58a9ebbb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#afb9852caf356b53bb0de460c58a9ebbb">&sect;&nbsp;</a></span>Factor <span class="overload">[2/2]</span></h2>
...
<a id="a7faef75eae1fb47bbe93f45f38e3d345"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7faef75eae1fb47bbe93f45f38e3d345">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[1/6]</span></h2>
...
<a id="a23c7452cc8e9eb943c3aea6234ce4297"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a23c7452cc8e9eb943c3aea6234ce4297">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[2/6]</span></h2>
...
<a id="a69a12c596114e77126616e7e0f7d798b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a69a12c596114e77126616e7e0f7d798b">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[3/6]</span></h2>
...
<a id="a7faef75eae1fb47bbe93f45f38e3d345"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7faef75eae1fb47bbe93f45f38e3d345">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[4/6]</span></h2>
...
<a id="a23c7452cc8e9eb943c3aea6234ce4297"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a23c7452cc8e9eb943c3aea6234ce4297">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[5/6]</span></h2>
...
<a id="a69a12c596114e77126616e7e0f7d798b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a69a12c596114e77126616e7e0f7d798b">&sect;&nbsp;</a></span>BlendMode() <span class="overload">[6/6]</span></h2>
...
<a id="aee6169f8983f5e92298c4ad6829563ba"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aee6169f8983f5e92298c4ad6829563ba">&sect;&nbsp;</a></span>operator!=() <span class="overload">[1/2]</span></h2>
...
<a id="aee6169f8983f5e92298c4ad6829563ba"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aee6169f8983f5e92298c4ad6829563ba">&sect;&nbsp;</a></span>operator!=() <span class="overload">[2/2]</span></h2>
...
<a id="a20d1be06061109c3cef58e0cc38729ea"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a20d1be06061109c3cef58e0cc38729ea">&sect;&nbsp;</a></span>operator==() <span class="overload">[1/2]</span></h2>
...
<a id="a20d1be06061109c3cef58e0cc38729ea"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a20d1be06061109c3cef58e0cc38729ea">&sect;&nbsp;</a></span>operator==() <span class="overload">[2/2]</span></h2>
...
<a id="aaf85b6b7943181cc81745569c4851e4e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aaf85b6b7943181cc81745569c4851e4e">&sect;&nbsp;</a></span>alphaDstFactor</h2>
...
<a id="a68f5a305e0912946f39ba6c9265710c4"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a68f5a305e0912946f39ba6c9265710c4">&sect;&nbsp;</a></span>alphaEquation</h2>
...
<a id="aa94e44f8e1042a7357e8eff78c61a1be"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa94e44f8e1042a7357e8eff78c61a1be">&sect;&nbsp;</a></span>alphaSrcFactor</h2>
...
<a id="adee68ee59e7f1bf71d12db03d251104d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#adee68ee59e7f1bf71d12db03d251104d">&sect;&nbsp;</a></span>colorDstFactor</h2>
...
<a id="aed12f06eb7f50a1b95b892b0964857b1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aed12f06eb7f50a1b95b892b0964857b1">&sect;&nbsp;</a></span>colorEquation</h2>
...
<a id="a32d1a55dbfada86a06d9b881dc8ccf7b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a32d1a55dbfada86a06d9b881dc8ccf7b">&sect;&nbsp;</a></span>colorSrcFactor</h2>
