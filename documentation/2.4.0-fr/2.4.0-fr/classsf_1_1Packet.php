...
<div class="title">sf::Packet Class Reference<div class="ingroups"><a class="el" href="group__network.php">Network module</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Network_2Packet_8hpp_source.php">Packet.hpp</a>&gt;</code></p>
...
<tr class="memitem:abfd771803c822f89f187e1fcc2af5afc"><td class="memItemLeft" align="right" valign="top">const void *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Packet.php#abfd771803c822f89f187e1fcc2af5afc">getData</a> () const</td></tr>
...
<tr class="memitem:a052e955906c9bfd671622cb625380edc"><td class="memItemLeft" align="right" valign="top">virtual const void *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Packet.php#a052e955906c9bfd671622cb625380edc">onSend</a> (std::size_t &amp;size)</td></tr>
...
Friends</h2></td></tr>
<tr class="memitem:ae50c91e8e9046881024f96682796ccfa"><td class="memItemLeft" align="right" valign="top"><a id="ae50c91e8e9046881024f96682796ccfa"></a>
class&#160;</td><td class="memItemRight" valign="bottom"><b>TcpSocket</b></td></tr>
<tr class="separator:ae50c91e8e9046881024f96682796ccfa"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a7e0415ed4a34b5104f6b34682f602c6e"><td class="memItemLeft" align="right" valign="top"><a id="a7e0415ed4a34b5104f6b34682f602c6e"></a>
class&#160;</td><td class="memItemRight" valign="bottom"><b>UdpSocket</b></td></tr>
<tr class="separator:a7e0415ed4a34b5104f6b34682f602c6e"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table>
...
<p>Usage example: </p><div class="fragment"><div class="line">sf::Uint32 x = 24;</div><div class="line">std::string s = <span class="stringliteral">&quot;hello&quot;</span>;</div><div class="line"><span class="keywordtype">double</span> d = 5.89;</div><div class="line"></div><div class="line"><span class="comment">// Group the variables to send into a packet</span></div><div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a> packet;</div><div class="line">packet &lt;&lt; x &lt;&lt; s &lt;&lt; d;</div><div class="line"></div><div class="line"><span class="comment">// Send it over the network (socket is a valid sf::TcpSocket)</span></div><div class="line">socket.send(packet);</div><div class="line"></div><div class="line">-----------------------------------------------------------------</div><div class="line"></div><div class="line"><span class="comment">// Receive the packet at the other end</span></div><div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a> packet;</div><div class="line">socket.receive(packet);</div><div class="line"></div><div class="line"><span class="comment">// Extract the variables contained in the packet</span></div><div class="line">sf::Uint32 x;</div><div class="line">std::string s;</div><div class="line"><span class="keywordtype">double</span> d;</div><div class="line"><span class="keywordflow">if</span> (packet &gt;&gt; x &gt;&gt; s &gt;&gt; d)</div><div class="line">{</div><div class="line">    <span class="comment">// Data extracted successfully...</span></div><div class="line">}</div></div><!-- fragment --><p>Packets have built-in operator &gt;&gt; and &lt;&lt; overloads for standard types: </p><ul>
<li>bool </li>
...
<div class="fragment"><div class="line"><span class="keyword">struct </span>MyStruct</div><div class="line">{</div><div class="line">    <span class="keywordtype">float</span>       number;</div><div class="line">    sf::Int8    integer;</div><div class="line">    std::string str;</div><div class="line">};</div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#aa5a465ed02ba29d83ecdafb0ac3fff21">operator &lt;&lt;</a>(<a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; packet, <span class="keyword">const</span> MyStruct&amp; m)</div><div class="line">{</div><div class="line">    <span class="keywordflow">return</span> packet &lt;&lt; m.number &lt;&lt; m.integer &lt;&lt; m.str;</div><div class="line">}</div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#af8e26c63ba9bdccd262565ff0d3eeba2">operator &gt;&gt;</a>(<a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; packet, MyStruct&amp; m)</div><div class="line">{</div><div class="line">    <span class="keywordflow">return</span> packet &gt;&gt; m.number &gt;&gt; m.integer &gt;&gt; m.str;</div><div class="line">}</div></div><!-- fragment --><p>Packets also provide an extra feature that allows to apply custom transformations to the data before it is sent, and after it is received. This is typically used to handle automatic compression or encryption of the data. This is achieved by inheriting from <a class="el" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network. ">sf::Packet</a>, and overriding the onSend and onReceive functions.</p>
<p>Here is an example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>ZipPacket : <span class="keyword">public</span> <a class="code" href="classsf_1_1Packet.php">sf::Packet</a></div><div class="line">{</div><div class="line">    <span class="keyword">virtual</span> <span class="keyword">const</span> <span class="keywordtype">void</span>* <a class="code" href="classsf_1_1Packet.php#a052e955906c9bfd671622cb625380edc">onSend</a>(std::size_t&amp; size)</div><div class="line">    {</div><div class="line">        <span class="keyword">const</span> <span class="keywordtype">void</span>* srcData = <a class="code" href="classsf_1_1Packet.php#abfd771803c822f89f187e1fcc2af5afc">getData</a>();</div><div class="line">        std::size_t srcSize = <a class="code" href="classsf_1_1Packet.php#a0fae6eccf2ca704fc5099cd90a9f56f7">getDataSize</a>();</div><div class="line"></div><div class="line">        <span class="keywordflow">return</span> MySuperZipFunction(srcData, srcSize, &amp;size);</div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1Packet.php#ab71a31ef0f1d5d856de6f9fc75434128">onReceive</a>(<span class="keyword">const</span> <span class="keywordtype">void</span>* data, std::size_t size)</div><div class="line">    {</div><div class="line">        std::size_t dstSize;</div><div class="line">        <span class="keyword">const</span> <span class="keywordtype">void</span>* dstData = MySuperUnzipFunction(data, size, &amp;dstSize);</div><div class="line"></div><div class="line">        <a class="code" href="classsf_1_1Packet.php#a7dd6e429b87520008326c4d71f1cf011">append</a>(dstData, dstSize);</div><div class="line">    }</div><div class="line">};</div><div class="line"></div><div class="line"><span class="comment">// Use like regular packets:</span></div><div class="line">ZipPacket packet;</div><div class="line">packet &lt;&lt; x &lt;&lt; s &lt;&lt; d;</div><div class="line">...</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol. ">sf::TcpSocket</a>, <a class="el" href="classsf_1_1UdpSocket.php" title="Specialized socket using the UDP protocol. ">sf::UdpSocket</a> </dd></dl>

<p>Definition at line <a class="el" href="include_2SFML_2Network_2Packet_8hpp_source.php#l00047">47</a> of file <a class="el" href="include_2SFML_2Network_2Packet_8hpp_source.php">include/SFML/Network/Packet.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a786e5d4ced83992ceefa1799963ea858"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a786e5d4ced83992ceefa1799963ea858">&sect;&nbsp;</a></span>Packet() <span class="overload">[1/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#adc0490ca3c7c3d1e321bd742e5213913">&sect;&nbsp;</a></span>~Packet() <span class="overload">[1/2]</span></h2>
...
<a id="a786e5d4ced83992ceefa1799963ea858"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a786e5d4ced83992ceefa1799963ea858">&sect;&nbsp;</a></span>Packet() <span class="overload">[2/2]</span></h2>
...
<a id="adc0490ca3c7c3d1e321bd742e5213913"></a>
<h2 class="memtitle"><span class="permalink"><a href="#adc0490ca3c7c3d1e321bd742e5213913">&sect;&nbsp;</a></span>~Packet() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a7dd6e429b87520008326c4d71f1cf011">&sect;&nbsp;</a></span>append() <span class="overload">[1/2]</span></h2>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Packet.php#a133ea8b8fe6e93c230f0d79f19a3bf0d" title="Clear the packet. ">clear</a> </dd></dl>

</div>
</div>
<a id="a7dd6e429b87520008326c4d71f1cf011"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7dd6e429b87520008326c4d71f1cf011">&sect;&nbsp;</a></span>append() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a133ea8b8fe6e93c230f0d79f19a3bf0d">&sect;&nbsp;</a></span>clear() <span class="overload">[1/2]</span></h2>
...
<a id="a133ea8b8fe6e93c230f0d79f19a3bf0d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a133ea8b8fe6e93c230f0d79f19a3bf0d">&sect;&nbsp;</a></span>clear() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a61e354fa670da053907c14b738839560">&sect;&nbsp;</a></span>endOfPacket() <span class="overload">[1/2]</span></h2>
...
<a id="a61e354fa670da053907c14b738839560"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a61e354fa670da053907c14b738839560">&sect;&nbsp;</a></span>endOfPacket() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#abfd771803c822f89f187e1fcc2af5afc">&sect;&nbsp;</a></span>getData() <span class="overload">[1/2]</span></h2>
...
<a id="abfd771803c822f89f187e1fcc2af5afc"></a>
<h2 class="memtitle"><span class="permalink"><a href="#abfd771803c822f89f187e1fcc2af5afc">&sect;&nbsp;</a></span>getData() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a0fae6eccf2ca704fc5099cd90a9f56f7">&sect;&nbsp;</a></span>getDataSize() <span class="overload">[1/2]</span></h2>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Packet.php#abfd771803c822f89f187e1fcc2af5afc" title="Get a pointer to the data contained in the packet. ">getData</a> </dd></dl>

</div>
</div>
<a id="a0fae6eccf2ca704fc5099cd90a9f56f7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a0fae6eccf2ca704fc5099cd90a9f56f7">&sect;&nbsp;</a></span>getDataSize() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ab71a31ef0f1d5d856de6f9fc75434128">&sect;&nbsp;</a></span>onReceive() <span class="overload">[1/2]</span></h2>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Packet.php#a052e955906c9bfd671622cb625380edc" title="Called before the packet is sent over the network. ">onSend</a> </dd></dl>

</div>
</div>
<a id="ab71a31ef0f1d5d856de6f9fc75434128"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ab71a31ef0f1d5d856de6f9fc75434128">&sect;&nbsp;</a></span>onReceive() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a052e955906c9bfd671622cb625380edc">&sect;&nbsp;</a></span>onSend() <span class="overload">[1/2]</span></h2>
...
<a id="a052e955906c9bfd671622cb625380edc"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a052e955906c9bfd671622cb625380edc">&sect;&nbsp;</a></span>onSend() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a8ab20be4a63921b7cb1a4d8ca5c30f75">&sect;&nbsp;</a></span>operator BoolType() <span class="overload">[1/2]</span></h2>
...
<a id="a8ab20be4a63921b7cb1a4d8ca5c30f75"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8ab20be4a63921b7cb1a4d8ca5c30f75">&sect;&nbsp;</a></span>operator BoolType() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aa5a465ed02ba29d83ecdafb0ac3fff21">&sect;&nbsp;</a></span>operator<<() <span class="overload">[1/2]</span></h2>
...
<a id="aa5a465ed02ba29d83ecdafb0ac3fff21"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa5a465ed02ba29d83ecdafb0ac3fff21">&sect;&nbsp;</a></span>operator<<() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af8e26c63ba9bdccd262565ff0d3eeba2">&sect;&nbsp;</a></span>operator>>() <span class="overload">[1/2]</span></h2>
...
<a id="af8e26c63ba9bdccd262565ff0d3eeba2"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af8e26c63ba9bdccd262565ff0d3eeba2">&sect;&nbsp;</a></span>operator>>() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Network_2Packet_8hpp_source.php">include/SFML/Network/Packet.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
