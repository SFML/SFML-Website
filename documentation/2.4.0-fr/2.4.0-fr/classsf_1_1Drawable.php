...
<p>Example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>MyDrawable : <span class="keyword">public</span> <a class="code" href="classsf_1_1Drawable.php">sf::Drawable</a></div><div class="line">{</div><div class="line"><span class="keyword">public</span>:</div><div class="line"></div><div class="line">   ...</div><div class="line"></div><div class="line">private:</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1Drawable.php#a90d2c88bba9b035a0844eccb380ef631">draw</a>(<a class="code" href="classsf_1_1RenderTarget.php">sf::RenderTarget</a>&amp; target, <a class="code" href="classsf_1_1RenderStates.php">sf::RenderStates</a> states)<span class="keyword"> const</span></div><div class="line"><span class="keyword">    </span>{</div><div class="line">        <span class="comment">// You can draw other high-level objects</span></div><div class="line">        target.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(m_sprite, states);</div><div class="line"></div><div class="line">        <span class="comment">// ... or use the low-level API</span></div><div class="line">        states.<a class="code" href="classsf_1_1RenderStates.php#ad7eb50453917561fa7a9df7f4c53f1fd">texture</a> = &amp;m_texture;</div><div class="line">        target.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(m_vertices, states);</div><div class="line"></div><div class="line">        <span class="comment">// ... or draw with OpenGL directly</span></div><div class="line">        glBegin(GL_QUADS);</div><div class="line">        ...</div><div class="line">        glEnd();</div><div class="line">    }</div><div class="line"></div><div class="line">    <a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> m_sprite;</div><div class="line">    <a class="code" href="classsf_1_1Texture.php">sf::Texture</a> m_texture;</div><div class="line">    <a class="code" href="classsf_1_1VertexArray.php">sf::VertexArray</a> m_vertices;</div><div class="line">};</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1RenderTarget.php" title="Base class for all render targets (window, texture, ...) ">sf::RenderTarget</a> </dd></dl>
...
<a id="a906002f2df7beb5edbddf5bbef96f120"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a906002f2df7beb5edbddf5bbef96f120">&sect;&nbsp;</a></span>~Drawable() <span class="overload">[1/2]</span></h2>
...
<a id="a906002f2df7beb5edbddf5bbef96f120"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a906002f2df7beb5edbddf5bbef96f120">&sect;&nbsp;</a></span>~Drawable() <span class="overload">[2/2]</span></h2>
...
<a id="a90d2c88bba9b035a0844eccb380ef631"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a90d2c88bba9b035a0844eccb380ef631">&sect;&nbsp;</a></span>draw() <span class="overload">[1/2]</span></h2>
...
<a id="a90d2c88bba9b035a0844eccb380ef631"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a90d2c88bba9b035a0844eccb380ef631">&sect;&nbsp;</a></span>draw() <span class="overload">[2/2]</span></h2>
