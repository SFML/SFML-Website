...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php">SoundFileWriter.hpp</a>&gt;</code></p>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>MySoundFileWriter : <span class="keyword">public</span> <a class="code" href="classsf_1_1SoundFileWriter.php">sf::SoundFileWriter</a></div><div class="line">{</div><div class="line"><span class="keyword">public</span>:</div><div class="line"></div><div class="line">    <span class="keyword">static</span> <span class="keywordtype">bool</span> check(<span class="keyword">const</span> std::string&amp; filename)</div><div class="line">    {</div><div class="line">        <span class="comment">// typically, check the extension</span></div><div class="line">        <span class="comment">// return true if the writer can handle the format</span></div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code" href="classsf_1_1SoundFileWriter.php#a5c92bcaaa880ef4d3eaab18dae1d3d07">open</a>(<span class="keyword">const</span> std::string&amp; filename, <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> sampleRate, <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> channelCount)</div><div class="line">    {</div><div class="line">        <span class="comment">// open the file &#39;filename&#39; for writing,</span></div><div class="line">        <span class="comment">// write the given sample rate and channel count to the file header</span></div><div class="line">        <span class="comment">// return true on success</span></div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1SoundFileWriter.php#a4ce597e7682d22c5b2c98d77e931a1da">write</a>(<span class="keyword">const</span> sf::Int16* samples, sf::Uint64 count)</div><div class="line">    {</div><div class="line">        <span class="comment">// write &#39;count&#39; samples stored at address &#39;samples&#39;,</span></div><div class="line">        <span class="comment">// convert them (for example to normalized float) if the format requires it</span></div><div class="line">    }</div><div class="line">};</div><div class="line"></div><div class="line">sf::SoundFileFactory::registerWriter&lt;MySoundFileWriter&gt;();</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1OutputSoundFile.php" title="Provide write access to sound files. ">sf::OutputSoundFile</a>, <a class="el" href="classsf_1_1SoundFileFactory.php" title="Manages and instantiates sound file readers and writers. ">sf::SoundFileFactory</a>, <a class="el" href="classsf_1_1SoundFileReader.php" title="Abstract base class for sound file decoding. ">sf::SoundFileReader</a> </dd></dl>

<p>Definition at line <a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php#l00041">41</a> of file <a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php">include/SFML/Audio/SoundFileWriter.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a76944fc158688f35050bd5b592c90270"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76944fc158688f35050bd5b592c90270">&sect;&nbsp;</a></span>~SoundFileWriter() <span class="overload">[1/2]</span></h2>
...
<p>Definition at line <a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php#l00049">49</a> of file <a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php">include/SFML/Audio/SoundFileWriter.hpp</a>.</p>

</div>
</div>
<a id="a76944fc158688f35050bd5b592c90270"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76944fc158688f35050bd5b592c90270">&sect;&nbsp;</a></span>~SoundFileWriter() <span class="overload">[2/2]</span></h2>
...
<p>Definition at line <a class="el" href="shared_2include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php#l00049">49</a> of file <a class="el" href="shared_2include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php">shared/include/SFML/Audio/SoundFileWriter.hpp</a>.</p>

</div>
</div>
<h2 class="groupheader">Member Function Documentation</h2>
<a id="a5c92bcaaa880ef4d3eaab18dae1d3d07"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5c92bcaaa880ef4d3eaab18dae1d3d07">&sect;&nbsp;</a></span>open() <span class="overload">[1/2]</span></h2>
...
<a id="a5c92bcaaa880ef4d3eaab18dae1d3d07"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5c92bcaaa880ef4d3eaab18dae1d3d07">&sect;&nbsp;</a></span>open() <span class="overload">[2/2]</span></h2>
...
<a id="a4ce597e7682d22c5b2c98d77e931a1da"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4ce597e7682d22c5b2c98d77e931a1da">&sect;&nbsp;</a></span>write() <span class="overload">[1/2]</span></h2>
...
<a id="a4ce597e7682d22c5b2c98d77e931a1da"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4ce597e7682d22c5b2c98d77e931a1da">&sect;&nbsp;</a></span>write() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Audio_2SoundFileWriter_8hpp_source.php">include/SFML/Audio/SoundFileWriter.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
