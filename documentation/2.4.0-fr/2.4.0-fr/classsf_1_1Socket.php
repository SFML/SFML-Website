...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Network_2Socket_8hpp_source.php">Socket.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<area href="classsf_1_1TcpListener.php" title="Socket that listens to new TCP connections. " alt="sf::TcpListener" shape="rect" coords="115,112,220,136"/>
<area href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol. " alt="sf::TcpSocket" shape="rect" coords="230,112,335,136"/>
<area href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol. " alt="sf::TcpSocket" shape="rect" coords="345,112,450,136"/>
<area href="classsf_1_1UdpSocket.php" title="Specialized socket using the UDP protocol. " alt="sf::UdpSocket" shape="rect" coords="460,112,565,136"/>
<area href="classsf_1_1UdpSocket.php" title="Specialized socket using the UDP protocol. " alt="sf::UdpSocket" shape="rect" coords="575,112,680,136"/>
</map>
 </div></div>
...
Friends</h2></td></tr>
<tr class="memitem:a4d597c43b180384801eff14207b0e137"><td class="memItemLeft" align="right" valign="top"><a id="a4d597c43b180384801eff14207b0e137"></a>
class&#160;</td><td class="memItemRight" valign="bottom"><b>SocketSelector</b></td></tr>
<tr class="separator:a4d597c43b180384801eff14207b0e137"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table>
...
<p>In non-blocking mode, all the socket functions will return immediately. If the socket is not ready to complete the requested operation, the function simply returns the proper status code (<a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca412bf3512c20bfcbcd511858d55acfbd" title="The socket is not ready to send / receive data yet. ">Socket::NotReady</a>).</p>
...
<p>Definition at line <a class="el" href="include_2SFML_2Network_2Socket_8hpp_source.php#l00045">45</a> of file <a class="el" href="include_2SFML_2Network_2Socket_8hpp_source.php">include/SFML/Network/Socket.hpp</a>.</p>
...
<h2 class="memtitle"><span class="permalink"><a href="#a79a4b5918f0b34a2f8db449089694788">&sect;&nbsp;</a></span>~Socket() <span class="overload">[1/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a80ffb47ec0bafc83af019055d3e6a303">&sect;&nbsp;</a></span>Socket() <span class="overload">[1/2]</span></h2>
...
<a id="a79a4b5918f0b34a2f8db449089694788"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a79a4b5918f0b34a2f8db449089694788">&sect;&nbsp;</a></span>~Socket() <span class="overload">[2/2]</span></h2>
...
<a id="a80ffb47ec0bafc83af019055d3e6a303"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a80ffb47ec0bafc83af019055d3e6a303">&sect;&nbsp;</a></span>Socket() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Network_2Socket_8hpp_source.php">include/SFML/Network/Socket.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
