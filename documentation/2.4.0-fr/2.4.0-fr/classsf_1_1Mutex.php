...
<p>Usage example: </p><div class="fragment"><div class="line">Database database; <span class="comment">// this is a critical resource that needs some protection</span></div><div class="line"><a class="code" href="classsf_1_1Mutex.php">sf::Mutex</a> mutex;</div><div class="line"></div><div class="line"><span class="keywordtype">void</span> thread1()</div><div class="line">{</div><div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread2</span></div><div class="line">    database.write(...);</div><div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">unlock</a>(); <span class="comment">// if thread2 was waiting, it will now be unblocked</span></div><div class="line">}</div><div class="line"></div><div class="line"><span class="keywordtype">void</span> thread2()</div><div class="line">{</div><div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread1</span></div><div class="line">    database.write(...);</div><div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33">unlock</a>(); <span class="comment">// if thread1 was waiting, it will now be unblocked</span></div><div class="line">}</div></div><!-- fragment --><p>Be very careful with mutexes. A bad usage can lead to bad problems, like deadlocks (two threads are waiting for each other and the application is globally stuck).</p>
...
<a id="a9bd52a48320fd7b6db8a78037aad276e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9bd52a48320fd7b6db8a78037aad276e">&sect;&nbsp;</a></span>Mutex() <span class="overload">[1/2]</span></h2>
...
<a id="a9f76a67b7b6d3918131a692179b4e3f2"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9f76a67b7b6d3918131a692179b4e3f2">&sect;&nbsp;</a></span>~Mutex() <span class="overload">[1/2]</span></h2>
...
<a id="a9bd52a48320fd7b6db8a78037aad276e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9bd52a48320fd7b6db8a78037aad276e">&sect;&nbsp;</a></span>Mutex() <span class="overload">[2/2]</span></h2>
...
<a id="a9f76a67b7b6d3918131a692179b4e3f2"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9f76a67b7b6d3918131a692179b4e3f2">&sect;&nbsp;</a></span>~Mutex() <span class="overload">[2/2]</span></h2>
...
<a id="a1a16956a6bbea764480c1b80f2e45763"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a1a16956a6bbea764480c1b80f2e45763">&sect;&nbsp;</a></span>lock() <span class="overload">[1/2]</span></h2>
...
<a id="a1a16956a6bbea764480c1b80f2e45763"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a1a16956a6bbea764480c1b80f2e45763">&sect;&nbsp;</a></span>lock() <span class="overload">[2/2]</span></h2>
...
<a id="ade71268ffc5e80756652058b01c23c33"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ade71268ffc5e80756652058b01c23c33">&sect;&nbsp;</a></span>unlock() <span class="overload">[1/2]</span></h2>
...
<a id="ade71268ffc5e80756652058b01c23c33"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ade71268ffc5e80756652058b01c23c33">&sect;&nbsp;</a></span>unlock() <span class="overload">[2/2]</span></h2>
