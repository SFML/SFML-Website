...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Network_2TcpListener_8hpp_source.php">TcpListener.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<tr class="memdesc:a784b9a9c59d4cdbae1795e90b8015780"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the port to which the socket is bound locally.  <a href="#a784b9a9c59d4cdbae1795e90b8015780">More...</a><br /></td></tr>
...
<tr class="memdesc:a9504758ea3570e62cb20b209c11776a1"><td class="mdescLeft">&#160;</td><td class="mdescRight">Start listening for connections.  <a href="#a9504758ea3570e62cb20b209c11776a1">More...</a><br /></td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Create a listener socket and make it wait for new</span></div><div class="line"><span class="comment">// connections on port 55001</span></div><div class="line"><a class="code" href="classsf_1_1TcpListener.php">sf::TcpListener</a> listener;</div><div class="line">listener.<a class="code" href="classsf_1_1TcpListener.php#a9504758ea3570e62cb20b209c11776a1">listen</a>(55001);</div><div class="line"></div><div class="line"><span class="comment">// Endless loop that waits for new connections</span></div><div class="line"><span class="keywordflow">while</span> (running)</div><div class="line">{</div><div class="line">    <a class="code" href="classsf_1_1TcpSocket.php">sf::TcpSocket</a> client;</div><div class="line">    <span class="keywordflow">if</span> (listener.<a class="code" href="classsf_1_1TcpListener.php#ae2c83ce5a64d50b68180c46bef0a7346">accept</a>(client) == <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca6b3d5ba897b6df8ebda86c823b30348a">sf::Socket::Done</a>)</div><div class="line">    {</div><div class="line">        <span class="comment">// A new client just connected!</span></div><div class="line">        std::cout &lt;&lt; <span class="stringliteral">&quot;New connection received from &quot;</span> &lt;&lt; client.<a class="code" href="classsf_1_1TcpSocket.php#aa8579c203b1fd21beb74d7f76444a94c">getRemoteAddress</a>() &lt;&lt; std::endl;</div><div class="line">        doSomethingWith(client);</div><div class="line">    }</div><div class="line">}</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol. ">sf::TcpSocket</a>, <a class="el" href="classsf_1_1Socket.php" title="Base class for all the socket types. ">sf::Socket</a> </dd></dl>

<p>Definition at line <a class="el" href="include_2SFML_2Network_2TcpListener_8hpp_source.php#l00044">44</a> of file <a class="el" href="include_2SFML_2Network_2TcpListener_8hpp_source.php">include/SFML/Network/TcpListener.hpp</a>.</p>
...
<a id="a59a1db5b6f4711a3e57390da2f8d9630"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a59a1db5b6f4711a3e57390da2f8d9630">&sect;&nbsp;</a></span>TcpListener() <span class="overload">[1/2]</span></h2>
...
<a id="a59a1db5b6f4711a3e57390da2f8d9630"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a59a1db5b6f4711a3e57390da2f8d9630">&sect;&nbsp;</a></span>TcpListener() <span class="overload">[2/2]</span></h2>
...
<a id="ae2c83ce5a64d50b68180c46bef0a7346"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ae2c83ce5a64d50b68180c46bef0a7346">&sect;&nbsp;</a></span>accept() <span class="overload">[1/2]</span></h2>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1TcpListener.php#a9504758ea3570e62cb20b209c11776a1" title="Start listening for connections. ">listen</a> </dd></dl>

</div>
</div>
<a id="ae2c83ce5a64d50b68180c46bef0a7346"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ae2c83ce5a64d50b68180c46bef0a7346">&sect;&nbsp;</a></span>accept() <span class="overload">[2/2]</span></h2>
...
<a id="a3a00a850506bd0f9f48867a0fe59556b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a3a00a850506bd0f9f48867a0fe59556b">&sect;&nbsp;</a></span>close() <span class="overload">[1/2]</span></h2>
...
<a id="a3a00a850506bd0f9f48867a0fe59556b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a3a00a850506bd0f9f48867a0fe59556b">&sect;&nbsp;</a></span>close() <span class="overload">[2/2]</span></h2>
...
<a id="a784b9a9c59d4cdbae1795e90b8015780"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a784b9a9c59d4cdbae1795e90b8015780">&sect;&nbsp;</a></span>getLocalPort() <span class="overload">[1/2]</span></h2>
...
<a id="a784b9a9c59d4cdbae1795e90b8015780"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a784b9a9c59d4cdbae1795e90b8015780">&sect;&nbsp;</a></span>getLocalPort() <span class="overload">[2/2]</span></h2>
...
<a id="a9504758ea3570e62cb20b209c11776a1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9504758ea3570e62cb20b209c11776a1">&sect;&nbsp;</a></span>listen() <span class="overload">[1/2]</span></h2>
...
<a id="a9504758ea3570e62cb20b209c11776a1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9504758ea3570e62cb20b209c11776a1">&sect;&nbsp;</a></span>listen() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Network_2TcpListener_8hpp_source.php">include/SFML/Network/TcpListener.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
