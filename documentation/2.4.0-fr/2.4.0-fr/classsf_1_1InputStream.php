...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// custom stream class that reads from inside a zip file</span></div><div class="line"><span class="keyword">class </span>ZipStream : <span class="keyword">public</span> <a class="code" href="classsf_1_1InputStream.php">sf::InputStream</a></div><div class="line">{</div><div class="line"><span class="keyword">public</span>:</div><div class="line"></div><div class="line">    ZipStream(std::string archive);</div><div class="line"></div><div class="line">    <span class="keywordtype">bool</span> open(std::string filename);</div><div class="line"></div><div class="line">    Int64 <a class="code" href="classsf_1_1InputStream.php#a8dd89c74c1acb693203f50e750c6ae53">read</a>(<span class="keywordtype">void</span>* data, Int64 size);</div><div class="line"></div><div class="line">    Int64 <a class="code" href="classsf_1_1InputStream.php#a76aba8e5d5cf9b1c5902d5e04f7864fc">seek</a>(Int64 position);</div><div class="line"></div><div class="line">    Int64 <a class="code" href="classsf_1_1InputStream.php#a599515b9ccdbddb6fef5a98424fd559c">tell</a>();</div><div class="line"></div><div class="line">    Int64 <a class="code" href="classsf_1_1InputStream.php#a311eaaaa65d636728e5153b574b72d5d">getSize</a>();</div><div class="line"></div><div class="line"><span class="keyword">private</span>:</div><div class="line"></div><div class="line">    ...</div><div class="line">};</div><div class="line"></div><div class="line"><span class="comment">// now you can load textures...</span></div><div class="line"><a class="code" href="classsf_1_1Texture.php">sf::Texture</a> texture;</div><div class="line">ZipStream stream(<span class="stringliteral">&quot;resources.zip&quot;</span>);</div><div class="line">stream.open(<span class="stringliteral">&quot;images/img.png&quot;</span>);</div><div class="line">texture.<a class="code" href="classsf_1_1Texture.php#a786b486a46b1c6d1c16ff4af61ecc601">loadFromStream</a>(stream);</div><div class="line"></div><div class="line"><span class="comment">// musics...</span></div><div class="line"><a class="code" href="classsf_1_1Music.php">sf::Music</a> music;</div><div class="line">ZipStream stream(<span class="stringliteral">&quot;resources.zip&quot;</span>);</div><div class="line">stream.open(<span class="stringliteral">&quot;musics/msc.ogg&quot;</span>);</div><div class="line">music.<a class="code" href="classsf_1_1Music.php#a4e55d1910a26858b44778c26b237d673">openFromStream</a>(stream);</div><div class="line"></div><div class="line"><span class="comment">// etc.</span></div></div><!-- fragment --> 
...
<a id="a4b2eb0f92323e630bd0542bc6191682e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4b2eb0f92323e630bd0542bc6191682e">&sect;&nbsp;</a></span>~InputStream() <span class="overload">[1/2]</span></h2>
...
<a id="a4b2eb0f92323e630bd0542bc6191682e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4b2eb0f92323e630bd0542bc6191682e">&sect;&nbsp;</a></span>~InputStream() <span class="overload">[2/2]</span></h2>
...
<a id="a311eaaaa65d636728e5153b574b72d5d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a311eaaaa65d636728e5153b574b72d5d">&sect;&nbsp;</a></span>getSize() <span class="overload">[1/2]</span></h2>
...
<a id="a311eaaaa65d636728e5153b574b72d5d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a311eaaaa65d636728e5153b574b72d5d">&sect;&nbsp;</a></span>getSize() <span class="overload">[2/2]</span></h2>
...
<a id="a8dd89c74c1acb693203f50e750c6ae53"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8dd89c74c1acb693203f50e750c6ae53">&sect;&nbsp;</a></span>read() <span class="overload">[1/2]</span></h2>
...
<a id="a8dd89c74c1acb693203f50e750c6ae53"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8dd89c74c1acb693203f50e750c6ae53">&sect;&nbsp;</a></span>read() <span class="overload">[2/2]</span></h2>
...
<a id="a76aba8e5d5cf9b1c5902d5e04f7864fc"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76aba8e5d5cf9b1c5902d5e04f7864fc">&sect;&nbsp;</a></span>seek() <span class="overload">[1/2]</span></h2>
...
<a id="a76aba8e5d5cf9b1c5902d5e04f7864fc"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76aba8e5d5cf9b1c5902d5e04f7864fc">&sect;&nbsp;</a></span>seek() <span class="overload">[2/2]</span></h2>
...
<a id="a599515b9ccdbddb6fef5a98424fd559c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a599515b9ccdbddb6fef5a98424fd559c">&sect;&nbsp;</a></span>tell() <span class="overload">[1/2]</span></h2>
...
<a id="a599515b9ccdbddb6fef5a98424fd559c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a599515b9ccdbddb6fef5a98424fd559c">&sect;&nbsp;</a></span>tell() <span class="overload">[2/2]</span></h2>
