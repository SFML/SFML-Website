...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">VideoMode.hpp</a>&gt;</code></p>
...
<tr class="memitem:ad5e04c044b0925523c75ecb173d2129a"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1VideoMode.php#ad5e04c044b0925523c75ecb173d2129a">isValid</a> () const</td></tr>
...
<tr class="memitem:a6815b9b3b35767d5b4563fbed4bfc67b"><td class="memItemLeft" align="right" valign="top">static const std::vector&lt; <a class="el" href="classsf_1_1VideoMode.php">VideoMode</a> &gt; &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1VideoMode.php#a6815b9b3b35767d5b4563fbed4bfc67b">getFullscreenModes</a> ()</td></tr>
...
<p>A custom video mode can also be checked directly for fullscreen compatibility with its <a class="el" href="classsf_1_1VideoMode.php#ad5e04c044b0925523c75ecb173d2129a" title="Tell whether or not the video mode is valid. ">isValid()</a> function.</p>
<p>Additionally, <a class="el" href="classsf_1_1VideoMode.php" title="VideoMode defines a video mode (width, height, bpp) ">sf::VideoMode</a> provides a static function to get the mode currently used by the desktop: <a class="el" href="classsf_1_1VideoMode.php#ac1be160a4342e6eafb2cb0e8c9b18d44" title="Get the current desktop video mode. ">getDesktopMode()</a>. This allows to build windows with the same size or pixel depth as the current resolution.</p>
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Display the list of all the video modes available for fullscreen</span></div><div class="line">std::vector&lt;sf::VideoMode&gt; modes = <a class="code" href="classsf_1_1VideoMode.php#a6815b9b3b35767d5b4563fbed4bfc67b">sf::VideoMode::getFullscreenModes</a>();</div><div class="line"><span class="keywordflow">for</span> (std::size_t i = 0; i &lt; modes.size(); ++i)</div><div class="line">{</div><div class="line">    <a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a> mode = modes[i];</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Mode #&quot;</span> &lt;&lt; i &lt;&lt; <span class="stringliteral">&quot;: &quot;</span></div><div class="line">              &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#a9b3b2ad2cac6b9c266823fb5ed506d90">width</a> &lt;&lt; <span class="stringliteral">&quot;x&quot;</span> &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#a5a88d44c9470db7474361a42a189342d">height</a> &lt;&lt; <span class="stringliteral">&quot; - &quot;</span></div><div class="line">              &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#aa080f1ef96a1008d58b1920eceb189df">bitsPerPixel</a> &lt;&lt; <span class="stringliteral">&quot; bpp&quot;</span> &lt;&lt; std::endl;</div><div class="line">}</div><div class="line"></div><div class="line"><span class="comment">// Create a window with the same pixel depth as the desktop</span></div><div class="line"><a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a> desktop = <a class="code" href="classsf_1_1VideoMode.php#ac1be160a4342e6eafb2cb0e8c9b18d44">sf::VideoMode::getDesktopMode</a>();</div><div class="line">window.create(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(1024, 768, desktop.<a class="code" href="classsf_1_1VideoMode.php#aa080f1ef96a1008d58b1920eceb189df">bitsPerPixel</a>), <span class="stringliteral">&quot;SFML window&quot;</span>);</div></div><!-- fragment --> 
<p>Definition at line <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php#l00041">41</a> of file <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">include/SFML/Window/VideoMode.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a04c9417e5c304510bef5f6aeb03f6ce1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a04c9417e5c304510bef5f6aeb03f6ce1">&sect;&nbsp;</a></span>VideoMode() <span class="overload">[1/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a46c35ed41de9e115661dcd529d64e9d3">&sect;&nbsp;</a></span>VideoMode() <span class="overload">[2/4]</span></h2>
...
<a id="a04c9417e5c304510bef5f6aeb03f6ce1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a04c9417e5c304510bef5f6aeb03f6ce1">&sect;&nbsp;</a></span>VideoMode() <span class="overload">[3/4]</span></h2>
...
<a id="a46c35ed41de9e115661dcd529d64e9d3"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a46c35ed41de9e115661dcd529d64e9d3">&sect;&nbsp;</a></span>VideoMode() <span class="overload">[4/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ac1be160a4342e6eafb2cb0e8c9b18d44">&sect;&nbsp;</a></span>getDesktopMode() <span class="overload">[1/2]</span></h2>
...
<a id="ac1be160a4342e6eafb2cb0e8c9b18d44"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ac1be160a4342e6eafb2cb0e8c9b18d44">&sect;&nbsp;</a></span>getDesktopMode() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a6815b9b3b35767d5b4563fbed4bfc67b">&sect;&nbsp;</a></span>getFullscreenModes() <span class="overload">[1/2]</span></h2>
...
<a id="a6815b9b3b35767d5b4563fbed4bfc67b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a6815b9b3b35767d5b4563fbed4bfc67b">&sect;&nbsp;</a></span>getFullscreenModes() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ad5e04c044b0925523c75ecb173d2129a">&sect;&nbsp;</a></span>isValid() <span class="overload">[1/2]</span></h2>
...
<a id="ad5e04c044b0925523c75ecb173d2129a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad5e04c044b0925523c75ecb173d2129a">&sect;&nbsp;</a></span>isValid() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a34b5c266a7b9cd5bc95de62f8beafc5a">&sect;&nbsp;</a></span>operator!=() <span class="overload">[1/2]</span></h2>
...
<a id="a34b5c266a7b9cd5bc95de62f8beafc5a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a34b5c266a7b9cd5bc95de62f8beafc5a">&sect;&nbsp;</a></span>operator!=() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a54cc77c0b6c4b133e0147a43d6829b13">&sect;&nbsp;</a></span>operator<() <span class="overload">[1/2]</span></h2>
...
<a id="a54cc77c0b6c4b133e0147a43d6829b13"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a54cc77c0b6c4b133e0147a43d6829b13">&sect;&nbsp;</a></span>operator<() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aa094b7b9ae4c0194892ebda7b4b9bb37">&sect;&nbsp;</a></span>operator<=() <span class="overload">[1/2]</span></h2>
...
<a id="aa094b7b9ae4c0194892ebda7b4b9bb37"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa094b7b9ae4c0194892ebda7b4b9bb37">&sect;&nbsp;</a></span>operator<=() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aca24086fd94d11014f3a0b5ca9a3acd6">&sect;&nbsp;</a></span>operator==() <span class="overload">[1/2]</span></h2>
...
<a id="aca24086fd94d11014f3a0b5ca9a3acd6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aca24086fd94d11014f3a0b5ca9a3acd6">&sect;&nbsp;</a></span>operator==() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a5b894cab5f2a3a14597e4c6d200179a4">&sect;&nbsp;</a></span>operator>() <span class="overload">[1/2]</span></h2>
...
<a id="a5b894cab5f2a3a14597e4c6d200179a4"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5b894cab5f2a3a14597e4c6d200179a4">&sect;&nbsp;</a></span>operator>() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a6e3d91683fcabb88c5b640e9884fe3df">&sect;&nbsp;</a></span>operator>=() <span class="overload">[1/2]</span></h2>
...
<a id="a6e3d91683fcabb88c5b640e9884fe3df"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a6e3d91683fcabb88c5b640e9884fe3df">&sect;&nbsp;</a></span>operator>=() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aa080f1ef96a1008d58b1920eceb189df">&sect;&nbsp;</a></span>bitsPerPixel</h2>
...
<p>Definition at line <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php#l00104">104</a> of file <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">include/SFML/Window/VideoMode.hpp</a>.</p>

</div>
</div>
<a id="a5a88d44c9470db7474361a42a189342d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5a88d44c9470db7474361a42a189342d">&sect;&nbsp;</a></span>height</h2>
...
<p>Definition at line <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php#l00103">103</a> of file <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">include/SFML/Window/VideoMode.hpp</a>.</p>

</div>
</div>
<a id="a9b3b2ad2cac6b9c266823fb5ed506d90"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9b3b2ad2cac6b9c266823fb5ed506d90">&sect;&nbsp;</a></span>width</h2>
...
<p>Definition at line <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php#l00102">102</a> of file <a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">include/SFML/Window/VideoMode.hpp</a>.</p>

</div>
</div>
<hr/>The documentation for this class was generated from the following file:<ul>
<li><a class="el" href="include_2SFML_2Window_2VideoMode_8hpp_source.php">include/SFML/Window/VideoMode.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
