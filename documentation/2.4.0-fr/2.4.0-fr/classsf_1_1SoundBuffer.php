...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Audio_2SoundBuffer_8hpp_source.php">SoundBuffer.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<area href="classsf_1_1AlResource.php" title="Base class for classes that require an OpenAL context. " alt="sf::AlResource" shape="rect" coords="109,0,208,24"/>
</map>
 </div></div>
...
<tr class="memitem:ab9b2525a8da64cb266ba728aff7adecb"><td class="memItemLeft" align="right" valign="top">const Int16 *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundBuffer.php#ab9b2525a8da64cb266ba728aff7adecb">getSamples</a> () const</td></tr>
...
Friends</h2></td></tr>
<tr class="memitem:a78d488655886fd6a1355b1162fba927f"><td class="memItemLeft" align="right" valign="top"><a id="a78d488655886fd6a1355b1162fba927f"></a>
class&#160;</td><td class="memItemRight" valign="bottom"><b>Sound</b></td></tr>
<tr class="separator:a78d488655886fd6a1355b1162fba927f"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Declare a new sound buffer</span></div><div class="line"><a class="code" href="classsf_1_1SoundBuffer.php">sf::SoundBuffer</a> buffer;</div><div class="line"></div><div class="line"><span class="comment">// Load it from a file</span></div><div class="line"><span class="keywordflow">if</span> (!buffer.<a class="code" href="classsf_1_1SoundBuffer.php#a2be6a8025c97eb622a7dff6cf2594394">loadFromFile</a>(<span class="stringliteral">&quot;sound.wav&quot;</span>))</div><div class="line">{</div><div class="line">    <span class="comment">// error...</span></div><div class="line">}</div><div class="line"></div><div class="line"><span class="comment">// Create a sound source and bind it to the buffer</span></div><div class="line"><a class="code" href="classsf_1_1Sound.php">sf::Sound</a> sound1;</div><div class="line">sound1.<a class="code" href="classsf_1_1Sound.php#a8b395e9713d0efa48a18628c8ec1972e">setBuffer</a>(buffer);</div><div class="line"></div><div class="line"><span class="comment">// Play the sound</span></div><div class="line">sound1.<a class="code" href="classsf_1_1Sound.php#a2953ffe632536e72e696fd880ced2532">play</a>();</div><div class="line"></div><div class="line"><span class="comment">// Create another sound source bound to the same buffer</span></div><div class="line"><a class="code" href="classsf_1_1Sound.php">sf::Sound</a> sound2;</div><div class="line">sound2.<a class="code" href="classsf_1_1Sound.php#a8b395e9713d0efa48a18628c8ec1972e">setBuffer</a>(buffer);</div><div class="line"></div><div class="line"><span class="comment">// Play it with a higher pitch -- the first sound remains unchanged</span></div><div class="line">sound2.<a class="code" href="classsf_1_1SoundSource.php#a72a13695ed48b7f7b55e7cd4431f4bb6">setPitch</a>(2);</div><div class="line">sound2.<a class="code" href="classsf_1_1Sound.php#a2953ffe632536e72e696fd880ced2532">play</a>();</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment. ">sf::Sound</a>, <a class="el" href="classsf_1_1SoundBufferRecorder.php" title="Specialized SoundRecorder which stores the captured audio data into a sound buffer. ">sf::SoundBufferRecorder</a> </dd></dl>

<p>Definition at line <a class="el" href="include_2SFML_2Audio_2SoundBuffer_8hpp_source.php#l00049">49</a> of file <a class="el" href="include_2SFML_2Audio_2SoundBuffer_8hpp_source.php">include/SFML/Audio/SoundBuffer.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a0cabfbfe19b831bf7d5c9592d92ef233"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a0cabfbfe19b831bf7d5c9592d92ef233">&sect;&nbsp;</a></span>SoundBuffer() <span class="overload">[1/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aaf000fc741ff27015907e8588263f4a6">&sect;&nbsp;</a></span>SoundBuffer() <span class="overload">[2/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aea240161724ffba74a0d6a9e277d3cd5">&sect;&nbsp;</a></span>~SoundBuffer() <span class="overload">[1/2]</span></h2>
...
<a id="a0cabfbfe19b831bf7d5c9592d92ef233"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a0cabfbfe19b831bf7d5c9592d92ef233">&sect;&nbsp;</a></span>SoundBuffer() <span class="overload">[3/4]</span></h2>
...
<a id="aaf000fc741ff27015907e8588263f4a6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aaf000fc741ff27015907e8588263f4a6">&sect;&nbsp;</a></span>SoundBuffer() <span class="overload">[4/4]</span></h2>
...
<a id="aea240161724ffba74a0d6a9e277d3cd5"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aea240161724ffba74a0d6a9e277d3cd5">&sect;&nbsp;</a></span>~SoundBuffer() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a127707b831d875ed790eef1aa2b9fcc3">&sect;&nbsp;</a></span>getChannelCount() <span class="overload">[1/2]</span></h2>
...
<a id="a127707b831d875ed790eef1aa2b9fcc3"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a127707b831d875ed790eef1aa2b9fcc3">&sect;&nbsp;</a></span>getChannelCount() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a280a581d9b360fd16121714c51fc8261">&sect;&nbsp;</a></span>getDuration() <span class="overload">[1/2]</span></h2>
...
<a id="a280a581d9b360fd16121714c51fc8261"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a280a581d9b360fd16121714c51fc8261">&sect;&nbsp;</a></span>getDuration() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aebe2a4bdbfbd9249353748da3f6a4fa1">&sect;&nbsp;</a></span>getSampleCount() <span class="overload">[1/2]</span></h2>
...
<p>The array of samples can be accessed with the <a class="el" href="classsf_1_1SoundBuffer.php#ab9b2525a8da64cb266ba728aff7adecb" title="Get the array of audio samples stored in the buffer. ">getSamples()</a> function.</p>
<dl class="section return"><dt>Returns</dt><dd>Number of samples</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundBuffer.php#ab9b2525a8da64cb266ba728aff7adecb" title="Get the array of audio samples stored in the buffer. ">getSamples</a> </dd></dl>

</div>
</div>
<a id="aebe2a4bdbfbd9249353748da3f6a4fa1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aebe2a4bdbfbd9249353748da3f6a4fa1">&sect;&nbsp;</a></span>getSampleCount() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a2c2cf0078ce0549246ecc4a1646212b4">&sect;&nbsp;</a></span>getSampleRate() <span class="overload">[1/2]</span></h2>
...
<a id="a2c2cf0078ce0549246ecc4a1646212b4"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a2c2cf0078ce0549246ecc4a1646212b4">&sect;&nbsp;</a></span>getSampleRate() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ab9b2525a8da64cb266ba728aff7adecb">&sect;&nbsp;</a></span>getSamples() <span class="overload">[1/2]</span></h2>
...
<a id="ab9b2525a8da64cb266ba728aff7adecb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ab9b2525a8da64cb266ba728aff7adecb">&sect;&nbsp;</a></span>getSamples() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a2be6a8025c97eb622a7dff6cf2594394">&sect;&nbsp;</a></span>loadFromFile() <span class="overload">[1/2]</span></h2>
...
<a id="a2be6a8025c97eb622a7dff6cf2594394"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a2be6a8025c97eb622a7dff6cf2594394">&sect;&nbsp;</a></span>loadFromFile() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af8cfa5599739a7edae69c5cba273d33f">&sect;&nbsp;</a></span>loadFromMemory() <span class="overload">[1/2]</span></h2>
...
<a id="af8cfa5599739a7edae69c5cba273d33f"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af8cfa5599739a7edae69c5cba273d33f">&sect;&nbsp;</a></span>loadFromMemory() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a42d51ce4bb3b60c7ea06f63c273fd063">&sect;&nbsp;</a></span>loadFromSamples() <span class="overload">[1/2]</span></h2>
...
<a id="a42d51ce4bb3b60c7ea06f63c273fd063"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a42d51ce4bb3b60c7ea06f63c273fd063">&sect;&nbsp;</a></span>loadFromSamples() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ad292156b1e01f6dabd4c0c277d5e079e">&sect;&nbsp;</a></span>loadFromStream() <span class="overload">[1/2]</span></h2>
...
<a id="ad292156b1e01f6dabd4c0c277d5e079e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad292156b1e01f6dabd4c0c277d5e079e">&sect;&nbsp;</a></span>loadFromStream() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#adcc786b60bbd95be1551368fafd274a7">&sect;&nbsp;</a></span>operator=() <span class="overload">[1/2]</span></h2>
...
<a id="adcc786b60bbd95be1551368fafd274a7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#adcc786b60bbd95be1551368fafd274a7">&sect;&nbsp;</a></span>operator=() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aade64260c6375580a085314a30be007e">&sect;&nbsp;</a></span>saveToFile() <span class="overload">[1/2]</span></h2>
...
<a id="aade64260c6375580a085314a30be007e"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aade64260c6375580a085314a30be007e">&sect;&nbsp;</a></span>saveToFile() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Audio_2SoundBuffer_8hpp_source.php">include/SFML/Audio/SoundBuffer.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
