...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>CustomRecorder : <span class="keyword">public</span> <a class="code" href="classsf_1_1SoundRecorder.php">sf::SoundRecorder</a></div><div class="line">{</div><div class="line">    ~CustomRecorder()</div><div class="line">    {</div><div class="line">        <span class="comment">// Make sure to stop the recording thread</span></div><div class="line">        <a class="code" href="classsf_1_1SoundRecorder.php#a8d9c8346aa9aa409cfed4a1101159c4c">stop</a>();</div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code" href="classsf_1_1SoundRecorder.php#a7af418fb036201d3f85745bef78ce77f">onStart</a>() <span class="comment">// optional</span></div><div class="line">    {</div><div class="line">        <span class="comment">// Initialize whatever has to be done before the capture starts</span></div><div class="line">        ...</div><div class="line"></div><div class="line">        <span class="comment">// Return true to start playing</span></div><div class="line">        <span class="keywordflow">return</span> <span class="keyword">true</span>;</div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code" href="classsf_1_1SoundRecorder.php#a2670124cbe7a87c7e46b4840807f4fd7">onProcessSamples</a>(<span class="keyword">const</span> Int16* samples, std::size_t sampleCount)</div><div class="line">    {</div><div class="line">        <span class="comment">// Do something with the new chunk of samples (store them, send them, ...)</span></div><div class="line">        ...</div><div class="line"></div><div class="line">        <span class="comment">// Return true to continue playing</span></div><div class="line">        <span class="keywordflow">return</span> <span class="keyword">true</span>;</div><div class="line">    }</div><div class="line"></div><div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1SoundRecorder.php#aefc36138ca1e96c658301280e4a31b64">onStop</a>() <span class="comment">// optional</span></div><div class="line">    {</div><div class="line">        <span class="comment">// Clean up whatever has to be done after the capture ends</span></div><div class="line">        ...</div><div class="line">    }</div><div class="line">}</div><div class="line"></div><div class="line"><span class="comment">// Usage</span></div><div class="line"><span class="keywordflow">if</span> (CustomRecorder::isAvailable())</div><div class="line">{</div><div class="line">    CustomRecorder recorder;</div><div class="line"></div><div class="line">    <span class="keywordflow">if</span> (!recorder.start())</div><div class="line">        <span class="keywordflow">return</span> -1;</div><div class="line"></div><div class="line">    ...</div><div class="line">    recorder.stop();</div><div class="line">}</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundBufferRecorder.php" title="Specialized SoundRecorder which stores the captured audio data into a sound buffer. ">sf::SoundBufferRecorder</a> </dd></dl>
...
<a id="acc599e61aaa47edaae88cf43f0a43549"></a>
<h2 class="memtitle"><span class="permalink"><a href="#acc599e61aaa47edaae88cf43f0a43549">&sect;&nbsp;</a></span>~SoundRecorder() <span class="overload">[1/2]</span></h2>
...
<a id="a50ebad413c4f157408a0fa49f23212a9"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a50ebad413c4f157408a0fa49f23212a9">&sect;&nbsp;</a></span>SoundRecorder() <span class="overload">[1/2]</span></h2>
...
<a id="acc599e61aaa47edaae88cf43f0a43549"></a>
<h2 class="memtitle"><span class="permalink"><a href="#acc599e61aaa47edaae88cf43f0a43549">&sect;&nbsp;</a></span>~SoundRecorder() <span class="overload">[2/2]</span></h2>
...
<a id="a50ebad413c4f157408a0fa49f23212a9"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a50ebad413c4f157408a0fa49f23212a9">&sect;&nbsp;</a></span>SoundRecorder() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a26198c5c11efcd61f426f326fe314afe">&sect;&nbsp;</a></span>getAvailableDevices() <span class="overload">[1/2]</span></h2>
...
<a id="a26198c5c11efcd61f426f326fe314afe"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a26198c5c11efcd61f426f326fe314afe">&sect;&nbsp;</a></span>getAvailableDevices() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a610e98e7a73b316ce26b7c55234f86e9">&sect;&nbsp;</a></span>getChannelCount() <span class="overload">[1/2]</span></h2>
...
<a id="a610e98e7a73b316ce26b7c55234f86e9"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a610e98e7a73b316ce26b7c55234f86e9">&sect;&nbsp;</a></span>getChannelCount() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ad1d450a80642dab4b632999d72a1bf23">&sect;&nbsp;</a></span>getDefaultDevice() <span class="overload">[1/2]</span></h2>
...
<a id="ad1d450a80642dab4b632999d72a1bf23"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad1d450a80642dab4b632999d72a1bf23">&sect;&nbsp;</a></span>getDefaultDevice() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ab16cd53c6884cbf3380c017cee72ba81">&sect;&nbsp;</a></span>getDevice() <span class="overload">[1/2]</span></h2>
...
<a id="ab16cd53c6884cbf3380c017cee72ba81"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ab16cd53c6884cbf3380c017cee72ba81">&sect;&nbsp;</a></span>getDevice() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aed292c297a3e0d627db4eb5c18f58c44">&sect;&nbsp;</a></span>getSampleRate() <span class="overload">[1/2]</span></h2>
...
<a id="aed292c297a3e0d627db4eb5c18f58c44"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aed292c297a3e0d627db4eb5c18f58c44">&sect;&nbsp;</a></span>getSampleRate() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aab2bd0fee9e48d6cfd449b1cb078ce5a">&sect;&nbsp;</a></span>isAvailable() <span class="overload">[1/2]</span></h2>
...
<a id="aab2bd0fee9e48d6cfd449b1cb078ce5a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aab2bd0fee9e48d6cfd449b1cb078ce5a">&sect;&nbsp;</a></span>isAvailable() <span class="overload">[2/2]</span></h2>
...
<a id="a2670124cbe7a87c7e46b4840807f4fd7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a2670124cbe7a87c7e46b4840807f4fd7">&sect;&nbsp;</a></span>onProcessSamples() <span class="overload">[1/2]</span></h2>
...
<a id="a2670124cbe7a87c7e46b4840807f4fd7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a2670124cbe7a87c7e46b4840807f4fd7">&sect;&nbsp;</a></span>onProcessSamples() <span class="overload">[2/2]</span></h2>
...
<a id="a7af418fb036201d3f85745bef78ce77f"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7af418fb036201d3f85745bef78ce77f">&sect;&nbsp;</a></span>onStart() <span class="overload">[1/2]</span></h2>
...
<a id="a7af418fb036201d3f85745bef78ce77f"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7af418fb036201d3f85745bef78ce77f">&sect;&nbsp;</a></span>onStart() <span class="overload">[2/2]</span></h2>
...
<a id="aefc36138ca1e96c658301280e4a31b64"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aefc36138ca1e96c658301280e4a31b64">&sect;&nbsp;</a></span>onStop() <span class="overload">[1/2]</span></h2>
...
<a id="aefc36138ca1e96c658301280e4a31b64"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aefc36138ca1e96c658301280e4a31b64">&sect;&nbsp;</a></span>onStop() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ae4e22ba67d12a74966eb05fad55a317c">&sect;&nbsp;</a></span>setChannelCount() <span class="overload">[1/2]</span></h2>
...
<a id="ae4e22ba67d12a74966eb05fad55a317c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ae4e22ba67d12a74966eb05fad55a317c">&sect;&nbsp;</a></span>setChannelCount() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a8eb3e473292c16e874322815836d3cd3">&sect;&nbsp;</a></span>setDevice() <span class="overload">[1/2]</span></h2>
...
<a id="a8eb3e473292c16e874322815836d3cd3"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8eb3e473292c16e874322815836d3cd3">&sect;&nbsp;</a></span>setDevice() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a85b7fb8a86c08b5084f8f142767bccf6">&sect;&nbsp;</a></span>setProcessingInterval() <span class="overload">[1/2]</span></h2>
...
<a id="a85b7fb8a86c08b5084f8f142767bccf6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a85b7fb8a86c08b5084f8f142767bccf6">&sect;&nbsp;</a></span>setProcessingInterval() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a715f0fd2f228c83d79aaedca562ae51f">&sect;&nbsp;</a></span>start() <span class="overload">[1/2]</span></h2>
...
<a id="a715f0fd2f228c83d79aaedca562ae51f"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a715f0fd2f228c83d79aaedca562ae51f">&sect;&nbsp;</a></span>start() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a8d9c8346aa9aa409cfed4a1101159c4c">&sect;&nbsp;</a></span>stop() <span class="overload">[1/2]</span></h2>
...
<a id="a8d9c8346aa9aa409cfed4a1101159c4c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8d9c8346aa9aa409cfed4a1101159c4c">&sect;&nbsp;</a></span>stop() <span class="overload">[2/2]</span></h2>
