...
<div class="title">sf::RenderTexture Class Reference<div class="ingroups"><a class="el" href="group__graphics.php">Graphics module</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="include_2SFML_2Graphics_2RenderTexture_8hpp_source.php">RenderTexture.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<area href="classsf_1_1RenderTarget.php" title="Base class for all render targets (window, texture, ...) " alt="sf::RenderTarget" shape="rect" coords="60,56,171,80"/>
<area href="classsf_1_1RenderTarget.php" title="Base class for all render targets (window, texture, ...) " alt="sf::RenderTarget" shape="rect" coords="302,56,413,80"/>
...
<area href="classsf_1_1NonCopyable.php" title="Utility class that makes any derived class non-copyable. " alt="sf::NonCopyable" shape="rect" coords="121,0,232,24"/>
<area href="classsf_1_1NonCopyable.php" title="Utility class that makes any derived class non-copyable. " alt="sf::NonCopyable" shape="rect" coords="242,0,353,24"/>
<area href="classsf_1_1NonCopyable.php" title="Utility class that makes any derived class non-copyable. " alt="sf::NonCopyable" shape="rect" coords="363,0,474,24"/>
</map>
 </div></div>
...
<tr class="memitem:aefbb76eb3b87e368ab974b2660931ccb"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1RenderTexture.php#aefbb76eb3b87e368ab974b2660931ccb">create</a> (unsigned int width, unsigned int height, bool depthBuffer=false)</td></tr>
...
<tr class="memitem:a07ecea85f05932fa02a8279416721bc9"><td class="memItemLeft" align="right" valign="top">const <a class="el" href="classsf_1_1Texture.php">Texture</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1RenderTexture.php#a07ecea85f05932fa02a8279416721bc9">getTexture</a> () const</td></tr>
...
<p>Usage example:</p>
<div class="fragment"><div class="line"><span class="comment">// Create a new render-window</span></div><div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Create a new render-texture</span></div><div class="line"><a class="code" href="classsf_1_1RenderTexture.php">sf::RenderTexture</a> texture;</div><div class="line"><span class="keywordflow">if</span> (!texture.<a class="code" href="classsf_1_1RenderTexture.php#aefbb76eb3b87e368ab974b2660931ccb">create</a>(500, 500))</div><div class="line">    <span class="keywordflow">return</span> -1;</div><div class="line"></div><div class="line"><span class="comment">// The main loop</span></div><div class="line"><span class="keywordflow">while</span> (window.isOpen())</div><div class="line">{</div><div class="line">   <span class="comment">// Event processing</span></div><div class="line">   <span class="comment">// ...</span></div><div class="line"></div><div class="line">   <span class="comment">// Clear the whole texture with red color</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a6bb6f0ba348f2b1e2f46114aeaf60f26">clear</a>(<a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>);</div><div class="line"></div><div class="line">   <span class="comment">// Draw stuff to the texture</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(sprite);  <span class="comment">// sprite is a sf::Sprite</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(shape);   <span class="comment">// shape is a sf::Shape</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(text);    <span class="comment">// text is a sf::Text</span></div><div class="line"></div><div class="line">   <span class="comment">// We&#39;re done drawing to the texture</span></div><div class="line">   texture.<a class="code" href="classsf_1_1RenderTexture.php#af92886d5faef3916caff9fa9ab32c555">display</a>();</div><div class="line"></div><div class="line">   <span class="comment">// Now we start rendering to the window, clear it first</span></div><div class="line">   window.clear();</div><div class="line"></div><div class="line">   <span class="comment">// Draw the texture</span></div><div class="line">   <a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> sprite(texture.<a class="code" href="classsf_1_1RenderTexture.php#a07ecea85f05932fa02a8279416721bc9">getTexture</a>());</div><div class="line">   window.draw(sprite);</div><div class="line"></div><div class="line">   <span class="comment">// End the current frame and display its contents on screen</span></div><div class="line">   window.display();</div><div class="line">}</div></div><!-- fragment --><p>Like <a class="el" href="classsf_1_1RenderWindow.php" title="Window that can serve as a target for 2D drawing. ">sf::RenderWindow</a>, <a class="el" href="classsf_1_1RenderTexture.php" title="Target for off-screen 2D rendering into a texture. ">sf::RenderTexture</a> is still able to render direct OpenGL stuff. It is even possible to mix together OpenGL calls and regular SFML drawing commands. If you need a depth buffer for 3D rendering, don't forget to request it when calling <a class="el" href="classsf_1_1RenderTexture.php#aefbb76eb3b87e368ab974b2660931ccb" title="Create the render-texture. ">RenderTexture::create</a>.</p>
...
<p>Definition at line <a class="el" href="include_2SFML_2Graphics_2RenderTexture_8hpp_source.php#l00047">47</a> of file <a class="el" href="include_2SFML_2Graphics_2RenderTexture_8hpp_source.php">include/SFML/Graphics/RenderTexture.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a19ee6e5b4c40ad251803389b3953a9c6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a19ee6e5b4c40ad251803389b3953a9c6">&sect;&nbsp;</a></span>RenderTexture() <span class="overload">[1/2]</span></h2>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1RenderTexture.php#aefbb76eb3b87e368ab974b2660931ccb" title="Create the render-texture. ">create</a> </dd></dl>

</div>
</div>
<a id="a94b84ab9335be84d2a014c964d973304"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a94b84ab9335be84d2a014c964d973304">&sect;&nbsp;</a></span>~RenderTexture() <span class="overload">[1/2]</span></h2>
...
<a id="a19ee6e5b4c40ad251803389b3953a9c6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a19ee6e5b4c40ad251803389b3953a9c6">&sect;&nbsp;</a></span>RenderTexture() <span class="overload">[2/2]</span></h2>
...
<a id="a94b84ab9335be84d2a014c964d973304"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a94b84ab9335be84d2a014c964d973304">&sect;&nbsp;</a></span>~RenderTexture() <span class="overload">[2/2]</span></h2>
...
<a id="aefbb76eb3b87e368ab974b2660931ccb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aefbb76eb3b87e368ab974b2660931ccb">&sect;&nbsp;</a></span>create() <span class="overload">[1/2]</span></h2>
...
<a id="aefbb76eb3b87e368ab974b2660931ccb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aefbb76eb3b87e368ab974b2660931ccb">&sect;&nbsp;</a></span>create() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af92886d5faef3916caff9fa9ab32c555">&sect;&nbsp;</a></span>display() <span class="overload">[1/2]</span></h2>
...
<a id="af92886d5faef3916caff9fa9ab32c555"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af92886d5faef3916caff9fa9ab32c555">&sect;&nbsp;</a></span>display() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a8ca34c8b7e00793c1d3ef4f9a834f8cc">&sect;&nbsp;</a></span>generateMipmap() <span class="overload">[1/2]</span></h2>
...
<a id="a8ca34c8b7e00793c1d3ef4f9a834f8cc"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a8ca34c8b7e00793c1d3ef4f9a834f8cc">&sect;&nbsp;</a></span>generateMipmap() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a6685315b5c4c25a5dcb75b4280b381ba">&sect;&nbsp;</a></span>getSize() <span class="overload">[1/2]</span></h2>
...
<a id="a6685315b5c4c25a5dcb75b4280b381ba"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a6685315b5c4c25a5dcb75b4280b381ba">&sect;&nbsp;</a></span>getSize() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a07ecea85f05932fa02a8279416721bc9">&sect;&nbsp;</a></span>getTexture() <span class="overload">[1/2]</span></h2>
...
<a id="a07ecea85f05932fa02a8279416721bc9"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a07ecea85f05932fa02a8279416721bc9">&sect;&nbsp;</a></span>getTexture() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af530274b34159d644e509b4b4dc43eb7">&sect;&nbsp;</a></span>initialize() <span class="overload">[1/2]</span></h2>
...
<a id="af530274b34159d644e509b4b4dc43eb7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af530274b34159d644e509b4b4dc43eb7">&sect;&nbsp;</a></span>initialize() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a81c5a453a21c7e78299b062b97dc8c87">&sect;&nbsp;</a></span>isRepeated() <span class="overload">[1/2]</span></h2>
...
<a id="a81c5a453a21c7e78299b062b97dc8c87"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a81c5a453a21c7e78299b062b97dc8c87">&sect;&nbsp;</a></span>isRepeated() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a5b43c007ab6643accc5dae84b5bc8f61">&sect;&nbsp;</a></span>isSmooth() <span class="overload">[1/2]</span></h2>
...
<a id="a5b43c007ab6643accc5dae84b5bc8f61"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5b43c007ab6643accc5dae84b5bc8f61">&sect;&nbsp;</a></span>isSmooth() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a5da95ecdbce615a80bb78399012508cf">&sect;&nbsp;</a></span>setActive() <span class="overload">[1/2]</span></h2>
...
<a id="a5da95ecdbce615a80bb78399012508cf"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5da95ecdbce615a80bb78399012508cf">&sect;&nbsp;</a></span>setActive() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af8f97b33512bf7d5b6be3da6f65f7365">&sect;&nbsp;</a></span>setRepeated() <span class="overload">[1/2]</span></h2>
...
<a id="af8f97b33512bf7d5b6be3da6f65f7365"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af8f97b33512bf7d5b6be3da6f65f7365">&sect;&nbsp;</a></span>setRepeated() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#af08991e63c6020865dd07b20e27305b6">&sect;&nbsp;</a></span>setSmooth() <span class="overload">[1/2]</span></h2>
...
<a id="af08991e63c6020865dd07b20e27305b6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af08991e63c6020865dd07b20e27305b6">&sect;&nbsp;</a></span>setSmooth() <span class="overload">[2/2]</span></h2>
...
<li><a class="el" href="include_2SFML_2Graphics_2RenderTexture_8hpp_source.php">include/SFML/Graphics/RenderTexture.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
