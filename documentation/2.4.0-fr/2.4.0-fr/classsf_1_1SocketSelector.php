...
<tr class="memdesc:a917a4bac708290a6782e6686fd3bf889"><td class="mdescLeft">&#160;</td><td class="mdescRight">Test a socket to know if it is ready to receive data.  <a href="#a917a4bac708290a6782e6686fd3bf889">More...</a><br /></td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Create a socket to listen to new connections</span></div><div class="line"><a class="code" href="classsf_1_1TcpListener.php">sf::TcpListener</a> listener;</div><div class="line">listener.<a class="code" href="classsf_1_1TcpListener.php#a9504758ea3570e62cb20b209c11776a1">listen</a>(55001);</div><div class="line"></div><div class="line"><span class="comment">// Create a list to store the future clients</span></div><div class="line">std::list&lt;sf::TcpSocket*&gt; clients;</div><div class="line"></div><div class="line"><span class="comment">// Create a selector</span></div><div class="line"><a class="code" href="classsf_1_1SocketSelector.php">sf::SocketSelector</a> selector;</div><div class="line"></div><div class="line"><span class="comment">// Add the listener to the selector</span></div><div class="line">selector.<a class="code" href="classsf_1_1SocketSelector.php#ade952013232802ff7b9b33668f8d2096">add</a>(listener);</div><div class="line"></div><div class="line"><span class="comment">// Endless loop that waits for new connections</span></div><div class="line"><span class="keywordflow">while</span> (running)</div><div class="line">{</div><div class="line">    <span class="comment">// Make the selector wait for data on any socket</span></div><div class="line">    <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a9cfda5475f17925e65889394d70af702">wait</a>())</div><div class="line">    {</div><div class="line">        <span class="comment">// Test the listener</span></div><div class="line">        <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a917a4bac708290a6782e6686fd3bf889">isReady</a>(listener))</div><div class="line">        {</div><div class="line">            <span class="comment">// The listener is ready: there is a pending connection</span></div><div class="line">            <a class="code" href="classsf_1_1TcpSocket.php">sf::TcpSocket</a>* client = <span class="keyword">new</span> <a class="code" href="classsf_1_1TcpSocket.php">sf::TcpSocket</a>;</div><div class="line">            <span class="keywordflow">if</span> (listener.<a class="code" href="classsf_1_1TcpListener.php#ae2c83ce5a64d50b68180c46bef0a7346">accept</a>(*client) == <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca6b3d5ba897b6df8ebda86c823b30348a">sf::Socket::Done</a>)</div><div class="line">            {</div><div class="line">                <span class="comment">// Add the new client to the clients list</span></div><div class="line">                clients.push_back(client);</div><div class="line"></div><div class="line">                <span class="comment">// Add the new client to the selector so that we will</span></div><div class="line">                <span class="comment">// be notified when he sends something</span></div><div class="line">                selector.<a class="code" href="classsf_1_1SocketSelector.php#ade952013232802ff7b9b33668f8d2096">add</a>(*client);</div><div class="line">            }</div><div class="line">            <span class="keywordflow">else</span></div><div class="line">            {</div><div class="line">                <span class="comment">// Error, we won&#39;t get a new connection, delete the socket</span></div><div class="line">                <span class="keyword">delete</span> client;</div><div class="line">            }</div><div class="line">        }</div><div class="line">        <span class="keywordflow">else</span></div><div class="line">        {</div><div class="line">            <span class="comment">// The listener socket is not ready, test all other sockets (the clients)</span></div><div class="line">            <span class="keywordflow">for</span> (std::list&lt;sf::TcpSocket*&gt;::iterator it = clients.begin(); it != clients.end(); ++it)</div><div class="line">            {</div><div class="line">                <a class="code" href="classsf_1_1TcpSocket.php">sf::TcpSocket</a>&amp; client = **it;</div><div class="line">                <span class="keywordflow">if</span> (selector.<a class="code" href="classsf_1_1SocketSelector.php#a917a4bac708290a6782e6686fd3bf889">isReady</a>(client))</div><div class="line">                {</div><div class="line">                    <span class="comment">// The client has sent some data, we can receive it</span></div><div class="line">                    <a class="code" href="classsf_1_1Packet.php">sf::Packet</a> packet;</div><div class="line">                    <span class="keywordflow">if</span> (client.<a class="code" href="classsf_1_1TcpSocket.php#a90ce50811ea61d4f00efc62bb99ae1af">receive</a>(packet) == <a class="code" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca6b3d5ba897b6df8ebda86c823b30348a">sf::Socket::Done</a>)</div><div class="line">                    {</div><div class="line">                        ...</div><div class="line">                    }</div><div class="line">                }</div><div class="line">            }</div><div class="line">        }</div><div class="line">    }</div><div class="line">}</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Socket.php" title="Base class for all the socket types. ">sf::Socket</a> </dd></dl>
...
<a id="a741959c5158aeb1e4457cad47d90f76b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a741959c5158aeb1e4457cad47d90f76b">&sect;&nbsp;</a></span>SocketSelector() <span class="overload">[1/4]</span></h2>
...
<a id="a50b1b955eb7ecb2e7c2764f3f4722fbf"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a50b1b955eb7ecb2e7c2764f3f4722fbf">&sect;&nbsp;</a></span>SocketSelector() <span class="overload">[2/4]</span></h2>
...
<a id="a9069cd61208260b8ed9cf233afa1f73d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9069cd61208260b8ed9cf233afa1f73d">&sect;&nbsp;</a></span>~SocketSelector() <span class="overload">[1/2]</span></h2>
...
<a id="a741959c5158aeb1e4457cad47d90f76b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a741959c5158aeb1e4457cad47d90f76b">&sect;&nbsp;</a></span>SocketSelector() <span class="overload">[3/4]</span></h2>
...
<a id="a50b1b955eb7ecb2e7c2764f3f4722fbf"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a50b1b955eb7ecb2e7c2764f3f4722fbf">&sect;&nbsp;</a></span>SocketSelector() <span class="overload">[4/4]</span></h2>
...
<a id="a9069cd61208260b8ed9cf233afa1f73d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9069cd61208260b8ed9cf233afa1f73d">&sect;&nbsp;</a></span>~SocketSelector() <span class="overload">[2/2]</span></h2>
...
<a id="ade952013232802ff7b9b33668f8d2096"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ade952013232802ff7b9b33668f8d2096">&sect;&nbsp;</a></span>add() <span class="overload">[1/2]</span></h2>
...
<a id="ade952013232802ff7b9b33668f8d2096"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ade952013232802ff7b9b33668f8d2096">&sect;&nbsp;</a></span>add() <span class="overload">[2/2]</span></h2>
...
<a id="a76e650acb0199d4be91e90a493fbc91a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76e650acb0199d4be91e90a493fbc91a">&sect;&nbsp;</a></span>clear() <span class="overload">[1/2]</span></h2>
...
<a id="a76e650acb0199d4be91e90a493fbc91a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a76e650acb0199d4be91e90a493fbc91a">&sect;&nbsp;</a></span>clear() <span class="overload">[2/2]</span></h2>
...
<a id="a917a4bac708290a6782e6686fd3bf889"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a917a4bac708290a6782e6686fd3bf889">&sect;&nbsp;</a></span>isReady() <span class="overload">[1/2]</span></h2>
...
<a id="a917a4bac708290a6782e6686fd3bf889"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a917a4bac708290a6782e6686fd3bf889">&sect;&nbsp;</a></span>isReady() <span class="overload">[2/2]</span></h2>
...
<a id="ae6395c7a8d29a9ea14939cc5d1ba3a33"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ae6395c7a8d29a9ea14939cc5d1ba3a33">&sect;&nbsp;</a></span>operator=() <span class="overload">[1/2]</span></h2>
...
<a id="ae6395c7a8d29a9ea14939cc5d1ba3a33"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ae6395c7a8d29a9ea14939cc5d1ba3a33">&sect;&nbsp;</a></span>operator=() <span class="overload">[2/2]</span></h2>
...
<a id="a98b6ab693a65b82caa375639232357c1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a98b6ab693a65b82caa375639232357c1">&sect;&nbsp;</a></span>remove() <span class="overload">[1/2]</span></h2>
...
<a id="a98b6ab693a65b82caa375639232357c1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a98b6ab693a65b82caa375639232357c1">&sect;&nbsp;</a></span>remove() <span class="overload">[2/2]</span></h2>
...
<a id="a9cfda5475f17925e65889394d70af702"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9cfda5475f17925e65889394d70af702">&sect;&nbsp;</a></span>wait() <span class="overload">[1/2]</span></h2>
...
<a id="a9cfda5475f17925e65889394d70af702"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a9cfda5475f17925e65889394d70af702">&sect;&nbsp;</a></span>wait() <span class="overload">[2/2]</span></h2>
