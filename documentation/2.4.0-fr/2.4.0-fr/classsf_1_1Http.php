...
<tr class="memitem:aaf09ebfb5e00dcc82e0d494d5c6a9e2a"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Http_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Http.php#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">sendRequest</a> (const <a class="el" href="classsf_1_1Http_1_1Request.php">Request</a> &amp;request, <a class="el" href="classsf_1_1Time.php">Time</a> timeout=<a class="el" href="classsf_1_1Time.php#aa343e67f43a940e7b3b51aa10a495f2f">Time::Zero</a>)</td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Create a new HTTP client</span></div><div class="line"><a class="code" href="classsf_1_1Http.php">sf::Http</a> http;</div><div class="line"></div><div class="line"><span class="comment">// We&#39;ll work on http://www.sfml-dev.org</span></div><div class="line">http.<a class="code" href="classsf_1_1Http.php#a55121d543b61c41cf20b885a97b04e65">setHost</a>(<span class="stringliteral">&quot;http://www.sfml-dev.org&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Prepare a request to get the &#39;features.php&#39; page</span></div><div class="line"><a class="code" href="classsf_1_1Http_1_1Request.php">sf::Http::Request</a> request(<span class="stringliteral">&quot;features.php&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Send the request</span></div><div class="line"><a class="code" href="classsf_1_1Http_1_1Response.php">sf::Http::Response</a> response = http.<a class="code" href="classsf_1_1Http.php#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">sendRequest</a>(request);</div><div class="line"></div><div class="line"><span class="comment">// Check the status code and display the result</span></div><div class="line"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8">sf::Http::Response::Status</a> status = response.<a class="code" href="classsf_1_1Http_1_1Response.php#a4271651703764fd9a7d2c0315aff20de">getStatus</a>();</div><div class="line"><span class="keywordflow">if</span> (status == <a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a1c0988840633e4f4836b7813c85a6720">sf::Http::Response::Ok</a>)</div><div class="line">{</div><div class="line">    std::cout &lt;&lt; response.<a class="code" href="classsf_1_1Http_1_1Response.php#ab3bfc29867563aa815f6460eeea16136">getBody</a>() &lt;&lt; std::endl;</div><div class="line">}</div><div class="line"><span class="keywordflow">else</span></div><div class="line">{</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Error &quot;</span> &lt;&lt; status &lt;&lt; std::endl;</div><div class="line">}</div></div><!-- fragment --> 
<p>Definition at line <a class="el" href="include_2SFML_2Network_2Http_8hpp_source.php#l00046">46</a> of file <a class="el" href="include_2SFML_2Network_2Http_8hpp_source.php">include/SFML/Network/Http.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="abe2360194f99bdde402c9f97a85cf067"></a>
<h2 class="memtitle"><span class="permalink"><a href="#abe2360194f99bdde402c9f97a85cf067">&sect;&nbsp;</a></span>Http() <span class="overload">[1/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a79efd844a735f083fcce0edbf1092385">&sect;&nbsp;</a></span>Http() <span class="overload">[2/4]</span></h2>
...
<a id="abe2360194f99bdde402c9f97a85cf067"></a>
<h2 class="memtitle"><span class="permalink"><a href="#abe2360194f99bdde402c9f97a85cf067">&sect;&nbsp;</a></span>Http() <span class="overload">[3/4]</span></h2>
...
<a id="a79efd844a735f083fcce0edbf1092385"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a79efd844a735f083fcce0edbf1092385">&sect;&nbsp;</a></span>Http() <span class="overload">[4/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">&sect;&nbsp;</a></span>sendRequest() <span class="overload">[1/2]</span></h2>
...
<p>You must have a valid host before sending a request (see setHost). Any missing mandatory header field in the request will be added with an appropriate value. Warning: this function waits for the server's response and may not return instantly; use a thread if you don't want to block your application, or use a timeout to limit the time to wait. A value of <a class="el" href="classsf_1_1Time.php#aa343e67f43a940e7b3b51aa10a495f2f" title="Predefined &quot;zero&quot; time value. ">Time::Zero</a> means that the client will use the system default timeout (which is usually pretty long).</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<a id="aaf09ebfb5e00dcc82e0d494d5c6a9e2a"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">&sect;&nbsp;</a></span>sendRequest() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a55121d543b61c41cf20b885a97b04e65">&sect;&nbsp;</a></span>setHost() <span class="overload">[1/2]</span></h2>
...
<a id="a55121d543b61c41cf20b885a97b04e65"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a55121d543b61c41cf20b885a97b04e65">&sect;&nbsp;</a></span>setHost() <span class="overload">[2/2]</span></h2>
