...
<tr class="memitem:a7f33b30315f6ce8d8b4acfdabba065f7"><td class="memItemLeft" align="right" valign="top">const <a class="el" href="structsf_1_1Font_1_1Info.php">Info</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a7f33b30315f6ce8d8b4acfdabba065f7">getInfo</a> () const</td></tr>
...
<tr class="memitem:a308876e51e75bb69844fa3926a214fbf"><td class="memItemLeft" align="right" valign="top">const <a class="el" href="classsf_1_1Glyph.php">Glyph</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a308876e51e75bb69844fa3926a214fbf">getGlyph</a> (Uint32 codePoint, unsigned int characterSize, bool bold, float outlineThickness=0) const</td></tr>
...
<tr class="memitem:a5e1d5aca772d4765ce940670c2f786a6"><td class="memItemLeft" align="right" valign="top">float&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a5e1d5aca772d4765ce940670c2f786a6">getKerning</a> (Uint32 first, Uint32 second, unsigned int characterSize) const</td></tr>
...
<tr class="memitem:a15528d289f91cfd4b2597f8a9423e612"><td class="memItemLeft" align="right" valign="top">const <a class="el" href="classsf_1_1Texture.php">Texture</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Font.php#a15528d289f91cfd4b2597f8a9423e612">getTexture</a> (unsigned int characterSize) const</td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Declare a new font</span></div><div class="line"><a class="code" href="classsf_1_1Font.php">sf::Font</a> font;</div><div class="line"></div><div class="line"><span class="comment">// Load it from a file</span></div><div class="line"><span class="keywordflow">if</span> (!font.<a class="code" href="classsf_1_1Font.php#ab020052ef4e01f6c749a85571c0f3fd1">loadFromFile</a>(<span class="stringliteral">&quot;arial.ttf&quot;</span>))</div><div class="line">{</div><div class="line">    <span class="comment">// error...</span></div><div class="line">}</div><div class="line"></div><div class="line"><span class="comment">// Create a text which uses our font</span></div><div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text1;</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81">setFont</a>(font);</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e">setCharacterSize</a>(30);</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82a65dbbdd9d938efe1eea1e2f3b7d7c944">sf::Text::Regular</a>);</div><div class="line"></div><div class="line"><span class="comment">// Create another text using the same font, but with different parameters</span></div><div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text2;</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81">setFont</a>(font);</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e">setCharacterSize</a>(50);</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82af3e10eb0fa68aa746fbbdfcecbf352c9">sf::Text::Italic</a>);</div></div><!-- fragment --><p>Apart from loading font files, and passing them to instances of <a class="el" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target. ">sf::Text</a>, you should normally not have to deal directly with this class. However, it may be useful to access the font metrics or rasterized glyphs for advanced usage.</p>
...
<p>Definition at line <a class="el" href="include_2SFML_2Graphics_2Font_8hpp_source.php#l00050">50</a> of file <a class="el" href="include_2SFML_2Graphics_2Font_8hpp_source.php">include/SFML/Graphics/Font.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a506404655b8869ed60d1e7709812f583"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a506404655b8869ed60d1e7709812f583">&sect;&nbsp;</a></span>Font() <span class="overload">[1/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a72d7322b355ee2f1be4500f530e98081">&sect;&nbsp;</a></span>Font() <span class="overload">[2/4]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#aa18a3c62e6e01e9a21c531b5cad4b7f2">&sect;&nbsp;</a></span>~Font() <span class="overload">[1/2]</span></h2>
...
<a id="a506404655b8869ed60d1e7709812f583"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a506404655b8869ed60d1e7709812f583">&sect;&nbsp;</a></span>Font() <span class="overload">[3/4]</span></h2>
...
<a id="a72d7322b355ee2f1be4500f530e98081"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a72d7322b355ee2f1be4500f530e98081">&sect;&nbsp;</a></span>Font() <span class="overload">[4/4]</span></h2>
...
<a id="aa18a3c62e6e01e9a21c531b5cad4b7f2"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa18a3c62e6e01e9a21c531b5cad4b7f2">&sect;&nbsp;</a></span>~Font() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a308876e51e75bb69844fa3926a214fbf">&sect;&nbsp;</a></span>getGlyph() <span class="overload">[1/2]</span></h2>
...
<a id="a308876e51e75bb69844fa3926a214fbf"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a308876e51e75bb69844fa3926a214fbf">&sect;&nbsp;</a></span>getGlyph() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a7f33b30315f6ce8d8b4acfdabba065f7">&sect;&nbsp;</a></span>getInfo() <span class="overload">[1/2]</span></h2>
...
<a id="a7f33b30315f6ce8d8b4acfdabba065f7"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a7f33b30315f6ce8d8b4acfdabba065f7">&sect;&nbsp;</a></span>getInfo() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a5e1d5aca772d4765ce940670c2f786a6">&sect;&nbsp;</a></span>getKerning() <span class="overload">[1/2]</span></h2>
...
<a id="a5e1d5aca772d4765ce940670c2f786a6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a5e1d5aca772d4765ce940670c2f786a6">&sect;&nbsp;</a></span>getKerning() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a4538cc8af337393208a87675fe1c3e59">&sect;&nbsp;</a></span>getLineSpacing() <span class="overload">[1/2]</span></h2>
...
<a id="a4538cc8af337393208a87675fe1c3e59"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4538cc8af337393208a87675fe1c3e59">&sect;&nbsp;</a></span>getLineSpacing() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a15528d289f91cfd4b2597f8a9423e612">&sect;&nbsp;</a></span>getTexture() <span class="overload">[1/2]</span></h2>
...
<a id="a15528d289f91cfd4b2597f8a9423e612"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a15528d289f91cfd4b2597f8a9423e612">&sect;&nbsp;</a></span>getTexture() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a726a55f40c19ac108e348b103190caad">&sect;&nbsp;</a></span>getUnderlinePosition() <span class="overload">[1/2]</span></h2>
...
<a id="a726a55f40c19ac108e348b103190caad"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a726a55f40c19ac108e348b103190caad">&sect;&nbsp;</a></span>getUnderlinePosition() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ad6d0a5bc6c026fe85c239f1f822b54e6">&sect;&nbsp;</a></span>getUnderlineThickness() <span class="overload">[1/2]</span></h2>
...
<a id="ad6d0a5bc6c026fe85c239f1f822b54e6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad6d0a5bc6c026fe85c239f1f822b54e6">&sect;&nbsp;</a></span>getUnderlineThickness() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#ab020052ef4e01f6c749a85571c0f3fd1">&sect;&nbsp;</a></span>loadFromFile() <span class="overload">[1/2]</span></h2>
...
<a id="ab020052ef4e01f6c749a85571c0f3fd1"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ab020052ef4e01f6c749a85571c0f3fd1">&sect;&nbsp;</a></span>loadFromFile() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#abf2f8d6de31eb4e1db02e061c323e346">&sect;&nbsp;</a></span>loadFromMemory() <span class="overload">[1/2]</span></h2>
...
<a id="abf2f8d6de31eb4e1db02e061c323e346"></a>
<h2 class="memtitle"><span class="permalink"><a href="#abf2f8d6de31eb4e1db02e061c323e346">&sect;&nbsp;</a></span>loadFromMemory() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#abc3f37a354ce8b9a21f8eb93bd9fdafb">&sect;&nbsp;</a></span>loadFromStream() <span class="overload">[1/2]</span></h2>
...
<a id="abc3f37a354ce8b9a21f8eb93bd9fdafb"></a>
<h2 class="memtitle"><span class="permalink"><a href="#abc3f37a354ce8b9a21f8eb93bd9fdafb">&sect;&nbsp;</a></span>loadFromStream() <span class="overload">[2/2]</span></h2>
...
<h2 class="memtitle"><span class="permalink"><a href="#a232515549846e3172a514d0b47918399">&sect;&nbsp;</a></span>operator=() <span class="overload">[1/2]</span></h2>
...
<a id="a232515549846e3172a514d0b47918399"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a232515549846e3172a514d0b47918399">&sect;&nbsp;</a></span>operator=() <span class="overload">[2/2]</span></h2>
