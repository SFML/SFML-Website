...
<p>Usage examples: </p><div class="fragment"><div class="line"><span class="comment">// example 1: non member function with one argument</span></div><div class="line"></div><div class="line"><span class="keywordtype">void</span> threadFunc(<span class="keywordtype">int</span> argument)</div><div class="line">{</div><div class="line">    ...</div><div class="line">}</div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Thread.php">sf::Thread</a> thread(&amp;threadFunc, 5);</div><div class="line">thread.launch(); <span class="comment">// start the thread (internally calls threadFunc(5))</span></div></div><!-- fragment --><div class="fragment"><div class="line"><span class="comment">// example 2: member function</span></div><div class="line"></div><div class="line"><span class="keyword">class </span>Task</div><div class="line">{</div><div class="line"><span class="keyword">public</span>:</div><div class="line">    <span class="keywordtype">void</span> run()</div><div class="line">    {</div><div class="line">        ...</div><div class="line">    }</div><div class="line">};</div><div class="line"></div><div class="line">Task task;</div><div class="line"><a class="code" href="classsf_1_1Thread.php">sf::Thread</a> thread(&amp;Task::run, &amp;task);</div><div class="line">thread.launch(); <span class="comment">// start the thread (internally calls task.run())</span></div></div><!-- fragment --><div class="fragment"><div class="line"><span class="comment">// example 3: functor</span></div><div class="line"></div><div class="line"><span class="keyword">struct </span>Task</div><div class="line">{</div><div class="line">    <span class="keywordtype">void</span> operator()()</div><div class="line">    {</div><div class="line">        ...</div><div class="line">    }</div><div class="line">};</div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Thread.php">sf::Thread</a> thread(Task());</div><div class="line">thread.launch(); <span class="comment">// start the thread (internally calls operator() on the Task instance)</span></div></div><!-- fragment --><p>Creating parallel threads of execution can be dangerous: all threads inside the same process share the same memory space, which means that you may end up accessing the same variable from multiple threads at the same time. To prevent this kind of situations, you can use mutexes (see <a class="el" href="classsf_1_1Mutex.php" title="Blocks concurrent access to shared resources from multiple threads. ">sf::Mutex</a>).</p>
...
<a id="a4cc65399bbb111cf8132537783b8e96c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4cc65399bbb111cf8132537783b8e96c">&sect;&nbsp;</a></span>Thread() <span class="overload">[1/6]</span></h2>
...
<p>Use this constructor for this kind of function: </p><div class="fragment"><div class="line"><span class="keywordtype">void</span> <span class="keyword">function</span>();</div><div class="line"></div><div class="line"><span class="comment">// --- or ----</span></div><div class="line"></div><div class="line"><span class="keyword">struct </span>Functor</div><div class="line">{</div><div class="line">    <span class="keywordtype">void</span> operator()();</div><div class="line">};</div></div><!-- fragment --><p> Note: this does <em>not</em> run the thread, use <a class="el" href="classsf_1_1Thread.php#a74f75a9e86e1eb47479496314048b5f6" title="Run the thread. ">launch()</a>.</p>
...
<a id="a719b2cc067d92d52c35064a49d850a53"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a719b2cc067d92d52c35064a49d850a53">&sect;&nbsp;</a></span>Thread() <span class="overload">[2/6]</span></h2>
...
<p>Use this constructor for this kind of function: </p><div class="fragment"><div class="line"><span class="keywordtype">void</span> <span class="keyword">function</span>(<span class="keywordtype">int</span> arg);</div><div class="line"></div><div class="line"><span class="comment">// --- or ----</span></div><div class="line"></div><div class="line"><span class="keyword">struct </span>Functor</div><div class="line">{</div><div class="line">    <span class="keywordtype">void</span> operator()(std::string arg);</div><div class="line">};</div></div><!-- fragment --><p> Note: this does <em>not</em> run the thread, use <a class="el" href="classsf_1_1Thread.php#a74f75a9e86e1eb47479496314048b5f6" title="Run the thread. ">launch()</a>.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
    <tr><td class="paramname">function</td><td>Functor or free function to use as the entry point of the thread </td></tr>
...
<a id="aa9f473c8cbb078900c62b1fd14a83a34"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa9f473c8cbb078900c62b1fd14a83a34">&sect;&nbsp;</a></span>Thread() <span class="overload">[3/6]</span></h2>
...
<p>This constructor is a template, which means that you can use it with any class. Use this constructor for this kind of function: </p><div class="fragment"><div class="line"><span class="keyword">class </span>MyClass</div><div class="line">{</div><div class="line"><span class="keyword">public</span>:</div><div class="line"></div><div class="line">    <span class="keywordtype">void</span> <span class="keyword">function</span>();</div><div class="line">};</div></div><!-- fragment --><p> Note: this does <em>not</em> run the thread, use <a class="el" href="classsf_1_1Thread.php#a74f75a9e86e1eb47479496314048b5f6" title="Run the thread. ">launch()</a>.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<a id="af77942fc1730af7c31bc4c3a913a9c1d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af77942fc1730af7c31bc4c3a913a9c1d">&sect;&nbsp;</a></span>~Thread() <span class="overload">[1/2]</span></h2>
...
<a id="a4cc65399bbb111cf8132537783b8e96c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4cc65399bbb111cf8132537783b8e96c">&sect;&nbsp;</a></span>Thread() <span class="overload">[4/6]</span></h2>
...
<a id="a719b2cc067d92d52c35064a49d850a53"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a719b2cc067d92d52c35064a49d850a53">&sect;&nbsp;</a></span>Thread() <span class="overload">[5/6]</span></h2>
...
<a id="aa9f473c8cbb078900c62b1fd14a83a34"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa9f473c8cbb078900c62b1fd14a83a34">&sect;&nbsp;</a></span>Thread() <span class="overload">[6/6]</span></h2>
...
<a id="af77942fc1730af7c31bc4c3a913a9c1d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af77942fc1730af7c31bc4c3a913a9c1d">&sect;&nbsp;</a></span>~Thread() <span class="overload">[2/2]</span></h2>
...
<a id="a74f75a9e86e1eb47479496314048b5f6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a74f75a9e86e1eb47479496314048b5f6">&sect;&nbsp;</a></span>launch() <span class="overload">[1/2]</span></h2>
...
<a id="a74f75a9e86e1eb47479496314048b5f6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a74f75a9e86e1eb47479496314048b5f6">&sect;&nbsp;</a></span>launch() <span class="overload">[2/2]</span></h2>
...
<a id="ad6b205d4f1ce38b8d44bba0f5501477c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad6b205d4f1ce38b8d44bba0f5501477c">&sect;&nbsp;</a></span>terminate() <span class="overload">[1/2]</span></h2>
...
<a id="ad6b205d4f1ce38b8d44bba0f5501477c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad6b205d4f1ce38b8d44bba0f5501477c">&sect;&nbsp;</a></span>terminate() <span class="overload">[2/2]</span></h2>
...
<a id="a724b1f94c2d54f84280f2f78bde95fa0"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a724b1f94c2d54f84280f2f78bde95fa0">&sect;&nbsp;</a></span>wait() <span class="overload">[1/2]</span></h2>
...
<a id="a724b1f94c2d54f84280f2f78bde95fa0"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a724b1f94c2d54f84280f2f78bde95fa0">&sect;&nbsp;</a></span>wait() <span class="overload">[2/2]</span></h2>
