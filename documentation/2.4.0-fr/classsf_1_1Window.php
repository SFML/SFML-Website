...
<tr class="memitem:ad2b55a731ba1680fe67292991ef1610e"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Vector2.php">Vector2u</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Window.php#ad2b55a731ba1680fe67292991ef1610e">getSize</a> () const </td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Declare and create a new window</span></div><div class="line"><a class="code" href="classsf_1_1Window.php">sf::Window</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div><div class="line"></div><div class="line"><span class="comment">// Limit the framerate to 60 frames per second (this step is optional)</span></div><div class="line">window.<a class="code" href="classsf_1_1Window.php#af4322d315baf93405bf0d5087ad5e784">setFramerateLimit</a>(60);</div><div class="line"></div><div class="line"><span class="comment">// The main loop - ends as soon as the window is closed</span></div><div class="line"><span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#a5aa9c2b2b0e51d3423c2b66c80253337">isOpen</a>())</div><div class="line">{</div><div class="line">   <span class="comment">// Event processing</span></div><div class="line">   <a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div><div class="line">   <span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#a338e996585faf82e93069858e3b531b7">pollEvent</a>(event))</div><div class="line">   {</div><div class="line">       <span class="comment">// Request for closing the window</span></div><div class="line">       <span class="keywordflow">if</span> (event.<a class="code" href="classsf_1_1Event.php#adf2f8044f713fd9d6019077b0d1ffe0a">type</a> == <a class="code" href="classsf_1_1Event.php#af41fa9ed45c02449030699f671331d4aa316e4212e083f1dce79efd8d9e9c0a95">sf::Event::Closed</a>)</div><div class="line">           window.<a class="code" href="classsf_1_1Window.php#a99d1e030387b0c26f5995670504fe7b5">close</a>();</div><div class="line">   }</div><div class="line"></div><div class="line">   <span class="comment">// Activate the window for OpenGL rendering</span></div><div class="line">   window.<a class="code" href="classsf_1_1Window.php#a17ccf8ece0ce0bf2f1e6698bcfa29731">setActive</a>();</div><div class="line"></div><div class="line">   <span class="comment">// OpenGL drawing commands go here...</span></div><div class="line"></div><div class="line">   <span class="comment">// End the current frame and display its contents on screen</span></div><div class="line">   window.<a class="code" href="classsf_1_1Window.php#adabf839cb103ac96cfc82f781638772a">display</a>();</div><div class="line">}</div></div><!-- fragment --> 
<p>Definition at line <a class="el" href="Window_2Window_8hpp_source.php#l00057">57</a> of file <a class="el" href="Window_2Window_8hpp_source.php">Window/Window.hpp</a>.</p>
