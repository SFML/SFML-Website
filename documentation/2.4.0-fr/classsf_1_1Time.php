...
<p>Usage example: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Time.php">sf::Time</a> t1 = sf::seconds(0.1f);</div><div class="line">Int32 milli = t1.<a class="code" href="classsf_1_1Time.php#a85e6deb41fa71896508ce0f64059a6ae">asMilliseconds</a>(); <span class="comment">// 100</span></div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Time.php">sf::Time</a> t2 = sf::milliseconds(30);</div><div class="line">Int64 micro = t2.<a class="code" href="classsf_1_1Time.php#ae41a7e0ca73ceea771b3c150c12abdd2">asMicroseconds</a>(); <span class="comment">// 30000</span></div><div class="line"></div><div class="line"><a class="code" href="classsf_1_1Time.php">sf::Time</a> t3 = sf::microseconds(-800000);</div><div class="line"><span class="keywordtype">float</span> sec = t3.<a class="code" href="classsf_1_1Time.php#a7538140d095e48da9d7eee015dd455a9">asSeconds</a>(); <span class="comment">// -0.8</span></div></div><!-- fragment --><div class="fragment"><div class="line"><span class="keywordtype">void</span> update(<a class="code" href="classsf_1_1Time.php">sf::Time</a> elapsed)</div><div class="line">{</div><div class="line">   position += speed * elapsed.<a class="code" href="classsf_1_1Time.php#a7538140d095e48da9d7eee015dd455a9">asSeconds</a>();</div><div class="line">}</div><div class="line"></div><div class="line">update(sf::milliseconds(100));</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Clock.php" title="Utility class that measures the elapsed time. ">sf::Clock</a> </dd></dl>
