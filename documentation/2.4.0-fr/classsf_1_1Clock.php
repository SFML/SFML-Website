...
<p>Usage example: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Clock.php">sf::Clock</a> clock;</div><div class="line">...</div><div class="line">Time time1 = clock.<a class="code" href="classsf_1_1Clock.php#a799feb6acb099b57b58d8d20984fce11">getElapsedTime</a>();</div><div class="line">...</div><div class="line"><a class="code" href="classsf_1_1Time.php#acba0cfbc49e3a09a22a8e079eb67a05c">Time</a> time2 = clock.<a class="code" href="classsf_1_1Clock.php#a123e2627f2943e5ecaa1db0c7df3231b">restart</a>();</div></div><!-- fragment --><p>The <a class="el" href="classsf_1_1Time.php" title="Represents a time value. ">sf::Time</a> value returned by the clock can then be converted to a number of seconds, milliseconds or even microseconds.</p>
