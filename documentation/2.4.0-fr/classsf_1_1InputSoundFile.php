...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Open a sound file</span></div><div class="line"><a class="code" href="classsf_1_1InputSoundFile.php">sf::InputSoundFile</a> file;</div><div class="line"><span class="keywordflow">if</span> (!file.<a class="code" href="classsf_1_1InputSoundFile.php#af68e54bc9bfac19554c84601156fe93f">openFromFile</a>(<span class="stringliteral">&quot;music.ogg&quot;</span>))</div><div class="line">    <span class="comment">/* error */</span>;</div><div class="line"></div><div class="line"><span class="comment">// Print the sound attributes</span></div><div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;duration: &quot;</span> &lt;&lt; file.<a class="code" href="classsf_1_1InputSoundFile.php#a8c5707b202d8785f806bd6604a9e19c5">getDuration</a>().<a class="code" href="classsf_1_1Time.php#a7538140d095e48da9d7eee015dd455a9">asSeconds</a>() &lt;&lt; std::endl;</div><div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;channels: &quot;</span> &lt;&lt; file.<a class="code" href="classsf_1_1InputSoundFile.php#a3a3d113d0f093c806edeb47a0eb509bd">getChannelCount</a>() &lt;&lt; std::endl;</div><div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;sample rate: &quot;</span> &lt;&lt; file.<a class="code" href="classsf_1_1InputSoundFile.php#adfbd1eaaf9fc0b469311fc159f5a3ecb">getSampleRate</a>() &lt;&lt; std::endl;</div><div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;sample count: &quot;</span> &lt;&lt; file.<a class="code" href="classsf_1_1InputSoundFile.php#a0c7d3293a5b0ed6aff674d5c8bcc1cdf">getSampleCount</a>() &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Read and process batches of samples until the end of file is reached</span></div><div class="line">sf::Int16 samples[1024];</div><div class="line">sf::Uint64 count;</div><div class="line"><span class="keywordflow">do</span></div><div class="line">{</div><div class="line">    count = file.<a class="code" href="classsf_1_1InputSoundFile.php#a83d6f64617456601edeb0daf9d14a17f">read</a>(samples, 1024);</div><div class="line"></div><div class="line">    <span class="comment">// process, analyze, play, convert, or whatever</span></div><div class="line">    <span class="comment">// you want to do with the samples...</span></div><div class="line">}</div><div class="line"><span class="keywordflow">while</span> (count &gt; 0);</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1SoundFileReader.php" title="Abstract base class for sound file decoding. ">sf::SoundFileReader</a>, <a class="el" href="classsf_1_1OutputSoundFile.php" title="Provide write access to sound files. ">sf::OutputSoundFile</a> </dd></dl>
