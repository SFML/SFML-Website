...
<div id="nav-path" class="navpath">
  <ul>
<li class="navelem"><b>sf</b></li><li class="navelem"><a class="el" href="singletonsf_1_1Utf.php">Utf</a></li>  </ul>
</div>
</div><!-- top -->
<div class="header">
...
<p>Utility class providing generic functions for UTF conversions.  
 <a href="singletonsf_1_1Utf.php#details">More...</a></p>
...
<p><a class="el" href="singletonsf_1_1Utf.php" title="Utility class providing generic functions for UTF conversions. ">sf::Utf</a> is a low-level, generic interface for counting, iterating, encoding and decoding Unicode characters and strings. It is able to handle ANSI, wide, latin-1, UTF-8, UTF-16 and UTF-32 encodings.</p>
