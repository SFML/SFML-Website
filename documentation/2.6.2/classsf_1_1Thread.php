...
<a href="classsf_1_1Thread-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::Thread Class Reference<div class="ingroups"><a class="el" href="group__system.php">System module</a></div></div></div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="Thread_8hpp_source.php">SFML/System/Thread.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<tr class="memitem:a4cc65399bbb111cf8132537783b8e96c" id="r_a4cc65399bbb111cf8132537783b8e96c"><td class="memTemplParams" colspan="2">template&lt;typename F &gt; </td></tr>
<tr class="memitem:a4cc65399bbb111cf8132537783b8e96c"><td class="memTemplItemLeft" align="right" valign="top">&#160;</td><td class="memTemplItemRight" valign="bottom"><a class="el" href="#a4cc65399bbb111cf8132537783b8e96c">Thread</a> (F function)</td></tr>
<tr class="memdesc:a4cc65399bbb111cf8132537783b8e96c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Construct the thread from a functor with no argument.  <br /></td></tr>
<tr class="separator:a4cc65399bbb111cf8132537783b8e96c"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a719b2cc067d92d52c35064a49d850a53" id="r_a719b2cc067d92d52c35064a49d850a53"><td class="memTemplParams" colspan="2">template&lt;typename F , typename A &gt; </td></tr>
<tr class="memitem:a719b2cc067d92d52c35064a49d850a53"><td class="memTemplItemLeft" align="right" valign="top">&#160;</td><td class="memTemplItemRight" valign="bottom"><a class="el" href="#a719b2cc067d92d52c35064a49d850a53">Thread</a> (F function, A argument)</td></tr>
<tr class="memdesc:a719b2cc067d92d52c35064a49d850a53"><td class="mdescLeft">&#160;</td><td class="mdescRight">Construct the thread from a functor with an argument.  <br /></td></tr>
<tr class="separator:a719b2cc067d92d52c35064a49d850a53"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aa9f473c8cbb078900c62b1fd14a83a34" id="r_aa9f473c8cbb078900c62b1fd14a83a34"><td class="memTemplParams" colspan="2">template&lt;typename C &gt; </td></tr>
<tr class="memitem:aa9f473c8cbb078900c62b1fd14a83a34"><td class="memTemplItemLeft" align="right" valign="top">&#160;</td><td class="memTemplItemRight" valign="bottom"><a class="el" href="#aa9f473c8cbb078900c62b1fd14a83a34">Thread</a> (void(C::*function)(), C *object)</td></tr>
<tr class="memdesc:aa9f473c8cbb078900c62b1fd14a83a34"><td class="mdescLeft">&#160;</td><td class="mdescRight">Construct the thread from a member function and an object.  <br /></td></tr>
<tr class="separator:aa9f473c8cbb078900c62b1fd14a83a34"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:af77942fc1730af7c31bc4c3a913a9c1d" id="r_af77942fc1730af7c31bc4c3a913a9c1d"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af77942fc1730af7c31bc4c3a913a9c1d">~Thread</a> ()</td></tr>
<tr class="memdesc:af77942fc1730af7c31bc4c3a913a9c1d"><td class="mdescLeft">&#160;</td><td class="mdescRight">Destructor.  <br /></td></tr>
<tr class="separator:af77942fc1730af7c31bc4c3a913a9c1d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a74f75a9e86e1eb47479496314048b5f6" id="r_a74f75a9e86e1eb47479496314048b5f6"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a74f75a9e86e1eb47479496314048b5f6">launch</a> ()</td></tr>
<tr class="memdesc:a74f75a9e86e1eb47479496314048b5f6"><td class="mdescLeft">&#160;</td><td class="mdescRight">Run the thread.  <br /></td></tr>
<tr class="separator:a74f75a9e86e1eb47479496314048b5f6"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a724b1f94c2d54f84280f2f78bde95fa0" id="r_a724b1f94c2d54f84280f2f78bde95fa0"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a724b1f94c2d54f84280f2f78bde95fa0">wait</a> ()</td></tr>
<tr class="memdesc:a724b1f94c2d54f84280f2f78bde95fa0"><td class="mdescLeft">&#160;</td><td class="mdescRight">Wait until the thread finishes.  <br /></td></tr>
<tr class="separator:a724b1f94c2d54f84280f2f78bde95fa0"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ad6b205d4f1ce38b8d44bba0f5501477c" id="r_ad6b205d4f1ce38b8d44bba0f5501477c"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ad6b205d4f1ce38b8d44bba0f5501477c">terminate</a> ()</td></tr>
<tr class="memdesc:ad6b205d4f1ce38b8d44bba0f5501477c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Terminate the thread.  <br /></td></tr>
...
<p>The thread ends when its function is terminated. If the owner <a class="el" href="classsf_1_1Thread.php" title="Utility class to manipulate threads.">sf::Thread</a> instance is destroyed before the thread is finished, the destructor will wait (see <a class="el" href="#a724b1f94c2d54f84280f2f78bde95fa0" title="Wait until the thread finishes.">wait()</a>)</p>
...
<div class="line">}</div>
<div class="line"> </div>
<div class="line"><a class="code hl_class" href="classsf_1_1Thread.php">sf::Thread</a> thread(&amp;threadFunc, 5);</div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1Thread.php">sf::Thread</a> thread(&amp;Task::run, &amp;task);</div>
...
<div class="line">};</div>
<div class="line"> </div>
<div class="line"><a class="code hl_class" href="classsf_1_1Thread.php">sf::Thread</a> thread(Task());</div>
...
<p class="definition">Definition at line <a class="el" href="Thread_8hpp_source.php#l00048">48</a> of file <a class="el" href="Thread_8hpp_source.php">Thread.hpp</a>.</p>
</div><h2 class="groupheader">Constructor &amp; Destructor Documentation</h2>
<a id="a4cc65399bbb111cf8132537783b8e96c" name="a4cc65399bbb111cf8132537783b8e96c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a4cc65399bbb111cf8132537783b8e96c">&#9670;&#160;</a></span>Thread() <span class="overload">[1/3]</span></h2>
...
template&lt;typename F &gt; </div>
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">F</td>          <td class="paramname"><span class="paramname"><em>function</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
...
<p>Use this constructor for this kind of function: </p><div class="fragment"><div class="line"><span class="keywordtype">void</span> function();</div>
<div class="line"> </div>
...
<div class="line">    <span class="keywordtype">void</span> operator()();</div>
<div class="line">};</div>
</div><!-- fragment --><p> Note: this does <em>not</em> run the thread, use <a class="el" href="#a74f75a9e86e1eb47479496314048b5f6" title="Run the thread.">launch()</a>.</p>
...
<a id="a719b2cc067d92d52c35064a49d850a53" name="a719b2cc067d92d52c35064a49d850a53"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a719b2cc067d92d52c35064a49d850a53">&#9670;&#160;</a></span>Thread() <span class="overload">[2/3]</span></h2>
...
template&lt;typename F , typename A &gt; </div>
      <table class="memname">
        ...
        <tr>
          ...
          <td></td>
          <td class="paramtype">A</td>          <td class="paramname"><span class="paramname"><em>argument</em></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<p>Use this constructor for this kind of function: </p><div class="fragment"><div class="line"><span class="keywordtype">void</span> function(<span class="keywordtype">int</span> arg);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// --- or ----</span></div>
<div class="line"> </div>
<div class="line"><span class="keyword">struct </span>Functor</div>
...
<a id="aa9f473c8cbb078900c62b1fd14a83a34" name="aa9f473c8cbb078900c62b1fd14a83a34"></a>
<h2 class="memtitle"><span class="permalink"><a href="#aa9f473c8cbb078900c62b1fd14a83a34">&#9670;&#160;</a></span>Thread() <span class="overload">[3/3]</span></h2>
...
<a id="af77942fc1730af7c31bc4c3a913a9c1d" name="af77942fc1730af7c31bc4c3a913a9c1d"></a>
<h2 class="memtitle"><span class="permalink"><a href="#af77942fc1730af7c31bc4c3a913a9c1d">&#9670;&#160;</a></span>~Thread()</h2>
...
<p>Destructor. </p>
<p>This destructor calls <a class="el" href="#a724b1f94c2d54f84280f2f78bde95fa0" title="Wait until the thread finishes.">wait()</a>, so that the internal thread cannot survive after its <a class="el" href="classsf_1_1Thread.php" title="Utility class to manipulate threads.">sf::Thread</a> instance is destroyed. </p>

</div>
</div>
<h2 class="groupheader">Member Function Documentation</h2>
<a id="a74f75a9e86e1eb47479496314048b5f6" name="a74f75a9e86e1eb47479496314048b5f6"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a74f75a9e86e1eb47479496314048b5f6">&#9670;&#160;</a></span>launch()</h2>
...
<a id="ad6b205d4f1ce38b8d44bba0f5501477c" name="ad6b205d4f1ce38b8d44bba0f5501477c"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ad6b205d4f1ce38b8d44bba0f5501477c">&#9670;&#160;</a></span>terminate()</h2>
...
<a id="a724b1f94c2d54f84280f2f78bde95fa0" name="a724b1f94c2d54f84280f2f78bde95fa0"></a>
<h2 class="memtitle"><span class="permalink"><a href="#a724b1f94c2d54f84280f2f78bde95fa0">&#9670;&#160;</a></span>wait()</h2>
...
<li><a class="el" href="Thread_8hpp_source.php">Thread.hpp</a></li>
</ul>
</div><!-- contents -->
<?php
    require("../footer.php");
