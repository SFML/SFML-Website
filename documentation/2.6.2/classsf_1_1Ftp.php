...
<tr class="memitem:a1cd6b89ad23253f6d97e6d4ca4d558cb" id="r_a1cd6b89ad23253f6d97e6d4ca4d558cb"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cb">TransferMode</a> { <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cba6f253b362639fb5e059dc292762a21ee">Binary</a>
, <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2">Ascii</a>
, <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cbabb1e34435231e73c96534c71090be7f4">Ebcdic</a>
 }</td></tr>
...
<tr class="memitem:acf7459926f3391cd06bf84337ed6a0f4" id="r_acf7459926f3391cd06bf84337ed6a0f4"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#acf7459926f3391cd06bf84337ed6a0f4">disconnect</a> ()</td></tr>
...
<tr class="memitem:a686262bc377584cd50e52e1576aa3a9b" id="r_a686262bc377584cd50e52e1576aa3a9b"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a686262bc377584cd50e52e1576aa3a9b">login</a> ()</td></tr>
...
<tr class="memitem:aa1127d442b4acb2105aa8060a39d04fc" id="r_aa1127d442b4acb2105aa8060a39d04fc"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aa1127d442b4acb2105aa8060a39d04fc">keepAlive</a> ()</td></tr>
...
<tr class="memitem:a8f37258e461fcb9e2a0655e9df0be4a0" id="r_a8f37258e461fcb9e2a0655e9df0be4a0"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1ListingResponse.php">ListingResponse</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a8f37258e461fcb9e2a0655e9df0be4a0">getDirectoryListing</a> (const std::string &amp;directory=&quot;&quot;)</td></tr>
...
<tr class="memitem:a20c1600ec5fd6f5a2ad1429ab8aa5df4" id="r_a20c1600ec5fd6f5a2ad1429ab8aa5df4"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a20c1600ec5fd6f5a2ad1429ab8aa5df4">download</a> (const std::string &amp;remoteFile, const std::string &amp;localPath, <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cb">TransferMode</a> mode=<a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cba6f253b362639fb5e059dc292762a21ee">Binary</a>)</td></tr>
...
<tr class="memitem:a0402d2cec27a197ffba34c88ffaddeac" id="r_a0402d2cec27a197ffba34c88ffaddeac"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Ftp_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a0402d2cec27a197ffba34c88ffaddeac">upload</a> (const std::string &amp;localFile, const std::string &amp;remotePath, <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cb">TransferMode</a> mode=<a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cba6f253b362639fb5e059dc292762a21ee">Binary</a>, bool append=false)</td></tr>
...
<p>Every command returns a FTP response, which contains the status code as well as a message from the server. Some commands such as <a class="el" href="#a79c654fcdd0c81e68c4fa29af3b45e0c" title="Get the current working directory.">getWorkingDirectory()</a> and <a class="el" href="#a8f37258e461fcb9e2a0655e9df0be4a0" title="Get the contents of the given directory.">getDirectoryListing()</a> return additional data, and use a class derived from <a class="el" href="classsf_1_1Ftp_1_1Response.php" title="Define a FTP response.">sf::Ftp::Response</a> to provide this data. The most often used commands are directly provided as member functions, but it is also possible to use specific commands with the <a class="el" href="#a44e095103ecbce175a33eaf0820440ff" title="Send a command to the FTP server.">sendCommand()</a> function.</p>
...
<div class="line"><a class="code hl_class" href="classsf_1_1Ftp_1_1Response.php">sf::Ftp::Response</a> response = ftp.<a class="code hl_function" href="#af02fb3de3f450a50a27981961c69c860">connect</a>(<span class="stringliteral">&quot;ftp://ftp.myserver.com&quot;</span>);</div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1Ftp_1_1DirectoryResponse.php">sf::Ftp::DirectoryResponse</a> directory = ftp.<a class="code hl_function" href="#a79c654fcdd0c81e68c4fa29af3b45e0c">getWorkingDirectory</a>();</div>
...
<div class="line">response = ftp.<a class="code hl_function" href="#a0402d2cec27a197ffba34c88ffaddeac">upload</a>(<span class="stringliteral">&quot;local-path/file.txt&quot;</span>, <span class="stringliteral">&quot;files&quot;</span>, <a class="code hl_enumvalue" href="#a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2">sf::Ftp::Ascii</a>);</div>
<div class="line"><span class="keywordflow">if</span> (response.<a class="code hl_function" href="classsf_1_1Ftp_1_1Response.php#a5102552955a2652c1a39e9046e617b36">isOk</a>())</div>
...
<div class="ttc" id="aclasssf_1_1Ftp_php_a0402d2cec27a197ffba34c88ffaddeac"><div class="ttname"><a href="#a0402d2cec27a197ffba34c88ffaddeac">sf::Ftp::upload</a></div><div class="ttdeci">Response upload(const std::string &amp;localFile, const std::string &amp;remotePath, TransferMode mode=Binary, bool append=false)</div><div class="ttdoc">Upload a file to the server.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2"><div class="ttname"><a href="#a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2">sf::Ftp::Ascii</a></div><div class="ttdeci">@ Ascii</div><div class="ttdoc">Text mode using ASCII encoding.</div><div class="ttdef"><b>Definition</b> <a href="Ftp_8hpp_source.php#l00058">Ftp.hpp:58</a></div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_a247b84c4b25da37804218c2b748c4787"><div class="ttname"><a href="#a247b84c4b25da37804218c2b748c4787">sf::Ftp::createDirectory</a></div><div class="ttdeci">Response createDirectory(const std::string &amp;name)</div><div class="ttdoc">Create a new directory.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_a44e095103ecbce175a33eaf0820440ff"><div class="ttname"><a href="#a44e095103ecbce175a33eaf0820440ff">sf::Ftp::sendCommand</a></div><div class="ttdeci">Response sendCommand(const std::string &amp;command, const std::string &amp;parameter=&quot;&quot;)</div><div class="ttdoc">Send a command to the FTP server.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_a686262bc377584cd50e52e1576aa3a9b"><div class="ttname"><a href="#a686262bc377584cd50e52e1576aa3a9b">sf::Ftp::login</a></div><div class="ttdeci">Response login()</div><div class="ttdoc">Log in using an anonymous account.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_a79c654fcdd0c81e68c4fa29af3b45e0c"><div class="ttname"><a href="#a79c654fcdd0c81e68c4fa29af3b45e0c">sf::Ftp::getWorkingDirectory</a></div><div class="ttdeci">DirectoryResponse getWorkingDirectory()</div><div class="ttdoc">Get the current working directory.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_acf7459926f3391cd06bf84337ed6a0f4"><div class="ttname"><a href="#acf7459926f3391cd06bf84337ed6a0f4">sf::Ftp::disconnect</a></div><div class="ttdeci">Response disconnect()</div><div class="ttdoc">Close the connection with the server.</div></div>
<div class="ttc" id="aclasssf_1_1Ftp_php_af02fb3de3f450a50a27981961c69c860"><div class="ttname"><a href="#af02fb3de3f450a50a27981961c69c860">sf::Ftp::connect</a></div><div class="ttdeci">Response connect(const IpAddress &amp;server, unsigned short port=21, Time timeout=Time::Zero)</div><div class="ttdoc">Connect to the specified FTP server.</div></div>
</div><!-- fragment --> 
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">enum <a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cb">sf::Ftp::TransferMode</a></td>
        </tr>
      </table>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a79c654fcdd0c81e68c4fa29af3b45e0c" title="Get the current working directory.">getWorkingDirectory</a>, <a class="el" href="#a8f37258e461fcb9e2a0655e9df0be4a0" title="Get the contents of the given directory.">getDirectoryListing</a>, <a class="el" href="#ad295cf77f30f9ad07b5c401fd9849189" title="Go to the parent directory of the current one.">parentDirectory</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>server</em></span>, </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype"><a class="el" href="classsf_1_1Time.php">Time</a></td>          <td class="paramname"><span class="paramname"><em>timeout</em></span><span class="paramdefsep"> = </span><span class="paramdefval"><a class="el" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0">Time::Zero</a></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#acf7459926f3391cd06bf84337ed6a0f4" title="Close the connection with the server.">disconnect</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a2a8a7ef9144204b5b319c9a4be8806c2" title="Remove an existing directory.">deleteDirectory</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a247b84c4b25da37804218c2b748c4787" title="Create a new directory.">createDirectory</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a8f99251d7153e1dc26723e4006deb764" title="Rename an existing file.">renameFile</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#af02fb3de3f450a50a27981961c69c860" title="Connect to the specified FTP server.">connect</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>remoteFile</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>localPath</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype"><a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cb">TransferMode</a></td>          <td class="paramname"><span class="paramname"><em>mode</em></span><span class="paramdefsep"> = </span><span class="paramdefval"><a class="el" href="#a1cd6b89ad23253f6d97e6d4ca4d558cba6f253b362639fb5e059dc292762a21ee">Binary</a></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a0402d2cec27a197ffba34c88ffaddeac" title="Upload a file to the server.">upload</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a79c654fcdd0c81e68c4fa29af3b45e0c" title="Get the current working directory.">getWorkingDirectory</a>, <a class="el" href="#a7e93488ea6330dd4dd76e428da9bb6d3" title="Change the current working directory.">changeDirectory</a>, <a class="el" href="#ad295cf77f30f9ad07b5c401fd9849189" title="Go to the parent directory of the current one.">parentDirectory</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a8f37258e461fcb9e2a0655e9df0be4a0" title="Get the contents of the given directory.">getDirectoryListing</a>, <a class="el" href="#a7e93488ea6330dd4dd76e428da9bb6d3" title="Change the current working directory.">changeDirectory</a>, <a class="el" href="#ad295cf77f30f9ad07b5c401fd9849189" title="Go to the parent directory of the current one.">parentDirectory</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a79c654fcdd0c81e68c4fa29af3b45e0c" title="Get the current working directory.">getWorkingDirectory</a>, <a class="el" href="#a8f37258e461fcb9e2a0655e9df0be4a0" title="Get the contents of the given directory.">getDirectoryListing</a>, <a class="el" href="#a7e93488ea6330dd4dd76e428da9bb6d3" title="Change the current working directory.">changeDirectory</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>newName</em></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a8aa272b0eb7769a850006e70fcad370f" title="Remove an existing file.">deleteFile</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>localFile</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>remotePath</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
...
<dl class="section return"><dt>Returns</dt><dd>Server response to the request</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a20c1600ec5fd6f5a2ad1429ab8aa5df4" title="Download a file from the server.">download</a> </dd></dl>
