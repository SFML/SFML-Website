...
<tr class="memitem:a741959c5158aeb1e4457cad47d90f76b" id="r_a741959c5158aeb1e4457cad47d90f76b"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a741959c5158aeb1e4457cad47d90f76b">SocketSelector</a> ()</td></tr>
...
<tr class="memitem:a50b1b955eb7ecb2e7c2764f3f4722fbf" id="r_a50b1b955eb7ecb2e7c2764f3f4722fbf"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a50b1b955eb7ecb2e7c2764f3f4722fbf">SocketSelector</a> (const <a class="el" href="classsf_1_1SocketSelector.php">SocketSelector</a> &amp;copy)</td></tr>
...
<tr class="memitem:a9069cd61208260b8ed9cf233afa1f73d" id="r_a9069cd61208260b8ed9cf233afa1f73d"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a9069cd61208260b8ed9cf233afa1f73d">~SocketSelector</a> ()</td></tr>
...
<tr class="memitem:ade952013232802ff7b9b33668f8d2096" id="r_ade952013232802ff7b9b33668f8d2096"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ade952013232802ff7b9b33668f8d2096">add</a> (<a class="el" href="classsf_1_1Socket.php">Socket</a> &amp;socket)</td></tr>
...
<tr class="memitem:a98b6ab693a65b82caa375639232357c1" id="r_a98b6ab693a65b82caa375639232357c1"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a98b6ab693a65b82caa375639232357c1">remove</a> (<a class="el" href="classsf_1_1Socket.php">Socket</a> &amp;socket)</td></tr>
...
<tr class="memitem:a76e650acb0199d4be91e90a493fbc91a" id="r_a76e650acb0199d4be91e90a493fbc91a"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a76e650acb0199d4be91e90a493fbc91a">clear</a> ()</td></tr>
...
<tr class="memitem:a9cfda5475f17925e65889394d70af702" id="r_a9cfda5475f17925e65889394d70af702"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a9cfda5475f17925e65889394d70af702">wait</a> (<a class="el" href="classsf_1_1Time.php">Time</a> timeout=<a class="el" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0">Time::Zero</a>)</td></tr>
...
<tr class="memitem:a917a4bac708290a6782e6686fd3bf889" id="r_a917a4bac708290a6782e6686fd3bf889"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a917a4bac708290a6782e6686fd3bf889">isReady</a> (<a class="el" href="classsf_1_1Socket.php">Socket</a> &amp;socket) const</td></tr>
...
<tr class="memitem:af7247f1c8badd43932f3adcbc1fec7e8" id="r_af7247f1c8badd43932f3adcbc1fec7e8"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1SocketSelector.php">SocketSelector</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af7247f1c8badd43932f3adcbc1fec7e8">operator=</a> (const <a class="el" href="classsf_1_1SocketSelector.php">SocketSelector</a> &amp;right)</td></tr>
...
<div class="line">selector.<a class="code hl_function" href="#ade952013232802ff7b9b33668f8d2096">add</a>(listener);</div>
<div class="line"> </div>
...
<div class="line">    <span class="keywordflow">if</span> (selector.<a class="code hl_function" href="#a9cfda5475f17925e65889394d70af702">wait</a>())</div>
<div class="line">    {</div>
<div class="line">        <span class="comment">// Test the listener</span></div>
<div class="line">        <span class="keywordflow">if</span> (selector.<a class="code hl_function" href="#a917a4bac708290a6782e6686fd3bf889">isReady</a>(listener))</div>
<div class="line">        {</div>
...
<div class="line">                selector.<a class="code hl_function" href="#ade952013232802ff7b9b33668f8d2096">add</a>(*client);</div>
<div class="line">            }</div>
...
<div class="line">                <span class="keywordflow">if</span> (selector.<a class="code hl_function" href="#a917a4bac708290a6782e6686fd3bf889">isReady</a>(client))</div>
<div class="line">                {</div>
...
<div class="ttc" id="aclasssf_1_1SocketSelector_php_a917a4bac708290a6782e6686fd3bf889"><div class="ttname"><a href="#a917a4bac708290a6782e6686fd3bf889">sf::SocketSelector::isReady</a></div><div class="ttdeci">bool isReady(Socket &amp;socket) const</div><div class="ttdoc">Test a socket to know if it is ready to receive data.</div></div>
<div class="ttc" id="aclasssf_1_1SocketSelector_php_a9cfda5475f17925e65889394d70af702"><div class="ttname"><a href="#a9cfda5475f17925e65889394d70af702">sf::SocketSelector::wait</a></div><div class="ttdeci">bool wait(Time timeout=Time::Zero)</div><div class="ttdoc">Wait until one or more sockets are ready to receive.</div></div>
<div class="ttc" id="aclasssf_1_1SocketSelector_php_ade952013232802ff7b9b33668f8d2096"><div class="ttname"><a href="#ade952013232802ff7b9b33668f8d2096">sf::SocketSelector::add</a></div><div class="ttdeci">void add(Socket &amp;socket)</div><div class="ttdoc">Add a new socket to the selector.</div></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">sf::SocketSelector::SocketSelector </td>
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1SocketSelector.php">SocketSelector</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>copy</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="classsf_1_1Socket.php">Socket</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>socket</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a98b6ab693a65b82caa375639232357c1" title="Remove a socket from the selector.">remove</a>, <a class="el" href="#a76e650acb0199d4be91e90a493fbc91a" title="Remove all the sockets stored in the selector.">clear</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ade952013232802ff7b9b33668f8d2096" title="Add a new socket to the selector.">add</a>, <a class="el" href="#a98b6ab693a65b82caa375639232357c1" title="Remove a socket from the selector.">remove</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a917a4bac708290a6782e6686fd3bf889" title="Test a socket to know if it is ready to receive data.">isReady</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1SocketSelector.php">SocketSelector</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>right</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ade952013232802ff7b9b33668f8d2096" title="Add a new socket to the selector.">add</a>, <a class="el" href="#a76e650acb0199d4be91e90a493fbc91a" title="Remove all the sockets stored in the selector.">clear</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="classsf_1_1Time.php">Time</a></td>          <td class="paramname"><span class="paramname"><em>timeout</em></span><span class="paramdefsep"> = </span><span class="paramdefval"><a class="el" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0">Time::Zero</a></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
