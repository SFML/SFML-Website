...
<a href="classsf_1_1Http-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::Http Class Reference<div class="ingroups"><a class="el" href="group__network.php">Network module</a></div></div></div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:abe2360194f99bdde402c9f97a85cf067" id="r_abe2360194f99bdde402c9f97a85cf067"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#abe2360194f99bdde402c9f97a85cf067">Http</a> ()</td></tr>
...
<tr class="memitem:a79efd844a735f083fcce0edbf1092385" id="r_a79efd844a735f083fcce0edbf1092385"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a79efd844a735f083fcce0edbf1092385">Http</a> (const std::string &amp;host, unsigned short port=0)</td></tr>
...
<tr class="memitem:a55121d543b61c41cf20b885a97b04e65" id="r_a55121d543b61c41cf20b885a97b04e65"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a55121d543b61c41cf20b885a97b04e65">setHost</a> (const std::string &amp;host, unsigned short port=0)</td></tr>
...
<tr class="memitem:aaf09ebfb5e00dcc82e0d494d5c6a9e2a" id="r_aaf09ebfb5e00dcc82e0d494d5c6a9e2a"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Http_1_1Response.php">Response</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">sendRequest</a> (const <a class="el" href="classsf_1_1Http_1_1Request.php">Request</a> &amp;request, <a class="el" href="classsf_1_1Time.php">Time</a> timeout=<a class="el" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0">Time::Zero</a>)</td></tr>
...
<div class="line"><a class="code hl_class" href="classsf_1_1Http.php">sf::Http</a> http;</div>
<div class="line"> </div>
<div class="line"><span class="comment">// We&#39;ll work on http://www.sfml-dev.org</span></div>
<div class="line">http.<a class="code hl_function" href="#a55121d543b61c41cf20b885a97b04e65">setHost</a>(<span class="stringliteral">&quot;http://www.sfml-dev.org&quot;</span>);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Prepare a request to get the &#39;features.php&#39; page</span></div>
<div class="line"><a class="code hl_class" href="classsf_1_1Http_1_1Request.php">sf::Http::Request</a> request(<span class="stringliteral">&quot;features.php&quot;</span>);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Send the request</span></div>
<div class="line"><a class="code hl_class" href="classsf_1_1Http_1_1Response.php">sf::Http::Response</a> response = http.<a class="code hl_function" href="#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">sendRequest</a>(request);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Check the status code and display the result</span></div>
<div class="line"><a class="code hl_enumeration" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8">sf::Http::Response::Status</a> status = response.<a class="code hl_function" href="classsf_1_1Http_1_1Response.php#a4271651703764fd9a7d2c0315aff20de">getStatus</a>();</div>
<div class="line"><span class="keywordflow">if</span> (status == <a class="code hl_enumvalue" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0158f932254d3f09647dd1f64bd43832">sf::Http::Response::Ok</a>)</div>
<div class="line">{</div>
<div class="line">    std::cout &lt;&lt; response.<a class="code hl_function" href="classsf_1_1Http_1_1Response.php#ac59e2b11cae4b6232c737547a3ca9850">getBody</a>() &lt;&lt; std::endl;</div>
<div class="line">}</div>
...
<div class="ttc" id="aclasssf_1_1Http_1_1Response_php_a663e071978e30fbbeb20ed045be874d8a0158f932254d3f09647dd1f64bd43832"><div class="ttname"><a href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0158f932254d3f09647dd1f64bd43832">sf::Http::Response::Ok</a></div><div class="ttdeci">@ Ok</div><div class="ttdoc">Most common code returned when operation was successful.</div><div class="ttdef"><b>Definition</b> <a href="Http_8hpp_source.php#l00204">Http.hpp:204</a></div></div>
...
<div class="ttc" id="aclasssf_1_1Http_php_a55121d543b61c41cf20b885a97b04e65"><div class="ttname"><a href="#a55121d543b61c41cf20b885a97b04e65">sf::Http::setHost</a></div><div class="ttdeci">void setHost(const std::string &amp;host, unsigned short port=0)</div><div class="ttdoc">Set the target host.</div></div>
<div class="ttc" id="aclasssf_1_1Http_php_aaf09ebfb5e00dcc82e0d494d5c6a9e2a"><div class="ttname"><a href="#aaf09ebfb5e00dcc82e0d494d5c6a9e2a">sf::Http::sendRequest</a></div><div class="ttdeci">Response sendRequest(const Request &amp;request, Time timeout=Time::Zero)</div><div class="ttdoc">Send a HTTP request and return the server's response.</div></div>
</div><!-- fragment --> 
<p class="definition">Definition at line <a class="el" href="Http_8hpp_source.php#l00046">46</a> of file <a class="el" href="Http_8hpp_source.php">Http.hpp</a>.</p>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          ...
          <td></td>
          <td class="paramtype">unsigned short</td>          <td class="paramname"><span class="paramname"><em>port</em></span><span class="paramdefsep"> = </span><span class="paramdefval">0</span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1Http_1_1Request.php">Request</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>request</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
