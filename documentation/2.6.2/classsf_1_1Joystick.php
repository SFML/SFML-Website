...
<tr class="memitem:aee00dd432eacd8369d279b47c3ab4cc5" id="r_aee00dd432eacd8369d279b47c3ab4cc5"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom">{ <a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5a6e0a2a95bc1da277610c04d80f52715e">Count</a> = 8
, <a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5a2f1b8a0a59f2c12a4775c0e1e69e1816">ButtonCount</a> = 32
, <a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5accf3e487c9f6ee2f384351323626a42c">AxisCount</a> = 8
 }</td></tr>
<tr class="memdesc:aee00dd432eacd8369d279b47c3ab4cc5"><td class="mdescLeft">&#160;</td><td class="mdescRight">Constants related to joysticks capabilities.  <a href="#aee00dd432eacd8369d279b47c3ab4cc5">More...</a><br /></td></tr>
<tr class="separator:aee00dd432eacd8369d279b47c3ab4cc5"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a48db337092c2e263774f94de6d50baa7" id="r_a48db337092c2e263774f94de6d50baa7"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a48db337092c2e263774f94de6d50baa7">Axis</a> { <br />
&#160;&#160;<a class="el" href="#a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e">X</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce">Y</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7a7c37a1240b2dafbbfc5c1a0e23911315">Z</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7aeebbcdb0828850f4d69e6a084801fab8">R</a>
, <br />
&#160;&#160;<a class="el" href="#a48db337092c2e263774f94de6d50baa7a0a901f61e75292dd2f642b6e4f33a214">U</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7aa2e2c8ffa1837e7911ee0c7d045bf8f4">V</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7a06420f7714e4dfd8b841885a0b5f3954">PovX</a>
, <a class="el" href="#a48db337092c2e263774f94de6d50baa7a0f8ffb2dcddf91b98ab910a4f8327ad9">PovY</a>
<br />
 }</td></tr>
...
<tr class="memitem:ac7d4e1923e9f9420174f26703ea63d6c" id="r_ac7d4e1923e9f9420174f26703ea63d6c"><td class="memItemLeft" align="right" valign="top">static bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ac7d4e1923e9f9420174f26703ea63d6c">isConnected</a> (unsigned int joystick)</td></tr>
...
<tr class="memitem:a4de9f445c6582bfe9f0873f695682885" id="r_a4de9f445c6582bfe9f0873f695682885"><td class="memItemLeft" align="right" valign="top">static unsigned int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a4de9f445c6582bfe9f0873f695682885">getButtonCount</a> (unsigned int joystick)</td></tr>
...
<tr class="memitem:a268e8f2a11ae6af4a47c727cb4ab4d95" id="r_a268e8f2a11ae6af4a47c727cb4ab4d95"><td class="memItemLeft" align="right" valign="top">static bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a268e8f2a11ae6af4a47c727cb4ab4d95">hasAxis</a> (unsigned int joystick, <a class="el" href="#a48db337092c2e263774f94de6d50baa7">Axis</a> axis)</td></tr>
...
<tr class="memitem:ae0d97a4b84268cbe6a7078e1b2717835" id="r_ae0d97a4b84268cbe6a7078e1b2717835"><td class="memItemLeft" align="right" valign="top">static bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ae0d97a4b84268cbe6a7078e1b2717835">isButtonPressed</a> (unsigned int joystick, unsigned int button)</td></tr>
...
<tr class="memitem:aea4930193331df1851b709f3060ba58b" id="r_aea4930193331df1851b709f3060ba58b"><td class="memItemLeft" align="right" valign="top">static float&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aea4930193331df1851b709f3060ba58b">getAxisPosition</a> (unsigned int joystick, <a class="el" href="#a48db337092c2e263774f94de6d50baa7">Axis</a> axis)</td></tr>
...
<tr class="memitem:aa917c9435330e6e0368d3893672d1b74" id="r_aa917c9435330e6e0368d3893672d1b74"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="structsf_1_1Joystick_1_1Identification.php">Identification</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aa917c9435330e6e0368d3893672d1b74">getIdentification</a> (unsigned int joystick)</td></tr>
...
<tr class="memitem:ab85fa9175b4edd3e5a07ee3cde0b0f48" id="r_ab85fa9175b4edd3e5a07ee3cde0b0f48"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ab85fa9175b4edd3e5a07ee3cde0b0f48">update</a> ()</td></tr>
...
<li>8 joysticks (<a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5a6e0a2a95bc1da277610c04d80f52715e" title="Maximum number of supported joysticks.">sf::Joystick::Count</a>) </li>
<li>32 buttons per joystick (<a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5a2f1b8a0a59f2c12a4775c0e1e69e1816" title="Maximum number of supported buttons.">sf::Joystick::ButtonCount</a>) </li>
<li>8 axes per joystick (<a class="el" href="#aee00dd432eacd8369d279b47c3ab4cc5accf3e487c9f6ee2f384351323626a42c" title="Maximum number of supported axes.">sf::Joystick::AxisCount</a>)</li>
</ul>
<p>Unlike the keyboard or mouse, the state of joysticks is sometimes not directly available (depending on the OS), therefore an <a class="el" href="#ab85fa9175b4edd3e5a07ee3cde0b0f48" title="Update the states of all joysticks.">update()</a> function must be called in order to update the current state of joysticks. When you have a window with event handling, this is done automatically, you don't need to call anything. But if you have no window, or if you want to check joysticks state before creating one, you must call <a class="el" href="#ab85fa9175b4edd3e5a07ee3cde0b0f48" title="Update the states of all joysticks.">sf::Joystick::update</a> explicitly.</p>
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Is joystick #0 connected?</span></div>
<div class="line"><span class="keywordtype">bool</span> connected = <a class="code hl_function" href="#ac7d4e1923e9f9420174f26703ea63d6c">sf::Joystick::isConnected</a>(0);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// How many buttons does joystick #0 support?</span></div>
<div class="line"><span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> buttons = <a class="code hl_function" href="#a4de9f445c6582bfe9f0873f695682885">sf::Joystick::getButtonCount</a>(0);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Does joystick #0 define a X axis?</span></div>
<div class="line"><span class="keywordtype">bool</span> hasX = <a class="code hl_function" href="#a268e8f2a11ae6af4a47c727cb4ab4d95">sf::Joystick::hasAxis</a>(0, <a class="code hl_enumvalue" href="#a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e">sf::Joystick::X</a>);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Is button #2 pressed on joystick #0?</span></div>
<div class="line"><span class="keywordtype">bool</span> pressed = <a class="code hl_function" href="#ae0d97a4b84268cbe6a7078e1b2717835">sf::Joystick::isButtonPressed</a>(0, 2);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// What&#39;s the current position of the Y axis on joystick #0?</span></div>
<div class="line"><span class="keywordtype">float</span> position = <a class="code hl_function" href="#aea4930193331df1851b709f3060ba58b">sf::Joystick::getAxisPosition</a>(0, <a class="code hl_enumvalue" href="#a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce">sf::Joystick::Y</a>);</div>
<div class="ttc" id="aclasssf_1_1Joystick_php_a268e8f2a11ae6af4a47c727cb4ab4d95"><div class="ttname"><a href="#a268e8f2a11ae6af4a47c727cb4ab4d95">sf::Joystick::hasAxis</a></div><div class="ttdeci">static bool hasAxis(unsigned int joystick, Axis axis)</div><div class="ttdoc">Check if a joystick supports a given axis.</div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce"><div class="ttname"><a href="#a48db337092c2e263774f94de6d50baa7a51ef1455f7511ad4a78ba241d66593ce">sf::Joystick::Y</a></div><div class="ttdeci">@ Y</div><div class="ttdoc">The Y axis.</div><div class="ttdef"><b>Definition</b> <a href="Joystick_8hpp_source.php#l00063">Joystick.hpp:63</a></div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e"><div class="ttname"><a href="#a48db337092c2e263774f94de6d50baa7a95dc8b9bf7b0a2157fc67891c54c401e">sf::Joystick::X</a></div><div class="ttdeci">@ X</div><div class="ttdoc">The X axis.</div><div class="ttdef"><b>Definition</b> <a href="Joystick_8hpp_source.php#l00062">Joystick.hpp:62</a></div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_a4de9f445c6582bfe9f0873f695682885"><div class="ttname"><a href="#a4de9f445c6582bfe9f0873f695682885">sf::Joystick::getButtonCount</a></div><div class="ttdeci">static unsigned int getButtonCount(unsigned int joystick)</div><div class="ttdoc">Return the number of buttons supported by a joystick.</div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_ac7d4e1923e9f9420174f26703ea63d6c"><div class="ttname"><a href="#ac7d4e1923e9f9420174f26703ea63d6c">sf::Joystick::isConnected</a></div><div class="ttdeci">static bool isConnected(unsigned int joystick)</div><div class="ttdoc">Check if a joystick is connected.</div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_ae0d97a4b84268cbe6a7078e1b2717835"><div class="ttname"><a href="#ae0d97a4b84268cbe6a7078e1b2717835">sf::Joystick::isButtonPressed</a></div><div class="ttdeci">static bool isButtonPressed(unsigned int joystick, unsigned int button)</div><div class="ttdoc">Check if a joystick button is pressed.</div></div>
<div class="ttc" id="aclasssf_1_1Joystick_php_aea4930193331df1851b709f3060ba58b"><div class="ttname"><a href="#aea4930193331df1851b709f3060ba58b">sf::Joystick::getAxisPosition</a></div><div class="ttdeci">static float getAxisPosition(unsigned int joystick, Axis axis)</div><div class="ttdoc">Get the current position of a joystick axis.</div></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">enum <a class="el" href="#a48db337092c2e263774f94de6d50baa7">sf::Joystick::Axis</a></td>
        </tr>
      </table>
</div><div class="memdoc">
