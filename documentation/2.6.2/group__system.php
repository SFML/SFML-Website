...
Functions</h2></td></tr>
<tr class="memitem:ga666414341ce8396227f5a125ee5b7053" id="r_ga666414341ce8396227f5a125ee5b7053"><td class="memItemLeft" align="right" valign="top">ANativeActivity *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ga666414341ce8396227f5a125ee5b7053">sf::getNativeActivity</a> ()</td></tr>
...
<tr class="memitem:gab8c0d1f966b4e5110fd370b662d8c11b" id="r_gab8c0d1f966b4e5110fd370b662d8c11b"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#gab8c0d1f966b4e5110fd370b662d8c11b">sf::sleep</a> (<a class="el" href="classsf_1_1Time.php">Time</a> duration)</td></tr>
...
<tr class="memitem:ga885486205a724571d140a7c8a0e3626b" id="r_ga885486205a724571d140a7c8a0e3626b"><td class="memItemLeft" align="right" valign="top">std::ostream &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ga885486205a724571d140a7c8a0e3626b">sf::err</a> ()</td></tr>
...
<p>Base module of SFML, defining various utilities. It provides vector classes, Unicode strings and conversion functions, threads and mutexes, timing classes. </p>
<h2 class="groupheader">Function Documentation</h2>
<a id="ga885486205a724571d140a7c8a0e3626b" name="ga885486205a724571d140a7c8a0e3626b"></a>
<h2 class="memtitle"><span class="permalink"><a href="#ga885486205a724571d140a7c8a0e3626b">&#9670;&#160;</a></span>err()</h2>

<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">std::ostream &amp; sf::err </td>
          <td>(</td>
...
<p>By default, <a class="el" href="#ga885486205a724571d140a7c8a0e3626b" title="Standard stream used by SFML to output warnings and errors.">sf::err()</a> outputs to the same location as std::cerr, (-&gt; the stderr descriptor) which is the console if there's one available.</p>
...
<p><a class="el" href="#ga885486205a724571d140a7c8a0e3626b" title="Standard stream used by SFML to output warnings and errors.">sf::err()</a> can be redirected to write to another output, independently of std::cerr, by using the rdbuf() function provided by the std::ostream class.</p>
...
<div class="line">std::streambuf* previous = <a class="code hl_function" href="#ga885486205a724571d140a7c8a0e3626b">sf::err</a>().rdbuf(file.rdbuf());</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Redirect to nothing</span></div>
<div class="line"><a class="code hl_function" href="#ga885486205a724571d140a7c8a0e3626b">sf::err</a>().rdbuf(NULL);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Restore the original output</span></div>
<div class="line"><a class="code hl_function" href="#ga885486205a724571d140a7c8a0e3626b">sf::err</a>().rdbuf(previous);</div>
<div class="ttc" id="agroup__system_php_ga885486205a724571d140a7c8a0e3626b"><div class="ttname"><a href="#ga885486205a724571d140a7c8a0e3626b">sf::err</a></div><div class="ttdeci">std::ostream &amp; err()</div><div class="ttdoc">Standard stream used by SFML to output warnings and errors.</div></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="classsf_1_1Time.php">Time</a></td>          <td class="paramname"><span class="paramname"><em>duration</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<p><a class="el" href="#gab8c0d1f966b4e5110fd370b662d8c11b" title="Make the current thread sleep for a given duration.">sf::sleep</a> is the best way to block a program or one of its threads, as it doesn't consume any CPU power.</p>
