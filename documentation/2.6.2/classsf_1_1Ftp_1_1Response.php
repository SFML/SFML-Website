...
<a href="classsf_1_1Ftp_1_1Response-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::Ftp::Response Class Reference</div></div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:af81738f06b6f571761696291276acb3b" id="r_af81738f06b6f571761696291276acb3b"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af81738f06b6f571761696291276acb3b">Status</a> { <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba07e06d3326ba2d078583bef93930d909">RestartMarkerReply</a> = 110
, <a class="el" href="#af81738f06b6f571761696291276acb3ba22413357ade6b586f6ceb0d704f35075">ServiceReadySoon</a> = 120
, <a class="el" href="#af81738f06b6f571761696291276acb3bafa52d19bc813d69055f4cc390d4a76ca">DataConnectionAlreadyOpened</a> = 125
, <a class="el" href="#af81738f06b6f571761696291276acb3ba794ebe743688be611447638bf9e49d86">OpeningDataConnection</a> = 150
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3baa956e229ba6c0cdf0d88b0e05b286210">Ok</a> = 200
, <a class="el" href="#af81738f06b6f571761696291276acb3ba38adc424f1adcd332745de8cd3b7737a">PointlessCommand</a> = 202
, <a class="el" href="#af81738f06b6f571761696291276acb3ba9bdd02ae119b8be639e778859ee74060">SystemStatus</a> = 211
, <a class="el" href="#af81738f06b6f571761696291276acb3ba8729460a695013cc96330e2fced0ae1f">DirectoryStatus</a> = 212
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3baebddfc7997dca289c83068dff3f47dce">FileStatus</a> = 213
, <a class="el" href="#af81738f06b6f571761696291276acb3ba840fd2a1872fd4310b046541f57fdeb7">HelpMessage</a> = 214
, <a class="el" href="#af81738f06b6f571761696291276acb3ba78391f73aa11f07f1514c7d070b93c08">SystemType</a> = 215
, <a class="el" href="#af81738f06b6f571761696291276acb3baea2ee2007d7843c21108bb686ef03757">ServiceReady</a> = 220
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3bab23931490fc2d1df3081d651fe0f4d6e">ClosingConnection</a> = 221
, <a class="el" href="#af81738f06b6f571761696291276acb3badc78ed87d5bddb174fa3c16707ac2f2d">DataConnectionOpened</a> = 225
, <a class="el" href="#af81738f06b6f571761696291276acb3bac723ebc8a38913bbf0d9504556cbaaa6">ClosingDataConnection</a> = 226
, <a class="el" href="#af81738f06b6f571761696291276acb3ba48314fc47a72ad0aacdea93b91756f6e">EnteringPassiveMode</a> = 227
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba54a88210386cb72e35d737813a221754">LoggedIn</a> = 230
, <a class="el" href="#af81738f06b6f571761696291276acb3baf988b69b0a5f55f8122da5ba001932e0">FileActionOk</a> = 250
, <a class="el" href="#af81738f06b6f571761696291276acb3ba06d26e95a170fc422af13def415e0437">DirectoryOk</a> = 257
, <a class="el" href="#af81738f06b6f571761696291276acb3ba9249e3fe9818eb93f181fbbf3ae3bc56">NeedPassword</a> = 331
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba9e048185f253f6eb6f5ff9e063b712fa">NeedAccountToLogIn</a> = 332
, <a class="el" href="#af81738f06b6f571761696291276acb3ba02e6f05964ecb829e9b6fb6020d6528a">NeedInformation</a> = 350
, <a class="el" href="#af81738f06b6f571761696291276acb3ba43022ddf49b68a4f5aff0bea7e09e89f">ServiceUnavailable</a> = 421
, <a class="el" href="#af81738f06b6f571761696291276acb3ba757b89ff1f236941f7759b0ed0c28b88">DataConnectionUnavailable</a> = 425
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba7cfefcc586c12ba70f752353fde7126e">TransferAborted</a> = 426
, <a class="el" href="#af81738f06b6f571761696291276acb3baf822d1b0abf3e9ae7dd44684549d512d">FileActionAborted</a> = 450
, <a class="el" href="#af81738f06b6f571761696291276acb3bae54e84baaca95a7b36271ca3f3fdb900">LocalError</a> = 451
, <a class="el" href="#af81738f06b6f571761696291276acb3ba5d9f3666222c808553c27e4e099c7c6d">InsufficientStorageSpace</a> = 452
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba75bdf0b6844fa9c07b3c25647d22c269">CommandUnknown</a> = 500
, <a class="el" href="#af81738f06b6f571761696291276acb3baf4c7c88815981bbb7c3a3461f9f48b67">ParametersUnknown</a> = 501
, <a class="el" href="#af81738f06b6f571761696291276acb3ba2ca4834c756c81b924ebed696fcba0a8">CommandNotImplemented</a> = 502
, <a class="el" href="#af81738f06b6f571761696291276acb3bad0c7ab07f01c1f7af16a1852650d7c47">BadCommandSequence</a> = 503
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba8807473b8590e1debfb3740b7a3d081c">ParameterNotImplemented</a> = 504
, <a class="el" href="#af81738f06b6f571761696291276acb3bafcfbaff2c6fed941b6bcbc0999db764e">NotLoggedIn</a> = 530
, <a class="el" href="#af81738f06b6f571761696291276acb3ba1af0f173062a471739b50d8e0f40d5f7">NeedAccountToStore</a> = 532
, <a class="el" href="#af81738f06b6f571761696291276acb3ba3f8f931e499936fde6b750d81f5ecfef">FileUnavailable</a> = 550
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3bad220bc12dc45593af6e5079ea6c532c3">PageTypeUnknown</a> = 551
, <a class="el" href="#af81738f06b6f571761696291276acb3baf418e54753e0b8f9cb0325dd618acd14">NotEnoughMemory</a> = 552
, <a class="el" href="#af81738f06b6f571761696291276acb3ba03254aba823298179a98056e15568c5b">FilenameNotAllowed</a> = 553
, <a class="el" href="#af81738f06b6f571761696291276acb3ba59e041e4ef186e8ae8d6035973fc46bd">InvalidResponse</a> = 1000
, <br />
&#160;&#160;<a class="el" href="#af81738f06b6f571761696291276acb3ba51aa367cc1e85a45ea3c7be48730e990">ConnectionFailed</a> = 1001
, <a class="el" href="#af81738f06b6f571761696291276acb3bad1e5dcf298ce30c528261435f1a2eb53">ConnectionClosed</a> = 1002
, <a class="el" href="#af81738f06b6f571761696291276acb3baed2c74a9f335dee1463ca1a4f41c6478">InvalidFile</a> = 1003
<br />
 }</td></tr>
<tr class="memdesc:af81738f06b6f571761696291276acb3b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Status codes possibly returned by a FTP response.  <a href="#af81738f06b6f571761696291276acb3b">More...</a><br /></td></tr>
<tr class="separator:af81738f06b6f571761696291276acb3b"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table><table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a id="pub-methods" name="pub-methods"></a>
Public Member Functions</h2></td></tr>
<tr class="memitem:af300fffd4862774102f978eb22f85d9b" id="r_af300fffd4862774102f978eb22f85d9b"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af300fffd4862774102f978eb22f85d9b">Response</a> (<a class="el" href="#af81738f06b6f571761696291276acb3b">Status</a> code=<a class="el" href="#af81738f06b6f571761696291276acb3ba59e041e4ef186e8ae8d6035973fc46bd">InvalidResponse</a>, const std::string &amp;message=&quot;&quot;)</td></tr>
<tr class="memdesc:af300fffd4862774102f978eb22f85d9b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Default constructor.  <br /></td></tr>
<tr class="separator:af300fffd4862774102f978eb22f85d9b"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a5102552955a2652c1a39e9046e617b36" id="r_a5102552955a2652c1a39e9046e617b36"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a5102552955a2652c1a39e9046e617b36">isOk</a> () const</td></tr>
...
<tr class="memitem:a52bbca9fbf5451157bc055e3d8430c25" id="r_a52bbca9fbf5451157bc055e3d8430c25"><td class="memItemLeft" align="right" valign="top"><a class="el" href="#af81738f06b6f571761696291276acb3b">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a52bbca9fbf5451157bc055e3d8430c25">getStatus</a> () const</td></tr>
...
<tr class="memitem:adc2890c93c9f8ee997b828fcbef82c97" id="r_adc2890c93c9f8ee997b828fcbef82c97"><td class="memItemLeft" align="right" valign="top">const std::string &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#adc2890c93c9f8ee997b828fcbef82c97">getMessage</a> () const</td></tr>
...
<p class="definition">Definition at line <a class="el" href="Ftp_8hpp_source.php#l00066">66</a> of file <a class="el" href="Ftp_8hpp_source.php">Ftp.hpp</a>.</p>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">enum <a class="el" href="#af81738f06b6f571761696291276acb3b">sf::Ftp::Response::Status</a></td>
        </tr>
      </table>
...
<a id="af300fffd4862774102f978eb22f85d9b" name="af300fffd4862774102f978eb22f85d9b"></a>
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="#af81738f06b6f571761696291276acb3b">Status</a></td>          <td class="paramname"><span class="paramname"><em>code</em></span><span class="paramdefsep"> = </span><span class="paramdefval"><a class="el" href="#af81738f06b6f571761696291276acb3ba59e041e4ef186e8ae8d6035973fc46bd">InvalidResponse</a></span>, </td>
        </tr>
        <tr>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"><a class="el" href="#af81738f06b6f571761696291276acb3b">Status</a> sf::Ftp::Response::getStatus </td>
          <td>(</td>
          <td class="paramname"><span class="paramname"><em></em></span></td><td>)</td>
          <td> const</td>
        </tr>
