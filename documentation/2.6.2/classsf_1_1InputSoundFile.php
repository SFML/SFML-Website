...
<tr class="memitem:a3b95347de25d1d93a3230287cf47a077" id="r_a3b95347de25d1d93a3230287cf47a077"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a3b95347de25d1d93a3230287cf47a077">InputSoundFile</a> ()</td></tr>
...
<tr class="memitem:a326a1a486587038123de0c187bf5c635" id="r_a326a1a486587038123de0c187bf5c635"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a326a1a486587038123de0c187bf5c635">~InputSoundFile</a> ()</td></tr>
...
<tr class="memitem:af68e54bc9bfac19554c84601156fe93f" id="r_af68e54bc9bfac19554c84601156fe93f"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af68e54bc9bfac19554c84601156fe93f">openFromFile</a> (const std::string &amp;filename)</td></tr>
...
<tr class="memitem:a665b7fed6cdca3e0c622909e5a6655e4" id="r_a665b7fed6cdca3e0c622909e5a6655e4"><td class="memItemLeft" align="right" valign="top">Uint64&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a665b7fed6cdca3e0c622909e5a6655e4">getSampleCount</a> () const</td></tr>
...
<tr class="memitem:aa081bd4d9732408d10b48227a360778e" id="r_aa081bd4d9732408d10b48227a360778e"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Time.php">Time</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aa081bd4d9732408d10b48227a360778e">getDuration</a> () const</td></tr>
...
<tr class="memitem:ad1a2238acb734d8b1144ecd75cccc2e7" id="r_ad1a2238acb734d8b1144ecd75cccc2e7"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Time.php">Time</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ad1a2238acb734d8b1144ecd75cccc2e7">getTimeOffset</a> () const</td></tr>
...
<tr class="memitem:a73a99f159e8aca6e39478f6cf686d7ad" id="r_a73a99f159e8aca6e39478f6cf686d7ad"><td class="memItemLeft" align="right" valign="top">Uint64&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a73a99f159e8aca6e39478f6cf686d7ad">getSampleOffset</a> () const</td></tr>
...
<tr class="memitem:aaf97be15020a42e159ff88f76f22af20" id="r_aaf97be15020a42e159ff88f76f22af20"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aaf97be15020a42e159ff88f76f22af20">seek</a> (Uint64 sampleOffset)</td></tr>
...
<tr class="memitem:a8eee7af58ad75ddc61f93ad72e2d66c1" id="r_a8eee7af58ad75ddc61f93ad72e2d66c1"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a8eee7af58ad75ddc61f93ad72e2d66c1">seek</a> (<a class="el" href="classsf_1_1Time.php">Time</a> timeOffset)</td></tr>
...
<tr class="memitem:a83d6f64617456601edeb0daf9d14a17f" id="r_a83d6f64617456601edeb0daf9d14a17f"><td class="memItemLeft" align="right" valign="top">Uint64&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a83d6f64617456601edeb0daf9d14a17f">read</a> (Int16 *samples, Uint64 maxCount)</td></tr>
...
<div class="line"><span class="keywordflow">if</span> (!file.<a class="code hl_function" href="#af68e54bc9bfac19554c84601156fe93f">openFromFile</a>(<span class="stringliteral">&quot;music.ogg&quot;</span>))</div>
<div class="line">    <span class="comment">/* error */</span>;</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Print the sound attributes</span></div>
<div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;duration: &quot;</span> &lt;&lt; file.<a class="code hl_function" href="#aa081bd4d9732408d10b48227a360778e">getDuration</a>().<a class="code hl_function" href="classsf_1_1Time.php#aa3df2f992d0b0041b4eb02258d43f0e3">asSeconds</a>() &lt;&lt; std::endl;</div>
<div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;channels: &quot;</span> &lt;&lt; file.<a class="code hl_function" href="#a54307c308ba05dea63aba54a29c804a4">getChannelCount</a>() &lt;&lt; std::endl;</div>
<div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;sample rate: &quot;</span> &lt;&lt; file.<a class="code hl_function" href="#a6b8177e40dd8020752f6d52f96b774c3">getSampleRate</a>() &lt;&lt; std::endl;</div>
<div class="line">std::cout &lt;&lt; <span class="stringliteral">&quot;sample count: &quot;</span> &lt;&lt; file.<a class="code hl_function" href="#a665b7fed6cdca3e0c622909e5a6655e4">getSampleCount</a>() &lt;&lt; std::endl;</div>
<div class="line"> </div>
...
<div class="line">{</div>
<div class="line">    count = file.<a class="code hl_function" href="#a83d6f64617456601edeb0daf9d14a17f">read</a>(samples, 1024);</div>
<div class="line"> </div>
...
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_a54307c308ba05dea63aba54a29c804a4"><div class="ttname"><a href="#a54307c308ba05dea63aba54a29c804a4">sf::InputSoundFile::getChannelCount</a></div><div class="ttdeci">unsigned int getChannelCount() const</div><div class="ttdoc">Get the number of channels used by the sound.</div></div>
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_a665b7fed6cdca3e0c622909e5a6655e4"><div class="ttname"><a href="#a665b7fed6cdca3e0c622909e5a6655e4">sf::InputSoundFile::getSampleCount</a></div><div class="ttdeci">Uint64 getSampleCount() const</div><div class="ttdoc">Get the total number of audio samples in the file.</div></div>
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_a6b8177e40dd8020752f6d52f96b774c3"><div class="ttname"><a href="#a6b8177e40dd8020752f6d52f96b774c3">sf::InputSoundFile::getSampleRate</a></div><div class="ttdeci">unsigned int getSampleRate() const</div><div class="ttdoc">Get the sample rate of the sound.</div></div>
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_a83d6f64617456601edeb0daf9d14a17f"><div class="ttname"><a href="#a83d6f64617456601edeb0daf9d14a17f">sf::InputSoundFile::read</a></div><div class="ttdeci">Uint64 read(Int16 *samples, Uint64 maxCount)</div><div class="ttdoc">Read audio samples from the open file.</div></div>
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_aa081bd4d9732408d10b48227a360778e"><div class="ttname"><a href="#aa081bd4d9732408d10b48227a360778e">sf::InputSoundFile::getDuration</a></div><div class="ttdeci">Time getDuration() const</div><div class="ttdoc">Get the total duration of the sound file.</div></div>
<div class="ttc" id="aclasssf_1_1InputSoundFile_php_af68e54bc9bfac19554c84601156fe93f"><div class="ttname"><a href="#af68e54bc9bfac19554c84601156fe93f">sf::InputSoundFile::openFromFile</a></div><div class="ttdeci">bool openFromFile(const std::string &amp;filename)</div><div class="ttdoc">Open a sound file from the disk for reading.</div></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">Int16 *</td>          <td class="paramname"><span class="paramname"><em>samples</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">Uint64</td>          <td class="paramname"><span class="paramname"><em>maxCount</em></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">void sf::InputSoundFile::seek </td>
          <td>(</td>
          <td class="paramtype">Uint64</td>          <td class="paramname"><span class="paramname"><em>sampleOffset</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
