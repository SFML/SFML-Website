...
<tr class="memitem:a59a1db5b6f4711a3e57390da2f8d9630" id="r_a59a1db5b6f4711a3e57390da2f8d9630"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a59a1db5b6f4711a3e57390da2f8d9630">TcpListener</a> ()</td></tr>
...
<tr class="memitem:a784b9a9c59d4cdbae1795e90b8015780" id="r_a784b9a9c59d4cdbae1795e90b8015780"><td class="memItemLeft" align="right" valign="top">unsigned short&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a784b9a9c59d4cdbae1795e90b8015780">getLocalPort</a> () const</td></tr>
...
<tr class="memitem:a9504758ea3570e62cb20b209c11776a1" id="r_a9504758ea3570e62cb20b209c11776a1"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a9504758ea3570e62cb20b209c11776a1">listen</a> (unsigned short port, const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;address=<a class="el" href="classsf_1_1IpAddress.php#a3dbc10b0dc6804cc69e29342f7406907">IpAddress::Any</a>)</td></tr>
...
<tr class="memitem:a3a00a850506bd0f9f48867a0fe59556b" id="r_a3a00a850506bd0f9f48867a0fe59556b"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a3a00a850506bd0f9f48867a0fe59556b">close</a> ()</td></tr>
...
<tr class="memitem:ae2c83ce5a64d50b68180c46bef0a7346" id="r_ae2c83ce5a64d50b68180c46bef0a7346"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ae2c83ce5a64d50b68180c46bef0a7346">accept</a> (<a class="el" href="classsf_1_1TcpSocket.php">TcpSocket</a> &amp;socket)</td></tr>
...
<p>A listener is automatically closed on destruction, like all other types of socket. However if you want to stop listening before the socket is destroyed, you can call its <a class="el" href="#a3a00a850506bd0f9f48867a0fe59556b" title="Stop listening and close the socket.">close()</a> function.</p>
...
<div class="line">listener.<a class="code hl_function" href="#a9504758ea3570e62cb20b209c11776a1">listen</a>(55001);</div>
<div class="line"> </div>
...
<div class="line">    <span class="keywordflow">if</span> (listener.<a class="code hl_function" href="#ae2c83ce5a64d50b68180c46bef0a7346">accept</a>(client) == <a class="code hl_enumvalue" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dca1de3a85bc56d3ae85b3d0f3cfd04ae90">sf::Socket::Done</a>)</div>
<div class="line">    {</div>
...
<div class="ttc" id="aclasssf_1_1TcpListener_php_a9504758ea3570e62cb20b209c11776a1"><div class="ttname"><a href="#a9504758ea3570e62cb20b209c11776a1">sf::TcpListener::listen</a></div><div class="ttdeci">Status listen(unsigned short port, const IpAddress &amp;address=IpAddress::Any)</div><div class="ttdoc">Start listening for incoming connection attempts.</div></div>
<div class="ttc" id="aclasssf_1_1TcpListener_php_ae2c83ce5a64d50b68180c46bef0a7346"><div class="ttname"><a href="#ae2c83ce5a64d50b68180c46bef0a7346">sf::TcpListener::accept</a></div><div class="ttdeci">Status accept(TcpSocket &amp;socket)</div><div class="ttdoc">Accept a new connection.</div></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="classsf_1_1TcpSocket.php">TcpSocket</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>socket</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a9504758ea3570e62cb20b209c11776a1" title="Start listening for incoming connection attempts.">listen</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>Status code</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ae2c83ce5a64d50b68180c46bef0a7346" title="Accept a new connection.">accept</a>, <a class="el" href="#a3a00a850506bd0f9f48867a0fe59556b" title="Stop listening and close the socket.">close</a> </dd></dl>
