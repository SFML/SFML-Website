...
<a href="classsf_1_1Touch-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::Touch Class Reference<div class="ingroups"><a class="el" href="group__window.php">Window module</a></div></div></div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="Touch_8hpp_source.php">SFML/Window/Touch.hpp</a>&gt;</code></p>
<table class="memberdecls">
<tr class="heading"><td colspan="2"><h2 class="groupheader"><a id="pub-static-methods" name="pub-static-methods"></a>
Static Public Member Functions</h2></td></tr>
<tr class="memitem:a2f85297123ea4e401d02c346e50d48a3" id="r_a2f85297123ea4e401d02c346e50d48a3"><td class="memItemLeft" align="right" valign="top">static bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a2f85297123ea4e401d02c346e50d48a3">isDown</a> (unsigned int finger)</td></tr>
...
<tr class="memitem:af1b7035be709091c7475075e43e2bc23" id="r_af1b7035be709091c7475075e43e2bc23"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1Vector2.php">Vector2i</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af1b7035be709091c7475075e43e2bc23">getPosition</a> (unsigned int finger)</td></tr>
...
<tr class="memitem:a8a1456574d2825d4249fcf72f11d4398" id="r_a8a1456574d2825d4249fcf72f11d4398"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1Vector2.php">Vector2i</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a8a1456574d2825d4249fcf72f11d4398">getPosition</a> (unsigned int finger, const <a class="el" href="classsf_1_1WindowBase.php">WindowBase</a> &amp;relativeTo)</td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keywordflow">if</span> (<a class="code hl_function" href="#a2f85297123ea4e401d02c346e50d48a3">sf::Touch::isDown</a>(0))</div>
<div class="line">{</div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1Vector2.php">sf::Vector2i</a> globalPos = <a class="code hl_function" href="#af1b7035be709091c7475075e43e2bc23">sf::Touch::getPosition</a>(1);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// get position of touch 1 relative to a window</span></div>
<div class="line"><a class="code hl_class" href="classsf_1_1Vector2.php">sf::Vector2i</a> relativePos = <a class="code hl_function" href="#af1b7035be709091c7475075e43e2bc23">sf::Touch::getPosition</a>(1, window);</div>
<div class="ttc" id="aclasssf_1_1Touch_php_a2f85297123ea4e401d02c346e50d48a3"><div class="ttname"><a href="#a2f85297123ea4e401d02c346e50d48a3">sf::Touch::isDown</a></div><div class="ttdeci">static bool isDown(unsigned int finger)</div><div class="ttdoc">Check if a touch event is currently down.</div></div>
<div class="ttc" id="aclasssf_1_1Touch_php_af1b7035be709091c7475075e43e2bc23"><div class="ttname"><a href="#af1b7035be709091c7475075e43e2bc23">sf::Touch::getPosition</a></div><div class="ttdeci">static Vector2i getPosition(unsigned int finger)</div><div class="ttdoc">Get the current position of a touch in desktop coordinates.</div></div>
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">unsigned int</td>          <td class="paramname"><span class="paramname"><em>finger</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
  </td>
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="classsf_1_1Vector2.php">Vector2i</a> sf::Touch::getPosition </td>
          <td>(</td>
          <td class="paramtype">unsigned int</td>          <td class="paramname"><span class="paramname"><em>finger</em></span>, </td>
        </tr>
        <tr>
