...
<tr class="memitem:af32a0574baa0f46e48deb2d83ca7658b" id="r_af32a0574baa0f46e48deb2d83ca7658b"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#af32a0574baa0f46e48deb2d83ca7658b">IpAddress</a> ()</td></tr>
...
<tr class="memitem:a656b7445ab04cabaa7398685bc09c3f7" id="r_a656b7445ab04cabaa7398685bc09c3f7"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a656b7445ab04cabaa7398685bc09c3f7">IpAddress</a> (const std::string &amp;address)</td></tr>
...
<tr class="memitem:a92f2a9be74334a61b96c2fc79fe6eb78" id="r_a92f2a9be74334a61b96c2fc79fe6eb78"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a92f2a9be74334a61b96c2fc79fe6eb78">IpAddress</a> (const char *address)</td></tr>
...
<tr class="memitem:a1d289dcb9ce7a64c600c6f84cba88cc6" id="r_a1d289dcb9ce7a64c600c6f84cba88cc6"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a1d289dcb9ce7a64c600c6f84cba88cc6">IpAddress</a> (Uint8 byte0, Uint8 byte1, Uint8 byte2, Uint8 byte3)</td></tr>
...
<tr class="memitem:a8ed34ba3a40d70eb9f09ac5ae779a162" id="r_a8ed34ba3a40d70eb9f09ac5ae779a162"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a8ed34ba3a40d70eb9f09ac5ae779a162">IpAddress</a> (Uint32 address)</td></tr>
...
<tr class="memitem:a88507954142d7fc2176cce7f36422340" id="r_a88507954142d7fc2176cce7f36422340"><td class="memItemLeft" align="right" valign="top">std::string&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a88507954142d7fc2176cce7f36422340">toString</a> () const</td></tr>
...
<tr class="memitem:ae7911c5ea9562f9602c3e29cd54b15e9" id="r_ae7911c5ea9562f9602c3e29cd54b15e9"><td class="memItemLeft" align="right" valign="top">Uint32&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ae7911c5ea9562f9602c3e29cd54b15e9">toInteger</a> () const</td></tr>
...
<tr class="memitem:a3dbc10b0dc6804cc69e29342f7406907" id="r_a3dbc10b0dc6804cc69e29342f7406907"><td class="memItemLeft" align="right" valign="top">static const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a3dbc10b0dc6804cc69e29342f7406907">Any</a></td></tr>
...
Friends</h2></td></tr>
<tr class="memitem:a4886da3f195b8c30d415a94a7009fdd7" id="r_a4886da3f195b8c30d415a94a7009fdd7"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a4886da3f195b8c30d415a94a7009fdd7">operator&lt;</a> (const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;left, const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;right)</td></tr>
...
<div class="line"><a class="code hl_class" href="classsf_1_1IpAddress.php">sf::IpAddress</a> a1 = <a class="code hl_variable" href="#a4619b4abbe3c8fef056e7299db967404">sf::IpAddress::None</a>;               <span class="comment">// an invalid address (same as a0)</span></div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1IpAddress.php">sf::IpAddress</a> a3 = <a class="code hl_variable" href="#aa93d1d57b65d243f2baf804b6035465c">sf::IpAddress::Broadcast</a>;          <span class="comment">// the broadcast address</span></div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1IpAddress.php">sf::IpAddress</a> a8 = <a class="code hl_function" href="#a4c31622ad87edca48adbb8e8ed00ee4a">sf::IpAddress::getLocalAddress</a>();  <span class="comment">// my address on the local network</span></div>
<div class="line"><a class="code hl_class" href="classsf_1_1IpAddress.php">sf::IpAddress</a> a9 = <a class="code hl_function" href="#a5c5cbf67e4aacf23c24f2ad991df4c55">sf::IpAddress::getPublicAddress</a>(); <span class="comment">// my address on the internet</span></div>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">sf::IpAddress::IpAddress </td>
          <td>(</td>
          <td class="paramtype">const std::string &amp;</td>          <td class="paramname"><span class="paramname"><em>address</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">sf::IpAddress::IpAddress </td>
          <td>(</td>
          <td class="paramtype">Uint8</td>          <td class="paramname"><span class="paramname"><em>byte0</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">Uint8</td>          <td class="paramname"><span class="paramname"><em>byte1</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">Uint8</td>          <td class="paramname"><span class="paramname"><em>byte2</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">Uint8</td>          <td class="paramname"><span class="paramname"><em>byte3</em></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">sf::IpAddress::IpAddress </td>
          <td>(</td>
          <td class="paramtype">Uint32</td>          <td class="paramname"><span class="paramname"><em>address</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
  </td>
...
<p>This constructor uses the internal representation of the address directly. It should be used for optimization purposes, and only if you got that representation from <a class="el" href="#ae7911c5ea9562f9602c3e29cd54b15e9" title="Get an integer representation of the address.">IpAddress::toInteger()</a>.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ae7911c5ea9562f9602c3e29cd54b15e9" title="Get an integer representation of the address.">toInteger</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a5c5cbf67e4aacf23c24f2ad991df4c55" title="Get the computer&#39;s public address.">getPublicAddress</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a4c31622ad87edca48adbb8e8ed00ee4a" title="Get the computer&#39;s local address.">getLocalAddress</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a88507954142d7fc2176cce7f36422340" title="Get a string representation of the address.">toString</a> </dd></dl>
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>left</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>right</em></span>&#160;)</td>
        </tr>
      </table>
  </td>
  <td class="mlabels-right">
