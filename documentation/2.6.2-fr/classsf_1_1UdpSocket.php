...
<a href="classsf_1_1UdpSocket-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::UdpSocket Class Reference<div class="ingroups"><a class="el" href="group__network.php">Network module</a></div></div></div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="UdpSocket_8hpp_source.php">SFML/Network/UdpSocket.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<tr class="memitem:a8ad087820b1ae07267858212f3d0fac5" id="r_a8ad087820b1ae07267858212f3d0fac5"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom">{ <a class="el" href="#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb">MaxDatagramSize</a> = 65507
 }</td></tr>
...
<tr class="memitem:abb10725e26dee9d3a8165fe87ffb71bb" id="r_abb10725e26dee9d3a8165fe87ffb71bb"><td class="memItemLeft" align="right" valign="top">&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#abb10725e26dee9d3a8165fe87ffb71bb">UdpSocket</a> ()</td></tr>
...
<tr class="memitem:a5c03644b3da34bb763bce93e758c938e" id="r_a5c03644b3da34bb763bce93e758c938e"><td class="memItemLeft" align="right" valign="top">unsigned short&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a5c03644b3da34bb763bce93e758c938e">getLocalPort</a> () const</td></tr>
...
<tr class="memitem:ad764c3d06d90b4714dcc97a0d1647bcc" id="r_ad764c3d06d90b4714dcc97a0d1647bcc"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ad764c3d06d90b4714dcc97a0d1647bcc">bind</a> (unsigned short port, const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;address=<a class="el" href="classsf_1_1IpAddress.php#a3dbc10b0dc6804cc69e29342f7406907">IpAddress::Any</a>)</td></tr>
...
<tr class="memitem:a2c4abb8102a1bd31f51fcfe7f15427a3" id="r_a2c4abb8102a1bd31f51fcfe7f15427a3"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a2c4abb8102a1bd31f51fcfe7f15427a3">unbind</a> ()</td></tr>
...
<tr class="memitem:a664ab8f26f37c21cc4de1b847c2efcca" id="r_a664ab8f26f37c21cc4de1b847c2efcca"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a664ab8f26f37c21cc4de1b847c2efcca">send</a> (const void *data, std::size_t size, const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;remoteAddress, unsigned short remotePort)</td></tr>
...
<tr class="memitem:ade9ca0f7ed7919136917b0b997a9833a" id="r_ade9ca0f7ed7919136917b0b997a9833a"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#ade9ca0f7ed7919136917b0b997a9833a">receive</a> (void *data, std::size_t size, std::size_t &amp;received, <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;remoteAddress, unsigned short &amp;remotePort)</td></tr>
...
<tr class="memitem:a48969a62c80d40fd74293a740798e435" id="r_a48969a62c80d40fd74293a740798e435"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a48969a62c80d40fd74293a740798e435">send</a> (<a class="el" href="classsf_1_1Packet.php">Packet</a> &amp;packet, const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;remoteAddress, unsigned short remotePort)</td></tr>
...
<tr class="memitem:afdd5c655d00c96222d5b477fc057a22b" id="r_afdd5c655d00c96222d5b477fc057a22b"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#afdd5c655d00c96222d5b477fc057a22b">receive</a> (<a class="el" href="classsf_1_1Packet.php">Packet</a> &amp;packet, <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;remoteAddress, unsigned short &amp;remotePort)</td></tr>
...
<div class="line"><a class="code hl_class" href="classsf_1_1UdpSocket.php">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code hl_function" href="#ad764c3d06d90b4714dcc97a0d1647bcc">bind</a>(55001);</div>
<div class="line"> </div>
<div class="line"><span class="comment">// Send a message to 192.168.1.50 on port 55002</span></div>
<div class="line">std::string message = <span class="stringliteral">&quot;Hi, I am &quot;</span> + <a class="code hl_function" href="classsf_1_1IpAddress.php#a4c31622ad87edca48adbb8e8ed00ee4a">sf::IpAddress::getLocalAddress</a>().<a class="code hl_function" href="classsf_1_1IpAddress.php#a88507954142d7fc2176cce7f36422340">toString</a>();</div>
<div class="line">socket.<a class="code hl_function" href="#a664ab8f26f37c21cc4de1b847c2efcca">send</a>(message.c_str(), message.size() + 1, <span class="stringliteral">&quot;192.168.1.50&quot;</span>, 55002);</div>
<div class="line"> </div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1IpAddress.php">sf::IpAddress</a> sender;</div>
<div class="line"><span class="keywordtype">unsigned</span> <span class="keywordtype">short</span> port;</div>
<div class="line">socket.<a class="code hl_function" href="#ade9ca0f7ed7919136917b0b997a9833a">receive</a>(buffer, <span class="keyword">sizeof</span>(buffer), received, sender, port);</div>
...
<div class="line"><a class="code hl_class" href="classsf_1_1UdpSocket.php">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code hl_function" href="#ad764c3d06d90b4714dcc97a0d1647bcc">bind</a>(55002);</div>
<div class="line"> </div>
...
<div class="line">std::string message = <span class="stringliteral">&quot;Welcome &quot;</span> + sender.<a class="code hl_function" href="classsf_1_1IpAddress.php#a88507954142d7fc2176cce7f36422340">toString</a>();</div>
<div class="line">socket.<a class="code hl_function" href="#a664ab8f26f37c21cc4de1b847c2efcca">send</a>(message.c_str(), message.size() + 1, sender, port);</div>
...
<div class="ttc" id="aclasssf_1_1IpAddress_php_a88507954142d7fc2176cce7f36422340"><div class="ttname"><a href="classsf_1_1IpAddress.php#a88507954142d7fc2176cce7f36422340">sf::IpAddress::toString</a></div><div class="ttdeci">std::string toString() const</div><div class="ttdoc">Get a string representation of the address.</div></div>
...
<p class="definition">Definition at line <a class="el" href="UdpSocket_8hpp_source.php#l00045">45</a> of file <a class="el" href="UdpSocket_8hpp_source.php">UdpSocket.hpp</a>.</p>
...
<p class="definition">Definition at line <a class="el" href="UdpSocket_8hpp_source.php#l00052">52</a> of file <a class="el" href="UdpSocket_8hpp_source.php">UdpSocket.hpp</a>.</p>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          ...
          <td></td>
          <td class="paramtype">const <a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>address</em></span><span class="paramdefsep"> = </span><span class="paramdefval"><a class="el" href="classsf_1_1IpAddress.php#a3dbc10b0dc6804cc69e29342f7406907">IpAddress::Any</a></span>&#160;)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a2c4abb8102a1bd31f51fcfe7f15427a3" title="Unbind the socket from the local port to which it is bound.">unbind</a>, <a class="el" href="#a5c03644b3da34bb763bce93e758c938e" title="Get the port to which the socket is bound locally.">getLocalPort</a> </dd></dl>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ad764c3d06d90b4714dcc97a0d1647bcc" title="Bind the socket to a specific port.">bind</a> </dd></dl>
...
<div class="memproto">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype"><a class="el" href="classsf_1_1Packet.php">Packet</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>packet</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype"><a class="el" href="classsf_1_1IpAddress.php">IpAddress</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>remoteAddress</em></span>, </td>
        </tr>
        <tr>
          <td class="paramkey"></td>
          <td></td>
...
<dl class="section return"><dt>Returns</dt><dd>Status code</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#a664ab8f26f37c21cc4de1b847c2efcca" title="Send raw data to a remote peer.">send</a> </dd></dl>
...
<p>Make sure that <em>size</em> is not greater than <a class="el" href="#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb" title="The maximum number of bytes that can be sent in a single UDP datagram.">UdpSocket::MaxDatagramSize</a>, otherwise this function will fail and no data will be sent.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<dl class="section return"><dt>Returns</dt><dd>Status code</dd></dl>
<dl class="section see"><dt>See also</dt><dd><a class="el" href="#ade9ca0f7ed7919136917b0b997a9833a" title="Receive raw data from a remote peer.">receive</a> </dd></dl>
...
<p>Make sure that the packet size is not greater than <a class="el" href="#a8ad087820b1ae07267858212f3d0fac5a728a7d33027bee0d65f70f964dd9c9eb" title="The maximum number of bytes that can be sent in a single UDP datagram.">UdpSocket::MaxDatagramSize</a>, otherwise this function will fail and no data will be sent.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
