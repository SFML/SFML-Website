...
<tr class="memitem:a3c385cc2b6d78a3d0cfa29928a7d6eb8" id="r_a3c385cc2b6d78a3d0cfa29928a7d6eb8"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="classsf_1_1String.php">String</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a3c385cc2b6d78a3d0cfa29928a7d6eb8">getString</a> ()</td></tr>
...
<tr class="memitem:a29c597c2165d3ca3a89c17f31ff7413d" id="r_a29c597c2165d3ca3a89c17f31ff7413d"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a29c597c2165d3ca3a89c17f31ff7413d">setString</a> (const <a class="el" href="classsf_1_1String.php">String</a> &amp;text)</td></tr>
...
<div class="line"><a class="code hl_class" href="classsf_1_1String.php">sf::String</a> <span class="keywordtype">string</span> = <a class="code hl_function" href="#a3c385cc2b6d78a3d0cfa29928a7d6eb8">sf::Clipboard::getString</a>();</div>
<div class="line"> </div>
...
<div class="line">            <span class="keywordtype">string</span> = <a class="code hl_function" href="#a3c385cc2b6d78a3d0cfa29928a7d6eb8">sf::Clipboard::getString</a>();</div>
<div class="line"> </div>
...
<div class="line">            <a class="code hl_function" href="#a29c597c2165d3ca3a89c17f31ff7413d">sf::Clipboard::setString</a>(<span class="stringliteral">&quot;Hello World!&quot;</span>);</div>
<div class="line">    }</div>
<div class="line">}</div>
<div class="ttc" id="aclasssf_1_1Clipboard_php_a29c597c2165d3ca3a89c17f31ff7413d"><div class="ttname"><a href="#a29c597c2165d3ca3a89c17f31ff7413d">sf::Clipboard::setString</a></div><div class="ttdeci">static void setString(const String &amp;text)</div><div class="ttdoc">Set the content of the clipboard as string data.</div></div>
<div class="ttc" id="aclasssf_1_1Clipboard_php_a3c385cc2b6d78a3d0cfa29928a7d6eb8"><div class="ttname"><a href="#a3c385cc2b6d78a3d0cfa29928a7d6eb8">sf::Clipboard::getString</a></div><div class="ttdeci">static String getString()</div><div class="ttdoc">Get the content of the clipboard as string data.</div></div>
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          ...
          <td>(</td>
          <td class="paramtype">const <a class="el" href="classsf_1_1String.php">String</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>text</em></span></td><td>)</td>
          <td></td>
        </tr>
      </table>
  </td>
