...
<a href="classsf_1_1SoundFileReader-members.php">List of all members</a>  </div>
  <div class="headertitle"><div class="title">sf::SoundFileReader Class Reference<span class="mlabels"><span class="mlabel">abstract</span></span><div class="ingroups"><a class="el" href="group__audio.php">Audio module</a></div></div></div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:a34163297f302d15818c76b54f815acc8" id="r_a34163297f302d15818c76b54f815acc8"><td class="memItemLeft" align="right" valign="top">virtual&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a34163297f302d15818c76b54f815acc8">~SoundFileReader</a> ()</td></tr>
<tr class="memdesc:a34163297f302d15818c76b54f815acc8"><td class="mdescLeft">&#160;</td><td class="mdescRight">Virtual destructor.  <br /></td></tr>
<tr class="separator:a34163297f302d15818c76b54f815acc8"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aa1d2fee2ba8f359c833ab74590d55935" id="r_aa1d2fee2ba8f359c833ab74590d55935"><td class="memItemLeft" align="right" valign="top">virtual bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#aa1d2fee2ba8f359c833ab74590d55935">open</a> (<a class="el" href="classsf_1_1InputStream.php">InputStream</a> &amp;stream, <a class="el" href="structsf_1_1SoundFileReader_1_1Info.php">Info</a> &amp;info)=0</td></tr>
<tr class="memdesc:aa1d2fee2ba8f359c833ab74590d55935"><td class="mdescLeft">&#160;</td><td class="mdescRight">Open a sound file for reading.  <br /></td></tr>
<tr class="separator:aa1d2fee2ba8f359c833ab74590d55935"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a1e18ade5ffe882bdfa20a2ebe7e2b015" id="r_a1e18ade5ffe882bdfa20a2ebe7e2b015"><td class="memItemLeft" align="right" valign="top">virtual void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a1e18ade5ffe882bdfa20a2ebe7e2b015">seek</a> (Uint64 sampleOffset)=0</td></tr>
<tr class="memdesc:a1e18ade5ffe882bdfa20a2ebe7e2b015"><td class="mdescLeft">&#160;</td><td class="mdescRight">Change the current read position to the given sample offset.  <br /></td></tr>
<tr class="separator:a1e18ade5ffe882bdfa20a2ebe7e2b015"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a3b7d86769ea07e24e7b0f0486bed7591" id="r_a3b7d86769ea07e24e7b0f0486bed7591"><td class="memItemLeft" align="right" valign="top">virtual Uint64&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="#a3b7d86769ea07e24e7b0f0486bed7591">read</a> (Int16 *samples, Uint64 maxCount)=0</td></tr>
<tr class="memdesc:a3b7d86769ea07e24e7b0f0486bed7591"><td class="mdescLeft">&#160;</td><td class="mdescRight">Read audio samples from the open file.  <br /></td></tr>
...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>MySoundFileReader : <span class="keyword">public</span> <a class="code hl_class" href="classsf_1_1SoundFileReader.php">sf::SoundFileReader</a></div>
<div class="line">{</div>
<div class="line"><span class="keyword">public</span>:</div>
<div class="line"> </div>
<div class="line">    <span class="keyword">static</span> <span class="keywordtype">bool</span> check(<a class="code hl_class" href="classsf_1_1InputStream.php">sf::InputStream</a>&amp; stream)</div>
<div class="line">    {</div>
...
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code hl_function" href="#aa1d2fee2ba8f359c833ab74590d55935">open</a>(<a class="code hl_class" href="classsf_1_1InputStream.php">sf::InputStream</a>&amp; stream, Info&amp; info)</div>
<div class="line">    {</div>
...
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code hl_function" href="#a1e18ade5ffe882bdfa20a2ebe7e2b015">seek</a>(sf::Uint64 sampleOffset)</div>
<div class="line">    {</div>
<div class="line">        <span class="comment">// advance to the sampleOffset-th sample from the beginning of the sound</span></div>
<div class="line">    }</div>
<div class="line"> </div>
<div class="line">    <span class="keyword">virtual</span> sf::Uint64 <a class="code hl_function" href="#a3b7d86769ea07e24e7b0f0486bed7591">read</a>(sf::Int16* samples, sf::Uint64 maxCount)</div>
<div class="line">    {</div>
...
<div class="line">};</div>
<div class="line"> </div>
<div class="line"><a class="code hl_function" href="classsf_1_1SoundFileFactory.php#aeee396bfdbb6ac24c57e5c73c30ec105">sf::SoundFileFactory::registerReader&lt;MySoundFileReader&gt;</a>();</div>
...
<div class="ttc" id="aclasssf_1_1SoundFileReader_php_a1e18ade5ffe882bdfa20a2ebe7e2b015"><div class="ttname"><a href="#a1e18ade5ffe882bdfa20a2ebe7e2b015">sf::SoundFileReader::seek</a></div><div class="ttdeci">virtual void seek(Uint64 sampleOffset)=0</div><div class="ttdoc">Change the current read position to the given sample offset.</div></div>
<div class="ttc" id="aclasssf_1_1SoundFileReader_php_a3b7d86769ea07e24e7b0f0486bed7591"><div class="ttname"><a href="#a3b7d86769ea07e24e7b0f0486bed7591">sf::SoundFileReader::read</a></div><div class="ttdeci">virtual Uint64 read(Int16 *samples, Uint64 maxCount)=0</div><div class="ttdoc">Read audio samples from the open file.</div></div>
<div class="ttc" id="aclasssf_1_1SoundFileReader_php_aa1d2fee2ba8f359c833ab74590d55935"><div class="ttname"><a href="#aa1d2fee2ba8f359c833ab74590d55935">sf::SoundFileReader::open</a></div><div class="ttdeci">virtual bool open(InputStream &amp;stream, Info &amp;info)=0</div><div class="ttdoc">Open a sound file for reading.</div></div>
...
<a id="a34163297f302d15818c76b54f815acc8" name="a34163297f302d15818c76b54f815acc8"></a>
...
<a id="aa1d2fee2ba8f359c833ab74590d55935" name="aa1d2fee2ba8f359c833ab74590d55935"></a>
  ...
  <td class="mlabels-left">
      <table class="memname">
        ...
        <tr>
          ...
          <td></td>
          <td class="paramtype"><a class="el" href="structsf_1_1SoundFileReader_1_1Info.php">Info</a> &amp;</td>          <td class="paramname"><span class="paramname"><em>info</em></span>&#160;)</td>
        </tr>
      </table>
  </td>
  <td class="mlabels-right">
...
<a id="a3b7d86769ea07e24e7b0f0486bed7591" name="a3b7d86769ea07e24e7b0f0486bed7591"></a>
...
<a id="a1e18ade5ffe882bdfa20a2ebe7e2b015" name="a1e18ade5ffe882bdfa20a2ebe7e2b015"></a>
