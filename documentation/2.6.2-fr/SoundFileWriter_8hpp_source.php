<?php
    ...
    $pagetitle = 'SoundFileWriter.hpp Source File'; // the $ title variable is automatically replaced by doxygen with the page title
...
<div id="doc-content">
<div class="header">
  <div class="headertitle"><div class="title">SoundFileWriter.hpp</div></div>
</div><!--header-->
<div class="contents">
...
<div class="line"><a id="l00025" name="l00025"></a><span class="lineno">   25</span><span class="preprocessor">#ifndef SFML_SOUNDFILEWRITER_HPP</span></div>
<div class="line"><a id="l00026" name="l00026"></a><span class="lineno">   26</span><span class="preprocessor">#define SFML_SOUNDFILEWRITER_HPP</span></div>
...
<div class="line"><a id="l00041" name="l00041"></a><span class="lineno"><a class="line" href="classsf_1_1SoundFileWriter.php">   41</a></span><span class="keyword">class </span>SFML_AUDIO_API <a class="code hl_class" href="classsf_1_1SoundFileWriter.php">SoundFileWriter</a></div>
...
<div class="line"><a id="l00049" name="l00049"></a><span class="lineno"><a class="line" href="classsf_1_1SoundFileWriter.php#a76944fc158688f35050bd5b592c90270">   49</a></span>    <span class="keyword">virtual</span> <a class="code hl_function" href="classsf_1_1SoundFileWriter.php#a76944fc158688f35050bd5b592c90270">~SoundFileWriter</a>() {}</div>
<div class="line"><a id="l00050" name="l00050"></a><span class="lineno">   50</span> </div>
<div class="line"><a id="l00061" name="l00061"></a><span class="lineno"><a class="line" href="classsf_1_1SoundFileWriter.php#a5c92bcaaa880ef4d3eaab18dae1d3d07">   61</a></span>    <span class="keyword">virtual</span> <span class="keywordtype">bool</span> <a class="code hl_function" href="classsf_1_1SoundFileWriter.php#a5c92bcaaa880ef4d3eaab18dae1d3d07">open</a>(<span class="keyword">const</span> std::string&amp; filename, <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> sampleRate, <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> channelCount) = 0;</div>
<div class="line"><a id="l00062" name="l00062"></a><span class="lineno">   62</span> </div>
<div class="line"><a id="l00070" name="l00070"></a><span class="lineno"><a class="line" href="classsf_1_1SoundFileWriter.php#a4ce597e7682d22c5b2c98d77e931a1da">   70</a></span>    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code hl_function" href="classsf_1_1SoundFileWriter.php#a4ce597e7682d22c5b2c98d77e931a1da">write</a>(<span class="keyword">const</span> Int16* samples, Uint64 count) = 0;</div>
...
<div class="line"><a id="l00076" name="l00076"></a><span class="lineno">   76</span><span class="preprocessor">#endif </span><span class="comment">// SFML_SOUNDFILEWRITER_HPP</span></div>
<div class="line"><a id="l00077" name="l00077"></a><span class="lineno">   77</span> </div>
<div class="line"><a id="l00078" name="l00078"></a><span class="lineno">   78</span> </div>
<div class="ttc" id="aclasssf_1_1SoundFileWriter_php"><div class="ttname"><a href="classsf_1_1SoundFileWriter.php">sf::SoundFileWriter</a></div><div class="ttdoc">Abstract base class for sound file encoding.</div><div class="ttdef"><b>Definition</b> <a href="#l00041">SoundFileWriter.hpp:42</a></div></div>
<div class="ttc" id="aclasssf_1_1SoundFileWriter_php_a4ce597e7682d22c5b2c98d77e931a1da"><div class="ttname"><a href="classsf_1_1SoundFileWriter.php#a4ce597e7682d22c5b2c98d77e931a1da">sf::SoundFileWriter::write</a></div><div class="ttdeci">virtual void write(const Int16 *samples, Uint64 count)=0</div><div class="ttdoc">Write audio samples to the open file.</div></div>
<div class="ttc" id="aclasssf_1_1SoundFileWriter_php_a5c92bcaaa880ef4d3eaab18dae1d3d07"><div class="ttname"><a href="classsf_1_1SoundFileWriter.php#a5c92bcaaa880ef4d3eaab18dae1d3d07">sf::SoundFileWriter::open</a></div><div class="ttdeci">virtual bool open(const std::string &amp;filename, unsigned int sampleRate, unsigned int channelCount)=0</div><div class="ttdoc">Open a sound file for writing.</div></div>
<div class="ttc" id="aclasssf_1_1SoundFileWriter_php_a76944fc158688f35050bd5b592c90270"><div class="ttname"><a href="classsf_1_1SoundFileWriter.php#a76944fc158688f35050bd5b592c90270">sf::SoundFileWriter::~SoundFileWriter</a></div><div class="ttdeci">virtual ~SoundFileWriter()</div><div class="ttdoc">Virtual destructor.</div><div class="ttdef"><b>Definition</b> <a href="#l00049">SoundFileWriter.hpp:49</a></div></div>
