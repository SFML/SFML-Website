...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Declare a new font</span></div><div class="line"><a class="code" href="classsf_1_1Font.php">sf::Font</a> font;</div><div class="line"></div><div class="line"><span class="comment">// Load it from a file</span></div><div class="line"><span class="keywordflow">if</span> (!font.<a class="code" href="classsf_1_1Font.php#ab020052ef4e01f6c749a85571c0f3fd1">loadFromFile</a>(<span class="stringliteral">&quot;arial.ttf&quot;</span>))</div><div class="line">{</div><div class="line">    <span class="comment">// error...</span></div><div class="line">}</div><div class="line"></div><div class="line"><span class="comment">// Create a text which uses our font</span></div><div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text1;</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81">setFont</a>(font);</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e">setCharacterSize</a>(30);</div><div class="line">text1.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82a2af9ae5e1cda126570f744448e0caa32">sf::Text::Regular</a>);</div><div class="line"></div><div class="line"><span class="comment">// Create another text using the same font, but with different parameters</span></div><div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text2;</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#a2927805d1ae92d57f15034ea34756b81">setFont</a>(font);</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#ae96f835fc1bff858f8a23c5b01eaaf7e">setCharacterSize</a>(50);</div><div class="line">text2.<a class="code" href="classsf_1_1Text.php#ad791702bc2d1b6590a1719aa60635edf">setStyle</a>(<a class="code" href="classsf_1_1Text.php#aa8add4aef484c6e6b20faff07452bd82aee249eb803848723c542c2062ebe69d8">sf::Text::Italic</a>);</div></div><!-- fragment --><p>Apart from loading font files, and passing them to instances of <a class="el" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target. ">sf::Text</a>, you should normally not have to deal directly with this class. However, it may be useful to access the font metrics or rasterized glyphs for advanced usage.</p>
...
<p class="definition">Definition at line <a class="el" href="Font_8hpp_source.php#l00050">50</a> of file <a class="el" href="Font_8hpp_source.php">Font.hpp</a>.</p>
