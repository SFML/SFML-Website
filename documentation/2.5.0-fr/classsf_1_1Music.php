...
typedef <a class="el" href="structsf_1_1Music_1_1Span.php">Span</a>&lt; <a class="el" href="classsf_1_1Time.php">Time</a> &gt;&#160;</td><td class="memItemRight" valign="bottom"><b>TimeSpan</b></td></tr>
...
<tr class="memdesc:ae7b339f0a957dfad045f3f28083a015e"><td class="mdescLeft">&#160;</td><td class="mdescRight">Sets the beginning and end of the sound's looping sequence using <a class="el" href="classsf_1_1Time.php" title="Represents a time value. ">sf::Time</a>.  <a href="#ae7b339f0a957dfad045f3f28083a015e">More...</a><br /></td></tr>
...
<a id="a7707214e7cd4ffcf1c123e7bcab4092a"></a>
...
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a id="a7707214e7cd4ffcf1c123e7bcab4092aa2f2c638731fdff0d6fe4e3e82b6f6146"></a>NoLoop&#160;</td><td class="fielddoc"><p>"Invalid" endSeeks value, telling us to continue uninterrupted </p>
</td></tr>
</table>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a id="ac43af72c98c077500b239bc75b812f03adabb01e8aa85b2f54b344890addf764a"></a>Stopped&#160;</td><td class="fielddoc"><p><a class="el" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment. ">Sound</a> is not playing. </p>
</td></tr>
<tr><td class="fieldname"><a id="ac43af72c98c077500b239bc75b812f03ac3ca1fcc0394267c9bdbe3dc0a8a7e41"></a>Paused&#160;</td><td class="fielddoc"><p><a class="el" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment. ">Sound</a> is paused. </p>
</td></tr>
<tr><td class="fieldname"><a id="ac43af72c98c077500b239bc75b812f03af07bdea9f70ef7606dfc9f955beeee18"></a>Playing&#160;</td><td class="fielddoc"><p><a class="el" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment. ">Sound</a> is playing. </p>
</td></tr>
</table>
...
<a id="aae3451cad5c16ee6a6e124e62ed61361"></a>
...
<a id="aa68a64bdaf5d16e9ed64f202f5c45e03"></a>
...
<a id="ae7b339f0a957dfad045f3f28083a015e"></a>
...
<p>Sets the beginning and end of the sound's looping sequence using <a class="el" href="classsf_1_1Time.php" title="Represents a time value. ">sf::Time</a>. </p>
<p>Loop points allow one to specify a pair of positions such that, when the music is enabled for looping, it will seamlessly seek to the beginning whenever it encounters the end. Valid ranges for timePoints.offset and timePoints.length are [0, Dur) and (0, Dur-offset] respectively, where Dur is the value returned by <a class="el" href="classsf_1_1Music.php#a288ef6f552a136b0e56952dcada3d672" title="Get the total duration of the music. ">getDuration()</a>. Note that the EOF "loop point" from the end to the beginning of the stream is still honored, in case the caller seeks to a point after the end of the loop range. This function can be safely called at any point after a stream is opened, and will be applied to a playing sound without affecting the current playing offset.</p>
