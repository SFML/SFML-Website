...
<div class="center"><img src="classsf_1_1Text__inherit__graph.png" border="0" usemap="#sf_1_1Text_inherit__map" alt="Inheritance graph"/></div>
<map name="sf_1_1Text_inherit__map" id="sf_1_1Text_inherit__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
<div class="dynheader">
Collaboration diagram for sf::Text:</div>
<div class="dyncontent">
<div class="center"><img src="classsf_1_1Text__coll__graph.png" border="0" usemap="#sf_1_1Text_coll__map" alt="Collaboration graph"/></div>
<map name="sf_1_1Text_coll__map" id="sf_1_1Text_coll__map">
</map>
<center><span class="legend">[<a href="graph_legend.php">legend</a>]</span></center></div>
...
<tr class="memitem:ae4ca753f719c54692fd4d9284573a2c7"><td class="memItemLeft" align="right" valign="top">const <a class="el" href="classsf_1_1Color.php">Color</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Text.php#ae4ca753f719c54692fd4d9284573a2c7">getColor</a> () const</td></tr>
...
<dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000017">Deprecated:</a></b></dt><dd>There is now fill and outline colors instead of a single global color. Use <a class="el" href="classsf_1_1Text.php#a6b4ba8c435b59e1e05f831e6230dc537" title="Get the fill color of the text. ">getFillColor()</a> or <a class="el" href="classsf_1_1Text.php#a53559d563461089f1172571b375442dc" title="Get the outline color of the text. ">getOutlineColor()</a> instead.</dd></dl>
...
<p>This function multiplies the current scale of the object, unlike setScale which overwrites it. Thus, it is equivalent to the following code: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a> <a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a> = <span class="keywordtype">object</span>.getScale();</div><div class="line"><span class="keywordtype">object</span>.setScale(<a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a>.x * factorX, <a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a>.y * factorY);</div></div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
<p>Scale the object. </p>
<p>This function multiplies the current scale of the object, unlike setScale which overwrites it. Thus, it is equivalent to the following code: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a> <a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a> = <span class="keywordtype">object</span>.getScale();</div><div class="line"><span class="keywordtype">object</span>.setScale(<a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a>.x * factor.x, <a class="code" href="classsf_1_1Transformable.php#a3de0c6d8957f3cf318092f3f60656391">scale</a>.y * factor.y);</div></div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
