...
<div class="line"><a name="l00044"></a><span class="lineno"><a class="code" href="classsf_1_1IpAddress.php">   44</a></span>&#160;<span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a></div>
<div class="line"><a name="l00045"></a><span class="lineno">   45</span>&#160;{</div>
<div class="line"><a name="l00046"></a><span class="lineno">   46</span>&#160;<span class="keyword">public</span> :</div>
<div class="line"><a name="l00047"></a><span class="lineno">   47</span>&#160;</div>
<div class="line"><a name="l00054"></a><span class="lineno">   54</span>&#160;    <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>();</div>
<div class="line"><a name="l00055"></a><span class="lineno">   55</span>&#160;</div>
<div class="line"><a name="l00065"></a><span class="lineno">   65</span>&#160;    <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>(<span class="keyword">const</span> std::string&amp; address);</div>
<div class="line"><a name="l00066"></a><span class="lineno">   66</span>&#160;</div>
<div class="line"><a name="l00079"></a><span class="lineno">   79</span>&#160;    <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>(<span class="keyword">const</span> <span class="keywordtype">char</span>* address);</div>
<div class="line"><a name="l00080"></a><span class="lineno">   80</span>&#160;</div>
<div class="line"><a name="l00094"></a><span class="lineno">   94</span>&#160;    <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>(Uint8 byte0, Uint8 byte1, Uint8 byte2, Uint8 byte3);</div>
<div class="line"><a name="l00095"></a><span class="lineno">   95</span>&#160;</div>
<div class="line"><a name="l00109"></a><span class="lineno">  109</span>&#160;    <span class="keyword">explicit</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>(Uint32 address);</div>
...
<div class="line"><a name="l00155"></a><span class="lineno">  155</span>&#160;    <span class="keyword">static</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a> getLocalAddress();</div>
<div class="line"><a name="l00156"></a><span class="lineno">  156</span>&#160;</div>
<div class="line"><a name="l00179"></a><span class="lineno">  179</span>&#160;    <span class="keyword">static</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a> getPublicAddress(<a class="code" href="classsf_1_1Time.php" title="Represents a time value.">Time</a> timeout = <a class="code" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0" title="Predefined &quot;zero&quot; time value.">Time::Zero</a>);</div>
<div class="line"><a name="l00180"></a><span class="lineno">  180</span>&#160;</div>
<div class="line"><a name="l00182"></a><span class="lineno">  182</span>&#160;    <span class="comment">// Static member data</span></div>
<div class="line"><a name="l00184"></a><span class="lineno"><a class="code" href="classsf_1_1IpAddress.php#a4619b4abbe3c8fef056e7299db967404">  184</a></span>&#160;<span class="comment"></span>    <span class="keyword">static</span> <span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a> <a class="code" href="classsf_1_1IpAddress.php#a4619b4abbe3c8fef056e7299db967404" title="Value representing an empty/invalid address.">None</a>;      </div>
<div class="line"><a name="l00185"></a><span class="lineno"><a class="code" href="classsf_1_1IpAddress.php#a594d3a8e2559f8fa8ab0a96fa597333b">  185</a></span>&#160;    <span class="keyword">static</span> <span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a> <a class="code" href="classsf_1_1IpAddress.php#a594d3a8e2559f8fa8ab0a96fa597333b" title="The &quot;localhost&quot; address (for connecting a computer to itself locally)">LocalHost</a>; </div>
<div class="line"><a name="l00186"></a><span class="lineno"><a class="code" href="classsf_1_1IpAddress.php#aa93d1d57b65d243f2baf804b6035465c">  186</a></span>&#160;    <span class="keyword">static</span> <span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a> <a class="code" href="classsf_1_1IpAddress.php#aa93d1d57b65d243f2baf804b6035465c" title="The &quot;broadcast&quot; address (for sending UDP messages to everyone on a local network)">Broadcast</a>; </div>
...
<div class="line"><a name="l00205"></a><span class="lineno">  205</span>&#160;SFML_NETWORK_API <span class="keywordtype">bool</span> operator ==(<span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>&amp; left, <span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>&amp; right);</div>
...
<div class="line"><a name="l00271"></a><span class="lineno">  271</span>&#160;SFML_NETWORK_API std::istream&amp; operator &gt;&gt;(std::istream&amp; stream, <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>&amp; address);</div>
<div class="line"><a name="l00272"></a><span class="lineno">  272</span>&#160;</div>
<div class="line"><a name="l00282"></a><span class="lineno">  282</span>&#160;SFML_NETWORK_API std::ostream&amp; operator &lt;&lt;(std::ostream&amp; stream, <span class="keyword">const</span> <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>&amp; address);</div>
