...
<div class="line"><a class="code" href="classsf_1_1Window.php" title="Window that serves as a target for OpenGL rendering.">sf::Window</a> window(<a class="code" href="classsf_1_1VideoMode.php" title="VideoMode defines a video mode (width, height, bpp)">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Limit the framerate to 60 frames per second (this step is optional)</span></div>
<div class="line">window.<a class="code" href="classsf_1_1Window.php#af4322d315baf93405bf0d5087ad5e784" title="Limit the framerate to a maximum fixed frequency.">setFramerateLimit</a>(60);</div>
<div class="line"></div>
...
<div class="line">   window.<a class="code" href="classsf_1_1Window.php#a17ccf8ece0ce0bf2f1e6698bcfa29731" title="Activate or deactivate the window as the current target for OpenGL rendering.">setActive</a>();</div>
<div class="line"></div>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Window.php#ad6513418bb2963347cd1819a1810524d" title="Change the size of the rendering region of the window.">setSize</a> </dd></dl>
...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Event.php" title="Defines a system event and its parameters.">sf::Event</a> event;</div>
<div class="line"><span class="keywordflow">if</span> (window.<a class="code" href="classsf_1_1Window.php#aaf02ab64fbc1d374eef3696df54137bc" title="Wait for an event and return it.">waitEvent</a>(event))</div>
<div class="line">{</div>
<div class="line">   <span class="comment">// process event...</span></div>
<div class="line">}</div>
</div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
