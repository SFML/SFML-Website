...
<tr class="memdesc:a1a16956a6bbea764480c1b80f2e45763"><td class="mdescLeft">&#160;</td><td class="mdescRight"><a class="el" href="classsf_1_1Lock.php" title="Automatic wrapper for locking and unlocking mutexes.">Lock</a> the mutex.  <a href="#a1a16956a6bbea764480c1b80f2e45763"></a><br/></td></tr>
...
<tr class="memdesc:ade71268ffc5e80756652058b01c23c33"><td class="mdescLeft">&#160;</td><td class="mdescRight">Unlock the mutex.  <a href="#ade71268ffc5e80756652058b01c23c33"></a><br/></td></tr>
...
<div class="line"><a class="code" href="classsf_1_1Mutex.php" title="Blocks concurrent access to shared resources from multiple threads.">sf::Mutex</a> mutex;</div>
<div class="line"></div>
<div class="line"><span class="keywordtype">void</span> thread1()</div>
<div class="line">{</div>
<div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763" title="Lock the mutex.">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread2</span></div>
<div class="line">    database.write(...);</div>
<div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33" title="Unlock the mutex.">unlock</a>(); <span class="comment">// if thread2 was waiting, it will now be unblocked</span></div>
<div class="line">}</div>
<div class="line"></div>
<div class="line"><span class="keywordtype">void</span> thread2()</div>
<div class="line">{</div>
<div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#a1a16956a6bbea764480c1b80f2e45763" title="Lock the mutex.">lock</a>(); <span class="comment">// this call will block the thread if the mutex is already locked by thread1</span></div>
<div class="line">    database.write(...);</div>
<div class="line">    mutex.<a class="code" href="classsf_1_1Mutex.php#ade71268ffc5e80756652058b01c23c33" title="Unlock the mutex.">unlock</a>(); <span class="comment">// if thread1 was waiting, it will now be unblocked</span></div>
<div class="line">}</div>
