...
<tr class="memitem:a63da986e144b578135edd48e51c565e8"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundBuffer.php#a63da986e144b578135edd48e51c565e8">loadFromSamples</a> (const Int16 *samples, std::size_t sampleCount, unsigned int channelCount, unsigned int sampleRate)</td></tr>
...
<tr class="memitem:a2df1f1ae89213adee1494b95bb583f9d"><td class="memItemLeft" align="right" valign="top">std::size_t&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1SoundBuffer.php#a2df1f1ae89213adee1494b95bb583f9d">getSampleCount</a> () const </td></tr>
...
<p>A sample is a 16 bits signed integer that defines the amplitude of the sound at a given time. The sound is then restituted by playing these samples at a high rate (for example, 44100 samples per second is the standard rate used for playing CDs). In short, audio samples are like texture pixels, and a <a class="el" href="classsf_1_1SoundBuffer.php" title="Storage for audio samples defining a sound.">sf::SoundBuffer</a> is similar to a <a class="el" href="classsf_1_1Texture.php" title="Image living on the graphics card that can be used for drawing.">sf::Texture</a>.</p>
...
<div class="line"><a class="code" href="classsf_1_1SoundBuffer.php" title="Storage for audio samples defining a sound.">sf::SoundBuffer</a> buffer;</div>
<div class="line"></div>
<div class="line"><span class="comment">// Load it from a file</span></div>
<div class="line"><span class="keywordflow">if</span> (!buffer.<a class="code" href="classsf_1_1SoundBuffer.php#a2be6a8025c97eb622a7dff6cf2594394" title="Load the sound buffer from a file.">loadFromFile</a>(<span class="stringliteral">&quot;sound.wav&quot;</span>))</div>
<div class="line">{</div>
...
<div class="line"><a class="code" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment.">sf::Sound</a> sound1;</div>
<div class="line">sound1.<a class="code" href="classsf_1_1Sound.php#a8b395e9713d0efa48a18628c8ec1972e" title="Set the source buffer containing the audio data to play.">setBuffer</a>(buffer);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Play the sound</span></div>
<div class="line">sound1.<a class="code" href="classsf_1_1Sound.php#a2953ffe632536e72e696fd880ced2532" title="Start or resume playing the sound.">play</a>();</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create another sound source bound to the same buffer</span></div>
<div class="line"><a class="code" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment.">sf::Sound</a> sound2;</div>
<div class="line">sound2.<a class="code" href="classsf_1_1Sound.php#a8b395e9713d0efa48a18628c8ec1972e" title="Set the source buffer containing the audio data to play.">setBuffer</a>(buffer);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Play it with a higher pitch -- the first sound remains unchanged</span></div>
<div class="line">sound2.<a class="code" href="classsf_1_1SoundSource.php#a72a13695ed48b7f7b55e7cd4431f4bb6" title="Set the pitch of the sound.">setPitch</a>(2);</div>
<div class="line">sound2.<a class="code" href="classsf_1_1Sound.php#a2953ffe632536e72e696fd880ced2532" title="Start or resume playing the sound.">play</a>();</div>
...
<p>Definition at line <a class="el" href="SoundBuffer_8hpp_source.php#l00052">52</a> of file <a class="el" href="SoundBuffer_8hpp_source.php">SoundBuffer.hpp</a>.</p>
...
<p>The format of the returned samples is 16 bits signed integer (sf::Int16). The total number of samples in this array is given by the <a class="el" href="classsf_1_1SoundBuffer.php#a2df1f1ae89213adee1494b95bb583f9d" title="Get the number of samples stored in the buffer.">getSampleCount()</a> function.</p>
<dl class="section return"><dt>Returns</dt><dd>Read-only pointer to the array of sound samples</dd></dl>
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1SoundBuffer.php#a2df1f1ae89213adee1494b95bb583f9d" title="Get the number of samples stored in the buffer.">getSampleCount</a> </dd></dl>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1SoundBuffer.php#af8cfa5599739a7edae69c5cba273d33f" title="Load the sound buffer from a file in memory.">loadFromMemory</a>, <a class="el" href="classsf_1_1SoundBuffer.php#ad292156b1e01f6dabd4c0c277d5e079e" title="Load the sound buffer from a custom stream.">loadFromStream</a>, <a class="el" href="classsf_1_1SoundBuffer.php#a63da986e144b578135edd48e51c565e8" title="Load the sound buffer from an array of audio samples.">loadFromSamples</a>, <a class="el" href="classsf_1_1SoundBuffer.php#ab2083dc1a934c64959d9e3f162328a76" title="Save the sound buffer to an audio file.">saveToFile</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>True if loading succeeded, false if it failed</dd></dl>
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1SoundBuffer.php#a2be6a8025c97eb622a7dff6cf2594394" title="Load the sound buffer from a file.">loadFromFile</a>, <a class="el" href="classsf_1_1SoundBuffer.php#ad292156b1e01f6dabd4c0c277d5e079e" title="Load the sound buffer from a custom stream.">loadFromStream</a>, <a class="el" href="classsf_1_1SoundBuffer.php#a63da986e144b578135edd48e51c565e8" title="Load the sound buffer from an array of audio samples.">loadFromSamples</a> </dd></dl>
...
<dl class="section return"><dt>Returns</dt><dd>True if loading succeeded, false if it failed</dd></dl>
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1SoundBuffer.php#a2be6a8025c97eb622a7dff6cf2594394" title="Load the sound buffer from a file.">loadFromFile</a>, <a class="el" href="classsf_1_1SoundBuffer.php#af8cfa5599739a7edae69c5cba273d33f" title="Load the sound buffer from a file in memory.">loadFromMemory</a>, <a class="el" href="classsf_1_1SoundBuffer.php#a63da986e144b578135edd48e51c565e8" title="Load the sound buffer from an array of audio samples.">loadFromSamples</a> </dd></dl>
