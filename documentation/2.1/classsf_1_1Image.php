...
<tr class="memdesc:a2a67930e2fd9ad97cf004e918cf5832b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Create the image and fill it with a unique color.  <a href="#a2a67930e2fd9ad97cf004e918cf5832b"></a><br/></td></tr>
...
<tr class="memdesc:a1c2b960ea12bdbb29e80934ce5268ebf"><td class="mdescLeft">&#160;</td><td class="mdescRight">Create the image from an array of pixels.  <a href="#a1c2b960ea12bdbb29e80934ce5268ebf"></a><br/></td></tr>
...
<tr class="memdesc:a9e4f2aa8e36d0cabde5ed5a4ef80290b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the image from a file on disk.  <a href="#a9e4f2aa8e36d0cabde5ed5a4ef80290b"></a><br/></td></tr>
...
<tr class="memdesc:aaa6c7afa5851a51cec6ab438faa7354c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the image from a file in memory.  <a href="#aaa6c7afa5851a51cec6ab438faa7354c"></a><br/></td></tr>
...
<tr class="memdesc:a21122ded0e8368bb06ed3b9acfbfb501"><td class="mdescLeft">&#160;</td><td class="mdescRight">Load the image from a custom stream.  <a href="#a21122ded0e8368bb06ed3b9acfbfb501"></a><br/></td></tr>
<tr class="separator:a21122ded0e8368bb06ed3b9acfbfb501"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aec0ed16b67df7b512aaa5c53388ba14e"><td class="memItemLeft" align="right" valign="top">bool&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Image.php#aec0ed16b67df7b512aaa5c53388ba14e">saveToFile</a> (const std::string &amp;filename) const </td></tr>
<tr class="memdesc:aec0ed16b67df7b512aaa5c53388ba14e"><td class="mdescLeft">&#160;</td><td class="mdescRight">Save the image to a file on disk.  <a href="#aec0ed16b67df7b512aaa5c53388ba14e"></a><br/></td></tr>
<tr class="separator:aec0ed16b67df7b512aaa5c53388ba14e"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a5c3e9bebdc001c3ebf85ca97039fc86b"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Vector2.php">Vector2u</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Image.php#a5c3e9bebdc001c3ebf85ca97039fc86b">getSize</a> () const </td></tr>
<tr class="memdesc:a5c3e9bebdc001c3ebf85ca97039fc86b"><td class="mdescLeft">&#160;</td><td class="mdescRight">Return the size (width and height) of the image.  <a href="#a5c3e9bebdc001c3ebf85ca97039fc86b"></a><br/></td></tr>
...
<tr class="memdesc:a22f13f8c242a6b38eb73cc176b37ae34"><td class="mdescLeft">&#160;</td><td class="mdescRight">Create a transparency mask from a specified color-key.  <a href="#a22f13f8c242a6b38eb73cc176b37ae34"></a><br/></td></tr>
...
<tr class="memdesc:ab2fa337c956f85f93377dcb52153a45a"><td class="mdescLeft">&#160;</td><td class="mdescRight">Copy pixels from another image onto this one.  <a href="#ab2fa337c956f85f93377dcb52153a45a"></a><br/></td></tr>
...
<tr class="memdesc:a9fd329b8cd7d4439e07fb5d3bb2d9744"><td class="mdescLeft">&#160;</td><td class="mdescRight">Change the color of a pixel.  <a href="#a9fd329b8cd7d4439e07fb5d3bb2d9744"></a><br/></td></tr>
<tr class="separator:a9fd329b8cd7d4439e07fb5d3bb2d9744"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a8c8460e311dcb00557cb00a81c29163d"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Color.php">Color</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Image.php#a8c8460e311dcb00557cb00a81c29163d">getPixel</a> (unsigned int x, unsigned int y) const </td></tr>
<tr class="memdesc:a8c8460e311dcb00557cb00a81c29163d"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the color of a pixel.  <a href="#a8c8460e311dcb00557cb00a81c29163d"></a><br/></td></tr>
<tr class="separator:a8c8460e311dcb00557cb00a81c29163d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ac6137a608a9efaae2735c13ff259c214"><td class="memItemLeft" align="right" valign="top">const Uint8 *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1Image.php#ac6137a608a9efaae2735c13ff259c214">getPixelsPtr</a> () const </td></tr>
<tr class="memdesc:ac6137a608a9efaae2735c13ff259c214"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get a read-only pointer to the array of pixels.  <a href="#ac6137a608a9efaae2735c13ff259c214"></a><br/></td></tr>
...
<tr class="memdesc:a57168e7bc29190e08bbd6c9c19f4bb2c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Flip the image horizontally (left &lt;-&gt; right)  <a href="#a57168e7bc29190e08bbd6c9c19f4bb2c"></a><br/></td></tr>
...
<tr class="memdesc:a78a702a7e49d1de2dec9894da99d279c"><td class="mdescLeft">&#160;</td><td class="mdescRight">Flip the image vertically (top &lt;-&gt; bottom)  <a href="#a78a702a7e49d1de2dec9894da99d279c"></a><br/></td></tr>
...
<div class="line"><a class="code" href="classsf_1_1Image.php" title="Class for loading, manipulating and saving images.">sf::Image</a> background;</div>
<div class="line"><span class="keywordflow">if</span> (!background.<a class="code" href="classsf_1_1Image.php#a9e4f2aa8e36d0cabde5ed5a4ef80290b" title="Load the image from a file on disk.">loadFromFile</a>(<span class="stringliteral">&quot;background.jpg&quot;</span>))</div>
<div class="line">    <span class="keywordflow">return</span> -1;</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create a 20x20 image filled with black color</span></div>
<div class="line"><a class="code" href="classsf_1_1Image.php" title="Class for loading, manipulating and saving images.">sf::Image</a> image;</div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#a2a67930e2fd9ad97cf004e918cf5832b" title="Create the image and fill it with a unique color.">create</a>(20, 20, <a class="code" href="classsf_1_1Color.php#a77c688197b981338f0b19dc58bd2facd" title="Black predefined color.">sf::Color::Black</a>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Copy image1 on image2 at position (10, 10)</span></div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#ab2fa337c956f85f93377dcb52153a45a" title="Copy pixels from another image onto this one.">copy</a>(background, 10, 10);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Make the top-left pixel transparent</span></div>
<div class="line"><a class="code" href="classsf_1_1Color.php" title="Utility class for manpulating RGBA colors.">sf::Color</a> color = image.<a class="code" href="classsf_1_1Image.php#a8c8460e311dcb00557cb00a81c29163d" title="Get the color of a pixel.">getPixel</a>(0, 0);</div>
<div class="line">color.<a class="code" href="classsf_1_1Color.php#a56dbdb47d5f040d9b78ac6a0b8b3a831" title="Alpha (opacity) component.">a</a> = 0;</div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#a9fd329b8cd7d4439e07fb5d3bb2d9744" title="Change the color of a pixel.">setPixel</a>(0, 0, color);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Save the image to a file</span></div>
<div class="line"><span class="keywordflow">if</span> (!image.<a class="code" href="classsf_1_1Image.php#aec0ed16b67df7b512aaa5c53388ba14e" title="Save the image to a file on disk.">saveToFile</a>(<span class="stringliteral">&quot;result.png&quot;</span>))</div>
<div class="line">    <span class="keywordflow">return</span> -1;</div>
...
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
    <tr><td class="paramname">color</td><td><a class="el" href="classsf_1_1Color.php" title="Utility class for manpulating RGBA colors.">Color</a> to make transparent </td></tr>
...
<dl class="section return"><dt>Returns</dt><dd><a class="el" href="classsf_1_1Color.php" title="Utility class for manpulating RGBA colors.">Color</a> of the pixel at coordinates (x, y)</dd></dl>
...
<p>The returned value points to an array of RGBA pixels made of 8 bits integers components. The size of the array is width * height * 4 (<a class="el" href="classsf_1_1Image.php#a5c3e9bebdc001c3ebf85ca97039fc86b" title="Return the size (width and height) of the image.">getSize()</a>.x * <a class="el" href="classsf_1_1Image.php#a5c3e9bebdc001c3ebf85ca97039fc86b" title="Return the size (width and height) of the image.">getSize()</a>.y * 4). Warning: the returned pointer may become invalid if you modify the image, so you should never store it for too long. If the image is empty, a null pointer is returned.</p>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Image.php#aaa6c7afa5851a51cec6ab438faa7354c" title="Load the image from a file in memory.">loadFromMemory</a>, <a class="el" href="classsf_1_1Image.php#a21122ded0e8368bb06ed3b9acfbfb501" title="Load the image from a custom stream.">loadFromStream</a>, <a class="el" href="classsf_1_1Image.php#aec0ed16b67df7b512aaa5c53388ba14e" title="Save the image to a file on disk.">saveToFile</a> </dd></dl>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Image.php#a8c8460e311dcb00557cb00a81c29163d" title="Get the color of a pixel.">getPixel</a> </dd></dl>
