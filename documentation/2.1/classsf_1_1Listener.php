...
<tr class="memdesc:a803a24a1fc04620cacc9f88c6fbc0e3a"><td class="mdescLeft">&#160;</td><td class="mdescRight">Change the global volume of all the sounds and musics.  <a href="#a803a24a1fc04620cacc9f88c6fbc0e3a"></a><br/></td></tr>
...
<tr class="memdesc:a137ea535799bdf70be6ec969673d4d33"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the current value of the global volume.  <a href="#a137ea535799bdf70be6ec969673d4d33"></a><br/></td></tr>
...
<tr class="memdesc:a5bc2d8d18ea2d8f339d23cbf17678564"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the position of the listener in the scene.  <a href="#a5bc2d8d18ea2d8f339d23cbf17678564"></a><br/></td></tr>
...
<tr class="memdesc:a28a27d85cfbf8065c535c39176898fcb"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the position of the listener in the scene.  <a href="#a28a27d85cfbf8065c535c39176898fcb"></a><br/></td></tr>
...
<tr class="memdesc:acd7ee65bc948ca38e1c669aa12340c54"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the current position of the listener in the scene.  <a href="#acd7ee65bc948ca38e1c669aa12340c54"></a><br/></td></tr>
...
<tr class="memdesc:ae479dc15513c6557984d26e32d06d06e"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the orientation of the listener in the scene.  <a href="#ae479dc15513c6557984d26e32d06d06e"></a><br/></td></tr>
...
<tr class="memdesc:a1d99d9457c6ddad93449ecb4f504c2bf"><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the orientation of the listener in the scene.  <a href="#a1d99d9457c6ddad93449ecb4f504c2bf"></a><br/></td></tr>
...
<tr class="memdesc:a54e91baba51d4431474f53ff7f9309f9"><td class="mdescLeft">&#160;</td><td class="mdescRight">Get the current orientation of the listener in the scene.  <a href="#a54e91baba51d4431474f53ff7f9309f9"></a><br/></td></tr>
...
<p><a class="el" href="classsf_1_1Listener.php" title="The audio listener is the point in the scene from where all the sounds are heard.">sf::Listener</a> is a simple interface, which allows to setup the listener in the 3D audio environment (position and direction), and to adjust the global volume.</p>
<p>Because the listener is unique in the scene, <a class="el" href="classsf_1_1Listener.php" title="The audio listener is the point in the scene from where all the sounds are heard.">sf::Listener</a> only contains static functions and doesn't have to be instanciated.</p>
<p>Usage example: </p>
<div class="fragment"><div class="line"><span class="comment">// Move the listener to the position (1, 0, -5)</span></div>
<div class="line"><a class="code" href="classsf_1_1Listener.php#a5bc2d8d18ea2d8f339d23cbf17678564" title="Set the position of the listener in the scene.">sf::Listener::setPosition</a>(1, 0, -5);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Make it face the right axis (1, 0, 0)</span></div>
<div class="line"><a class="code" href="classsf_1_1Listener.php#ae479dc15513c6557984d26e32d06d06e" title="Set the orientation of the listener in the scene.">sf::Listener::setDirection</a>(1, 0, 0);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Reduce the global volume</span></div>
<div class="line"><a class="code" href="classsf_1_1Listener.php#a803a24a1fc04620cacc9f88c6fbc0e3a" title="Change the global volume of all the sounds and musics.">sf::Listener::setGlobalVolume</a>(50);</div>
</div><!-- fragment --> 
...
<dl class="section return"><dt>Returns</dt><dd><a class="el" href="classsf_1_1Listener.php" title="The audio listener is the point in the scene from where all the sounds are heard.">Listener</a>'s orientation</dd></dl>
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Listener.php#ae479dc15513c6557984d26e32d06d06e" title="Set the orientation of the listener in the scene.">setDirection</a> </dd></dl>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Listener.php#a54e91baba51d4431474f53ff7f9309f9" title="Get the current orientation of the listener in the scene.">getDirection</a>, <a class="el" href="classsf_1_1Listener.php#a5bc2d8d18ea2d8f339d23cbf17678564" title="Set the position of the listener in the scene.">setPosition</a> </dd></dl>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Listener.php#acd7ee65bc948ca38e1c669aa12340c54" title="Get the current position of the listener in the scene.">getPosition</a>, <a class="el" href="classsf_1_1Listener.php#ae479dc15513c6557984d26e32d06d06e" title="Set the orientation of the listener in the scene.">setDirection</a> </dd></dl>
