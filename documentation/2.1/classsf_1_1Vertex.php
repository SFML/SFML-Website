...
<tr class="memdesc:a799faa0629442e90f07cd2edb568ff80"><td class="mdescLeft">&#160;</td><td class="mdescRight"><a class="el" href="classsf_1_1Color.php" title="Utility class for manpulating RGBA colors.">Color</a> of the vertex.  <a href="#a799faa0629442e90f07cd2edb568ff80"></a><br/></td></tr>
...
<div class="line"><a class="code" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates.">sf::Vertex</a> vertices[] =</div>
<div class="line">{</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates.">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(  0,   0), <a class="code" href="classsf_1_1Color.php#a127dbf55db9c07d0fa8f4bfcbb97594a" title="Red predefined color.">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>( 0,  0)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates.">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(  0, 100), <a class="code" href="classsf_1_1Color.php#a127dbf55db9c07d0fa8f4bfcbb97594a" title="Red predefined color.">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>( 0, 10)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates.">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(100, 100), <a class="code" href="classsf_1_1Color.php#a127dbf55db9c07d0fa8f4bfcbb97594a" title="Red predefined color.">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(10, 10)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates.">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(100,   0), <a class="code" href="classsf_1_1Color.php#a127dbf55db9c07d0fa8f4bfcbb97594a" title="Red predefined color.">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(10,  0))</div>
<div class="line">};</div>
<div class="line"></div>
<div class="line"><span class="comment">// draw it</span></div>
<div class="line">window.draw(vertices, 4, <a class="code" href="group__graphics.php#gga5ee56ac1339984909610713096283b1ba5041359b76b4bd3d3e6ef738826b8743" title="List of individual quads.">sf::Quads</a>);</div>
...
<p><a class="el" href="classsf_1_1Color.php" title="Utility class for manpulating RGBA colors.">Color</a> of the vertex. </p>
