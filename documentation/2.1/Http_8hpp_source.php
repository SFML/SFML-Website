...
<div class="line"><a name="l00046"></a><span class="lineno"><a class="code" href="classsf_1_1Http.php">   46</a></span>&#160;<span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1Http.php" title="A HTTP client.">Http</a> : <a class="code" href="classsf_1_1NonCopyable.php" title="Utility class that makes any derived class non-copyable.">NonCopyable</a></div>
<div class="line"><a name="l00047"></a><span class="lineno">   47</span>&#160;{</div>
<div class="line"><a name="l00048"></a><span class="lineno">   48</span>&#160;<span class="keyword">public</span> :</div>
<div class="line"><a name="l00049"></a><span class="lineno">   49</span>&#160;</div>
<div class="line"><a name="l00054"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Request.php">   54</a></span>&#160;    <span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1Http_1_1Request.php" title="Define a HTTP request.">Request</a></div>
<div class="line"><a name="l00055"></a><span class="lineno">   55</span>&#160;    {</div>
<div class="line"><a name="l00056"></a><span class="lineno">   56</span>&#160;    <span class="keyword">public</span> :</div>
<div class="line"><a name="l00057"></a><span class="lineno">   57</span>&#160;</div>
<div class="line"><a name="l00062"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598">   62</a></span>&#160;        <span class="keyword">enum</span> <a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598" title="Enumerate the available HTTP methods for a request.">Method</a></div>
<div class="line"><a name="l00063"></a><span class="lineno">   63</span>&#160;        {</div>
<div class="line"><a name="l00064"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598ab822baed393f3d0353621e5378b9fcb4">   64</a></span>&#160;            <a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598ab822baed393f3d0353621e5378b9fcb4" title="Request in get mode, standard method to retrieve a page.">Get</a>,  </div>
<div class="line"><a name="l00065"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598ae8ec4048b9550f8d0747d4199603141a">   65</a></span>&#160;            <a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598ae8ec4048b9550f8d0747d4199603141a" title="Request in post mode, usually to send data to a page.">Post</a>, </div>
<div class="line"><a name="l00066"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Request.php#a620f8bff6f43e1378f321bf53fbf5598a4df23138be7ed60f47aba6548ba65e7b">   66</a></span>&#160;            Head  </div>
<div class="line"><a name="l00067"></a><span class="lineno">   67</span>&#160;        };</div>
<div class="line"><a name="l00068"></a><span class="lineno">   68</span>&#160;</div>
<div class="line"><a name="l00080"></a><span class="lineno">   80</span>&#160;        <a class="code" href="classsf_1_1Http_1_1Request.php" title="Define a HTTP request.">Request</a>(<span class="keyword">const</span> std::string&amp; uri = <span class="stringliteral">&quot;/&quot;</span>, Method method = Get, <span class="keyword">const</span> std::string&amp; body = <span class="stringliteral">&quot;&quot;</span>);</div>
...
<div class="line"><a name="l00146"></a><span class="lineno">  146</span>&#160;        <span class="keyword">friend</span> <span class="keyword">class </span><a class="code" href="classsf_1_1Http.php" title="A HTTP client.">Http</a>;</div>
...
<div class="line"><a name="l00191"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php">  191</a></span>&#160;    <span class="keyword">class </span>SFML_NETWORK_API <a class="code" href="classsf_1_1Http_1_1Response.php" title="Define a HTTP response.">Response</a></div>
...
<div class="line"><a name="l00202"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0158f932254d3f09647dd1f64bd43832">  202</a></span>&#160;            Ok             = 200, </div>
<div class="line"><a name="l00203"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0a6e8bafa9365a0ed10b8a9cbfd0649b">  203</a></span>&#160;            Created        = 201, </div>
<div class="line"><a name="l00204"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8ad328945457bd2f0d65107ba6b5ccd443">  204</a></span>&#160;            Accepted       = 202, </div>
<div class="line"><a name="l00205"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8aefde9e4abf5682dcd314d63143be42e0">  205</a></span>&#160;            NoContent      = 204, </div>
<div class="line"><a name="l00206"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a77327cc2a5e34cc64030b322e61d12a8">  206</a></span>&#160;            ResetContent   = 205, </div>
<div class="line"><a name="l00207"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0cfae3ab0469b73dfddc54312a5e6a8a">  207</a></span>&#160;            PartialContent = 206, </div>
<div class="line"><a name="l00208"></a><span class="lineno">  208</span>&#160;</div>
<div class="line"><a name="l00209"></a><span class="lineno">  209</span>&#160;            <span class="comment">// 3xx: redirection</span></div>
<div class="line"><a name="l00210"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8add95cbd8fa27516821f763488557f96b">  210</a></span>&#160;            MultipleChoices  = 300, </div>
<div class="line"><a name="l00211"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a2f91651db3a09628faf68cbcefa0810a">  211</a></span>&#160;            MovedPermanently = 301, </div>
<div class="line"><a name="l00212"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a05c50d7b17c844e0b909e5802d5f1587">  212</a></span>&#160;            MovedTemporarily = 302, </div>
<div class="line"><a name="l00213"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a060ebc3af266e6bfe045b89e298e2545">  213</a></span>&#160;            NotModified      = 304, </div>
<div class="line"><a name="l00214"></a><span class="lineno">  214</span>&#160;</div>
<div class="line"><a name="l00215"></a><span class="lineno">  215</span>&#160;            <span class="comment">// 4xx: client error</span></div>
<div class="line"><a name="l00216"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a3f88a714cf5483ee22f9051e5a3c080a">  216</a></span>&#160;            BadRequest          = 400, </div>
<div class="line"><a name="l00217"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8ab7a79b7bff50fb1902c19eecbb4e2a2d">  217</a></span>&#160;            Unauthorized        = 401, </div>
<div class="line"><a name="l00218"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a64492842e823ebe12a85539b6b454986">  218</a></span>&#160;            Forbidden           = 403, </div>
<div class="line"><a name="l00219"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8affca8a8319a62d98bd3ef90ff5cfc030">  219</a></span>&#160;            NotFound            = 404, </div>
<div class="line"><a name="l00220"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a12533d00093b190e6d4c0076577e2239">  220</a></span>&#160;            RangeNotSatisfiable = 407, </div>
<div class="line"><a name="l00221"></a><span class="lineno">  221</span>&#160;</div>
<div class="line"><a name="l00222"></a><span class="lineno">  222</span>&#160;            <span class="comment">// 5xx: server error</span></div>
<div class="line"><a name="l00223"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8adae2b2a936414349d55b4ed8c583fed1">  223</a></span>&#160;            InternalServerError = 500, </div>
<div class="line"><a name="l00224"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a6920ba06d7e2bcf0b325da23ee95ef68">  224</a></span>&#160;            NotImplemented      = 501, </div>
<div class="line"><a name="l00225"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8aad0cbad4cdaf448beb763e86bc1f747c">  225</a></span>&#160;            BadGateway          = 502, </div>
<div class="line"><a name="l00226"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8ac4fffba9d5ad4c14171a1bbe4f6adf87">  226</a></span>&#160;            ServiceNotAvailable = 503, </div>
<div class="line"><a name="l00227"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a215935d823ab44694709a184a71353b0">  227</a></span>&#160;            GatewayTimeout      = 504, </div>
<div class="line"><a name="l00228"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8aeb32a1a087d5fcf1a42663eb40c3c305">  228</a></span>&#160;            VersionNotSupported = 505, </div>
<div class="line"><a name="l00229"></a><span class="lineno">  229</span>&#160;</div>
<div class="line"><a name="l00230"></a><span class="lineno">  230</span>&#160;            <span class="comment">// 10xx: SFML custom codes</span></div>
<div class="line"><a name="l00231"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a0af0090420e60bf54da4860749345c95">  231</a></span>&#160;            InvalidResponse  = 1000, </div>
<div class="line"><a name="l00232"></a><span class="lineno"><a class="code" href="classsf_1_1Http_1_1Response.php#a663e071978e30fbbeb20ed045be874d8a7f307376f13bdc06b24fc274ecd2aa60">  232</a></span>&#160;            ConnectionFailed = 1001  </div>
<div class="line"><a name="l00233"></a><span class="lineno">  233</span>&#160;        };</div>
<div class="line"><a name="l00234"></a><span class="lineno">  234</span>&#160;</div>
<div class="line"><a name="l00241"></a><span class="lineno">  241</span>&#160;        <a class="code" href="classsf_1_1Http_1_1Response.php" title="Define a HTTP response.">Response</a>();</div>
...
<div class="line"><a name="l00306"></a><span class="lineno">  306</span>&#160;        <span class="keyword">friend</span> <span class="keyword">class </span><a class="code" href="classsf_1_1Http.php" title="A HTTP client.">Http</a>;</div>
...
<div class="line"><a name="l00338"></a><span class="lineno">  338</span>&#160;    <a class="code" href="classsf_1_1Http.php" title="A HTTP client.">Http</a>();</div>
<div class="line"><a name="l00339"></a><span class="lineno">  339</span>&#160;</div>
<div class="line"><a name="l00354"></a><span class="lineno">  354</span>&#160;    <a class="code" href="classsf_1_1Http.php" title="A HTTP client.">Http</a>(<span class="keyword">const</span> std::string&amp; host, <span class="keywordtype">unsigned</span> <span class="keywordtype">short</span> port = 0);</div>
...
<div class="line"><a name="l00391"></a><span class="lineno">  391</span>&#160;    Response sendRequest(<span class="keyword">const</span> Request&amp; request, <a class="code" href="classsf_1_1Time.php" title="Represents a time value.">Time</a> timeout = <a class="code" href="classsf_1_1Time.php#a8db127b632fa8da21550e7282af11fa0" title="Predefined &quot;zero&quot; time value.">Time::Zero</a>);</div>
...
<div class="line"><a name="l00398"></a><span class="lineno">  398</span>&#160;<span class="comment"></span>    <a class="code" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol.">TcpSocket</a>      m_connection; </div>
<div class="line"><a name="l00399"></a><span class="lineno">  399</span>&#160;    <a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">IpAddress</a>      m_host;       </div>
