...
<tr class="memitem:ab0bf8d32849836f92beb2fd734565481"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1Socket.php#a51bf0fd51057b98a10fbb866246176dc">Status</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1UdpSocket.php#ab0bf8d32849836f92beb2fd734565481">bind</a> (unsigned short port)</td></tr>
...
<div class="line"><a class="code" href="classsf_1_1UdpSocket.php" title="Specialized socket using the UDP protocol.">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ab0bf8d32849836f92beb2fd734565481" title="Bind the socket to a specific port.">bind</a>(55001);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Send a message to 192.168.1.50 on port 55002</span></div>
<div class="line">std::string message = <span class="stringliteral">&quot;Hi, I am &quot;</span> + <a class="code" href="classsf_1_1IpAddress.php#a4c31622ad87edca48adbb8e8ed00ee4a" title="Get the computer&#39;s local address.">sf::IpAddress::getLocalAddress</a>().<a class="code" href="classsf_1_1IpAddress.php#a52f4be92fb0ceb689abc469e4a85fd82" title="Get a string representation of the address.">toString</a>();</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#a664ab8f26f37c21cc4de1b847c2efcca" title="Send raw data to a remote peer.">send</a>(message.c_str(), message.size() + 1, <span class="stringliteral">&quot;192.168.1.50&quot;</span>, 55002);</div>
<div class="line"></div>
...
<div class="line"><a class="code" href="classsf_1_1IpAddress.php" title="Encapsulate an IPv4 network address.">sf::IpAddress</a> sender;</div>
<div class="line"><span class="keywordtype">unsigned</span> <span class="keywordtype">short</span> port;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ade9ca0f7ed7919136917b0b997a9833a" title="Receive raw data from a remote peer.">receive</a>(buffer, <span class="keyword">sizeof</span>(buffer), received, sender, port);</div>
...
<div class="line"><a class="code" href="classsf_1_1UdpSocket.php" title="Specialized socket using the UDP protocol.">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ab0bf8d32849836f92beb2fd734565481" title="Bind the socket to a specific port.">bind</a>(55002);</div>
<div class="line"></div>
...
<div class="line">std::string message = <span class="stringliteral">&quot;Welcome &quot;</span> + sender.<a class="code" href="classsf_1_1IpAddress.php#a52f4be92fb0ceb689abc469e4a85fd82" title="Get a string representation of the address.">toString</a>();</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#a664ab8f26f37c21cc4de1b847c2efcca" title="Send raw data to a remote peer.">send</a>(message.c_str(), message.size() + 1, sender, port);</div>
...
<dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1UdpSocket.php#ab0bf8d32849836f92beb2fd734565481" title="Bind the socket to a specific port.">bind</a> </dd></dl>
