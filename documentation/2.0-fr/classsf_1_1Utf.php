<?php
    ...
    $pagetitle = 'sf::Utf Class Reference'; // the $ title variable is automatically replaced by doxygen with the page title
...
<div class="title">sf::Utf Class Reference<div class="ingroups"><a class="el" href="group__system.php">System module</a></div></div>  </div>
</div><!--header-->
<div class="contents">
