...
<p>Usage example: </p>
<div class="fragment"><div class="line"><span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599" title="Check if a key is pressed.">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142ac3fe5df11d15b57317c053a2ae13d9a9" title="Left arrow.">sf::Keyboard::Left</a>))</div>
<div class="line">{</div>
<div class="line">    <span class="comment">// move left...</span></div>
<div class="line">}</div>
<div class="line"><span class="keywordflow">else</span> <span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599" title="Check if a key is pressed.">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142a2aeb083dea103a8e36b6850b51ef3632" title="Right arrow.">sf::Keyboard::Right</a>))</div>
<div class="line">{</div>
<div class="line">    <span class="comment">// move right...</span></div>
<div class="line">}</div>
<div class="line"><span class="keywordflow">else</span> <span class="keywordflow">if</span> (<a class="code" href="classsf_1_1Keyboard.php#a80a04b2f53005886957f49eee3531599" title="Check if a key is pressed.">sf::Keyboard::isKeyPressed</a>(<a class="code" href="classsf_1_1Keyboard.php#acb4cacd7cc5802dec45724cf3314a142a64b7ecb543c5d03bec8383dde123c95d" title="The Escape key.">sf::Keyboard::Escape</a>))</div>
<div class="line">{</div>
<div class="line">    <span class="comment">// quit...</span></div>
<div class="line">}</div>
</div><!-- fragment --><dl class="section see"><dt>See Also</dt><dd><a class="el" href="classsf_1_1Joystick.php" title="Give access to the real-time state of the joysticks.">sf::Joystick</a>, <a class="el" href="classsf_1_1Mouse.php" title="Give access to the real-time state of the mouse.">sf::Mouse</a> </dd></dl>
