...
<p>Usage example: </p>
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector3.php" title="Utility template class for manipulating 3-dimensional vectors.">sf::Vector3f</a> v1(16.5f, 24.f, -8.2f);</div>
<div class="line">v1.x = 18.2f;</div>
<div class="line"><span class="keywordtype">float</span> y = v1.y;</div>
<div class="line"><span class="keywordtype">float</span> <a class="code" href="classsf_1_1Vector3.php#a2f36ab4b552c028e3a9734c1ad4df7d1" title="Z coordinate of the vector.">z</a> = v1.z;</div>
<div class="line"></div>
<div class="line"><a class="code" href="classsf_1_1Vector3.php" title="Utility template class for manipulating 3-dimensional vectors.">sf::Vector3f</a> v2 = v1 * 5.f;</div>
<div class="line"><a class="code" href="classsf_1_1Vector3.php" title="Utility template class for manipulating 3-dimensional vectors.">sf::Vector3f</a> v3;</div>
