...
<tr class="memitem:a14c7b7816e33ed1ef1f2fdb2404c06b5"><td class="memItemLeft" align="right" valign="top">enum &#160;</td><td class="memItemRight" valign="bottom">{ <a class="el" href="classsf_1_1UdpSocket.php#a14c7b7816e33ed1ef1f2fdb2404c06b5a728a7d33027bee0d65f70f964dd9c9eb">MaxDatagramSize</a> = 65507
 }</td></tr>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a14c7b7816e33ed1ef1f2fdb2404c06b5a728a7d33027bee0d65f70f964dd9c9eb"></a>MaxDatagramSize&#160;</td><td class="fielddoc">
<p>The maximum number of bytes that can be sent in a single UDP datagram. </p>
</td></tr>
</table>

<p>Definition at line <a class="el" href="UdpSocket_8hpp_source.php#l00052">52</a> of file <a class="el" href="UdpSocket_8hpp_source.php">UdpSocket.hpp</a>.</p>
...
<p>Binding the socket to a port is necessary for being able to receive data on that port. You can use the special value <a class="el" href="classsf_1_1Socket.php#a5deb2c955fd347259c3a20d27b2481aaa5a3c30fd128895403afc11076f461b19" title="Special value that tells the system to pick any available port. ">Socket::AnyPort</a> to tell the system to automatically pick an available port, and then call getLocalPort to retrieve the chosen port.</p>
...
<p>Make sure that the packet size is not greater than <a class="el" href="classsf_1_1UdpSocket.php#a14c7b7816e33ed1ef1f2fdb2404c06b5a728a7d33027bee0d65f70f964dd9c9eb" title="The maximum number of bytes that can be sent in a single UDP datagram. ">UdpSocket::MaxDatagramSize</a>, otherwise this function will fail and no data will be sent.</p>
<dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
