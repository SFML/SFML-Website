...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="comment">// Create a new FTP client</span></div><div class="line"><a class="code" href="classsf_1_1Ftp.php">sf::Ftp</a> ftp;</div><div class="line"></div><div class="line"><span class="comment">// Connect to the server</span></div><div class="line"><a class="code" href="classsf_1_1Ftp_1_1Response.php">sf::Ftp::Response</a> response = ftp.<a class="code" href="classsf_1_1Ftp.php#af02fb3de3f450a50a27981961c69c860">connect</a>(<span class="stringliteral">&quot;ftp://ftp.myserver.com&quot;</span>);</div><div class="line"><span class="keywordflow">if</span> (response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Connected&quot;</span> &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Log in</span></div><div class="line">response = ftp.<a class="code" href="classsf_1_1Ftp.php#a686262bc377584cd50e52e1576aa3a9b">login</a>(<span class="stringliteral">&quot;laurent&quot;</span>, <span class="stringliteral">&quot;dF6Zm89D&quot;</span>);</div><div class="line"><span class="keywordflow">if</span> (response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Logged in&quot;</span> &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Print the working directory</span></div><div class="line"><a class="code" href="classsf_1_1Ftp_1_1DirectoryResponse.php">sf::Ftp::DirectoryResponse</a> directory = ftp.<a class="code" href="classsf_1_1Ftp.php#a79c654fcdd0c81e68c4fa29af3b45e0c">getWorkingDirectory</a>();</div><div class="line"><span class="keywordflow">if</span> (directory.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Working directory: &quot;</span> &lt;&lt; directory.<a class="code" href="classsf_1_1Ftp_1_1DirectoryResponse.php#a500793778ad0ed223aa86ed8fbee28a3">getDirectory</a>() &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Create a new directory</span></div><div class="line">response = ftp.<a class="code" href="classsf_1_1Ftp.php#a247b84c4b25da37804218c2b748c4787">createDirectory</a>(<span class="stringliteral">&quot;files&quot;</span>);</div><div class="line"><span class="keywordflow">if</span> (response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Created new directory&quot;</span> &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Upload a file to this new directory</span></div><div class="line">response = ftp.<a class="code" href="classsf_1_1Ftp.php#a46d6e15cddd719288b5a08b685e11765">upload</a>(<span class="stringliteral">&quot;local-path/file.txt&quot;</span>, <span class="stringliteral">&quot;files&quot;</span>, <a class="code" href="classsf_1_1Ftp.php#a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2">sf::Ftp::Ascii</a>);</div><div class="line"><span class="keywordflow">if</span> (response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;File uploaded&quot;</span> &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Send specific commands (here: FEAT to list supported FTP features)</span></div><div class="line">response = ftp.<a class="code" href="classsf_1_1Ftp.php#a44e095103ecbce175a33eaf0820440ff">sendCommand</a>(<span class="stringliteral">&quot;FEAT&quot;</span>);</div><div class="line"><span class="keywordflow">if</span> (response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a4dadbe0fe0a3ef2d571a017e1645e675">isOk</a>())</div><div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Feature list:\n&quot;</span> &lt;&lt; response.<a class="code" href="classsf_1_1Ftp_1_1Response.php#a0015675c528a4a84a671484b9e5499d6">getMessage</a>() &lt;&lt; std::endl;</div><div class="line"></div><div class="line"><span class="comment">// Disconnect from the server (optional)</span></div><div class="line">ftp.<a class="code" href="classsf_1_1Ftp.php#acf7459926f3391cd06bf84337ed6a0f4">disconnect</a>();</div></div><!-- fragment --> 
...
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a1cd6b89ad23253f6d97e6d4ca4d558cba6f253b362639fb5e059dc292762a21ee"></a>Binary&#160;</td><td class="fielddoc">
<p>Binary mode (file is transfered as a sequence of bytes) </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a1cd6b89ad23253f6d97e6d4ca4d558cbac9e544a22dce8ef3177449cb235d15c2"></a>Ascii&#160;</td><td class="fielddoc">
<p><a class="el" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target. ">Text</a> mode using ASCII encoding. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a1cd6b89ad23253f6d97e6d4ca4d558cbabb1e34435231e73c96534c71090be7f4"></a>Ebcdic&#160;</td><td class="fielddoc">
<p><a class="el" href="classsf_1_1Text.php" title="Graphical text that can be drawn to a render target. ">Text</a> mode using EBCDIC encoding. </p>
</td></tr>
</table>

<p>Definition at line <a class="el" href="Ftp_8hpp_source.php#l00055">55</a> of file <a class="el" href="Ftp_8hpp_source.php">Ftp.hpp</a>.</p>
...
<a class="anchor" id="a44e095103ecbce175a33eaf0820440ff"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
