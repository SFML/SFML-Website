...
<p><a class="el" href="classsf_1_1Music.php" title="Streamed music played from an audio file. ">Music</a> objects are sounds that are streamed rather than completely loaded in memory.</p>
<p>This is especially useful for compressed music that usually takes hundreds of MB when it is uncompressed: by streaming it instead of loading it entirely, you avoid saturating the memory and have almost no loading delay.</p>
<p>Apart from that, <a class="el" href="classsf_1_1Music.php" title="Streamed music played from an audio file. ">sf::Music</a> has almost the same features as the <a class="el" href="classsf_1_1SoundBuffer.php" title="Storage for audio samples defining a sound. ">sf::SoundBuffer</a> / <a class="el" href="classsf_1_1Sound.php" title="Regular sound that can be played in the audio environment. ">sf::Sound</a> pair: you can play/pause/stop it, request its parameters (channels, sample rate), change the way it is played (pitch, volume, 3D position, ...), etc.</p>
