...
<div class="title">include/SFML/Audio/SoundStream.hpp</div>  </div>
</div><!--header-->
<div class="contents">
...
<div class="line"><a name="l00055"></a><span class="lineno"><a class="line" href="structsf_1_1SoundStream_1_1Chunk.php#ae0b301e2bdfc530a6dc9efeac7e8a2e7">   55</a></span>&#160;        <span class="keyword">const</span> Int16* <a class="code" href="structsf_1_1SoundStream_1_1Chunk.php#ae0b301e2bdfc530a6dc9efeac7e8a2e7">samples</a>;     </div>
...
<div class="line"><a name="l00262"></a><span class="lineno">  262</span>&#160;    <span class="keywordtype">bool</span> fillAndPushBuffer(<span class="keywordtype">unsigned</span> <span class="keywordtype">int</span> bufferNum, <span class="keywordtype">bool</span> immediateLoop = <span class="keyword">false</span>);</div>
<div class="line"><a name="l00263"></a><span class="lineno">  263</span>&#160;</div>
<div class="line"><a name="l00273"></a><span class="lineno">  273</span>&#160;    <span class="keywordtype">bool</span> fillQueue();</div>
<div class="line"><a name="l00274"></a><span class="lineno">  274</span>&#160;</div>
<div class="line"><a name="l00281"></a><span class="lineno">  281</span>&#160;    <span class="keywordtype">void</span> clearQueue();</div>
<div class="line"><a name="l00282"></a><span class="lineno">  282</span>&#160;</div>
<div class="line"><a name="l00283"></a><span class="lineno">  283</span>&#160;    <span class="keyword">enum</span></div>
<div class="line"><a name="l00284"></a><span class="lineno">  284</span>&#160;    {</div>
<div class="line"><a name="l00285"></a><span class="lineno">  285</span>&#160;        BufferCount = 3 </div>
<div class="line"><a name="l00286"></a><span class="lineno">  286</span>&#160;    };</div>
<div class="line"><a name="l00287"></a><span class="lineno">  287</span>&#160;</div>
<div class="line"><a name="l00289"></a><span class="lineno">  289</span>&#160;    <span class="comment">// Member data</span></div>
<div class="line"><a name="l00291"></a><span class="lineno">  291</span>&#160;<span class="comment"></span>    <a class="code" href="classsf_1_1Thread.php">Thread</a>        m_thread;                  </div>
<div class="line"><a name="l00292"></a><span class="lineno">  292</span>&#160;    <span class="keyword">mutable</span> <a class="code" href="classsf_1_1Mutex.php">Mutex</a> m_threadMutex;             </div>
<div class="line"><a name="l00293"></a><span class="lineno">  293</span>&#160;    Status        m_threadStartState;        </div>
<div class="line"><a name="l00294"></a><span class="lineno">  294</span>&#160;    <span class="keywordtype">bool</span>          m_isStreaming;             </div>
<div class="line"><a name="l00295"></a><span class="lineno">  295</span>&#160;    <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span>  m_buffers[BufferCount];    </div>
<div class="line"><a name="l00296"></a><span class="lineno">  296</span>&#160;    <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span>  m_channelCount;            </div>
<div class="line"><a name="l00297"></a><span class="lineno">  297</span>&#160;    <span class="keywordtype">unsigned</span> <span class="keywordtype">int</span>  m_sampleRate;              </div>
<div class="line"><a name="l00298"></a><span class="lineno">  298</span>&#160;    Uint32        m_format;                  </div>
<div class="line"><a name="l00299"></a><span class="lineno">  299</span>&#160;    <span class="keywordtype">bool</span>          m_loop;                    </div>
<div class="line"><a name="l00300"></a><span class="lineno">  300</span>&#160;    Uint64        m_samplesProcessed;        </div>
<div class="line"><a name="l00301"></a><span class="lineno">  301</span>&#160;    <span class="keywordtype">bool</span>          m_endBuffers[BufferCount]; </div>
<div class="line"><a name="l00302"></a><span class="lineno">  302</span>&#160;};</div>
<div class="line"><a name="l00303"></a><span class="lineno">  303</span>&#160;</div>
<div class="line"><a name="l00304"></a><span class="lineno">  304</span>&#160;} <span class="comment">// namespace sf</span></div>
<div class="line"><a name="l00305"></a><span class="lineno">  305</span>&#160;</div>
<div class="line"><a name="l00306"></a><span class="lineno">  306</span>&#160;</div>
<div class="line"><a name="l00307"></a><span class="lineno">  307</span>&#160;<span class="preprocessor">#endif // SFML_SOUNDSTREAM_HPP</span></div>
<div class="line"><a name="l00308"></a><span class="lineno">  308</span>&#160;</div>
<div class="line"><a name="l00309"></a><span class="lineno">  309</span>&#160;</div>
<div class="ttc" id="structsf_1_1SoundStream_1_1Chunk_php"><div class="ttname"><a href="structsf_1_1SoundStream_1_1Chunk.php">sf::SoundStream::Chunk</a></div><div class="ttdoc">Structure defining a chunk of audio data to stream. </div><div class="ttdef"><b>Definition:</b> <a href="include_2SFML_2Audio_2SoundStream_8hpp_source.php#l00053">include/SFML/Audio/SoundStream.hpp:53</a></div></div>
...
<div class="ttc" id="structsf_1_1SoundStream_1_1Chunk_php_ae0b301e2bdfc530a6dc9efeac7e8a2e7"><div class="ttname"><a href="structsf_1_1SoundStream_1_1Chunk.php#ae0b301e2bdfc530a6dc9efeac7e8a2e7">sf::SoundStream::Chunk::samples</a></div><div class="ttdeci">const Int16 * samples</div><div class="ttdoc">Pointer to the audio samples. </div><div class="ttdef"><b>Definition:</b> <a href="include_2SFML_2Audio_2SoundStream_8hpp_source.php#l00055">include/SFML/Audio/SoundStream.hpp:55</a></div></div>
<div class="ttc" id="classsf_1_1SoundStream_php"><div class="ttname"><a href="classsf_1_1SoundStream.php">sf::SoundStream</a></div><div class="ttdoc">Abstract base class for streamed audio sources. </div><div class="ttdef"><b>Definition:</b> <a href="include_2SFML_2Audio_2SoundStream_8hpp_source.php#l00045">include/SFML/Audio/SoundStream.hpp:45</a></div></div>
...
<div class="ttc" id="structsf_1_1SoundStream_1_1Chunk_php_af47f5d94012acf8b11f056ba77aff97a"><div class="ttname"><a href="structsf_1_1SoundStream_1_1Chunk.php#af47f5d94012acf8b11f056ba77aff97a">sf::SoundStream::Chunk::sampleCount</a></div><div class="ttdeci">std::size_t sampleCount</div><div class="ttdoc">Number of samples pointed by Samples. </div><div class="ttdef"><b>Definition:</b> <a href="include_2SFML_2Audio_2SoundStream_8hpp_source.php#l00056">include/SFML/Audio/SoundStream.hpp:56</a></div></div>
<div class="ttc" id="classsf_1_1Thread_php"><div class="ttname"><a href="classsf_1_1Thread.php">sf::Thread</a></div><div class="ttdoc">Utility class to manipulate threads. </div><div class="ttdef"><b>Definition:</b> <a href="include_2SFML_2System_2Thread_8hpp_source.php#l00048">include/SFML/System/Thread.hpp:48</a></div></div>
