...
<tr class="memitem:a8ce625debd4b1f885366a69faa270086"><td class="memItemLeft" align="right" valign="top">unsigned short&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1UdpSocket.php#a8ce625debd4b1f885366a69faa270086">getLocalPort</a> () const </td></tr>
...
<div class="line"><a class="code" href="classsf_1_1UdpSocket.php">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ad764c3d06d90b4714dcc97a0d1647bcc">bind</a>(55001);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Send a message to 192.168.1.50 on port 55002</span></div>
<div class="line">std::string message = <span class="stringliteral">&quot;Hi, I am &quot;</span> + <a class="code" href="classsf_1_1IpAddress.php#a4c31622ad87edca48adbb8e8ed00ee4a">sf::IpAddress::getLocalAddress</a>().<a class="code" href="classsf_1_1IpAddress.php#a52f4be92fb0ceb689abc469e4a85fd82">toString</a>();</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#a664ab8f26f37c21cc4de1b847c2efcca">send</a>(message.c_str(), message.size() + 1, <span class="stringliteral">&quot;192.168.1.50&quot;</span>, 55002);</div>
<div class="line"></div>
...
<div class="line"><a class="code" href="classsf_1_1IpAddress.php">sf::IpAddress</a> sender;</div>
<div class="line"><span class="keywordtype">unsigned</span> <span class="keywordtype">short</span> port;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ade9ca0f7ed7919136917b0b997a9833a">receive</a>(buffer, <span class="keyword">sizeof</span>(buffer), received, sender, port);</div>
...
<div class="line"><a class="code" href="classsf_1_1UdpSocket.php">sf::UdpSocket</a> socket;</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#ad764c3d06d90b4714dcc97a0d1647bcc">bind</a>(55002);</div>
<div class="line"></div>
...
<div class="line">std::string message = <span class="stringliteral">&quot;Welcome &quot;</span> + sender.<a class="code" href="classsf_1_1IpAddress.php#a52f4be92fb0ceb689abc469e4a85fd82">toString</a>();</div>
<div class="line">socket.<a class="code" href="classsf_1_1UdpSocket.php#a664ab8f26f37c21cc4de1b847c2efcca">send</a>(message.c_str(), message.size() + 1, sender, port);</div>
</div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Socket.php" title="Base class for all the socket types. ">sf::Socket</a>, <a class="el" href="classsf_1_1TcpSocket.php" title="Specialized socket using the TCP protocol. ">sf::TcpSocket</a>, <a class="el" href="classsf_1_1Packet.php" title="Utility class to build blocks of data to transfer over the network. ">sf::Packet</a> </dd></dl>
...
<a class="anchor" id="a6eac107739600c19d0c15b23afc349e5"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a6eac107739600c19d0c15b23afc349e5adee98ca77e6cde0b3d818eb1341e3db0"></a>AnyPort&#160;</td><td class="fielddoc">
...
<a class="anchor" id="a4ff30d48bdd5e5e06391d42f7adff204"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a4ff30d48bdd5e5e06391d42f7adff204a85c89bc58b797626b7211c06eb78e6b5"></a>MaxDatagramSize&#160;</td><td class="fielddoc">
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca6b3d5ba897b6df8ebda86c823b30348a"></a>Done&#160;</td><td class="fielddoc">
<p>The socket has sent / received the data. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca412bf3512c20bfcbcd511858d55acfbd"></a>NotReady&#160;</td><td class="fielddoc">
<p>The socket is not ready to send / receive data yet. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca1c852ba07a30478851e563336d86042e"></a>Partial&#160;</td><td class="fielddoc">
<p>The socket sent a part of the data. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca4cbfeb4c26392f23efa26ae6900ae164"></a>Disconnected&#160;</td><td class="fielddoc">
<p>The TCP socket has been disconnected. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca28b7d8d7de8cf854287b67003316dfbe"></a>Error&#160;</td><td class="fielddoc">
<p>An unexpected error happened. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca6b3d5ba897b6df8ebda86c823b30348a"></a>Done&#160;</td><td class="fielddoc">
<p>The socket has sent / received the data. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a51bf0fd51057b98a10fbb866246176dca412bf3512c20bfcbcd511858d55acfbd"></a>NotReady&#160;</td><td class="fielddoc">
<p>The socket is not ready to send / receive data yet. </p>
...
<table class="fieldtable">
<tr><th colspan="2">Enumerator</th></tr><tr><td class="fieldname"><a class="anchor" id="a5d3ff44e56e68f02816bb0fabc34adf8a61b0d1d657709c3d1412b46d001ea17b"></a>Tcp&#160;</td><td class="fielddoc">
<p>TCP protocol. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a5d3ff44e56e68f02816bb0fabc34adf8a63a22585eabe16c71a78322695e9c1de"></a>Udp&#160;</td><td class="fielddoc">
<p>UDP protocol. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a5d3ff44e56e68f02816bb0fabc34adf8a61b0d1d657709c3d1412b46d001ea17b"></a>Tcp&#160;</td><td class="fielddoc">
<p>TCP protocol. </p>
</td></tr>
<tr><td class="fieldname"><a class="anchor" id="a5d3ff44e56e68f02816bb0fabc34adf8a63a22585eabe16c71a78322695e9c1de"></a>Udp&#160;</td><td class="fielddoc">
<p>UDP protocol. </p>
...
<a class="anchor" id="ad764c3d06d90b4714dcc97a0d1647bcc"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1UdpSocket.php#a2c4abb8102a1bd31f51fcfe7f15427a3" title="Unbind the socket from the local port to which it is bound. ">unbind</a>, <a class="el" href="classsf_1_1UdpSocket.php#a8ce625debd4b1f885366a69faa270086" title="Get the port to which the socket is bound locally. ">getLocalPort</a> </dd></dl>
