...
<p>Usage example: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Mutex.php">sf::Mutex</a> mutex;</div>
<div class="line"></div>
<div class="line"><span class="keywordtype">void</span> <span class="keyword">function</span>()</div>
<div class="line">{</div>
<div class="line">    <a class="code" href="classsf_1_1Lock.php">sf::Lock</a> lock(mutex); <span class="comment">// mutex is now locked</span></div>
<div class="line"></div>
...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1Mutex.php">sf::Mutex</a> mutex;</div>
<div class="line"></div>
<div class="line"><span class="keywordtype">void</span> <span class="keyword">function</span>()</div>
<div class="line">{</div>
<div class="line">    {</div>
<div class="line">      <a class="code" href="classsf_1_1Lock.php">sf::Lock</a> lock(mutex);</div>
