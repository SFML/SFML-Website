...
<div class="line"><a class="code" href="classsf_1_1RenderTexture.php">sf::RenderTexture</a> texture;</div>
<div class="line"><span class="keywordflow">if</span> (!texture.<a class="code" href="classsf_1_1RenderTexture.php#aefbb76eb3b87e368ab974b2660931ccb">create</a>(500, 500))</div>
...
<div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a6bb6f0ba348f2b1e2f46114aeaf60f26">clear</a>(<a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>);</div>
<div class="line"></div>
<div class="line">   <span class="comment">// Draw stuff to the texture</span></div>
<div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(sprite);  <span class="comment">// sprite is a sf::Sprite</span></div>
<div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(shape);   <span class="comment">// shape is a sf::Shape</span></div>
<div class="line">   texture.<a class="code" href="classsf_1_1RenderTarget.php#a12417a3bcc245c41d957b29583556f39">draw</a>(text);    <span class="comment">// text is a sf::Text</span></div>
<div class="line"></div>
<div class="line">   <span class="comment">// We&#39;re done drawing to the texture</span></div>
<div class="line">   texture.<a class="code" href="classsf_1_1RenderTexture.php#af92886d5faef3916caff9fa9ab32c555">display</a>();</div>
<div class="line"></div>
...
<div class="line">   <a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> sprite(texture.<a class="code" href="classsf_1_1RenderTexture.php#a95bc5152c497066d31fdc57da8e17678">getTexture</a>());</div>
