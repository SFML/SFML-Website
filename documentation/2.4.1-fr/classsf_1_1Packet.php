...
Friends</h2></td></tr>
<tr class="memitem:ae50c91e8e9046881024f96682796ccfa"><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="ae50c91e8e9046881024f96682796ccfa"></a>
...
<tr class="memitem:a7e0415ed4a34b5104f6b34682f602c6e"><td class="memItemLeft" align="right" valign="top"><a class="anchor" id="a7e0415ed4a34b5104f6b34682f602c6e"></a>
...
<div class="line">};</div>
<div class="line"></div>
<div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#aa5a465ed02ba29d83ecdafb0ac3fff21">operator &lt;&lt;</a>(<a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; packet, <span class="keyword">const</span> MyStruct&amp; m)</div>
<div class="line">{</div>
<div class="line">    <span class="keywordflow">return</span> packet &lt;&lt; m.number &lt;&lt; m.integer &lt;&lt; m.str;</div>
<div class="line">}</div>
<div class="line"></div>
<div class="line"><a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; <a class="code" href="classsf_1_1Packet.php#af8e26c63ba9bdccd262565ff0d3eeba2">operator &gt;&gt;</a>(<a class="code" href="classsf_1_1Packet.php">sf::Packet</a>&amp; packet, MyStruct&amp; m)</div>
<div class="line">{</div>
<div class="line">    <span class="keywordflow">return</span> packet &gt;&gt; m.number &gt;&gt; m.integer &gt;&gt; m.str;</div>
<div class="line">}</div>
...
<p>Here is an example: </p><div class="fragment"><div class="line"><span class="keyword">class </span>ZipPacket : <span class="keyword">public</span> <a class="code" href="classsf_1_1Packet.php">sf::Packet</a></div>
<div class="line">{</div>
<div class="line">    <span class="keyword">virtual</span> <span class="keyword">const</span> <span class="keywordtype">void</span>* <a class="code" href="classsf_1_1Packet.php#a052e955906c9bfd671622cb625380edc">onSend</a>(std::size_t&amp; size)</div>
<div class="line">    {</div>
<div class="line">        <span class="keyword">const</span> <span class="keywordtype">void</span>* srcData = <a class="code" href="classsf_1_1Packet.php#a304ba9ec94c992710f4dfff879c6340e">getData</a>();</div>
<div class="line">        std::size_t srcSize = <a class="code" href="classsf_1_1Packet.php#a004b62aa5bafa69df8917171a3fe1fa0">getDataSize</a>();</div>
<div class="line"></div>
<div class="line">        <span class="keywordflow">return</span> MySuperZipFunction(srcData, srcSize, &amp;size);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="keyword">virtual</span> <span class="keywordtype">void</span> <a class="code" href="classsf_1_1Packet.php#ab71a31ef0f1d5d856de6f9fc75434128">onReceive</a>(<span class="keyword">const</span> <span class="keywordtype">void</span>* data, std::size_t size)</div>
<div class="line">    {</div>
...
<div class="line"></div>
<div class="line">        <a class="code" href="classsf_1_1Packet.php#a7dd6e429b87520008326c4d71f1cf011">append</a>(dstData, dstSize);</div>
<div class="line">    }</div>
<div class="line">};</div>
<div class="line"></div>
