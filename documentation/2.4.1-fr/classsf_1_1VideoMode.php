...
<div class="line">std::vector&lt;sf::VideoMode&gt; modes = <a class="code" href="classsf_1_1VideoMode.php#a6815b9b3b35767d5b4563fbed4bfc67b">sf::VideoMode::getFullscreenModes</a>();</div>
<div class="line"><span class="keywordflow">for</span> (std::size_t i = 0; i &lt; modes.size(); ++i)</div>
<div class="line">{</div>
<div class="line">    <a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a> mode = modes[i];</div>
<div class="line">    std::cout &lt;&lt; <span class="stringliteral">&quot;Mode #&quot;</span> &lt;&lt; i &lt;&lt; <span class="stringliteral">&quot;: &quot;</span></div>
<div class="line">              &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#a9b3b2ad2cac6b9c266823fb5ed506d90">width</a> &lt;&lt; <span class="stringliteral">&quot;x&quot;</span> &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#a5a88d44c9470db7474361a42a189342d">height</a> &lt;&lt; <span class="stringliteral">&quot; - &quot;</span></div>
<div class="line">              &lt;&lt; mode.<a class="code" href="classsf_1_1VideoMode.php#aa080f1ef96a1008d58b1920eceb189df">bitsPerPixel</a> &lt;&lt; <span class="stringliteral">&quot; bpp&quot;</span> &lt;&lt; std::endl;</div>
<div class="line">}</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create a window with the same pixel depth as the desktop</span></div>
<div class="line"><a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a> desktop = <a class="code" href="classsf_1_1VideoMode.php#ac1be160a4342e6eafb2cb0e8c9b18d44">sf::VideoMode::getDesktopMode</a>();</div>
<div class="line">window.create(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(1024, 768, desktop.<a class="code" href="classsf_1_1VideoMode.php#aa080f1ef96a1008d58b1920eceb189df">bitsPerPixel</a>), <span class="stringliteral">&quot;SFML window&quot;</span>);</div>
</div><!-- fragment --> 
