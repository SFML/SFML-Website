...
<p>Usage example: </p><div class="fragment"><div class="line"><span class="keywordflow">if</span> (<a class="code" href="classsf_1_1SoundRecorder.php#aab2bd0fee9e48d6cfd449b1cb078ce5a">sf::SoundBufferRecorder::isAvailable</a>())</div>
<div class="line">{</div>
<div class="line">    <span class="comment">// Record some audio data</span></div>
<div class="line">    <a class="code" href="classsf_1_1SoundBufferRecorder.php">sf::SoundBufferRecorder</a> recorder;</div>
<div class="line">    recorder.<a class="code" href="classsf_1_1SoundRecorder.php#a715f0fd2f228c83d79aaedca562ae51f">start</a>();</div>
<div class="line">    ...</div>
<div class="line">    recorder.<a class="code" href="classsf_1_1SoundRecorder.php#a8d9c8346aa9aa409cfed4a1101159c4c">stop</a>();</div>
<div class="line"></div>
<div class="line">    <span class="comment">// Get the buffer containing the captured audio data</span></div>
<div class="line">    <span class="keyword">const</span> <a class="code" href="classsf_1_1SoundBuffer.php">sf::SoundBuffer</a>&amp; buffer = recorder.<a class="code" href="classsf_1_1SoundBufferRecorder.php#a84fd636ad22f434bafe2a7c15a8e5107">getBuffer</a>();</div>
<div class="line"></div>
<div class="line">    <span class="comment">// Save it to a file (for example...)</span></div>
<div class="line">    buffer.<a class="code" href="classsf_1_1SoundBuffer.php#ab2083dc1a934c64959d9e3f162328a76">saveToFile</a>(<span class="stringliteral">&quot;my_record.ogg&quot;</span>);</div>
<div class="line">}</div>
...
<a class="anchor" id="a350f7f885ccfd12b4c6c120c23695637"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
