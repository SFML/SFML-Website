...
<div class="line">shader.setUniform(<span class="stringliteral">&quot;current&quot;</span>, <a class="code" href="classsf_1_1Shader.php#ac84c7953eec2e19358ea6e2cc5385b8d">sf::Shader::CurrentTexture</a>);</div>
...
<p>To use the texture of the object being drawn, which cannot be known in advance, you can pass the special value <a class="el" href="classsf_1_1Shader.php#ac84c7953eec2e19358ea6e2cc5385b8d" title="Represents the texture of the object being drawn. ">sf::Shader::CurrentTexture</a>: </p><div class="fragment"><div class="line">shader.setUniform(<span class="stringliteral">&quot;the_texture&quot;</span>, <a class="code" href="classsf_1_1Shader.php#ac84c7953eec2e19358ea6e2cc5385b8d">sf::Shader::CurrentTexture</a>).</div>
</div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
...
</div><!-- fragment --> <div class="fragment"><div class="line">shader.setUniform(<span class="stringliteral">&quot;current&quot;</span>, <a class="code" href="classsf_1_1Shader.php#ac84c7953eec2e19358ea6e2cc5385b8d">sf::Shader::CurrentTexture</a>);</div>
</div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
    <tr><td class="paramname">name</td><td>Name of the texture in the shader </td></tr>
  </table>
