...
<div class="title">sf::VertexBuffer Class Reference<div class="ingroups"><a class="el" href="group__graphics.php">Graphics module</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<p><code>#include &lt;<a class="el" href="VertexBuffer_8hpp_source.php">VertexBuffer.hpp</a>&gt;</code></p>
<div class="dynheader">
...
<tr class="memitem:a812f98083da8f10361d457008bf9fa79"><td class="memItemLeft" align="right" valign="top"><a class="el" href="classsf_1_1VertexBuffer.php">VertexBuffer</a> &amp;&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="classsf_1_1VertexBuffer.php#a812f98083da8f10361d457008bf9fa79">operator=</a> (const <a class="el" href="classsf_1_1VertexBuffer.php">VertexBuffer</a> &amp;right)</td></tr>
...
<p>Example: </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vertex.php">sf::Vertex</a> vertices[15];</div><div class="line">...</div><div class="line">sf::VertexBuffer triangles(<a class="code" href="group__graphics.php#gga5ee56ac1339984909610713096283b1ba880a7aa72c20b9f9beb7eb64d2434670">sf::Triangles</a>);</div><div class="line">triangles.create(15);</div><div class="line">triangles.update(vertices);</div><div class="line">...</div><div class="line">window.draw(triangles);</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd><a class="el" href="classsf_1_1Vertex.php" title="Define a point with color and texture coordinates. ">sf::Vertex</a>, <a class="el" href="classsf_1_1VertexArray.php" title="Define a set of one or more 2D primitives. ">sf::VertexArray</a> </dd></dl>
...
<div class="fragment"><div class="line"><a class="code" href="classsf_1_1VertexBuffer.php">sf::VertexBuffer</a> vb1, vb2;</div><div class="line">...</div><div class="line">sf::VertexBuffer::bind(&amp;vb1);</div><div class="line"><span class="comment">// draw OpenGL stuff that use vb1...</span></div><div class="line"><a class="code" href="classsf_1_1VertexBuffer.php#a1c623e9701b43125e4b3661bc0d0b65b">sf::VertexBuffer::bind</a>(&amp;vb2);</div><div class="line"><span class="comment">// draw OpenGL stuff that use vb2...</span></div><div class="line"><a class="code" href="classsf_1_1VertexBuffer.php#a1c623e9701b43125e4b3661bc0d0b65b">sf::VertexBuffer::bind</a>(NULL);</div><div class="line"><span class="comment">// draw OpenGL stuff that use no vertex buffer...</span></div></div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
  <table class="params">
