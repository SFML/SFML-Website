...
<div class="line"><a class="code" href="classsf_1_1Window.php">sf::Window</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Limit the framerate to 60 frames per second (this step is optional)</span></div>
<div class="line">window.<a class="code" href="classsf_1_1Window.php#af4322d315baf93405bf0d5087ad5e784">setFramerateLimit</a>(60);</div>
<div class="line"></div>
<div class="line"><span class="comment">// The main loop - ends as soon as the window is closed</span></div>
<div class="line"><span class="keywordflow">while</span> (window.<a class="code" href="classsf_1_1Window.php#a5aa9c2b2b0e51d3423c2b66c80253337">isOpen</a>())</div>
<div class="line">{</div>
...
<div class="line">   window.<a class="code" href="classsf_1_1RenderWindow.php#aee6c53eced675e885931eb3e91f11155">setActive</a>();</div>
<div class="line"></div>
...
<div class="line">   window.<a class="code" href="classsf_1_1Window.php#adabf839cb103ac96cfc82f781638772a">display</a>();</div>
<div class="line">}</div>
</div><!-- fragment --> 
...
<div class="line"><span class="keywordflow">if</span> (window.<a class="code" href="classsf_1_1Window.php#aaf02ab64fbc1d374eef3696df54137bc">waitEvent</a>(event))</div>
<div class="line">{</div>
<div class="line">   <span class="comment">// process event...</span></div>
<div class="line">}</div>
</div><!-- fragment --><dl class="params"><dt>Parameters</dt><dd>
