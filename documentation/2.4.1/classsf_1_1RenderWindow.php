...
<div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML window&quot;</span>);</div>
<div class="line"></div>
...
<div class="line">   <a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div>
...
<div class="line"><a class="code" href="classsf_1_1RenderWindow.php">sf::RenderWindow</a> window(<a class="code" href="classsf_1_1VideoMode.php">sf::VideoMode</a>(800, 600), <span class="stringliteral">&quot;SFML OpenGL&quot;</span>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create a sprite and a text to display</span></div>
<div class="line"><a class="code" href="classsf_1_1Sprite.php">sf::Sprite</a> sprite;</div>
<div class="line"><a class="code" href="classsf_1_1Text.php">sf::Text</a> text;</div>
<div class="line">...</div>
<div class="line"></div>
...
<dl class="deprecated"><dt><b><a class="el" href="deprecated.php#_deprecated000021">Deprecated:</a></b></dt><dd>Use a <a class="el" href="classsf_1_1Texture.php" title="Image living on the graphics card that can be used for drawing. ">sf::Texture</a> and its <a class="el" href="classsf_1_1Texture.php#ad3cceef238f7d5d2108a98dd38c17fc5" title="Update the texture from the contents of a window. ">sf::Texture::update(const Window&amp;)</a> function and copy its contents into an <a class="el" href="classsf_1_1Image.php" title="Class for loading, manipulating and saving images. ">sf::Image</a> instead. <div class="fragment"><div class="line"><a class="code" href="classsf_1_1Vector2.php">sf::Vector2u</a> windowSize = window.getSize();</div>
<div class="line"><a class="code" href="classsf_1_1Texture.php">sf::Texture</a> texture;</div>
<div class="line">texture.<a class="code" href="classsf_1_1Texture.php#a89b4c7d204acf1033c3a1b6e0a3ad0a3">create</a>(windowSize.<a class="code" href="classsf_1_1Vector2.php#a1e6ad77fa155f3753bfb92699bd28141">x</a>, windowSize.<a class="code" href="classsf_1_1Vector2.php#a420f2481b015f4eb929c75f2af564299">y</a>);</div>
<div class="line">texture.<a class="code" href="classsf_1_1Texture.php#ae4eab5c6781316840b0c50ad08370963">update</a>(window);</div>
<div class="line"><a class="code" href="classsf_1_1Image.php">sf::Image</a> screenshot = texture.<a class="code" href="classsf_1_1Texture.php#aefc19bcd95565dd2348fd4cec0facddc">copyToImage</a>();</div>
</div><!-- fragment --></dd></dl>
...
<p>This function is not blocking: if there's no pending event then it will return false and leave <em>event</em> unmodified. Note that more than one event may be present in the event queue, thus you should always call this function in a loop to make sure that you process every pending event. </p><div class="fragment"><div class="line"><a class="code" href="classsf_1_1Event.php">sf::Event</a> event;</div>
<div class="line"><span class="keywordflow">while</span> (window.pollEvent(event))</div>
<div class="line">{</div>
...
<a class="anchor" id="aee6c53eced675e885931eb3e91f11155"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
