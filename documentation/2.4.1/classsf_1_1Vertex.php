...
<div class="line">{</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(  0,   0), <a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>( 0,  0)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(  0, 100), <a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>( 0, 10)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(100, 100), <a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(10, 10)),</div>
<div class="line">    <a class="code" href="classsf_1_1Vertex.php">sf::Vertex</a>(<a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(100,   0), <a class="code" href="classsf_1_1Color.php#a7052b1c5408a953e25f9691e0e828c9d">sf::Color::Red</a>, <a class="code" href="classsf_1_1Vector2.php">sf::Vector2f</a>(10,  0))</div>
<div class="line">};</div>
<div class="line"></div>
<div class="line"><span class="comment">// draw it</span></div>
<div class="line">window.draw(vertices, 4, <a class="code" href="group__graphics.php#gga5ee56ac1339984909610713096283b1bac968add05250b2cf59350dc68043a3c0">sf::Quads</a>);</div>
