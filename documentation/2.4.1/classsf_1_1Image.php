...
<div class="line"><a class="code" href="classsf_1_1Image.php">sf::Image</a> background;</div>
<div class="line"><span class="keywordflow">if</span> (!background.<a class="code" href="classsf_1_1Image.php#a9e4f2aa8e36d0cabde5ed5a4ef80290b">loadFromFile</a>(<span class="stringliteral">&quot;background.jpg&quot;</span>))</div>
<div class="line">    <span class="keywordflow">return</span> -1;</div>
<div class="line"></div>
<div class="line"><span class="comment">// Create a 20x20 image filled with black color</span></div>
<div class="line"><a class="code" href="classsf_1_1Image.php">sf::Image</a> image;</div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#a2a67930e2fd9ad97cf004e918cf5832b">create</a>(20, 20, <a class="code" href="classsf_1_1Color.php#a25bf5208c8c7668f1a3836acbbb23986">sf::Color::Black</a>);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Copy image1 on image2 at position (10, 10)</span></div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#ab2fa337c956f85f93377dcb52153a45a">copy</a>(background, 10, 10);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Make the top-left pixel transparent</span></div>
<div class="line"><a class="code" href="classsf_1_1Color.php">sf::Color</a> color = image.<a class="code" href="classsf_1_1Image.php#a8c8460e311dcb00557cb00a81c29163d">getPixel</a>(0, 0);</div>
<div class="line">color.<a class="code" href="classsf_1_1Color.php#a56dbdb47d5f040d9b78ac6a0b8b3a831">a</a> = 0;</div>
<div class="line">image.<a class="code" href="classsf_1_1Image.php#a9fd329b8cd7d4439e07fb5d3bb2d9744">setPixel</a>(0, 0, color);</div>
<div class="line"></div>
<div class="line"><span class="comment">// Save the image to a file</span></div>
<div class="line"><span class="keywordflow">if</span> (!image.<a class="code" href="classsf_1_1Image.php#aec0ed16b67df7b512aaa5c53388ba14e">saveToFile</a>(<span class="stringliteral">&quot;result.png&quot;</span>))</div>
<div class="line">    <span class="keywordflow">return</span> -1;</div>
