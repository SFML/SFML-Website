...
<table class="directory">
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a1cd6b89ad23253f6d97e6d4ca4d558cba8576756172e84a60a8b3410b95273557">Ascii</a> enum value</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a1cd6b89ad23253f6d97e6d4ca4d558cba8d9a3497be63da2bf7ed663b1bfd7449">Binary</a> enum value</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a7e93488ea6330dd4dd76e428da9bb6d3">changeDirectory</a>(const std::string &amp;directory)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#af02fb3de3f450a50a27981961c69c860">connect</a>(const IpAddress &amp;server, unsigned short port=21, Time timeout=Time::Zero)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a247b84c4b25da37804218c2b748c4787">createDirectory</a>(const std::string &amp;name)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a2a8a7ef9144204b5b319c9a4be8806c2">deleteDirectory</a>(const std::string &amp;name)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a8aa272b0eb7769a850006e70fcad370f">deleteFile</a>(const std::string &amp;name)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#acf7459926f3391cd06bf84337ed6a0f4">disconnect</a>()</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a20c1600ec5fd6f5a2ad1429ab8aa5df4">download</a>(const std::string &amp;remoteFile, const std::string &amp;localPath, TransferMode mode=Binary)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a1cd6b89ad23253f6d97e6d4ca4d558cbaae2f269da401c71e5cfe5206726a9f30">Ebcdic</a> enum value</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a8f37258e461fcb9e2a0655e9df0be4a0">getDirectoryListing</a>(const std::string &amp;directory=&quot;&quot;)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a79c654fcdd0c81e68c4fa29af3b45e0c">getWorkingDirectory</a>()</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#aa1127d442b4acb2105aa8060a39d04fc">keepAlive</a>()</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a8f99251d7153e1dc26723e4006deb764">renameFile</a>(const std::string &amp;file, const std::string &amp;newName)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
  ...
  <tr class="even"><td class="entry"><a class="el" href="classsf_1_1Ftp.php#a46d6e15cddd719288b5a08b685e11765">upload</a>(const std::string &amp;localFile, const std::string &amp;remotePath, TransferMode mode=Binary)</td><td class="entry"><a class="el" href="classsf_1_1Ftp.php">sf::Ftp</a></td><td class="entry"></td></tr>
